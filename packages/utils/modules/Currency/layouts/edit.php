...
<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
    <tr>
        <td class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px" width="60%"><i class="fa fa-dollar w3-text-orange" style="font-size: 26px;"></i> [[.currency.]]</td>
		<td  width="40%" align="right">
				<?php if(USER::can_edit(false,ANY_CATEGORY)) {?><input type="submit" value="[[.Save.]]" class="w3-btn w3-blue" name="confirm_edit" style="margin-right: 5px;" />
					<input type="button" value="[[.delete.]]" class="w3-btn w3-red" onclick="mi_delete_selected_row('mi_currency');" />
				<?php }?>
		</td>
    </tr>
</table>
	...
	<div style="background-color:#EFEFEF;">
		<span id="mi_currency_all_elems">
			<span style="white-space:nowrap;">
				...
				<span class="multi_edit_input_header"><span style="width:180px;">[[.name.]]</span></span>
                <span class="multi_edit_input_header"><span style="width:80px;">[[.symbol.]]</span></span>
                <span class="multi_edit_input_header"><span style="width:105px;">[[.exchange_rate.]]</span></span>
                <span class="multi_edit_input_header"><span style="width:100px; text-align: center;">[[.use.]]</span></span>
				<span class="multi_edit_input_header"><span style="width:20px; text-align: center;">[[.delete.]]</span></span>
				<br/>
			</span>
		</span>
	</div>
	<?php 
	if(USER::can_add(false,ANY_CATEGORY)){?><input class="w3-btn w3-cyan w3-text-white" style="margin-top: 5px;" type="button" value="[[.add_currency.]]" onclick="mi_add_new_row('mi_currency');$('name_'+input_count).focus();"/><?php }?>[[|paging|]]
</div>
	</form>
<script>
