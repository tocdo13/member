...
<div class="form_bound">
	<script type="text/javascript" >
		...
		$('title_region').innerHTML='<table cellpadding="15" width="100%" class="table-bound"><tr><td  class="form-title" width="70%"><img alt="" src="packages/core/skins/default/images/buttons/<?php echo $action;?>_button.gif" align="absmiddle"/><?php echo $title;?></td><?php 
			if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a href="#a" onclick="ZoneForm.submit();"><img alt="" src="packages/core/skins/default/images/buttons/delete_button.gif" style="text-align:center"/><br />[[.do_action.]]<\/a></td><?php 
			}else{ 
...
<table cellspacing="0" cellpadding="5">
  <tr valign="top" >
	...
	<form name="ZoneForm" method="post">
