...
* @see Asido_Driver}
*/
include_once ASIDO_DIR . "packages/core/includes/utils/image/class.driver.php";

/**
* @see Asido_Image}
*/
include_once ASIDO_DIR . "packages/core/includes/utils/image/class.image.php";
...
Class Asido {
	...
	*/
	function __driver_filename($driver_name) {
		return ASIDO_DIR . sprintf('packages/core/includes/utils/image/class.driver.%s.php', strtolower($driver_name));
		}
