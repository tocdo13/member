(function ($) {
	$.widget("ui.rcarousel", {
		_create: function() {
			...
			// save all children of root element in â€˜pathsâ€™ array
			this._saveElements();
		...
		_generatePages: function() {
			...
			// creates 3 pages for â€˜visible: 5â€™ and â€˜step: 4â€™:
			// [ABCDE], [EFGHI], [FGHIJ]
			...
			function _paginate() {
				...
				while ( !_islastPage(data.pages[data.pages.length - 1]) || _isBeginning ) {
					...
					// we must assure that we have always â€˜visibleâ€™ (5 in our example) elements
					...
					if ( _complement ) {
						...
						// first add old elemets; for 3rd page it adds [FGHIâ€¦]
		...
		_goToPrevPage: function( by ) {
			...
			// CD page was shown (from 5 elements) â€˜_theSameâ€™ is true because
			// we compare the same
			...
			// for [ABCDFGHIJ] elements there are 3 pages for â€˜visibleâ€™ = 6 and
			// â€˜stepâ€™ = 2: [ABCDEF], [CDEFGH] and [EFGHIJ]; going from the 3rd
		...
		_goToNextPage: function( by ) {
			...
			// ABCD page was shown (from 5 elements) â€˜_theSameâ€™ is true because
			// we compare the same
			...
			// for [ABCDFGHIJ] elements there are 3 pages for â€˜visibleâ€™ = 6 and
			// â€˜stepâ€™ = 2: [ABCDEF], [CDEFGH] and [EFGHIJ]; going from the 2nd
		...
		_saveElements: function() {
			...
			$elements.each(
				function( i, el ) {
					...
					// keep elementâ€™s data and events
