  ...
  $.buildOfficeBar = function(object, options) {
    ...
    var officeBarClass = {
      ...
      showDropDown: function(triggerButton) {
		$('.buttonsplitmenu').css("display", "none");
        var me = $(triggerButton);
        var eventInfo = { id: me.attr("id"), rel: me.attr("rel") };
        var menu = me.data("officebar.menu");
        var pos = me.offset();
		var width = $('.officebar').offset().left;
        menu.css({top: (pos.top+20), left: (pos.left-width)}).show();
    ...
    //dropdown lists
    $("div.dropdown ul>li", object).each(function() {
      $(this).wrapInner('<span></span>');
    });
    ...
    $("div.split>div", object).each(function() {
      ...
      .data("officebar.menu",
         me.clone()
          ...
          .css({top: (pos.top+5), left: (pos.left-width), display: "none"})
          .appendTo(object)
    ...
    $("div.dropdown div", object).each(function(){
      var me = $(this);
      me.prev() //TODO: check node type
        .data("officebar.menu",
           me.clone()
    ...
    $("div.dropdown>a", object).bind("click", function(e) {
      var me = $(this);
      var menu = me.data("officebar.menu");
      if(menu) {
        if(menu.is(":visible")) {
