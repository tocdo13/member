...
(function( $ ){
  $.fn.printPage = function(options) {
   ...
   //this.live("mouseover", function(){  loadPrintDocument(this, pluginOptions); return false;  });
	...
	// $("body").append(components.messageBox(pluginOptions.message));
      $("#printer").append(components.messageBox(pluginOptions.message));
    ...
    function unloadMessage(){
      $("#printMessageBox").delay(500).animate({opacity:0}, 1000, function(){
        $(this).remove();
      });
    }
    /*
