...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Image','Flash','Table','Rule','Smiley','SpecialChar','PageBreak','UniversalKey'],['FitWindow'],
	'/',
...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','FontFormat','Image'],['FontName','FontSize','TextColor','BGColor']
	
] ;
FCKConfig.ToolbarSets["binh_moc"] = [
	['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','FontFormat'],['FontName','FontSize','TextColor','BGColor']
