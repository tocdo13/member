    ...
    protected function clearQueuedAddresses($kind)
    {
        if (version_compare(PHP_VERSION, '5.3.0', '<')) {
            ...
            $this->RecipientsQueue = array_filter(
                $this->RecipientsQueue,$this->clearQueuedAddressesClosure($params,$kind));
        }
    }
    
    protected function clearQueuedAddressesClosure($paramsClosure,$kindClosure){
        return $paramsClosure[0] != $kindClosure;
    }
