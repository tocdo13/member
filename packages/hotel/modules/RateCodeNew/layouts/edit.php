    ...
    <div class="container-fuild">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title">[[.rate_code_infomation.]]</h4>
            </div>
            <div class="panel-body">
                <div class="col-md-2 col-md-offset-10">
                    <input style="margin-right: 20px;" class="btn btn-info" type="submit" value="[[.save.]]"/>
                    <button class="btn btn-danger" type="button" onclick="if(confirm('[[.are_you_sure.]]')) window.close();">[[.close.]]</button>
                </div>
                <div class="col-md-12">
                        <div>
                            <div class="form-group" style="width:10%; float:left; margin-right:90px; margin-left:90px">
                                <label>[[.code.]] (*) :</label>
                                <input required="" class="form-control" name="code" <?php if(isset([[=schedule_list=]])){ echo "readonly=''";}?> value="[[|rate_code_code|]]" />
                            </div>
                            <div class="form-group" style="width:20%; float:left; ">
                                <label>[[.name.]] (*) :</label>
                                <input required="" class="form-control" name="name" value="[[|rate_code_name|]]" />
                            </div>
                            <div class="col-md-1 col-md-offset2" style="float: left; margin-top: 21px; margin-left: 50px;">
                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#setTime" id="setSchedule">[[.create_schedule.]]</button>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="setTimeLabel">[[.create_schedule.]]</h4>
                                      </div>
                                      <div class="modal-body">
                                           <div id="define_content">
                                                <div class="form-group inline">
                                                    <label style="width: 10%;">[[.loop.]]</label>
                                                    <select onchange="stringDate();" id="loop" name="loop" class="form-control" style="width: 30%;">
                                                        <option value="d">[[.every_day.]]</option>
                                                        <option value="w">[[.every_week.]]</option>
                                                    </select>
                                                </div>
                                                <div id="loopInfo" class="form-group">
                                                    <label style="width: 15%;">[[.loop_in.]] : </label>
                                                    <div class="checkbox" style="margin-bottom: 20px;">
                                                        <label>
                                                            <input id="in_week" onclick="checkInWeek();" type="checkbox"  /><span>[[.weekdays.]]</span>
                                                        </label>
                                                        <label>
                                                            <input id="out_week" onclick="checkInWeek();" type="checkbox"  /><span>[[.weekend.]]</span>
                                                        </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                ...
                                                <div id="inputDate">
                                                    <div class="form-group indate" id="add_1">
                                                        <label>[[.time_slot.]]:</label>
                                                            <span class="spFrom">[[.from.]] :</span> <input time="ok" type="date" name="from_date" id="from_date" class="form-control" style="width: 35%; float:left;"/>
                                                            <span class="spTo">[[.to.]] :</span> <input time="ok" type="date" name="to_date" id="to_date" class="form-control" style="width: 35%; float: left;"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="margin-top: 20px;" >
                                                    <label>[[.brief.]]:</label>
                                                    <p id="content" style="color: maroon;">[[.every_day.]]</p>
                                                    <input id="strHidden" name="strHidden" type="hidden" value="" />
                                                    <input id="sttHour" name="sttHour" type="hidden" value="1" />
                                                </div>
                                                <div class="form-group">
                                                    <label>[[.choose_priority.]] :  </label>
                                                    <div class="radio">
                                                        <label><input  type="radio" class="radio" name="special" value="1" /> <span style="padding-top:4px; display:block;">[[.level1.]]</span></label>
                                                    </div>
                                                    <div class="radio">
                                                        <label><input checked="" type="radio" class="radio" name="special" value="2" /> <span style="padding-top:4px; display:block;">[[.level2.]]</span></label>
                                                    </div>
                                                    <div class="radio">
                                                        <label><input checked="" type="radio" class="radio" name="special" value="3" /> <span style="padding-top:4px; display:block;">[[.level3.]]</span></label>
                                                    </div>
                                                </div>
                                            </div> 
                                      </div>
                            ...
                            <div class="col-md-2 col-md-offset2" style="margin-top: 20px; margin-bottom:20px; margin-left: 50px;">
                                <button data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-primary">[[.customer_group_list.]]</button>
                                <div style="overflow-y: auto !important;" class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel">[[.customer_group_list.]]</h4>
                                      </div>
                                      <div class="modal-body">
                                                ...
                                                <tbody>
                                                    <!--LIST:group_list-->
                                                            <tr class="customer_group">
                                                                <td><input id="[[|group_list.id|]]" type="checkbox" onclick="checkAllCustomer(this);"/></td>
                                                                <td onclick="open_customer(this);"><label style="width: 100%; height:inherit; color:blue;">[[|group_list.id|]]</label></td>
                                                                <td onclick="open_customer(this);"><label style="width: 90%; height:inherit; float:left; color:blue;">[[|group_list.name|]]</label> <span style="display: block; float:left; margin-top:12px;" class="glyphicon glyphicon-chevron-down"></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3" style="display:none;">
                                                                <!--LIST:group_list.items-->
                                                                    <div style="float: left; width:50%; padding:5px 0px;">
                                                                        <input name="group_list[]" type="checkbox" id="group_list[]" check_group_list="" onclick="tick_items(this);" value="[[|group_list.items.id|]]" />
                                                                        <label onclick="click_item(this);" style=" color:green;">[[|group_list.items.name|]]</label>
                                                                    </div>   
                                                                <!--/LIST:group_list.items-->
                                                                </td>
                                                            </tr>     
                                ...
                                <div style="overflow-y: auto;" class="modal fade" id="setPrice" tabindex="-1" role="dialog" aria-labelledby="setPriceLabel">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="setPriceLabel">[[.price_list.]]</h4>
                                      </div>
                                      <div class="modal-body">
                                         <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>[[.room_level_name.]]</th>
                                                    <th>[[.price.]]</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <!--LIST:room_level_list-->
                                                    <tr>
                                                        <td>[[|room_level_list.name|]]</td>
                                                        <td><input r_id="[[|room_level_list.id|]]" type="text" class="input_number" style="text-align: right;" oninput="this.value = number_format(to_numeric(this.value));" /></td>
                                                    </tr>
                                                <!--/LIST:room_level_list-->
                                            </tbody>
                                         </table>   
                                      ...
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" onclick="setPriceValue();">[[.save.]]</button>
                                        <button type="button" class="btn btn-default" data-dismiss="modal">[[.close.]]</button>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div class="clear"></div>
                            <div id="ScheduleWrapper" <?php if(!isset([[=schedule_list=]])) echo "style='display: none;'" ?> >
                                <div id="threadSchedule" class="Schedule">
                                    ...
                                    <div>[[.loop_in.]]</div>
                                    <div>[[.priority.]]</div>
                                    <div>[[.price_list.]]<button type="button" onclick="quickSetup()" title="[[.quick_setup.]]" class="pull-right btn btn-success btn-xs" style="margin: 11px 5px 0px 0px;"><span class="glyphicon glyphicon-import"></span></button></div>
                                    <div></div>
                                    <div></div>
                                    <div></div>
                                </div>
                                 ...
                                 ?>
                                    <!--LIST:schedule_list-->
                                        <div id="bodySchedule_<?php echo $k; ?>" class="Schedule">
                                            ...
                                            <div class='loopInfo' id='from_date_info' onclick='viewEditModal(<?php echo $k; ?>);'><?php echo date("d/m/Y", strtotime([[=schedule_list.start_date=]])); ?></div>
                                            <div class='loopInfo' id='to_date_info' onclick='viewEditModal(<?php echo $k; ?>);'><?php echo date("d/m/Y", strtotime([[=schedule_list.end_date=]])); ?></div>
                                            <div class='loopInfo' id='brief_info' onclick='viewEditModal(<?php echo $k; ?>);'>[[|schedule_list.brief|]]</div>
                                            <div class='loopInfo' id='priority_info' onclick='viewEditModal(<?php echo $k; ?>);'>[[|schedule_list.strPriority|]]</div>
                                            <div style="text-align:center; padding-top:9px;"><button  onclick='setPriceValueId(<?php echo $k; ?>)' type='button' class='btn btn-xs btn-success' data-toggle='modal' data-target='#setPrice'>[[.price_list.]]</button></div>
                                            <div style="text-align:center; padding-top:9px;"><button onclick='copyPrice(<?php echo $k; ?>);' type='button' class='btn btn-sm btn-primary' title="[[.copy.]]"><span style="color:white;" class="glyphicon glyphicon glyphicon-copy"></span></button></div>
                                            <div style="text-align:center; padding-top:9px;"><button onclick='pastePrice(<?php echo $k; ?>);' type='button' class='btn btn-sm btn-info' title="[[.paste.]]"><span style="color:white;" class="glyphicon glyphicon glyphicon-paste"></span></button></div>
                                            ...
                                            <!--LIST:schedule_list.schedule-->
                                            <input type="hidden" name="price_<?php echo $k; ?>_[[|schedule_list.schedule.id|]]" value="[[|schedule_list.schedule.price|]]" />
                                            <!--/LIST:schedule_list.schedule--> 
                                            <input type='hidden' name='start_date_<?php echo $k; ?>' value='<?php echo date("d/m/Y", strtotime([[=schedule_list.start_date=]])); ?>' />
                                            <input type='hidden' name='end_date_<?php echo $k; ?>' value='<?php echo date("d/m/Y", strtotime([[=schedule_list.end_date=]])); ?>'/>
                                            <input type='hidden' name='frequency_<?php echo $k; ?>' value='[[|schedule_list.frequency|]]'/>
                                            <input type='hidden' name='weekly_<?php echo $k; ?>' value='[[|schedule_list.weekly|]]'/>
                                            <input type='hidden' name='priority_<?php echo $k; ?>' value='[[|schedule_list.priority|]]'/>  
                                        </div>
                                        <?php $k++; ?>   
                                    <!--/LIST:schedule_list-->
                                 <?php       
...
<script>
    ...
    var room_level_list_js = [[|room_level_list_js|]];  
    var rate_code_list_contain_js = [[|rate_code_list_contain_js|]];
    ...
    function stringDate(){
        ...
        if(inweek==true && z==5){
            jQuery("p#content").html("[[.Every_week_on_weekdays.]]");
            jQuery("input#in_week").attr("checked","checked");
        }
        
        else if(z==7){
           jQuery("p#content").html("[[.Every_week_in_every_day.]]"); 
           jQuery("input#in_week").attr("checked","checked");
           jQuery("input#out_week").attr("checked","checked");
        }
        else if(z==0){
            jQuery("p#content").html("[[.every_week.]]");
        }
        else if(y==2 && z==2){
            jQuery("p#content").html("[[.Every_week_on_weekends.]]"); 
            jQuery("input#out_week").attr("checked","checked");
        }
        else if(z>=1 && z<7){
            ...
            jQuery("p#content").html("[[.every_day.]]");
        }
        jQuery("input#strHidden").val(jQuery("p#content").html());
    }
    jQuery(document).ready(function(){
        <?php
            if(isset([[=customer_group_list_js=]])){
         ?>
            var customer_group_list_js = [[|customer_group_list_js|]];
    ...
    <?php
        if(isset([[=schedule_list_js=]])){
            
     ?>
        var schedule_list_js = [[|schedule_list_js|]];
        var arr_schedule = [];
        var j = 0;
    ...
    function checkForm(action,target){
       ...
       if(loopVal=="w"){
            ...
            if(!boolen){
                jQuery("#error .modal-body").html("[[.You_have_not_selected_weekdays.]]");
                jQuery("#error").modal("show");
                //alert("[[.You_have_not_selected_weekdays.]]");
                return false;
               }
       }
       else{
           ...
           if(from_date && to_date){
               if(from_date>to_date){
                    //alert("[[.Start_date_is_greater_than_the_end_date.]]");
                    jQuery("#error .modal-body").html("[[.Start_date_is_greater_than_the_end_date.]]");
                    jQuery("#error").modal("show");
                    return false;
               }  
           }
           else{
               //alert("[[.You_did_not_enter_a_start_date_or_end_date.]]"); 
               jQuery("#error .modal-body").html("[[.You_did_not_enter_a_start_date_or_end_date.]]");
               jQuery("#error").modal("show");
               return false;
           }
     if(action=="add"){      
              ...
              if((from_date>=date_from && to_date<=date_to) || (from_date<=date_from && to_date>=date_to) || (from_date<=date_from && date_from<=to_date) || (from_date<=date_to && to_date>=date_to)){
                    ...
                    if(valueRdo==arr_schedule[k]['priority']){
                        if(loopVal=="d" || arr_schedule[k]['frequency']=="d"){
                            //alert("[[.Conflict_with_the_period_from.]] "+format_date(date_from)+" [[.to.]] "+format_date(date_to));
                            jQuery("#error .modal-body").html("[[.Conflict_with_the_period_from.]] "+format_date(date_from)+" [[.to.]] "+format_date(date_to));
                            jQuery("#error").modal("show");
                            return false;
                        }
                            ...
                            if(str_weeken!=""){
                                ...
                                //alert(str_weeken+" [[.was_installed_price_for_the_period_from.]] "+format_date(date_from)+" [[.to.]] "+format_date(date_to));
                                jQuery("#error .modal-body").html(str_weeken+" [[.was_installed_price_for_the_period_from.]] "+format_date(date_from)+" [[.to.]] "+format_date(date_to));
                                jQuery("#error").modal("show");
                                return false;
                            }
                        }
       ...
       arr_schedule[j]['brief'] = jQuery("p#content").text();
        ...
        var content = "<div  id=bodySchedule_"+j+" class='Schedule'>"
                            ...
                            +"<div style='border-top:none; text-align:center; padding-top:9px;'><button onclick='setPriceValueId("+j+")' type='button' class='btn btn-xs btn-success' data-toggle='modal' data-target='#setPrice'>[[.price_list.]]</button></div>"
                            +"<div style='border-top:none; text-align:center; padding-top:9px;'><button onclick='copyPrice("+j+");' type='button' class='btn btn-sm btn-primary' title='[[.copy.]]'><span style='color:white;' class='glyphicon glyphicon glyphicon-copy'></span></button></div>"
                            +"<div style='border-top:none; text-align:center; padding-top:9px;'><button onclick='pastePrice("+j+");' type='button' class='btn btn-sm btn-info' title='[[.paste.]]'><span style='color:white;' class='glyphicon glyphicon glyphicon-paste'></span></button></div>"
    ...
    function pastePrice(target){
        if(!arr_price_copy.length){
            ...
            jQuery("div#notice").html("[[.paste_successfully.]]");
            jQuery('div#notice').stop(true,true).fadeIn('slow').delay(1500).fadeOut('slow');
        }
    }
    ...
    function quickSetup(){
        if(!arr_schedule.length){
            jQuery("div#notice").html('[[.empty_target.]]');
            jQuery('div#notice').stop(true,true).fadeIn('slow').delay(1500).fadeOut('slow');
        }
        else{ 
          for( k = 1 ; k< j ; k++){
            ...
            jQuery("div#notice").html("[[.fill_up_successfully.]]");
            jQuery('div#notice').stop(true,true).fadeIn('slow').delay(1500).fadeOut('slow');
        }
    }
    function deletePrice(target){
        if(confirm("[[.are_you_sure.]]")){
            ...
            arr_price_copy=[];
            jQuery("div#notice").html("[[.delete_successfully.]]");
            jQuery('div#notice').stop(true,true).fadeIn('slow').delay(1500).fadeOut('slow');
    ...
    function checkAll(){
        if(!jQuery("input[check_group_list]:checked").length){
            jQuery("#error .modal-body").html("[[.You_have_not_selected_tourists.]]");
            jQuery("#error").modal("show");
            //alert("[[.You_have_not_selected_tourists.]]");
            return false;
        }
        if(j==0){
            //alert("[[.You_do_not_create_scheduled_Please_check_again.]]");
            jQuery("#error .modal-body").html("[[.You_do_not_create_scheduled_Please_check_again.]]");
            jQuery("#error").modal("show");
            return false;
        }
        arr_group = [];
                                ...
                                if(priority_current==priority){
                                    if((from_date>=date_from && to_date<=date_to) || (from_date<=date_from && to_date>=date_to) || (from_date<=date_from && date_from<=to_date) || (from_date<=date_to && to_date>=date_to)){
                                        if( frequency=="d" || frequency_current=="d" ){
                                            //alert("[[.The_tourists.]] :\n"+str_group+"\n"+" [[.was_installed_price_for_the_period_from.]] "+from_date+" [[.to.]] "+to_date+"\n\n [[.code.]]: "+schedule_code+"\n [[.name.]]: "+schedule_name);
                                            jQuery("#error .modal-body").html("[[.The_tourists.]] : <br/> "+str_group+"<br/>"+" [[.was_installed_price_for_the_period_from.]] "+from_date+" [[.to.]] "+to_date+"<br/><br/> [[.code.]]: "+schedule_code+"<br/> [[.name.]]: "+schedule_name);
                                            jQuery("#error").modal("show");
                                            //console.log("[[.The_tourists.]] :\n"+str_group+"\n"+" [[.was_installed_price_for_the_period_from.]] "+from_date+" [[.to.]] "+to_date+"\n\n [[.code.]]: "+schedule_code+"\n [[.name.]]: "+schedule_name);
                                            return false;
                                        }
                                        else{
                                            var str_day = "";
                                            ...
                                            if(str_day!=""){
                                                ...
                                                //alert("[[.The_tourists.]] :\n\n"+str_group+"\n"+" [[.was_installed_price_on.]] "+str_day+" [[.in_between.]] "+from_date+" [[.and.]] "+to_date+"\n\n [[.code.]]: "+schedule_code+"\n [[.name.]]: "+schedule_name);
                                                jQuery("#error .modal-body").html("[[.The_tourists.]] :<br/><br/>"+str_group+"<br/>"+" [[.was_installed_price_on.]] "+str_day+" [[.in_between.]] "+from_date+" [[.and.]] "+to_date+"<br/><br/> [[.code.]]: "+schedule_code+"<br/> [[.name.]]: "+schedule_name);
                                                jQuery("#error").modal("show");
                                                return false;
                                            }
                                        }
    ...
    jQuery(document).ready(function(){
           jQuery("button#setSchedule").click(function(){
              ...
              jQuery("div#setTime p#content").html("[[.every_day.]]"); 
              jQuery("input[fName]").each(function(){
                jQuery(this).removeAttr("checked");
              });
              jQuery("div#loopInfo").css("display","none");
