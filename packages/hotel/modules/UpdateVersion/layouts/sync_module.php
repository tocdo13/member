...
<form name="UpdateVersionSyncModuleForm" method="POST" enctype="multipart/form-data">
<input name="act" id="act" type="hidden" />
<input name="sync_table" id="sync_table" type="hidden" />
    <div class="w3-container">
        <div class="w3-row" style="min-width: 320px!important; max-width: 1420px; margin: 0px auto 50px;">
            <div class="w3-row">
                <div class="w3-button w3-margin w3-left" style="font-weight: bold; text-transform: uppercase; background: none!important;">
                    Update Version - Step 03: Sync Module
                </div>
...
<script>
    ...
    function GetData($table){
        ...
        UpdateVersionSyncModuleForm.submit();
    }
</script>
