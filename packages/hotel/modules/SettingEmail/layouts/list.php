    	...
    	<td>
            <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
					...
					<td align="right"><input name="submit11" type="button" value="[[.Save.]]" onclick="check_submit_form();" /></td>
                </tr>
            </table>
        </td>
    </tr>
			...
			<div class="setting-body 0" id="setting_info">
                ...
                <div id="email" class="tab-content">
                    ...
                    <div class="setting-field" style="display: none;">
						<label for="email_invoice_creart">[[.send_email_creat_date.]]</label>
						<input name="email_date_creart" type="text" id="email_date_creart" />
					</div>
                    
                    <div class="setting-field">
						<label for="email_invoice_creart">[[.send_email_creat_folio.]]</label>
						<input name="email_invoice_creart" type="text" id="email_invoice_creart" onchange="check_hide_config()" />
					</div>
                    
                    <div class="setting-field manager_invoice">
                        <label for="room_invoice">[[.room_invoice.]]</label>
                        <input  name="room_invoice" type="checkbox" id="room_invoice" <?php if(Url::get('room_invoice')){echo 'checked';}?> value="0"/>
                    </div>
                    
                    <div class="setting-field manager_invoice">
                        <label for="bar_invoice">[[.bar_invoice.]]</label>
                        <input  name="bar_invoice" type="checkbox" id="bar_invoice" <?php if(Url::get('bar_invoice')){echo 'checked';}?> value="0"/>
                    </div>
                    
                    <div class="setting-field manager_invoice">
                        <label for="spa_invoice">[[.spa_invoice.]]</label>
                        <input  name="spa_invoice" type="checkbox" id="spa_invoice" <?php if(Url::get('spa_invoice')){echo 'checked';}?> value="0"/>
                    </div>
                    
                    <div class="setting-field">
                        <label for="email_check_out">[[.email_check_out.]]</label>
                        <input  name="email_check_out" type="checkbox" id="email_check_out" <?php if(Url::get('email_check_out')){echo 'checked';}?> value="0"/>
                    </div>
                
                    
                    <div class="setting-field">
						<label for="email_invoice">[[.email_invoice.]]</label>
						<input name="email_invoice" type="text" id="email_invoice" />
					</div>
                    <div class="setting-field">
						<label for="email_invoice_password">[[.email_invoice_password.]]</label>
						<input name="email_invoice_password" type="password" id="email_invoice_password" />
                    ...
                    <div style="margin-left: 350px;">
                        <label id="invoice_toggle">[[.advance.]]</label>
                        <div id="advance_toogle">
                            <div class="setting-field">
                                <label for="email_invoice_smtp">[[.email_invoice_SMTP.]]</label>
                                <input name="email_invoice_smtp" type="text" id="email_invoice_smtp" value="smtp.gmail.com" />
                            </div>
                            
                            <div class="setting-field">
                                <label for="email_invoice_port">[[.email_invoice_PORT.]]</label>
                                <input name="email_invoice_port" type="text" id="email_invoice_port" value="465" />
                            </div>
                            <!--<p><i>Note: Nếu tài khoản của gmail thì để SMTP là smtp.gmail.com,zoho:smtp.zoho.com PORT thường là 465</i></p>-->
                        </div>
                    </div>
                    <div class="setting-field">
						<label for="email_invoice_content">[[.email_invoice_content.]]</label>
						<textarea name="email_invoice_content" id="email_invoice_content" style="width: 700px; height: 100px;"></textarea> 
					</div>
                    
                    <div class="setting-field">
						<label for="email_marketing">[[.email_marketing.]]</label>
						<input name="email_marketing" type="text" id="email_marketing" />
					</div>
                    <div class="setting-field">
						<label for="email_marketing_password">[[.email_marketing_password.]]</label>
						<input name="email_marketing_password" type="password" id="email_marketing_password" />
                        <?php if(User::can_admin(false,ANY_CATEGORY)){ ?>
                        <img src="packages/hotel/modules/SettingEmail/view.png" onclick="view_pass('email_marketing_password');" style="cursor: pointer;" />
                        <?php } ?>
					</div>
                    <div style="margin-left: 350px;">
                        <label id="marketing_toggle">[[.advance.]]</label>
                        <div id="advance_marketing_toogle">
                            <div class="setting-field">
                                <label for="email_marketing_smtp">[[.email_marketing_smtp.]]</label>
                                <input name="email_marketing_smtp" type="text" id="email_marketing_smtp" value="smtp.gmail.com" />
                            </div>
                            
                            <div class="setting-field">
                                <label for="email_marketing_port">[[.email_marketing_port.]]</label>
                                <input name="email_marketing_port" type="text" id="email_marketing_port" value="465" />
                            </div>
