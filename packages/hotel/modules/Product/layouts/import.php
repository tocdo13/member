		...
		<td align="left" colspan="2">
            <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
					...
					<td width="30" align="right" style="padding-right: 30px;"><input name="save" type="submit" value="[[.Save_and_close.]]" class="w3-btn w3-orange w3-text-white" style="text-transform: uppercase; margin-right: 5px;"/>
                    <input type="button" value="[[.back.]]" class="w3-btn w3-green" style="text-transform: uppercase; margin-right: 5px;" onclick="history.go(-1)"/></td>                    
                </tr>
            </table>
		</td>
	</tr>	
...
<table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolor="#CCCCCC">
    ...
    ?>
        <tr>
            <th colspan="7" style="text-align: center; color: red;">[[.product_error.]]:</th>
        </tr>
        <!--LIST:error-->
        <tr>
            <td style="cursor:pointer;">[[|error.id|]]</td>
            <td style="cursor:pointer;">[[|error.name_1|]]</td>
            <td style="cursor:pointer;">[[|error.name_2|]]</td>
    ...
    <?php 
        ...
        {
    ?>
        <tr><td colspan="7" align="center"><strong>[[.first_10_items.]]</strong></td></tr>
        <!--LIST:preview-->
        <tr>  
    ...
    ?>
        <tr>
            <th colspan="7" style="text-align: center;">[[.product_update.]]:</th>
        </tr>
        <!--LIST:update-->
        <tr>
