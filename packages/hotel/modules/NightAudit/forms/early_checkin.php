<?php
class EarlyCheckinForm extends Form
{
	function EarlyCheckinForm()
	{
		Form::Form('EarlyCheckinForm');
	...
	function draw()
	{
		$this->map = array();
		$cond = '
			reservation_room.status = \'CHECKIN\' AND reservation_room.confirm = 1 AND reservation_room.early_checkin is not null
		...
		$this->parse_layout('early_checkin',$this->map);
	}
}
?>