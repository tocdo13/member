<?php
class LateCheckoutForm extends Form
{
	function LateCheckoutForm()
	{
		Form::Form('LateCheckoutForm');
	...
	function draw()
	{
		$this->map = array();
		$cond = '
			reservation_room.status = \'CHECKIN\' AND reservation_room.confirm = 1 AND reservation_room.late_checkout is not null
		...
		$this->parse_layout('late_checkout',$this->map);
	}
}
?>