<?php
class ArrivalsNotYetCheckedInForm extends Form
{

	function ArrivalsNotYetCheckedInForm()
	{
		Form::Form('ArrivalsNotYetCheckedInForm');
	...
	{        
		...
		$this->parse_layout('arrivals_not_yet_checked_in',$this->map);
	}
}
?>