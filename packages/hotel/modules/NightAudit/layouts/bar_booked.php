...
<table cellspacing="0" width="100%">
	<tr valign="top">
		<td width="100%">
			...
			<td>
                ...
                <div>
                  <h3>[[.bar_booked.]] [[.date.]] <?php echo $_SESSION['night_audit_date'];?></h3>
                </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><p>&nbsp;</p><input type="button" value="[[.close_night_audit.]]" onclick="window.location='<?php echo Url::build('room_map');?>'" /> <input type="button" value="[[.continue_night_audit.]]" onclick="window.location='<?php echo Url::build_current(array('cmd'=>'bar_cancel','start_time_night_audit'=>Url::get('start_time_night_audit')));?>'"/><p>&nbsp;</p></td>
      </tr>
    </table>
    </td>
</tr>
