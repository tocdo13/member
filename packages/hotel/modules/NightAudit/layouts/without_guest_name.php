...
<form name="WithoutGuestNameForm" method="post">
<div>
<div><h3>[[.list_of_checked_in_reservations_without_guest_name.]] [[.in.]] [[.date.]] <?php echo $_SESSION['night_audit_date'];?></h3></div>
<table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#CCCCCC">
  ...
  <tr>
    ...
    <td>[[|items.brief_arrival_time|]] - [[|items.brief_departure_time|]]</td>
    <td><a target="_blank" href="<?php echo Url::build('reservation',array('cmd'=>'edit','id'=>[[=items.reservation_id=]]));?>">[[.correct.]]</a></td>
  </tr>
  <!--/LIST:items-->
  <!--IF:cond(![[=items=]])-->
  	<tr>
    	<td colspan="5" class="notice" align="center"><p>&nbsp;</p>[[.no_checked_in_reservations_without_guest_name.]]<p>&nbsp;</p></td>
    </tr>
  <!--/IF:cond-->
</table>
