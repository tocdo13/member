	...
	<span id="mi_product_sample">
	    <span id="input_group_#xxxx#">    
             <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    <td width="100">
                    	<input name="mi_product[#xxxx#][product_id]" type="text" id="product_id_#xxxx#" class="karaoke-product-id" style="width:90px;" onblur="update_product(this);calculate();" AUTOCOMPLETE=OFF>
                    </td>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
	<tr>
		<td width="100%">
			<form name="AddKaraokeReservationNewForm" method="post">
			...
			<tr height="25" bgcolor="#FFFFFF">
				...
				<tr>
					...
					<td width="60%" align="center" style="padding:0 0 0 0" nowrap="nowrap">&nbsp;&nbsp;<font style="font-size:20px; text-transform:uppercase;">[[.karaoke_reservation.]]</font></td>
            ...
            <div id="guest_information">
                <input type="hidden" id="select_karaoke" name="select_karaoke" value="0">
				...
				<table width="100%" style="text-align:left;">
					...
					<tr>
					  ...
					  <td nowrap="nowrap"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" width="200">[[.customer_res.]]</td>
                      ...
                      <fieldset style="text-align:left;">
                        ...
                        <table width="100%" border="0" cellpadding="2">
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td></td>
                            <td align="right" nowrap="nowrap"><select name="service_rate" id="service_rate" onchange="calculate();">
                            </select>
