	...
	<tr valign="top">
		<td align="left" colspan="2">
            <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
                    <td class="form-title" width="100%">[[.karaoke_reservation_list_debt.]]  ([[|karaoke_name|]])</td>
					<?php
				...
				<td width="100%">
					...
					<table>
						<tr>
							...
							<td>:</td>
							<td nowrap>
								<input name="from_arrival_time" type="text" id="from_arrival_time" size="8">
								[[.to.]]
								<input name="to_arrival_time" type="text" id="to_arrival_time" size="8">
								</td>
						    <td nowrap>&nbsp;</td>
						    <td nowrap>[[.agent_name.]]</td>
						    <td nowrap><input name="agent_name" type="text" id="agent_name"></td>
					...
					<table width="100%" cellpadding="2" cellspacing="0" bordercolor="#CECFCE" border="1" style="border-collapse:collapse">
						<tr class="table-header">
							...
							<th align="left" nowrap="nowrap"> <a href="<?php echo URL::build_current(((URL::get('order_by')=='karaoke_reservation.code' and URL::get('order_dir')!='desc')?array('order_dir'=>'desc'):array())+array('order_by'=>'karaoke_reservation.code'));?>">
                              <?php if(URL::get('order_by')=='karaoke_reservation.code') echo '<img src="skins/default/images/'.((URL::get('order_dir')!='desc')?'down':'up').'_arrow.gif">';?>[[.invoice_code.]] </a> </th>
							...
							<th align="right" nowrap>[[.debt_total.]]</th>
						...
						<tr bgcolor="<?php if(URL::get('just_edited_id',0)==[[=items.id=]]){ echo '#EFFFDF';} else {echo 'white';}?>" valign="middle" <?php Draw::hover('#EFEEEE');?>onclick="if(typeof(just_click)=='undefined' || !just_click){location='<?php echo URL::build_current();?>&id=[[|items.id|]]';}else{just_click=false;}" style="cursor:hand;">
							<td><input name="selected_ids[]" type="checkbox" value="[[|items.id|]]" onclick="just_click=true;"></td>
								...
								<td align="right" nowrap>[[|items.debt_total|]]</td>
							    <td align="left" nowrap>[[|items.user_id|]]</td>
						    <?php if(User::can_edit(false,ANY_CATEGORY))
							{
							?><td nowrap>
								&nbsp;<a href="<?php echo Url::build_current(array(  'karaoke_reservation_karaoke_id', 'karaoke_reservation_receptionist_id')+array('cmd'=>'edit','id'=>[[=items.id=]])); ?>"><img src="packages/core/skins/default/images/buttons/edit.gif" alt="[[.edit.]]" width="12" height="12" border="0"></a>							</td>
							<?php
							}
							if(User::can_delete(false,ANY_CATEGORY))
							{
							?><td nowrap>
								&nbsp;<a href="<?php echo Url::build_current(array(  'karaoke_reservation_karaoke_id', 'karaoke_reservation_receptionist_id')+array('cmd'=>'delete','id'=>[[=items.id=]])); ?>"><img src="packages/core/skins/default/images/buttons/delete.gif" alt="[[.delete.]]" width="12" height="12" border="0"></a>							</td>
							<?php
							}
							?></tr>
						<!--/LIST:items-->
