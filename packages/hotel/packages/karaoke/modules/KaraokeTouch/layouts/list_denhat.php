...
<div style="padding:0px;">
	...
	<div style="float:right; width:100%;margin-right:0px;text-align:right;white-space:nowrap;margin-bottom:5px;">
    	...
    	<span style="font-size:20px;text-transform:uppercase;padding-left:5px;" class="title">[[|karaoke_name|]]</span>
        <br />
        <span style="font-size:14px;text-transform:uppercase;padding-left:5px;float:left; color:#666;" class="title">[[|table_name|]]</span>
        </div>
        <div style="float:left;padding-left:10px;width:150px;display:none;" id="karaoke_other">
        <div align="right">[[.karaoke_menu.]]: <input name="karaoke_name" type="text" id="karaoke_name" style="width:200px; border:none; font-size:14px; font-weight:bold;" readonly="readonly" /></div>
        ...
        <input name="back" type="button" value="[[.back.]]" class="button-medium-back" onclick="window.location='<?php echo Url::build('karaoke_table_map',array('karaoke_id'=>Session::get('karaoke_id'),'group'=>Session::get('group')));?>'" />
	...
	<table cellpadding="2" width="100%" border="1" bordercolor="#A6A6A6" id="table_bound">
		<tr>
        	<td class="info-left" id="hidden_expan" style="background:#F5F3F3;">	
                    ...
                    <!--IF:cond_bill(isset([[=code=]]) and [[=code=]])--><b>[[.Bill_ID.]]: [[|code|]]</b><!--/IF:cond_bill-->
                      ...
                      <input  name="status" type="text" id="status" value="[[|status|]]" readonly="readonly" style="border:none; font-weight:bold;background:#F7F6F6; width:80px; " />
                        ...
                        <div style="float:right;">
                            ...
                            <!---<input type="button" name="preview" value=" [[.view_order.]]" tabindex="-1" class="func_button" onclick="if(jQuery('#status').val()!=''){window.open('<?php echo Url::build('vat_bill',array(  'department'=>'KARAOKE','cmd'=>'entry_karaoke','id'=>'vat_bill.id'))?>');}else{jQuery('#act').val('submit_invoice');KaraokeTouchForm.submit();}"/>--->                            
                            ...
                            <input type="button" name="preview" value=" [[.drink_order.]] " onclick="sentToPrint('karaoke','<?php echo Url::get('id');?>');" tabindex="-1" class="expan" style="display:none;">
                ...
                <div id="foot_drink_bound" style="width:84%; float:left;" class="selected-foot-and-drink-table">
                ...
                <div id="menu_extra">
                    <ul id="menu_extra_ul" style="float:right;">
                        ...
                        <li class="menu_extra_li_order" id="li_deposit" <?php if([[=pay_with_room=]]) echo 'style="background-color: rgb(214, 214, 214) !important; cursor: default !important; background-position: initial initial !important; background-repeat: initial initial !important;"'; ?> onclick="openWindowUrl('form.php?block_id=<?php echo BLOCK_PAYMENT;?>&cmd=deposit&id=<?php if(Url::get('id')){echo Url::get('id');}else{echo '';}?>&type=KARAOKE',Array('payment','payment_for',80,210,950,500));"><img src="packages/hotel/skins/default/images/iosstyle/7.png"  /></li>
                        <li class="menu_extra_li_order" id="li_payment" <?php if([[=pay_with_room=]]) echo 'style="background-color: rgb(214, 214, 214) !important; cursor: default !important; background-position: initial initial !important; background-repeat: initial initial !important;"'; ?> onclick="SubmitForm('payment');"><img src="packages/hotel/skins/default/images/iosstyle/8.png" /></li>
                        <li class="menu_extra_li_order" id="li_vat" style="background:#ffffc0; display:none;" onclick="window.location='?page=vat_bill&department=KARAOKE&cmd=entry_karaoke&b_r_id=<?php echo Url::get('id');?>'">
              ...
              <div id="sing_room" style="width:84%; float:left;">
                    <table cellpadding="5" width="100%" id="sing_table" cellspacing="0">
                        <tr class="foot-drink-tr header">
                            <td>[[.room.]]</td>
                        ...
                        <!--LIST:sing_room-->
                        <tr>
                            <td>[[|sing_room.name|]]</td>
                            <td align="center"><label id="sing_start_time_[[|sing_room.id|]]">[[|sing_room.sing_start_time|]]</label></td>
                            <td align="center"><label id="sing_end_time_[[|sing_room.id|]]">[[|sing_room.sing_end_time|]]</label></td>
                            <td align="right"><input name="sing_room[[[|sing_room.id|]]][price]" id="price_sing_room_[[|sing_room.id|]]" type="text" value="[[|sing_room.price|]]" style="width: 40px; text-align: right;" onkeyup="fun_update_total_sing([[|sing_room.id|]]);" /></td>
                            <td>
                                <input name="sing_room[[[|sing_room.id|]]][total]" id="total_sing_room_[[|sing_room.id|]]" type="text" value="[[|sing_room.total|]]" style="width: 40px; text-align: right;" readonly="" />
                                <input name="sing_room[[[|sing_room.id|]]][total_time]" id="total_time_sing_room_[[|sing_room.id|]]" type="text" value="[[|sing_room.total_time|]]" style="width: 40px; text-align: right; display: none;" readonly="" />
                            </td>
                            <td>
                                <?php if([[=sing_room.sing_end_time=]]==''){ ?>
                                <input type="button" value="[[.stop.]]" id="stop_[[|sing_room.id|]]" onclick="fun_stop([[|sing_room.id|]]);" />
                                <?php } ?>
                            </td>
                        </tr>
                        <!--/LIST:sing_room-->
                ...
                <div style="margin-bottom:5px; margin-top:5px;" align="left">
                    <font style="font-size:12px; "><b>[[.total_payment_traveller.]] (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp;<input name="total_payment_traveller" id="total_payment_traveller" type="text" onkeyup="GetTotalPayment(); format_price_m();" value="<?php if(isset([[=total_payment_traveller=]])){echo System::display_number([[=total_payment_traveller=]]);}else{echo 0;} ?>" />
                </div>
                <script>
                    function format_price_m(){
                        jQuery("#total_payment_traveller").val(number_format(jQuery("#total_payment_traveller").val()));
                    }
                </script>
                <div id="total_mini" style="margin-bottom:5px; margin-top:5px;" align="left">
                ...
                <div id="show_table">
                    <table cellpadding="0" cellspacing="0" width="75%" style="float:left;">     
                        <tr class="foot-drink-tr header">
                            <td width="60">[[.room_name.]]</td>
                            <td width="60">[[.split_room_button.]]</td>
                            <td width="60">[[.coupling_room.]]</td>
                            <td width="40">[[.select.]]</td>
                            <td width="20"></td>
                        </tr>
                    </table>
      ...
      <div id="info_summary"> [[|categories|]]  </div> 
                ...
                <div id="bound_summary" style="display:block;" class="dragclass">
                ...
                <legend class="title">[[.guest_retail.]]</legend>
					<table cellpadding="3" width="55%">
                        ...
                        <tr>
                            <td>[[.company.]]:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td nowrap="nowrap"><input name="customer_name" type="text" id="customer_name" value="[[|customer_name|]]" onfocus="Autocomplete();" autocomplete="off" class="input-text-max" style="float:left;" />
                ...
                <td valign="top">
                <fieldset style="text-align:left; margin-bottom:10px;margin-top:10px;height:120px;" id="guest_room_info">
				<legend class="title"><img src="packages/core/skins/default/images/customer_icon.jpg" width="15" height="20" align="top"/>&nbsp;[[.guest_room.]]</legend>
					<table cellpadding="3" width="55%">
						<tr>
							...
							<label for="pay_with_room"><span style="font-size:12px;" class="checkbox-span" title="[[.pay_with_room.]]">Yes</span></label>
                            </td>
                      	</tr>
                        <tr>
                            <td colspan="4">
    ...
    <div id="div_select_karaoke" style="display:none;">
        ...
        <table border="0" cellpadding="2" cellspacing="0" width="350" bordercolor="#CCCCCC" id="karaoke_select">
            ...
            <?php if($i%2==0){
				echo '<tr>';
				echo '<td><input name="'.[[=karaokes.name=]].'" type="button" id="'.[[=karaokes.name=]].'" value="'.[[=karaokes.name=]].'" lang="'.[[=karaokes.karaoke_id_from=]].'" onclick="jQuery(\'#karaoke_id_other\').val(this.lang);jQuery(\'#div_select_karaoke\').css(\'display\',\'none\');jQuery(\'#karaoke_name\').val(this.name);searchProduct(\'karaoke\',jQuery(\'#karaoke_id_other\').val());" style="width:125px; height:30px;" /></td>';	
			}else{
				echo '<td><input name="'.[[=karaokes.name=]].'" type="button" id="'.[[=karaokes.name=]].'" value="'.[[=karaokes.name=]].'" lang="'.[[=karaokes.karaoke_id_from=]].'" onclick="jQuery(\'#karaoke_id_other\').val(this.lang);jQuery(\'#div_select_karaoke\').css(\'display\',\'none\');jQuery(\'#karaoke_name\').val(this.name);searchProduct(\'karaoke\',jQuery(\'#karaoke_id_other\').val());"  style="width:125px; height:30px;"/></td>';		
				echo '</tr>';
			} $i++;?>
...
<script>
	...
	var can_admin_karaoke = '<?php echo User::can_admin(false,ANY_CATEGORY)?>';
...
document.onmouseup = up;
		...
		jQuery(".category-list-item,.category-list-item-parent").each(function(){
			jQuery(this).click(function(){		
				...
				jQuery.ajax({
					...
					type:"POST",
					data:{category_id:jQuery(this).attr('lang'),karaoke_id_other:karaoke_id,act:'product',cmd:'draw_products',type:'CATEGORY'},
	...
	jQuery('#act').val(0);
	 openWindowUrl('form.php?block_id=<?php echo BLOCK_PAYMENT;?>&cmd=payment&id=<?php echo Url::get('id');?>&type=KARAOKE&total_amount='+to_numeric(jQuery('#total_payment').val())+'&portal_id=<?php echo PORTAL_ID;?>',Array('payment','payment_for','80','210','950','500'));
	<?php
		}?>
	function searchProduct(act,karaoke_id)
    {
		if(jQuery('#input_product_name').val()=='' && act=='product'){
			...
			jQuery('.body').html('');
			get_karaoke_id = <?php echo Url::get('karaoke_id');?>;
			if(karaoke_id == ''){
			...
			jQuery.ajax({
				...
				type:"POST",			
				data:{product_name:jQuery("#input_product_name").val(),act:act,karaoke_id_other:karaoke_id,karaoke_id:<?php echo Url::get('karaoke_id');?>,cmd:'draw_products',type:'PRODUCT'},
				success:function(html){
		...
		for(var j in product_array)
        {
			if((product_array[j]['id'] == price_id) || (product_array[j]['product_id'] == price_id && ( price_id=='FOUTSIDE' || price_id=='DOUTSIDE' || price_id=='SOUTSIDE')))
            {
				...
				if(price_id=='FOUTSIDE'){
					var name = ' Äá»“ Äƒn ngoÃ i thá»±c Ä‘Æ¡n ';	
				}
				if(price_id=='DOUTSIDE'){
					var name = ' Äá»“ uá»‘ng ngoÃ i thá»±c Ä‘Æ¡n ';	
				}
...
//	}
    function drawTableList(arr){ 
		...
		items += '<td width="" style="display:none;"><input name="table_list['+arr['id']+'][table_id]" type="text" value="'+arr['id']+'" id="table_id_'+arr['id']+'" style=" border:none; width:55px;" readonly="readonly" maxlength="200"></td>';
        items += '<td width="" style="display:none;"><input name="table_list['+arr['id']+'][karaoke_reservation_table_id]" type="text" value="'+arr['karaoke_reservation_table_id']+'" id="karaoke_reservation_table_id_'+arr['id']+'" style=" border:none; width:55px; display: none;" readonly="readonly" maxlength="200"></td>';
		items += '<td width=""><input name="split_table" type="button" value="[[.split_room_button.]]" id="split_table" style="height:40px; width:73px;" <?php if(Url::get('cmd')=='edit' and Url::get('id')){?>onClick="window.location=\'<?php echo Url::build('karaoke_split_table',array('from_code'=>Url::get('id'),'type'=>'split')); ?>\'"<?php } ?>></td>';
		items += '<td width=""><input name="coupling_table" type="button" value="[[.coupling_room.]]" id="coupling_table" style="height:40px; width:73px;" <?php if(Url::get('cmd')=='edit' and Url::get('id')){?>onClick="window.location=\'<?php echo Url::build('karaoke_split_table',array('from_code'=>Url::get('id'))); ?>\'"<?php } ?>></td>';
		items += '<td width="1%"><input name="select_table" type="button" id="select_table" value="[[.change_room.]]" style="height:40px; width:73px;" onclick="jQuery(\'#table_map\').css(\'display\',\'block\');jQuery(\'#table_change\').val(\''+arr['id']+'\');" /></td>';
		items += '<td width="17" colspan="2"></td>';    
		items += '</tr></table>';	
		jQuery('#show_table').append(items);
	}
	function drawItems(arr){
		...
		items += '<tr class="foot-drink-tr" id="item_detail_'+arr['id']+'" onclick="if((jQuery(\'#status\').val()==\'CHECKOUT\' && can_admin_karaoke) || jQuery(\'#status\').val()!=\'CHECKOUT\'){if(jQuery(\'#selected_'+arr['id']+'\').attr(\'checked\')==true || jQuery(\'#selected_'+arr['id']+'\').attr(\'checked\')==\'checked\'){jQuery(\'#selected_'+arr['id']+'\').attr(\'checked\',false);}else{jQuery(\'#selected_'+arr['id']+'\').attr(\'checked\',true); }CssSelected();}">';
            ...
            if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
                ...
                for(obj in otbjs){
                    if(otbjs[obj]['no_member']==0){
                        alert("mÃ£ thÃ nh viÃªn khÃ´ng tá»“n táº¡i, vui lÃ²ng nháº­p láº¡i mÃ£!");
                        return;
                    }else{
...
function fun_view_info_member(){
    ...
    if(member_level_id == ''){
        alert("khÃ´ng cÃ³ chÆ°Æ¡ng trÃ¬nh giáº£m giÃ¡ giáº£m giÃ¡! kiá»ƒm tra láº¡i mÃ£ thÃ nh viÃªn!");
    }else{
    if (window.XMLHttpRequest){
            xmlhttp=new XMLHttpRequest();
        }
        ...
        xmlhttp.onreadystatechange=function()
        {
            if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
                ...
                if(otbjs['info_member']['no_discount']==0){
                    alert("KhÃ´ng cÃ³ chÆ°Æ¡ng trÃ¬nh giáº£m giÃ¡ cho háº¡ng thÃ nh viÃªn nÃ y!");
                    return;
                }else{
...
function fun_update_total_sing(key)
{
    if(jQuery("#sing_start_time_"+key).html()!='' && jQuery("#sing_end_time_"+key).html()!='')
    {
        var price = to_numeric(jQuery("#price_sing_room_"+key).val());
        console.log(to_numeric(jQuery("#total_time_sing_room_"+key).val()));
        var total = (price/3600)*to_numeric(jQuery("#total_time_sing_room_"+key).val());
        console.log(total);
        jQuery("#total_sing_room_"+key).val(number_format(total));
    }
    GetTotalPayment();
}
...
function fun_stop(key)
{
    if(confirm('bạn chắc chắn phòng hát đã nghỉ? Lưu ý thao tác này sẽ lưu lại những hành động của bạn.'))
    {
        if (window.XMLHttpRequest)
        {
            xmlhttp=new XMLHttpRequest();
        ...
        xmlhttp.open("GET","get_karaoke.php?data=stop_sing&id="+key,true);
        xmlhttp.send();
    }
}
</script> 