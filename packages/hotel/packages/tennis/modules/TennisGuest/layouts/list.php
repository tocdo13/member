...
<div class="TennisGuest-type-supplier-bound">
<form name="ListTennisGuestForm" method="post">
	<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr>
            ...
            <td width="20%" align="right" nowrap="nowrap">
				...
				<?php if(User::can_delete(false,ANY_CATEGORY)){?><a href="javascript:void(0)" onclick="if(!confirm('[[.are_you_sure.]]')){return false};ListTennisGuestForm.cmd.value='delete';ListTennisGuestForm.submit();"  class="button-medium-delete">[[.Delete.]]</a><?php }?>
            </td>
        </tr>
    </table>        
	<div class="content">
...
<script type="text/javascript">
	jQuery("#delete_button").click(function (){
		ListTennisGuestForm.cmd.value = 'delete';
		ListTennisGuestForm.submit();
	});
