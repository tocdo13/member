...
<div class="court-type-supplier-bound">
<form name="ListTennisCourtForm" method="post">
	<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr>
			...
			<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><a href="javascript:void(0)" onclick="if(!confirm('[[.are_you_sure.]]')){return false};ListTennisCourtForm.cmd.value='delete';ListTennisCourtForm.submit();"  class="button-medium-delete">[[.Delete.]]</a></td><?php }?>
        </tr>
    </table>        
	<div class="content">
		<table width="100%" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
			<tr bgcolor="#F1F1F1">
              ...
              <th width="20%" align="left">[[.court_name.]]</th>
			  <th width="20%" align="left">[[.court_type_name.]]</th>
...
<script type="text/javascript">
	jQuery("#delete_button").click(function (){
		ListTennisCourtForm.cmd.value = 'delete';
		ListTennisCourtForm.submit();
	});
