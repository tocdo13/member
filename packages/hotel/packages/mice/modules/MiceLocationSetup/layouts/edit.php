...
<form name="MiceDepartmentSetupForm" method="post" >
    <table width="100%" cellpadding="5" cellspacing="5">
    	<tr style="width: 100%;">
    		<td class="" style="text-transform: uppercase; font-size: 18px; width: 60%;" ><i class="fa fa-plus-square w3-text-orange" style="font-size: 24px;"></i> [[.mice_location_setup_project.]]</td>
    		<td style="width: 40%; text-align: right; padding-right: 30px;"><input id="btnsave" type="submit" value="[[.Save_and_close.]]" onclick="checksubmit();" class="w3-btn w3-orange w3-text-white" style="text-transform: uppercase; margin-right: 5px;"/>
    		<a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('mice_location_setup');" class="w3-btn w3-red" style="text-transform: uppercase; text-decoration: none;">[[.Delete.]]</a></td>
    	</tr>
    </table>
    <div class="body">
    <table cellspacing="5">
                			...
                			<div>
                				<span id="mice_location_setup_all_elems">
                					<span style="height: 24px; text-transform: uppercase;">
                						...
                						<span class="multi-input-header" style="width:35px; text-align: center;">[[.ID.]]</span>
                						<span class="multi-input-header" style="width:155px; text-align: center;">[[.name.]]</span>
                                        <span class="multi-input-header" style="width:50px; text-align: center;">[[.position.]]</span>
                						<span class="multi-input-header" style="width:30px; text-align: center;">[[.Delete.]]</span>
                					</span>
                                    <br clear="all"/>
                				</span>
                			</div>
                            <div>
                                <a href="javascript:void(0);" onclick="mi_add_new_row('mice_location_setup');$('name_'+input_count).focus();" class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; text-decoration: none; margin-left: 10px; margin-top: 5px;">[[.Add.]]</a>
                            </div>
                        </td>
                    </tr>
                </table>
...
function Confirm(index)
{
    ...
    return confirm('[[.Are_you_sure_delete_mice_location_setup.]]'+ mice_location_setup_name+'?');
}
...
{
    return confirm('[[.Are_you_sure_delete_mice_location_setup_selected.]]');
}
</script>