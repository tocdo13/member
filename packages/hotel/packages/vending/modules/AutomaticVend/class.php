        ...
        if(User::can_view(false,ANY_CATEGORY))
        {
    		...
    		{	
                ...
                case 'declare_counter':
                    ...
                    {
                        require_once 'forms/declare_counter.php';
    					$this->add_form(new DeclareCounterForm());break;
                    }
                case 'option_area':
    					require_once 'forms/option_area.php';
    					$this->add_form(new OptionAreaBarForm());break;	
    			case 'draw_products':
