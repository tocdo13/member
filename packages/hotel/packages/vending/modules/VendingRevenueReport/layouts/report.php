...
<!---------LAST GROUP VALUE----------->	        
    ...
    <?php  $discount += ([[=items.total_discount=]]+[[=items.product_discount=]]);
            $tax +=[[=items.tax=]];
            $rate += [[=items.fee_rate=]];
    ?>
	<!--/LIST:items-->
    ...
    <tr>
        ...
        <td align="right" colspan="6" class="report_sub_title" ><b><?php if([[=page_no=]]==[[=total_page=]])echo Portal::language('summary');else echo Portal::language('next_page_summary');?></b></td>
        <td align="right"><?php echo System::Display_number($discount);?></td>
        <td align="right"><?php echo System::Display_number($rate);?></td>
        <td align="right"><?php echo System::Display_number($tax);?></td>
