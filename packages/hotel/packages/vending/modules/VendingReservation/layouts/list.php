    ...
    <tr valign="top">
		<td align="left">
            <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
                    <td class="form-title" style="width: 350px;">[[.vending_reservation_list.]]</td>
                    <td>
                    <!--LIST:area-->
					<?php if(User::can_add(false,ANY_CATEGORY)){?>
                        <a href="<?php echo Url::build('automatic_vend',array('cmd'=>'add','department_id'=>[[=area.id=]],'department_code'=>[[=area.code=]],'arrival_time'=>date('d/m/Y')));?>" class="button-medium-add" style="float: right; margin: 3px;">[[|area.name|]]</a>
                    <?php }?>
                    <!--/LIST:area-->
                    </td>
			...
			<td>
				...
				<table width="100%" cellpadding="2" cellspacing="0" bordercolor="#CECFCE" border="1" style="border-collapse:collapse">
					<tr class="table-header">
						...
						<th align="left">[[.time.]]/[[.time_in.]]</th>
                        <!--<th align="left">[[.mice.]]</th>-->
                        <th align="left">[[.device_code.]]</th>
                        <th align="left">[[.guest_phone_number.]]</th>
						<th align="left">[[.code.]]</th>
						<!--<th align="left">[[.agent_name.]]</th>-->
						<th align="left">[[.total.]]</th>
                        <th align="center">[[.payment_status.]]</th>
                        <!--<th align="center" >[[.deposit_status.]]</th>-->
						<th align="left">[[.user.]]</th>
                        <th align="left">[[.lastest_edited_user_id.]]</th>
                        <!--<th>&nbsp;</th>
                        <th>&nbsp;</th>-->
					...
					<tr class="[[|items.row_class|]]" bgcolor="<?php if(URL::get('just_edited_id',0)==[[=items.id=]]){ echo '#EFFFDF';} ?>" valign="middle" <?php Draw::hover('#EFEEEE');?>  >
                        ...
                        <!--<td align="left" onclick="window.open('<?php echo Url::build('automatic_vend',array('cmd'=>'detail',md5('act')=>md5('print'),md5('preview')=>1,'id'=>[[=items.id=]]))?>');"><?php if([[=items.mice_reservation_id=]]!=''){ ?>MICE+[[|items.mice_reservation_id|]]<?php } ?></td>-->
                        <td align="left" onclick="window.open('<?php echo Url::build('automatic_vend',array('cmd'=>'detail',md5('act')=>md5('print'),md5('preview')=>1,'id'=>[[=items.id=]]))?>');">[[|items.device_code|]]</td>
                        <td align="left" onclick="window.open('<?php echo Url::build('automatic_vend',array('cmd'=>'detail',md5('act')=>md5('print'),md5('preview')=>1,'id'=>[[=items.id=]]))?>');">[[|items.guest_phone_number|]]</td>
                        ...
                        <td nowrap align="center">
                            ...
                            <a onclick="openPayment([[|items.id|]],<?php echo (System::calculate_number([[=items.total=]])); ?>,0,<?php if([[=items.member_code=]]){ echo [[=items.member_code=]]; }else{ echo 0; } ?>);" >
                                <img src="packages/core/skins/default/images/buttons/rate.jpg" alt="[[.payment.]]" title="[[.payment.]]" height="12" border="0"/>
                            </a>
                            <?php } ?>
                        </td>
                        <td nowrap align="center">
                            ...
                            <a onclick="
                                ...
                                " >
                                <img src="packages/core/skins/default/images/buttons/copy.png" alt="[[.deposit.]]" title="[[.deposit.]]" height="12" border="0"/>
                            </a>
                            <?php } ?>
                        </td>
                        -->
                        ...
                        <?php } ?>
						<?php if(User::can_admin(false,ANY_CATEGORY)) {?>
                        <td><a href="<?php echo Url::build_current(array('cmd'=>'delete','id'=>[[=items.id=]])); ?>"><img src="packages/core/skins/default/images/buttons/delete.gif" alt="[[.delete.]]" height="12"/></a></td>
						<?php } ?>
                    </tr>
					<!--/LIST:items-->
				</table>
