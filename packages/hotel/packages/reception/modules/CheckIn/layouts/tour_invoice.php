<div id="invoice">
	...
	<tr>
		...
		<td width="50%" align="center">
			...
			<div class="invoice-sub-title">PHI&#7870;U CHUY&#7874;N CHI TI&#7870;T</div>
	...
	<div class="item-body"><div class="seperator-line">&nbsp;</div></div>
	<!--IF:condr(!Url::get('service'))-->
	<!--IF:cond1(isset([[=items.room_amount=]]) and [[=items.room_amount=]]!="0.00" and [[=items.room_amount=]]>0)-->
	<div class="item-body"><span class="label">Room Amount / Ti&#7873;n ph&ograve;ng
	<!--IF:condfoc([[=items.foc=]] and ![[=items.foc_all=]])--> (FOC)<!--/IF:condfoc-->:</span> <span><?php echo System::display_number([[=items.room_amount=]])?></span></div>
	<!--/IF:cond1-->
	...
	<!--/IF:condr-->
	<!--LIST:items.services-->
	<!--IF:cond_servicex(Url::get('service') and [[=items.services.type=]]=='SERVICE')-->
	...
	<!--/IF:cond_servicex-->
	<!--IF:cond_roomx(Url::get('room') and [[=items.services.type=]]=='ROOM')-->
	<div class="item-body"><span class="label">[[|items.services.name|]]:</span> <span><?php echo System::display_number([[=items.services.amount=]])?></span></div>
	<!--/IF:cond_roomx-->
	<!--IF:cond_room_service(!Url::get('room') and !Url::get('service'))-->
	<div class="item-body"><span class="label">[[|items.services.name|]]:</span> <span><?php echo System::display_number([[=items.services.amount=]])?></span></div>
	<!--/IF:cond_room_service-->
	<!--/LIST:items.services-->
	<!--IF:cond__(Url::get('service') or !Url::get('room'))-->
	...
	<div class="item-body"><span class="label">Compansation Charge / Ti&#7873;n &#273;&#7873;n b&ugrave;:</span> <span><?php echo System::display_number([[=items.equipment=]])?></span></div><!--/IF:cond8e-->
	...
	<div class="item-body"><span class="label">[[|items.extra_services.name|]]:</span> <span><?php echo System::display_number([[=items.extra_services.amount=]])?></span></div>                                
	<!--/LIST:items.extra_services-->  
	...
	<!--/IF:cond14-->
	<!--/IF:cond_-->
	<!--IF:cond15(isset([[=items.total_amount=]]) and [[=items.total_amount=]]!="0.00" and [[=items.total_amount=]]>0)-->
	...
	<div class="item-body"><span class="label remain">Bank fees / Ph&iacute; ng&acirc;n h&agrave;ng ([[|items.bank_fee_percen|]]%):</span> <span class="remain"><?php echo System::display_number([[=items.total_bank_fee=]])?></span></div>
	<div class="item-body"><span class="label remain">Total with bank fees / T&#7893;ng thanh to&aacute;n g&#7891;m ph&iacute; ng&acirc;n h&agrave;ng:</span> <span class="remain"><?php echo System::display_number([[=items.total_with_bank_fee=]])?></span></div>
	<!--/IF:cond_bank_fee-->
	<!--/IF:cond15-->
	...
	<div class="item-body total-group">
		...
		<div class="sub-item-body"><span class="label">Deposit / &#272;&#7863;t c&#7885;c : </span><span><?php echo System::display_number([[=total_deposit=]])?></span></div>
		<div class="sub-item-body"><span class="label">Remain / C&ograve;n ph&#7843;i tr&#7843;: </span><span><?php echo System::display_number([[=total=]] - [[=total_deposit=]])?></span></div>
		<!--IF:cond_bank_fee([[=bank_fee_percen=]] and [[=total=]]!=[[=total_with_bank_fee=]])-->
		<div class="sub-item-body"><span class="label">Bank fees / Ph&iacute; ng&acirc;n h&agrave;ng ([[|bank_fee_percen|]]%): </span><span><?php echo System::display_number([[=total_bank_fee=]]);?></span></div>
		<div class="sub-item-body"><span class="label">Total with bank fees / T&#7893;ng thanh to&aacute;n g&#7891;m ph&iacute; ng&acirc;n h&agrave;ng: </span><span><?php echo System::display_number([[=total_with_bank_fee=]]);?></span></div>
		<div class="sub-item-body"><span><?php echo System::display_number(round(([[=total_with_bank_fee=]])*System::calculate_number([[=exchange_rate=]]),2));?> <?php echo HOTEL_EXCHANGE_CURRENCY;?></span></div>									
		<!--ELSE-->
		<div class="sub-item-body"><span><?php echo System::display_number(round(([[=total=]]-[[=total_deposit=]])*System::calculate_number([[=exchange_rate=]]),2));?> <?php echo HOTEL_EXCHANGE_CURRENCY;?></span></div>
		<!--/IF:cond_bank_fee-->
	</div>
	<!--IF:cond_footer(1==1)-->
	<div class="item-body"><div class="seperator-line">&nbsp;</div></div>
