                                ...
                                <table width="95%" style="margin-left: 10px; margin-top: 10px;vertical-align: central; margin-bottom: 10px; height: auto;" >
                                    <tr>
                                        <td>
                                            ...
                                            <span class="multi-input-header" style="float:left;width:65px; text-align: center; ">[[.guest_index.]]</span>                                            
...
<script type="text/javascript">
    ...
    function Send(i)
    {
        ...
        var s_id = jQuery("#reservation_room_id_"+i).val();
