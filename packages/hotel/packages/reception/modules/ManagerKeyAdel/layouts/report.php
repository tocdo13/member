...
<form name="ReportKeysForm" method="post">
    ...
    <div class="content">
        ...
        <tr class=table-header>
              ...
              <th width="15%" align="center">Thời gian tạo</th>
              
              <th width="15%" align="center">Ngày bắt đầu</th>
              <th width="15%" align="center">Ngày kết thúc</th>
              <th width="10%" align="center">Người tạo</th>
              <th width="15%" align="center">Tài khoản checkout</th>
              <th width="15%" align="center">Thời gian checkout</th>
              <!--<th width="20%" align="center">Lý do checkout</th>-->
              <th width="5%" align="center">delete</th>
          </tr>
          <?php
          if(isset($_REQUEST['r_r_id']))
          {
                ?>
                <tr>
               <td colspan="9" align="left" style="background-color: #FFFF99;">
                <div style="margin-left: 15px; width: 100%; height: auto; float:left;">Recode <span style="margin-left: 5px; margin-right: 5px;"><a class="recode" href="javascript:myJsFunc(<?php echo [[=reservation_room=]]['reservation_id'];?>)" ><?php echo '#'.[[=reservation_room=]]['reservation_id'];?></a></span>
               Phòng <span style="margin-left: 5px; font-size: 14px; color:blue; margin-right: 5px;"><?php echo [[=reservation_room=]]['name']?></span>
               Ngày đến <span style="margin-left: 5px; font-size: 14px; color:blue; margin-right: 5px;"><?php echo [[=reservation_room=]]['time_in']?></span>
               Ngày đi <span style="margin-left: 5px; font-size: 14px; color:blue; margin-right: 5px;"><?php echo [[=reservation_room=]]['time_out']?></span>
               </div></td>  
              </tr> 
              <!--LIST:items_key-->  
                <tr>
                   <td align="center">[[|items_key.index|]]</td> 
                   <td align="center">[[|items_key.create_time|]]</td>
                   <!--<td align="center">[[|items_key.id|]]</td>-->
                   <td align="center">[[|items_key.begin_time|]] </td>
                   <td align="center">[[|items_key.end_time|]]</td>
                   <td align="center">[[|items_key.create_user|]]</td>
                   <td align="center">[[|items_key.delete_user|]]</td>
                   <td align="center">[[|items_key.delete_time|]]</td>
                   <!--<td align="center">[[|items_key.delete_note|]]</td>-->
                   <td align="center"><input type="checkbox" name="check_list[]" value="[[|items_key.id|]]"/></td>
                </tr>  
                <!--/LIST:items_key--> 
                <?php 
          }
                ...
                <!--LIST:items-->
                  ...
                  <!--LIST:items.items_key-->  
                    <tr>
                       ...
                       <td align="center">[[|items.items_key.create_time|]]</td>
                       ...
                       <td align="center">[[|items.items_key.create_user|]]</td>
                       <td align="center">[[|items.items_key.delete_user|]]</td>
                       <td align="center">[[|items.items_key.delete_time|]]</td>
