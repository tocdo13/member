                                ...
                                <table width="95%" style="margin-left: 10px; margin-top: 10px;vertical-align: central;" >
                                    <tr>
                                        <td>
                                            ...
                                            <span class="multi-input-header" style="float:left;width:80px; text-align: center; ">[[.number_keys.]]</span>
                                    ...
                                    <tr height="60px" >
                                        ...
                                        <td align="center" >
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <input id="create" name="create" type="submit" value="[[.create_card.]]" style="width: 100px; height: 40px; font-size: 16px; font-weight: bold; color: #1F6B7A; " />
                                        </td>
                                    </tr>
                                </table>
                            </div>
