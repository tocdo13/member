                        ...
                        <td width ="100%" height="auto" align="center" style="background-color: silver; " >
                            <div style=" width: 60%; height: auto; border: 3px inset gray; background-color: white; margin: 20px 10px; ">
                                <div style="width: 100%; height: auto;">
                                    <p style=" font-size: 16px; font-weight: bold; color:blue; font-family: tahoma;">THÔNG TIN THẺ TỪ</p>
                                </div>
                                <table width="100%" align="center" style="margin: 20px 40px;" >
                                    ...
                                    <tr>
                                        ...
                                        <td style=" font-size: 16px;">
                                            <input name="txtRoomName" type="text" id="txtRoomName" value="<?php echo $result["room_name"] ?>" style="width: 200px; background-color: #E2E2E2;" readonly="readonly"/>
                                        </td>
                                    </tr>
