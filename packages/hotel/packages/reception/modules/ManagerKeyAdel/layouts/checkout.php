                        ...
                        <td width ="100%"align="center" style="background-color: silver; " >
                            <div style=" width:600px; border: 3px inset gray; background-color: white; padding-right: 10px; margin: 20px 20px;">
                                ...
                                <table width="200px" style="margin-top: 10px; margin-bottom: 10px;">
                                   <tr height="25px">
                                        <td>
                                            <span style=" font-size: 14px;">[[.room.]]</span>
                                            </td>
                                        <td>
                                            <select name="room_id" id="room_id" style="width: 85px;">
                                            [[|room_id|]]
                                            </select> 
                                            <!--<input id="checkout_guest" name="checkout_guest" type="submit" value="Guest" style="width: 60px; height: 20px; font-size: 12px; font-weight: bold; color: #1F6B7A; " />-->
                                        </td>
                                    </tr> 
                                   
                                    <tr height="25px">
                                        <td style="font-size: 14px;">[[.number_key_out.]]</td>
                                        <td>
                                    ...
                                    <tr height="30px">
                                        <td>
                                            <span style=" font-size: 14px;">[[.read_key_reception.]]</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                       ...
                                       <td style="margin-top: 10px;"> 
                                            <input id="delete" name="delete" type="submit" value="[[.checkout_card.]]" style="width: 85px; height: 40px; font-size: 14px; font-weight: bold; color: #1F6B7A; " />
                                       </td> 
                                    </tr>
