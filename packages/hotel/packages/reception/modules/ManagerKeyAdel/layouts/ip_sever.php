<span style="display:none">
	<span id="mi_group_sample">
		<div id="input_group_#xxxx#">
            ...
            <select name="mi_group[#xxxx#][add_client]" id="add_client_#xxxx#" style="width: 85px;">
					[[|add_client_options|]]
			</select>
            </span>
            <span class="multi-input">
            <select name="mi_group[#xxxx#][add_source]" id="add_source_#xxxx#" style="width: 85px;">
					[[|add_source_options|]]
			</select>
            </span>
                                ...
                                <table width="100%" style="margin-top: 10px;">
                                    <tr>
                                        <td>
                                            ...
                                            <span class="multi-input-header" style="float:left;width:80px; text-align: center; ">Add client</span>
                                            <span class="multi-input-header" style="float:left;width:80px; text-align: center; ">Add source</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" >
