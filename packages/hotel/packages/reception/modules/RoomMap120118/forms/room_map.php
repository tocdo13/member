<?php
class RoomMap120118Form extends Form
{
	function RoomMap120118Form()
	{
		Form::Form('RoomMap120118Form');
	...
	function draw()
	{
		...
		foreach($room_statuses as $key=>$room_status)
		{
			...
			if($room_status['house_status']=='REPAIR'){
                ...
                if($room_id_dn != $room_status['room_id'])
                {
                    $this->map['total_repaire_room']++;
                }
                $room_id_dn = $room_status['room_id'];
			}
