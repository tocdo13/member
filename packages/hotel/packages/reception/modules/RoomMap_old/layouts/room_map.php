...
<td class="calendar-bound">
	...
	<td align="left">
		<div id="room_map_left_utils" style="width:200px;">
            ...
            <tr>
                ...
                <input name="in_date" type="text" id="in_date" class="date-input" onchange="jQuery('#check_submit_date').removeAttr('checked');HotelRoomMapForm.submit();"/>
                </td>
            </tr>
		  </table>
		  </fieldset><br />
          ...
          <fieldset>
			<legend class="title">[[.forcecast.]]</legend>
				<table border="0" cellpadding="2">
				  	<tr class="checkin-today" onClick="window.open('?page=arrival_list&status=BOOKED');">
						<td align="left"><?php echo ([[=total_checkin_today_room=]]+ [[=total_books_without_room=]] + [[=total_change_room=]] );//echo ([[=total_checkin_today_room=]]+ [[=total_books_without_room=]]);//echo ( [[=total_checkin_today_room=]] + [[=total_books_without_room=]]);?> [[.check_in_today.]]</td>
					</tr>
                    <tr class="checkin-today" onClick="window.open('?page=checkin_list&date='+jQuery('#in_date').val());">
						<td align="left"><?php echo ([[=autual_checkin=]]);?> [[.actual_checkin_today.]]</td>
					</tr>
                    <tr class="checkin-today" onClick="window.open('?page=arrival_list&status=DAYUSE&date='+jQuery('#in_date').val());">
                    ...
                    <tr class="checkin-today" onClick="window.open('?page=departure_list&traveller_status=out&date='+jQuery('#in_date').val());">
						<td align="left">[[|autual_checkout|]] [[.actual_checkout_today.]]</td>
					</tr>
				 	<tr class="checkin-today" onClick="window.open('?page=room_status_report&in_date='+jQuery('#in_date').val());">
						<td align="left"><?php echo([[=total_books_without_room=]]+[[=total_occupied_today=]]+[[=total_checkin_today_room=]] + [[=total_change_room=]]);//echo([[=total_books_without_room=]] + [[=total_dayuse_today=]] + [[=total_occupied_today=]] + [[=total_booked_room=]]+ [[=total_overdue_booked_room=]] );//echo([[=total_books_without_room=]] + [[=total_dayused_room=]] + [[=total_occupied_today=]]+[[=total_checkin_today_room=]] )//[[=total_booked_room=]]echo([[=total_occupied_today=]]+ [[=total_books_without_room=]] + [[=total_checkin_today_room=]] - [[=total_dayuse_today=]]) //echo [[=total_checkin_room=]];echo [[=total_checkin_room=]];
						 ?> [[.total_occ_and_arr.]]</td>
					</tr>
                    <tr class="checkin-today" onClick="window.open('?page=occupancy_forecast_report');">
						<td align="left">[[.occupancy_forecast_report.]]</td>
					</tr>
			   </table>
			</fieldset><br />
		...
		<table cellpadding="2" width="100%" class="room-map-customer-search-box" style="border:0px;">
            <tr>
			  ...
			  <td><input name="booker" type="text" id="booker" style="width:100px;" onKeyPress="if(event.keyCode==13){buildReservationSearch();}"/></td>
			  </tr>
            <tr>
            <tr>
			  <td nowrap="nowrap" align="right">[[.phone_booker.]]</td>
			  <td><input name="phone_booker" type="text" id="phone_booker" style="width:100px;" onKeyPress="if(event.keyCode==13){buildReservationSearch();}"/></td>
	        </tr>
            ...
            <tr>
			  ...
			  <td><input name="start_date" type="text" id="start_date" style="width:100px;" onKeyPress="if(event.keyCode==13){buildReservationSearch();}"/></td>
			  </tr>
            <tr>
            <tr>
			  <td nowrap="nowrap" align="right">[[.End_date.]]</td>
			  <td><input name="end_date" type="text" id="end_date" style="width:100px;" onKeyPress="if(event.keyCode==13){buildReservationSearch();}"/></td>
			  </tr>
            <tr>
            <tr>
                <td></td>
		...
		<fieldset style="border:1px solid #9DC9FF">
            ...
            <marquee style="width:220px;color:#F00;" onMouseOut="this.start();" onMouseOver="this.stop();" scrollamount="3">
			...
			<table width="220px" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
            ...
            <marquee style="width:220px;color:#F00;" scrollamount="3" onMouseOut="this.start();" onMouseOver="this.stop();">
            <!--LIST:books_without_room-->
            ...
            <fieldset style="border:1px solid #9DC9FF">
               ...
               <div id="accordian">
                    <ul>
                        ...
                        <li>
                            <h3><span></span>[[.re_code.]] [[|booking_cut_of_day.recode_hard|]] |  [[|booking_cut_of_day.sum|]]P | <a href="?page=reservation&cmd=edit&id=[[|booking_cut_of_day.recode_hard|]]">[[.check.]]</a></h3>
                			<!--<ul>
                                <li><a href="?page=reservation&cmd=edit&id=[[|booking_cut_of_day.reservation_id|]]&r_r_id=[[|booking_cut_of_day.id|]]">[[.room_level.]]: [[|booking_cut_of_day.room_level|]]</a></li>
                				<li><a href="?page=reservation&cmd=edit&id=[[|booking_cut_of_day.reservation_id|]]&r_r_id=[[|booking_cut_of_day.id|]]">[[.booking_code.]]: [[|booking_cut_of_day.booking_code|]]</a></li>
                				<li><a href="?page=reservation&cmd=edit&id=[[|booking_cut_of_day.reservation_id|]]&r_r_id=[[|booking_cut_of_day.id|]]">[[.customer_name.]]: [[|booking_cut_of_day.customer_name|]]</a></li>
                				<li><a href="?page=reservation&cmd=edit&id=[[|booking_cut_of_day.reservation_id|]]&r_r_id=[[|booking_cut_of_day.id|]]">[[.time_in.]]: [[|booking_cut_of_day.time_in|]]</a></li>
                				<li><a href="?page=reservation&cmd=edit&id=[[|booking_cut_of_day.reservation_id|]]&r_r_id=[[|booking_cut_of_day.id|]]">[[.time_out.]]: [[|booking_cut_of_day.time_out|]]</a></li>
                				<li><a href="?page=reservation&cmd=edit&id=[[|booking_cut_of_day.reservation_id|]]&r_r_id=[[|booking_cut_of_day.id|]]">[[.creater.]]: [[|booking_cut_of_day.full_name|]]</a></li>
                			</ul>-->
                        </li>
                        <!--/LIST:booking_cut_of_day-->
                    </ul>
        ...
        <!-- end manh -->
        <!-- manh them han xac nhan waitting list -->
            <fieldset style="border:1px solid #9DC9FF">
	           <legend class="title">XN [[.waiting_book.]]</legend>
               <table width="99%" border="1" cellpadding="2" bordercolor="#CCCCCC">
                    ...
                    <tr style="font-size: 9px;">
                        <td>[[|waiting_book.contact_name|]]</td>
                        <td>[[|waiting_book.customer_name|]]</td>
                        <td>[[|waiting_book.arrival_date|]] - [[|waiting_book.departure_date|]]</td>
                        <td><a href="?page=waiting_book&cmd=edit&id=[[|waiting_book.id|]]"><img src="packages/core/skins/default/images/buttons/edit.gif" style="width: 15px; height: auto;" /></a></td>
                    </tr>
                    <!--/LIST:waiting_book-->
               </table>
            </fieldset>
		...
		<fieldset style="border:1px solid #9DC9FF">
            ...
            <tr>
				<td><div class="room_arround"><a href="#" class="room BOOKED" style="width:16px;height:16px;margin-right:2px; border: 4px solid #000000;">&nbsp;</a></div></td>
				<td>[[.booked.]] [[.doing_not_move.]]</td>
			</tr>
	...
	<td bgcolor="#FFFFFF" align="left" width="99%">
		...
		<!--/IF:cond-->
		<div class="body">
		<table width="1150" border="1" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" bordercolor="#CCCCCC">
			<!--LIST:floors-->	
		...
		{	
					...
					for(var j in room_reservations)
					{
						if(last_reservation != room_reservations[j]['reservation_id'])
						{
							...
							if(last_reservation && last_reservation!=0 && last_reservation!='')
							{
                                ...
                                information += '<tr><td></td><td width="1%"></td><td class="value"><a target="_blank" href="?page=master_reservation&reservation_room_id='+room_reservations[j]['reservation_room_id']+'&form_site=ROOM_MAP&autoload=1" class="room-map-edit-link">[[.view_detail_fast.]]</a></td></tr>';
                                <!--/IF:add_traveller-->
                                <!--IF:add_traveller(USER::can_add($this->get_module_id('Reservation'),ANY_CATEGORY))-->
                                information += '<tr><td></td><td width="1%"></td><td class="value"><a target="_blank" href="?page=reservation&cmd=import_traveller&r_id='+room_reservations[j]['reservation_id']+'&rr_id='+room_reservations[j]['reservation_room_id']+'" class="room-map-edit-link">[[.add_traveler.]]</a></td></tr>';
                                <!--/IF:add_traveller-->
								<!--IF:add_extra_service_invoice(USER::can_add($this->get_module_id('ExtraServiceInvoice'),ANY_CATEGORY))-->
                                information += '<tr><td></td><td width="1%"></td><td class="value"><a target="_blank" href="?page=extra_service_invoice&type=SERVICE&cmd=add&reservation_room_id='+room_reservations[j]['reservation_room_id']+'" class="room-map-edit-link"> [[.add_extra_service_invoice.]]</a></td></tr>';
                                <!--/IF:add_extra_service_invoice-->
                                 <!--IF:add_extra_service_invoice(USER::can_add($this->get_module_id('ExtraServiceInvoice'),ANY_CATEGORY))-->
                                information += '<tr><td></td><td width="1%"></td><td class="value"><a target="_blank" href="?page=extra_service_invoice&type=ROOM&cmd=add&reservation_room_id='+room_reservations[j]['reservation_room_id']+'" class="room-map-edit-link"> [[.extra_char_room.]]</a></td></tr>';
                                <!--/IF:add_extra_service_invoice-->
                                <!--ELSE-->
								...
								information += (room_reservations[j]['status']=='OVERDUE' || room_reservations[j]['status']=='OCCUPIED' || room_reservations[j]['status']=='PREPARE_FOR_CHECKOUT' || room_reservations[j]['status']=='EXPECTED_CHECKOUT' || room_reservations[j]['status']=='DAYUSED')?'<tr><td></td><td width="1%"></td><td class="value"><a target="_blank" href="?page=laundry_invoice&cmd=add&reservation_room_id='+room_reservations[j]['reservation_room_id']+'" class="room-map-edit-link"> [[.add_laundry_invoice.]]</a></td></tr>':'';
								<!--/IF:add_minibar_invoice-->
                                /*
								<!--IF:add_extra_service_invoice(USER::can_add($this->get_module_id('ExtraServiceInvoice'),ANY_CATEGORY))-->
                                ...
                                */
								...
								information += (room_reservations[j]['status']=='OVERDUE' || room_reservations[j]['status']=='OCCUPIED' || room_reservations[j]['status']=='PREPARE_FOR_CHECKOUT' || room_reservations[j]['status']=='EXPECTED_CHECKOUT' || room_reservations[j]['status']=='DAYUSED')?'<tr><td></td><td width="1%"></td><td class="value"><a target="_blank" href="?page=equipment_invoice&cmd=add&reservation_room_id='+room_reservations[j]['reservation_room_id']+'" class="room-map-edit-link"> [[.add_compensation_invoice.]]</a></td></tr>':'';
								...
								if(room_reservations[j]['net_price']==1){
									information += '<tr><td class="label">[[.price.]]</td><td>:</td><?php if(User::can_admin(false,ANY_CATEGORY)){ ?><td class="value">'+room_reservations[j]['price']+' <?php echo HOTEL_CURRENCY;?></td><?php }?></tr>';
								}else{
									information += '<tr><td class="label">[[.price.]]</td><td>:</td><?php if(User::can_admin(false,ANY_CATEGORY)){?><td class="value">'+room_reservations[j]['price']+room_reservations[j]['tax_rate']+room_reservations[j]['service_rate']+' <?php echo HOTEL_CURRENCY;?></td><?php } ?></tr>';
								}
						...
						<div  id="group_note_'+room_reservations[j]['reservation_id']+'" style="width:325px; border:none;" readonly>'+room_reservations[j]['group_note']+'</div> ';
								...
								information += '<tr><td colspan="3">[[.note.]]:\ <textarea  name="room_note_'+room_reservations[j]['reservation_id']+'" style="width:325px" class="valid_note" onkeyup="validText();" rows="3">'+room_reservations[j]['room_note']+'</textarea>';
                        <?php if(User::can_edit('1980','1041600000000000000')){ ?>
                        information += '<input  type="submit" value="Change" name="change_room_note_'+room.id+'"/>';
                        <?php } ?>
						information += '<br><hr></br></td></tr>';
								<!--/IF:room_note-->
							}
						}
					}
            ...
            if((room_reservations)){
                ...
                for(var tan in room_reservations){
                 ...
                 {
                    <?php if(User::can_edit('1980','1041600000000000000')){ ?>
                    information += '[[.house_status.]]: <select  name="house_status" id="house_status" onclick=" jQuery(\'#div_date_repair\').css(\'display\',\'\');jQuery(\'#repair_to\').datepicker({ minDate: new Date(CURRENT_YEAR, CURRENT_MONTH, CURRENT_DAY) ,yearRange: \'-100:+4\'}); jQuery(\'#ui-datepicker-div\').css(\'z-index\',\'3000\');"><option value="">READY</option><option value="SHOWROOM">SHOWROOM</option><option value="CLEAN">CLEAN</option><option value="DIRTY">DIRTY</option><option value="HOUSEUSE">HOUSEUSE</option></select><input type="submit" value="Change" class="hk-status-button" />';
                    <?php } ?>
                 } 
                else{
                    <?php if(User::can_edit('1980','1041600000000000000')){ ?>
                    information += '[[.house_status.]]: <select  name="house_status" id="house_status" onclick=" jQuery(\'#div_date_repair\').css(\'display\',\'\');jQuery(\'#repair_to\').datepicker({ minDate: new Date(CURRENT_YEAR, CURRENT_MONTH, CURRENT_DAY) ,yearRange: \'-100:+4\'}); jQuery(\'#ui-datepicker-div\').css(\'z-index\',\'3000\');"><option value="">READY</option><option value="SHOWROOM">SHOWROOM</option><option value="CLEAN">CLEAN</option><option value="DIRTY">DIRTY</option><option value="REPAIR">REPAIR</option><option value="HOUSEUSE">HOUSEUSE</option></select><input type="submit" value="Change"  class="hk-status-button" />';
                    <?php } ?>
                }
