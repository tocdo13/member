	...
	<tr id="title">
        ...
        <td width="50%"><span style="text-align:left; color:#0A3680;">
           ...
           <!--/LIST:folio-->
                ...
                <input name="save" type="button" style="float:right;margin-right: 5px; text-transform: uppercase; text-decoration: none;" id="save" value="[[.Save_and_stay.]]" class="w3-btn w3-blue w3-hover-blue w3-text-white w3-hover-text-white" onclick="SubmitForm('save');" />
                <input name="save_and_print" type="button" id="save_and_print" class="w3-btn w3-orange w3-hover-orange w3-text-white w3-hover-text-white" style="float:right;height:28px; margin-right: 5px; text-transform: uppercase; text-decoration: none;" value="[[.save_view.]]" onclick="SubmitForm('save_and_print');" />
                <?php } ?>
                ...
                <?php if($type != [[=folios.items.type=]] || $rr != [[=folios.id=]]){ $rr = [[=folios.id=]]; $type = [[=folios.items.type=]]; ?>       
                        <tr id="title_[[|folios.items.type|]]_[[|folios.id|]]">
                        	<td width="400">
                            	...
                            	<input name="total_[[|folios.items.type|]]_[[|folios.id|]]" id="total_[[|folios.items.type|]]_[[|folios.id|]]" value="" style="float:right; text-align:right; border:none;" align="right" /> [[|folios.id|]]
                            </td>
                            <td width="30">
