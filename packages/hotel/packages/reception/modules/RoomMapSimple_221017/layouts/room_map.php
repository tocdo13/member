...
<td class="calendar-bound">
	...
	<td bgcolor="#FFFFFF" align="left" width="99%">
        ...
        <a class="w3-btn w3-gray w3-hover-green" type="button" href="#" onClick="buildRoommapUrl('DETAIL');" style="text-decoration: none; text-transform: uppercase; border: 1px solid gray;">[[.room_map_detail.]]</a>
        ...
        <table width="100%" border="0" cellpadding="2" style="margin-top: 5px; border-top: 1px solid gray;">
			  <tr>
				<td style="padding-top: 5px; "><a href="#" class="room AVAILABLE w3-hover-white" style="width:25px;height:25px;margin-right:2px; color: black; ">[[|total_available_room|]]</a><div style="padding-top: 3px; ">[[.available_room.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room BOOKED" style="width:25px;height:25px;margin-right:2px; color: black;">[[|total_booked_room|]]</a><div style="padding-top: 3px;">[[.booked.]]</div></td>								
				<td style="padding-top: 5px; "><a href="#" class="room OVERDUE_BOOKED" style="width:25px;height:25px;margin-right:2px; color: black;">[[|total_overdue_booked_room|]]</a><div style="padding-top: 3px;">[[.overdue_booked.]]</div></td>			
			   ...
			   <!---<tr style="display:none;">
				...
				<td style="padding-top: 5px; "><a href="#" class="room OCCUPIED" style="width:25px;height:25px;margin-right:2px; color: black;"><?php echo [[=total_checkin_room=]];?></a><div style="padding-top: 3px;">[[.occupied.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room" style="width:25px;height:25px;margin-right:2px; background-color: #fde0c5; color: black;"><?php echo [[=total_change_room_today=]];?></a><div style="padding-top: 3px;">[[.checkin_change_today.]]</div></td>			
				<td style="padding-top: 5px; "><a href="#" class="room DAYUSED" style="width:25px;height:25px;margin-right:2px; color: black;"><?php echo [[=total_dayused_room=]] +[[=total_checkin_today=]] ;?></a><div style="padding-top: 3px;">[[.checkin_today.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room OVERDUE" style="width:25px;height:25px;margin-right:2px; color: black;">[[|total_overdue_room|]]</a><div style="padding-top: 3px;">[[.overdue.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room EXPECTED_CHECKOUT" style="width:25px;height:25px;margin-right:2px;color: black;">[[|total_checkout_today_room|]]</a><div style="padding-top: 3px;">[[.expected_checkout.]]</div></td>				
                <!---<tr style="display:none;">
				...
				<td style="padding-top: 5px; "><a href="#" class="room REPAIR" style="width:25px;height:25px;margin-right:2px; color: black;">[[|total_repaire_room|]]</a><div style="padding-top: 3px;">[[.reparing.]]</div></td>
                    ...
                    <?php //if(User::id()=='developer05') System::debug([[=floors.rooms=]]); ?>
						<!--LIST:floors.rooms-->
							  <div title="<?php echo addslashes([[=floors.rooms.note=]]);?>" class="room-bound">
							  	<span class="room-name" style="text-align: center !important;"><strong><span style="font-size:14px;color:black;"><!---[[|floors.rooms.name|]]---></span></strong> [[|floors.rooms.type_name|]]<br /></span><br clear="all"/>
                                    ...
                                    <!--IF:time2([[=floors.rooms.house_status=]] == 'HOUSEUSE')-->
									   <!--LIST:floors.rooms.reservations-->
                                            <!--IF:time3(isset([[=floors.rooms.reservations.start_date=]]) and isset([[=floors.rooms.reservations.end_date=]]))-->
                                                <!---<span style="font-size:9px;color:#003399;font-weight:bold;"><?php echo substr([[=floors.rooms.reservations.start_date=]],0,5);?> - <?php echo substr([[=floors.rooms.reservations.end_date=]],0,5);?></span>--->
                                            <!--IF:time3-->
                                       <?php break;?>
									   <!--/LIST:floors.rooms.reservations-->
                                    <!--/IF:time2-->									
