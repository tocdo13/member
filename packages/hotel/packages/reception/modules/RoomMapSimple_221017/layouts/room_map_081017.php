...
<td class="calendar-bound">
	...
	<td bgcolor="#FFFFFF" align="left" width="99%">
        ...
        <a class="w3-btn w3-gray" href="#" onClick="window.open('?page=room_map_new');">[[.room_map_detail.]]</a>
...
<!--ROOM STATUS ON ROOM MAP-->
                                    <span id="house_status_[[|floors.rooms.id|]]" style="font-size:9px;font-weight:normal;color:red; "><b style="font-size: 15px; color: black !important; ">[[|floors.rooms.name|]]</b><br/>[[|floors.rooms.house_status|]]</span>
								</a>
