...
<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		<td width="55%" class="form-title">[[.manage_gate.]]</td>
		<?php if(User::can_add(false,ANY_CATEGORY)){?><td width="1%"><input type="submit" value="[[.Save.]]" class="button-medium-save"></td><?php }?>
		<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('gate');" class="button-medium-delete">[[.Delete.]]</a></td><?php }?>
		<td width="1%"><input type="button" style="border:1px solid #CCCCCC; background:#FFFFFF; height:24px;" value="[[.discard.]]" onclick="location='<?php echo URL::build_current();?>';"/></td>
	</tr>
</table>
<table cellspacing="0">
	<tr><td style="padding-bottom:30px">
		...
		<tr valign="top">
			...
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('gate');$('name_'+input_count).focus();" class="button-medium-add">[[.Add.]]</a></div>
