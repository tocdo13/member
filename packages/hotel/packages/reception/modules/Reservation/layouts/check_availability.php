    	...
    	<div style="float:left;width:40%;overflow-y:hidden;">
            <div style="width:2500px;float:left;height: 480px;">
        		<!--LIST:room_levels-->
                    ...
                    ?>
                            <span class="check-availability-day header" style="border-right:1px solid #EFEFEF;position: absolute;"><strong>[[.total.]]</strong></span>
                            <span class="check-availability-day header" style="border-right:1px solid #EFEFEF;"><strong>[[.real.]]</strong></span>
                            <?php 
                        } 
                        else
                        {
                            ...
                            <!--IF:total_room([[=room_levels.id=]])-->
                    		 <span class="check-availability-day" style="background-color: #FFFFFF; color: black;">[[|room_levels.total_room_quantity|]]</span>
        		...
        		<!--/LIST:room_levels-->
                <div class="check-availability-item">
                    <span class="check-availability-day" style="background-color: #FFFFFF; color: black; position: absolute;"><strong>[[|total_room|]]</strong></span>
                </div>
