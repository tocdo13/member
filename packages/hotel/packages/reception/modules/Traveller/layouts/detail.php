...
<table width="100%" border="0" cellspacing="0" cellpadding="2" style="border:1px solid #CCCCCC">
  <tr>
    <td colspan="8" bgcolor="#C8DEF9"><font class="form_title"><b>[[.traveller_detail.]]</b></font></td>
...
<legend class="title">[[.archives.]]</legend>
	...
	<table cellpadding="2" cellspacing="0" width="85%" border="1">
        ...
        <tr>
            ...
            <td style="text-align: center;"><a target="_blank" href="<?php echo Url::build('view_traveller_folio',array('traveller_id'=>[[=items.re_traveller_id=]],'folio_id'=>[[=items.folio=]]))?>">[[|items.folio|]]</a></td>
