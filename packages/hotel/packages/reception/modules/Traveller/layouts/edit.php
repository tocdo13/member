...
<table cellspacing="0" width="100%">
	<tr valign="top">
		<td align="left">
			<table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
				<tr>
					<td width="50%" class="form-title">[[.edit_traveller_info.]]</td>
					<td width="50%" align="right" nowrap="nowrap">
						...
						<?php if(User::can_add(false,ANY_CATEGORY)){?><input name="save" id="save" type="submit" value="[[.Save.]]" class="button-medium-save" onclick="check_click();" /><?php }?>
                        <script>
                            var count_click=0;
						...
						<?php if(User::can_delete(false,ANY_CATEGORY)){?><a href="<?php echo Url::build_current(array('action'));?>"  class="button-medium-back">[[.back.]]</a><?php }?>
					</td>
				</tr>
			</table>
		</td>
	...
	<td><table width="400" cellpadding="2" cellspacing="0">
      ...
      <tr valign="top">
        <td align="right" nowrap="nowrap">[[.passport.]] <span style="color: red;">(*)</span></td>
        <td align="center">:</td>
