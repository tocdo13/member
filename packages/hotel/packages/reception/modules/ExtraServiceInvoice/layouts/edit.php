<script type="text/javascript">
	min_year = <?php echo date('Y',[[=arrival_time=]]);?>;   
	min_month = <?php echo date('m',[[=arrival_time=]]);?>;
	min_day = <?php echo date('d',[[=arrival_time=]]);?>;
	max_year = <?php echo date('Y',[[=departure_time=]]);?>;
	max_month = <?php echo date('m',[[=departure_time=]]);?>;
	max_day = <?php echo date('d',[[=departure_time=]]);?>;	
</script>
<style>
...
<input  name="deleted_ids" type="hidden"  id="deleted_ids" value="<?php echo URL::get('deleted_ids');?>"/>
	<table cellpadding="5" cellspacing="0" width="100%" class="table-bound">
		<tr height="40">
        	<td class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px; width: 70%"><i class="fa fa-folder-open w3-text-orange" style="font-size: 26px;"></i> [[|title|]]</td>
			<?php if(User::can_add(false,ANY_CATEGORY)){?>
                <td style="width: 30%; text-align: right; padding-right: 30px;">
                    <?php if([[=close_mice=]]==0){ ?>
                    <input  name="save" type="button" id="save"  onclick=" return check_service_id();" class="w3-btn w3-orange w3-text-white" style="margin-right: 5px; <!--IF:cond(Url::get('cmd')=='add' and [[=reservation_room_id=]]=='')-->display: none;<!--/IF:cond--> text-transform: uppercase;" <?php echo (isset([[=status=]]) and [[=status=]]=='CHECKOUT')?'disabled="disabled" title="'.Portal::language('room_checked_out_can_not_edit').'" style="background:#CCCCCC;color:#FF0000;"  value="'.Portal::language('room_checked_out_can_not_edit').'"':' value="'.Portal::language('Save').'"';?> />
                    <input name="act" id="act" type="hidden" />
                    <?php }?>
                
            <?php }?>
            <?php if(User::can_delete(false,ANY_CATEGORY) and !Url::get('fast')){?><a href="?page=extra_service_invoice&type=<?php echo Url::get('type');?>"  style="text-transform: uppercase; text-decoration: none;"  class="w3-btn w3-green">[[.back.]]</a></td><?php }?>
        </tr>
        <tr>
            <td colspan="3">
                <?php if(Url::get('cmd')=='edit' and (isset([[=check_mice=]]) and [[=check_mice=]] == 1) ){?>
                    <table style="" cellpadding="5" cellspacing="0">
                        <tr>
                            <?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=0 AND [[=mice_reservation_id=]]!=''){ ?>
                                <td></td>
                                <td style="color: red; font-weight: bold;">[[.mice.]]</td>
                                <td style="padding-left:10px;">
                                    ...
                                    <input value="[[.split.]] MICE" type="button" onclick="FunctionSplitMice('[[|mice_reservation_id|]]','EXS','<?php echo Url::get('id'); ?>');" style="font-weight: bold; padding: 3px 10px; margin-left: 20px;" />
                                </td>
                            <?php }else{ ?>
                                <td></td>
                                <td><input value="[[.add_mice.]]" type="button" onclick="FunctionAddMice('EXS','<?php echo Url::get('id'); ?>');" style="font-weight: bold; padding: 3px 10px;" /></td>
                                <td style="padding-left:10px;"><input value="[[.select.]] MICE" type="button" onclick="FunctionSelectMice('EXS','<?php echo Url::get('id'); ?>');" style="font-weight: bold; padding: 3px 10px;" /></td>
                                <td></td>
                            <?php } ?>
                        </tr>
                    </table>
	...
	<div class="content">
        ...
        <legend class="" style="text-transform: uppercase; font-size: 14px; font-weight: normal;">[[.service_information.]]</legend>
			<table border="0" cellspacing="0" cellpadding="2" id="table_info">
                <tr>
                    <td>[[.room.]]:</td> <td colspan="3"><select name="reservation_room_id" id="reservation_room_id" onchange="EditExtraServiceInvoiceForm.submit();" style="width:300px;font-size:11px;"<?php if(Url::get('cmd')=='edit'){echo 'disabled';} ?> ></select></td>				
					<td class="label">[[.code.]]:</td>
				    <td ><input name="bill_number" type="text" id="bill_number" readonly="readonly" class="readonly" style="width:100px;" /></td>
                    <td >[[.bill_number.]]</td>
                    <td><input name="code" type="text" id="code" style="width: 140px;" /></td>
				</tr>
                <tr>
                  <td >[[.service_type.]]</td>
                  <td ><select name="payment_type" id="payment_type" style="width:100px;"><option <?php echo 'value='.[[=payment_type=]].'' ?>>[[|payment_type_name|]]</option></select></td>
                  <td>[[.net_price.]]</td>
                  <td><!--IF:cond(Url::get('cmd')=='add')-->
                  ...
                  <td class="label">[[.note.]]</td>
                    <td colspan="3"><textarea name="note" id="note" rows="3" style="width:295px;"></textarea></td>         
                </tr>
                <tr style="display:none;">
                  <td class="label">[[.payment_method.]]</td>
                  <td colspan="3"><select name="payment_method_id" id="payment_method_id">
                  </select></td>
                </tr>
             <!-- <tr valign="top">
                <td class="label">[[.close.]]</td>
                <td colspan="3"><input name="close" type="checkbox" id="close" value="1" /></td>
              </tr> -->
			</table>
	  </fieldset><br />
      
      <fieldset style="<!--IF:cond(Url::get('cmd')=='add' and [[=reservation_room_id=]]=='')-->display: none;<!--/IF:cond-->">
        <legend class="" style="text-transform: uppercase; font-size: 14px; font-weight: normal;">[[.detail.]]</legend>
            <span id="mi_product_group_all_elems" style="text-align:center; height: 24px;">
                <span>
                    ...
                    <span class="multi-input-header" style="width:63px;">[[.number.]]</span>
                    <?php if(Url::get('cmd')=='edit'){?>
                    <span class="multi-input-header" style="width:63px;">[[.edit_quantity.]]</span>
                    <?php }?>
                    <span class="multi-input-header" style="width:64px;">[[.unit.]]</span>
                    <span class="multi-input-header" style="width:84px;">[[.price.]]</span>
                    <span class="multi-input-header" style="width:84px;">[[.usd_price.]]</span>
                    <span class="multi-input-header" style="width:104px;">[[.amount.]]</span>
                    <span class="multi-input-header" style="width:85px;">[[.from_date.]]</span>
                    <span class="multi-input-header" style="width:85px;">[[.to_date.]]</span>
                    <span class="multi-input-header" style="width:80px;">[[.total_day.]]</span>
                    <span class="multi-input-header" style="width:135px;">[[.package_sale_detail.]]</span>
					<span class="multi-input-header" style="width:200px;">[[.note.]]</span>
                    
                    <!--<span class="multi-input-header" style="width:70px;">[[.used.]]</span>-->
                </span><br clear="all">
            </span>
            <input class="w3-btn w3-cyan w3-text-white" style="float: left; margin-top: 5px; text-transform: uppercase; font-weight: normal;" type="button" value="[[.add_service.]]" id="add_product" onclick="mi_add_new_row('mi_product_group');jQuery('#quantity_'+input_count).removeAttr('readonly');jQuery('#quantity_'+input_count).ForceNumericOnly();jQuery('#price_'+input_count).ForceNumericOnly();jQuery('#price_'+input_count).FormatNumber();jQuery('#from_date_'+input_count).datepicker({minDate: new Date(min_date[2],min_date[1]-1,min_date[0]),maxDate: new Date(max_date[2],max_date[1]-1,max_date[0])});jQuery('#to_date_'+input_count).datepicker({minDate: new Date(min_date[2],min_date[1]-1,min_date[0]),maxDate: new Date(max_date[2],max_date[1]-1,max_date[0])})"/>
            ...
            <?php }?>
            <div style="text-align: right;">[[.total_before_tax.]]: <input  name="total_amount" type="text" id="total_amount" readonly class="readonly" style="width:104px;font-weight:bold;text-align:right;"/></div>
            <div style="text-align: right;">[[.service_rate.]](<input  name="service_rate" type="text" id="service_rate" value="[[|service_rate|]]" onkeyup="UpdateTotal();" style="width:20px;font-weight:bold;text-align:right;border:none"/> %): <input  name="service_amount" type="text" id="service_amount" readonly class="readonly" style="width:104px;font-weight:bold;text-align:right;"/></div>
            <div style="text-align: right;">[[.tax_rate.]](<input  name="tax_rate" type="text" id="tax_rate" value="[[|tax_rate|]]" onkeyup="UpdateTotal();" style="width:20px;font-weight:bold;text-align:right; border:none"> %): <input  name="tax_amount" type="text" id="tax_amount" readonly class="readonly" style="width:104px;font-weight:bold;text-align:right;"></div>
			<div style="text-align: right;">[[.total.]]: <input  name="total" type="text" id="total" readonly class="readonly" style="width:104px;font-weight:bold;text-align:right;"></div>
            </div>
    </fieldset>
    <i style="color: red;">[[.note_detail.]]</i>	
    </div>
...
<script>
    ...
    if(cmd=='add'){
      ...
      var arrival_date=<?php echo '\''.[[=arrival_date=]].'\''; ?>;
      var departure_date=<?php echo '\''.[[=departure_date=]].'\''; ?>;
    ...
    function check_date(i){
     ...
     if(from_date!='' && to_date!=''){
         ...
         var date2 = new Date(to_date_time[2],to_date_time[1]-1,to_date_time[0]);
         if(date2<date1){
            alert('[[.from_date_must_small_to_date.]]');
