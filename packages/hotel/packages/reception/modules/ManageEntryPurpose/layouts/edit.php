...
<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		<td width="55%" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;">[[.manage_entry_purposes.]]</td>
		...
		<?php if(User::can_delete(false,ANY_CATEGORY)){?><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('entry_purposes');" class="w3-btn w3-red w3-text-white" style="text-transform: uppercase; text-decoration: none;">[[.Delete.]]</a></td><?php }?>
	</tr>
</table>
<table cellspacing="0">
	<tr>
        <td style="padding-bottom:30px">
    		...
    		<table border="0">
        		...
        		<tr>
        			...
        			<div><a href="javascript:void(0);" onclick="mi_add_new_row('entry_purposes');$('name_'+input_count).focus();" class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; margin-top: 5px;">[[.Add.]]</a></div>
                    </td>
                </tr>
            </table>
        </td>
