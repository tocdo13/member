...
class MonthlyRoomReportNewForm extends Form
{
	...
	function draw()
    {
        ...
        $cond_order_by = Url::get('order_by')==2?'room_level.is_virtual,room_level.id asc,room_level.position,room_level.brief_name,room.name':'room.id,room.floor,room.position';
