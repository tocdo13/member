                        ...
                        <td width ="100%" height="auto" align="center" style="background-color: silver; " >
                            <div style=" width: 60%; height: auto; border: 3px inset gray; background-color: white; margin: 20px 10px; ">
                                ...
                                <table width="100%" align="center" style="margin: 20px 40px;" >
                                    ...
                                    <!--<tr>
                                        <td width ="100px" valign="top" style=" font-size: 16px;">[[.cardno_key.]]</td>
                                        <td style=" font-size: 16px;">
                                            <input name="txtCardNo" type="text" id="txtCardNo" value="<?php echo $result["CardNo"] ?>" style="width: 200px; background-color: #E2E2E2;" readonly="readonly"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width ="100px" valign="top" style=" font-size: 16px;">[[.guest_index.]]</td>
                                        <td style=" font-size: 16px;">
                                            <input name="txtGuestIndex" type="text" id="txtGuestIndex" value="<?php echo $result["GuestIdx"]; ?>" style="width: 200px; background-color: #E2E2E2;" readonly="readonly"/>
                                        </td>
                                    </tr>-->
                                    <tr>
                                        <td width ="100px" valign="top" style=" font-size: 16px;"> [[.room.]]</td>
                                        <td style=" font-size: 16px;">
                                            <input name="room" type="text" id="room" value="<?php if(isset($result["room"])) {echo $result["room"];} ?>" style="text-align: center; background-color: #E2E2E2;" size="15" readonly="readonly"/>
                                        </td>
                                    </tr>
