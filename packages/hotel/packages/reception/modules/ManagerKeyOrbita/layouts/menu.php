                ...
                <table width="800px" style="border: 1px solid #087E85;" >
                    <tr>
                        <td width ="150px" height="430px" align="center" style="background-color: silver; " >
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <input class="function" id="commdoor" type="button" value="Common door" style="width: 160px; height: 80px; font-size: 20px; font-weight: bold; color: #1F6B7A; " />
...
<script>
    jQuery(document).ready(function(){
        ...
        {
            var url = '<?php echo Url::build('manager_key_orbita');?>'+'&cmd='+this.id;
