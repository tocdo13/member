<span style="display:none">
	<span id="mi_group_sample">
		<div id="input_group_#xxxx#">
            ...
            <span class="multi-input"><input name="mi_group[#xxxx#][building]" type="text" id="building_#xxxx#"  tabindex="-1" style=" width:50px ; text-align: center; font-size: 14px; "/></span>
                                ...
                                <table width="100%" style="margin-top: 10px;">
                                    <tr>
                                        <td>
                                            ...
                                            <span class="multi-input-header" style="float:left;width:50px; text-align: center; ">Building</span>
                                            <span class="multi-input-header" style="float:left;width:100px; text-align: center; ">Door_ID</span>
                                            <span class="multi-input-header" style="float:left;width:100px; text-align: center; ">Room</span>
                                    ...
                                    <tr>
                                        <td align="center" >
                                			...
                                			<div style="padding-top: 2px; margin-left: 40px;" ><a href="javascript:void(0);" onclick="mi_add_new_row('mi_group'); jQuery('#index_'+ input_count).val(input_count-100); " class="button-medium-add">[[.Add.]]</a></div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
