		...
		<span id="input_group_#xxxx#">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#FFFFFF" id="table_#xxxx#">
			  <tr id="tr_#xxxx#">
                ...
                <td class="multi-input"><!--IF:right_cond(User::can_delete(false,ANY_CATEGORY))--><a href="#" onclick="if(confirm('[[.are_you_sure.]]')){ check_is_folio(#xxxx#);}" style="cursor:pointer;"><i class="fa fa-times-circle w3-text-red" style="font-size: 18px;"></i></a>
				<!--/IF:right_cond--></td >
			   ...
			   <tr>
                <td class="multi-input" colspan="12" style="padding-left:0px;" id="extra_guest_#xxxx#">
                	...
                	<table cellpadding="3" cellspacing="0" width="100%">
                    	<tr>
                        	<td style="width: 100px;">[[.telephone_number.]]: </td>
                    	...
                    	<tr>  
                        	<td style="width: 100px;">[[.arrival_time.]]</td>
                        	...
                        	<td style="width: 100px;">[[.departure_time.]]</td>
                            ...
                            <td>[[.target_of_entry.]]:</td>
                            <td><select name="mi_traveller[#xxxx#][entry_target]" id="entry_target_#xxxx#" style="width:250px" >[[|entry_target_options|]]</select></td>
                            <?php 
                        ...
                        <tr>
                            <td style="width: 100px;">[[.is_vn.]]</td>
                            <!--<td><select name="is_vn" id="is_vn_#xxxx#" style="width: 140px; "></select></td>-->
                            <td >
                                <select name="mi_traveller[#xxxx#][is_vn]" id="is_vn_#xxxx#" style="float: left;width:115px;">
                                <option id="0"></option>
                                <!--
                        ...
                        <tr>
                            <td style="width: 100px;">[[.to_judge.]]</td>
                            <td>
                    	...
                    	<tr>
							...
							<td style="width: 100px;">[[.car_note_arrival.]]: </td>
                    	...
                    	<tr>
                        	<td style="width: 100px;">[[.flight_code_departure.]]: </td>
                        	...
                        	<td style="width: 100px;">[[.flight_departure_time.]]: </td>
                        	...
                        	<td style="width: 100px;">[[.car_note_departure.]]: </td>
                        ...
                        <tr>
                        	...
                        	<td class="multi-input" style="width:116px;">
                                <select name="mi_traveller[#xxxx#][province_id]" style="width:100%; margin-left: 2px;" id="province_id_#xxxx#">
                                    <option value=""></option>
                                    [[|province_options|]]
                                </select>
                            </td>
                            ...
                            <td style="width: 100px;">[[.member_code.]]:</td>
	...
	<tr valign="top">
		<td align="left">
			<table width="100%" cellpadding="0" cellspacing="0">
                ...
                <div>
					<td width="95%" nowrap style="text-transform: uppercase; font-size: 16px;" class="w3-text-indigo"><i class="fa fa-group w3-text-orange" style="font-size: 20px;"></i> [[.update_traveller.]]</td>
                   ...
                   <a target="_blank" class="w3-btn w3-gray w3-hover-green" href="<?php echo $hef;?>" style="text-decoration: none; margin-right: 5px;" ><i class="fa fa-file-excel-o"></i> [[.import_from_excel.]]</a>
                    </td>
                    <!--Oanhbtk them export file excel -->                         
                    <td><input name="export_file_excel" type="submit" onclick="exportExcel()" value="[[.export_file_excel.]]" class="w3-btn w3-gray w3-hover-green" style="margin-right: 5px;"/></td>
                    <!-- End Oanhbtk -->
				  	<?php if(User::can_add(false,ANY_CATEGORY)){?><td width="1%" nowrap="nowrap"><input name="save" type="submit" value="[[.Save_and_close.]]" class="w3-btn w3-orange" style="margin-right: 5px;"/></td><?php }?>
					<?php if(User::can_edit(false,ANY_CATEGORY)){?><td width="1%" nowrap="nowrap"><input name="update" type="submit" value="[[.Save_and_stay.]]" class="w3-btn w3-blue" style="margin-right: 5px;"/></td><?php }?>
					<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%" nowrap="nowrap"><a href="#" onclick="onBackEvent();"  class="w3-btn w3-green">[[.back.]]</a></td><?php }?>
				</div>
                </form>
                </tr>
		  </table>
   ...
   <table id="myTable" class="tablesorter" width="100%" cellpadding="2" cellspacing="0" border="1">
	...
	<td><?php if(Form::$current->is_error()){?><div><br><?php echo Form::$current->error_messages();?></div><br clear="all"><?php }?>
    	<fieldset style="background:white;margin-bottom:5px;">
			<legend class="legend-title w3-text-indigo" style="width: 250px; font-weight: normal;">[[.guest_in_house.]]&nbsp;(<span id="count_number_of_guest"></span> [[.guest_per_room.]])</legend>
			...
			<span id="mi_traveller_all_elems">
                    ...
                    <span class="multi-input-header" style="width:100px;">[[.first_name.]] (*)</span>  
                    <span class="multi-input-header" style="width:80px;">[[.last_name.]] (*)</span>
                    <span class="multi-input-header" style="width:79px;">[[.passport.]] </span>
                    <span class="multi-input-header" style="width:17px;" title="[[.transit.]]">&nbsp; </span>
                    <span class="multi-input-header" style="width:79px;">[[.visa.]]</span>
                    <span class="multi-input-header" style="width:80px;">[[.visa_expired.]]</span>
                    <span class="multi-input-header" style="width:67px;">[[.gender.]]</span>
                    <span class="multi-input-header" style="width:60px;">[[.birth_date.]]</span>
                    <span class="multi-input-header" style="width:126px;">[[.nationality.]]</span>
                    <span class="multi-input-header" style="width:83px;">[[.traveller_level.]] (*)</span>
              ...
              <input type="button" value="[[.add_traveller.]]" class="w3-btn w3-gray w3-hover-cyan" onclick="addnew_traveller();">
            [[.copy_traveller.]] <input  name="traveller_indexs" id="traveller_indexs" value="index1,index2,index3" onclick="if(this.value=='index1,index2,index3'){this.value='';}" onblur="if(this.value==''){this.value='index1,index2,index3';}" type ="text" value="<?php echo String::html_normalize(URL::get('traveller_indexs'));?>"> [[.quantity.]] <input  name="traveller_quantity" id="traveller_quantity" style="width:30px;" size="100" maxlength="3" type ="text"><input class="w3-btn w3-gray w3-hover-indigo" type="button" value="[[.copy.]]" onclick="copyTraveller($('traveller_indexs').value,$('traveller_quantity').value)" style="margin-left: 5px;">
         </fieldset>
	<table width="100%">
	<tr><td align="left">
		</td></tr>
