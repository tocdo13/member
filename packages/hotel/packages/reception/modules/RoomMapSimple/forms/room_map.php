<?php
class RoomMapSimpleForm extends Form
{
	function RoomMapSimpleForm()
	{
		Form::Form('RoomMapSimpleForm');
		...
		$this->link_js('packages/hotel/packages/reception/modules/RoomMapSimple/room_map.js');
			...
			{	
				...
				}
				{
					...
					if($room_status['room_id']!=$room_id)
					{
                        ...
                        {
                            if($room_status['change_room_from_rr'] == '' && $room_status['change_room_to_rr'] == '' && $room_status['time_in'] >= (Date_Time::to_time($this->day.'/'.$this->month.'/'.$this->year)+(3600*6)))
                               {
