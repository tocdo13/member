        ...
        <table width="100%" border="0" cellpadding="2" style="margin-top: 5px; border-top: 1px solid gray;">
			  <tr>
			   ...
			   <!---<tr style="display:none;">
				...
				<td style="padding-top: 5px;width: 120px; "><a href="#" class="room DAYUSED" style="width:25px;height:20px;margin-right:2px; color: black;"><?php echo [[=total_dayused_room=]] +[[=total_checkin_today=]] ;?></a><div style="padding-top: 3px;">[[.checkin_today.]]</div></td>				
				...
				<td style="padding-top: 5px;width: 100px; "><a href="#" class="room EXPECTED_CHECKOUT" style="width:25px;height:20px;margin-right:2px;color: black;">[[|total_checkout_today_room|]]</a><div style="padding-top: 3px;">[[.expected_checkout.]]</div></td>				
                <!---<tr style="display:none;">
