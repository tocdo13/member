...
<td class="calendar-bound">
	...
	<td align="left">
		...
		<table cellpadding="2" width="100%" class="room-map-customer-search-box" style="border:0px;">
            ...
            <tr>
            <tr>
                <td colspan="2" style="text-align: right; padding-right: 2px;"><a class="w3-btn w3-gray" href="#" type="button" name="search-booking" onclick="buildReservationSearch();" value="" style="text-decoration: none; width: 100px;">[[.search.]]</a></td>
            </tr>
		</table>
        </fieldset> <br />
		<!--/IF:edit_reservation-->
...
<!--HAN CUT OFF DATE-->
	...
	<td bgcolor="#FFFFFF" align="left" width="99%">
        ...
        <table width="100%" border="0" cellpadding="2" style="margin-top: 5px; border-top: 1px solid gray;">
			  <tr>
				<td style="padding-top: 5px; "><a href="#" class="room AVAILABLE w3-hover-white" style="width:25px;height:20px;margin-right:2px; color: black; ">[[|total_available_room|]]</a><div style="padding-top: 3px; ">[[.available_room.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room BOOKED" style="width:25px;height:20px;margin-right:2px; color: black;">[[|total_booked_room|]]</a><div style="padding-top: 3px;">[[.booked.]]</div></td>								
				<td style="padding-top: 5px; "><a href="#" class="room OVERDUE_BOOKED" style="width:25px;height:20px;margin-right:2px; color: black;">[[|total_overdue_booked_room|]]</a><div style="padding-top: 3px;">[[.overdue_booked.]]</div></td>			
			   ...
			   <!---<tr style="display:none;">
				...
				<td style="padding-top: 5px; "><a href="#" class="room OCCUPIED" style="width:25px;height:20px;margin-right:2px; color: black;"><?php echo [[=total_checkin_room=]];?></a><div style="padding-top: 3px;">[[.occupied.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room" style="width:25px;height:20px;margin-right:2px; background-color: #fde0c5; color: black;"><?php echo [[=total_change_room_today=]];?></a><div style="padding-top: 3px;">[[.checkin_change_today.]]</div></td>			
				<td style="padding-top: 5px; "><a href="#" class="room DAYUSED" style="width:25px;height:20px;margin-right:2px; color: black;"><?php echo [[=total_dayused_room=]] +[[=total_checkin_today=]] ;?></a><div style="padding-top: 3px;">[[.checkin_today.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room OVERDUE" style="width:25px;height:20px;margin-right:2px; color: black;">[[|total_overdue_room|]]</a><div style="padding-top: 3px;">[[.overdue.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room EXPECTED_CHECKOUT" style="width:25px;height:20px;margin-right:2px;color: black;">[[|total_checkout_today_room|]]</a><div style="padding-top: 3px;">[[.expected_checkout.]]</div></td>				
                <!---<tr style="display:none;">
