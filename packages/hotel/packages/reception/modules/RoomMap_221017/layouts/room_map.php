			...
			<legend class="title">[[.forcecast.]]</legend>
				<table border="0" cellpadding="2">
				  	<tr class="checkin-today" onClick="window.open('?page=arrival_list&status=BOOKED');">
						<td class="w3-hover-text-red" align="left"><b><?php echo ([[=total_checkin_today_room=]]+ [[=total_books_without_room=]] + [[=total_change_room=]] );//echo ([[=total_checkin_today_room=]]+ [[=total_books_without_room=]]);//echo ( [[=total_checkin_today_room=]] + [[=total_books_without_room=]]);?></b> [[.check_in_today.]]</td>
					</tr>
                    <tr class="checkin-today" onClick="window.open('?page=checkin_list&date='+jQuery('#in_date').val());">
						<td class="w3-hover-text-red" style="height: 19px;" align="left"><b><?php echo ([[=autual_checkin=]]);?></b> [[.actual_checkin_today.]]</td>
					</tr>
                    <tr class="checkin-today" onClick="window.open('?page=arrival_list&status=DAYUSE&date='+jQuery('#in_date').val());">
						<td class="w3-hover-text-red" style="height: 19px;" align="left">(<b><?php echo ([[=total_dayuse_today=]]);?></b> [[.total_dayused.]])</td>
					</tr>
				 	<tr class="checkin-today" onClick="window.open('?page=departure_list');">
						<td class="w3-hover-text-red" style="height: 19px;" align="left"><b>[[|total_checkout_today_room|]]</b> [[.check_out_today.]]</td>
					</tr>
                    <tr class="checkin-today" onClick="window.open('?page=departure_list&traveller_status=out&date='+jQuery('#in_date').val());">
						<td class="w3-hover-text-red" style="height: 19px;" align="left"><b>[[|autual_checkout|]]</b> [[.actual_checkout_today.]]</td>
					</tr>
				 	<tr class="checkin-today" onClick="window.open('?page=room_status_report&in_date='+jQuery('#in_date').val());">
						<td class="w3-hover-text-red" style="height: 19px;" align="left"><b><?php echo([[=total_books_without_room=]]+[[=total_occupied_today=]]+[[=total_checkin_today_room=]] + [[=total_change_room=]]);//echo([[=total_books_without_room=]] + [[=total_dayuse_today=]] + [[=total_occupied_today=]] + [[=total_booked_room=]]+ [[=total_overdue_booked_room=]] );//echo([[=total_books_without_room=]] + [[=total_dayused_room=]] + [[=total_occupied_today=]]+[[=total_checkin_today_room=]] )//[[=total_booked_room=]]echo([[=total_occupied_today=]]+ [[=total_books_without_room=]] + [[=total_checkin_today_room=]] - [[=total_dayuse_today=]]) //echo [[=total_checkin_room=]];echo [[=total_checkin_room=]];
						 ?></b> [[.total_occ_and_arr.]]</td>
					</tr>
...
<!---PHONG CHUA GAN PHONG--->
            <!---<marquee style="width:200px;color:#F00;" onMouseOut="this.start();" onMouseOver="this.stop();" scrollamount="3">--->
...
<!--HAN CUT OFF DATE-->
            <!---<marquee style="width:200px;color:#F00;" scrollamount="3" onMouseOut="this.start();" onMouseOver="this.stop();">--->
            <!--LIST:books_without_room-->
	...
	<td bgcolor="#FFFFFF" align="left" width="99%">
        ...
        <a class="w3-btn w3-gray w3-hover-green" type="button" href="#" onClick="buildRoommapUrl('SIMPLE');" style="text-decoration: none; text-transform: uppercase; border: 1px solid gray;">[[.room_map_simple.]]</a>
        ...
        <!--/IF:cond_module-->
        <table width="95%" border="0" cellpadding="2" style="margin-top: 5px; border-top: 1px solid gray;">
			  <tr>
				<td style="padding-top: 5px; "><a href="#" class="room AVAILABLE w3-hover-white" style="width:30px;height:25px;;;margin-right:2px; color: black; ">[[|total_available_room|]]</a><div style="padding-top: 3px; ">[[.available_room.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room BOOKED" style="width:30px;height:25px;;;margin-right:2px; color: black;">[[|total_booked_room|]]</a><div style="padding-top: 3px;">[[.booked.]]</div></td>								
				<td style="padding-top: 5px; "><a href="#" class="room OVERDUE_BOOKED" style="width:30px;height:25px;;;margin-right:2px; color: black;">[[|total_overdue_booked_room|]]</a><div style="padding-top: 3px;">[[.overdue_booked.]]</div></td>			
				<!---<td><div class="room_arround"><a href="#" class="room BOOKED" style="width:16px;height:16px;margin-right:2px; color: black"></a>[[.booked.]] [[.doing_not_move.]]</div></td>--->			
			   <!---<tr style="display:none;">
				...
				<td style="padding-top: 5px; "><a href="#" class="room OCCUPIED" style="width:30px;height:25px;;;margin-right:2px; color: black;"><?php echo [[=total_checkin_room=]];?></a><div style="padding-top: 3px;">[[.occupied.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room" style="width:30px;height:25px;;;margin-right:2px; background-color: #fde0c5; color: black;"><?php echo [[=total_change_room_today=]];?></a><div style="padding-top: 3px;">[[.checkin_change_today.]]</div></td>			
				<td style="padding-top: 5px; "><a href="#" class="room DAYUSED" style="width:30px;height:25px;;;margin-right:2px; color: black;"><?php echo [[=total_dayused_room=]] +[[=total_checkin_today=]] ;?></a><div style="padding-top: 3px;">[[.checkin_today.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room OVERDUE" style="width:30px;height:25px;;;margin-right:2px; color: black;">[[|total_overdue_room|]]</a><div style="padding-top: 3px;">[[.overdue.]]</div></td>				
				<td style="padding-top: 5px; "><a href="#" class="room EXPECTED_CHECKOUT" style="width:30px;height:25px;;;margin-right:2px;color: black;">[[|total_checkout_today_room|]]</a><div style="padding-top: 3px;">[[.expected_checkout.]]</div></td>				
                <!---<tr style="display:none;">
				...
				<td style="padding-top: 5px; "><a href="#" class="room REPAIR" style="width:30px;height:25px;;;margin-right:2px; color: black;">[[|total_repaire_room|]]</a><div style="padding-top: 3px;">[[.reparing.]]</div></td>
		...
		<div class="body">
<!--THONG TIN PHONG-->        
		<table width="1150" border="1" cellpadding="2" cellspacing="0" bgcolor="#EAE9E9" bordercolor="#CCCCCC">
			<!--LIST:floors-->	
                    ...
                    <?php //if(User::id()=='developer05') System::debug([[=floors.rooms=]]); ?>
						<!--LIST:floors.rooms-->
							  <div title="<?php echo addslashes([[=floors.rooms.note=]]);?>" class="room-bound">
							  	<span class="room-name"><strong><span style="font-size:14px;color:black;">[[|floors.rooms.name|]]</span></strong> [[|floors.rooms.type_name|]]<br /></span><br clear="all"/>
                                   ...
                                   <?php if(isset($f[$r_r]) && $f[$r_r]>1){
									...
									<?php if([[=floors.rooms.note=]] and ([[=floors.rooms.status=]] != 'CHECKOUT' or ([[=floors.rooms.status=]] == 'CHECKOUT' and [[=floors.rooms.house_status=]] == 'REPAIR')))
									{
									   if(([[=floors.rooms.status=]] == 'CHECKOUT' and [[=floors.rooms.house_status=]] == 'REPAIR'))
                                       {
										...
										echo '<!---<span style="font-size:10px;color:#FF0000;font-weight:bold"><i class="fa fa-bell"></i></span>--->';
									}
									?>
                                    </div>
                                    <div style="height: 15%;">
...
//THONG TIN CLICK XEM CHI TIET PHONG            
			...
			information += '[[.note.]]:<br/><textarea  name="note" style="width:375px;" rows="3">'+((rooms.length==1)?room.hk_note:'')+'</textarea><br/>';
			<!--/IF:minibar-->
            ...
            if((room_reservations)){
                ...
                for(var tan in room_reservations){
                 ...
                 {
                    <?php if(User::can_edit('1980','1041600000000000000')){ ?>
                    information += '<div style="width: 380px; ">[[.house_status.]]: <select style="height: 30px; margin-top: 3px; width:90px;"  name="house_status" id="house_status" onclick=" jQuery(\'#div_date_repair\').css(\'display\',\'\');jQuery(\'#repair_to\').datepicker({ minDate: new Date(CURRENT_YEAR, CURRENT_MONTH, CURRENT_DAY) ,yearRange: \'-100:+4\'}); jQuery(\'#ui-datepicker-div\').css(\'z-index\',\'3000\');"><option value="">READY</option><option value="SHOWROOM">SHOWROOM</option><option value="CLEAN">CLEAN</option><option value="DIRTY">DIRTY</option><option value="HOUSEUSE">HOUSEUSE</option></select><input class="w3-btn w3-gray" type="submit" value="Change" style="margin-left: 3px;" /></div>';
                    <?php } ?>
                 } 
                else{
                    <?php if(User::can_edit('1980','1041600000000000000')){ ?>
                    information += '<div style="width: 380px; ">[[.house_status.]]: <select style="height: 30px; margin-top: 3px; width:90px;" name="house_status" id="house_status" onclick=" jQuery(\'#div_date_repair\').css(\'display\',\'\');jQuery(\'#repair_to\').datepicker({ minDate: new Date(CURRENT_YEAR, CURRENT_MONTH, CURRENT_DAY) ,yearRange: \'-100:+4\'}); jQuery(\'#ui-datepicker-div\').css(\'z-index\',\'3000\');"><option value="">READY</option><option value="SHOWROOM">SHOWROOM</option><option value="CLEAN">CLEAN</option><option value="DIRTY">DIRTY</option><option value="REPAIR">REPAIR</option><option value="HOUSEUSE">HOUSEUSE</option></select><input class="w3-btn w3-gray" type="submit" value="Change"  style="margin-left: 3px;" /></div>';
                    <?php } ?>
                }
   ...
   function get_query_string()
    ...
    function buildRoommapUrl(type)
    {
        if(type=='SIMPLE')
        {
            window.location='<?php echo Url::build('room_map_simple');?>';
        }
        else
        {
