                ...
                <table width="800px" style="border: 1px solid #087E85;" >
                    <tr>
                        <td width ="150px" height="430px" align="center" style="background-color: silver; " >
                            <span style="color: blue; font-size: 28px; " ><b>[[|status|]]</b></span>
                            <br /><br />
                            <span style="font-size: 20px;" ><?php if(isset([[=detail=]])) {echo [[=detail=]];}?></span>
                        </td>
                    </tr>
                </table>
            </td>
...
<script>
    jQuery(document).ready(function(){
        ...
        jQuery("#back").click(function(e)
        {
            ...
            window.location.href = '?page=manager_key&cmd=create&resevation_room_id='+reservation_room_id + '&portal=default';
        });
    });
</script>