<span style="display:none">
	<span id="mi_group_sample">
		<div id="input_group_#xxxx#">
            ...
            <span class="multi-input"><input name="mi_group[#xxxx#][ip]" type="text" id="ip_#xxxx#"  tabindex="-1" style=" width:200px ; text-align: center; font-size: 14px; "/></span>
            ...
            <span class="multi-input"><input name="mi_group[#xxxx#][reception]" type="text" id="reception_#xxxx#"  tabindex="-1" style="width:150px ; text-align: center;font-size: 14px;"/></span>
                                ...
                                <table width="100%" style="margin-top: 10px;">
                                    <tr>
                                        <td>
                                            ...
                                            <span class="multi-input-header" style="float:left;width:200px; text-align: center; ">IP</span>
                                            <span class="multi-input-header" style="float:left;width:100px; text-align: center; ">Port</span>
                                            <span class="multi-input-header" style="float:left;width:150px; text-align: center; ">Reception</span>
