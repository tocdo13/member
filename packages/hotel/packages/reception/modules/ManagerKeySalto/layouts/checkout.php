                    ...
                    <tr>
                        <td width ="100%" height="auto" align="center" style="background-color: silver; " >
                            <div style=" width:600px; border: 3px inset gray; background-color: white; padding-right: 10px; margin: 20px 20px;">
                                ...
                                if([[=result=]]!='')
                                {
                                    if([[=result=]]!='Check out room success')
                                ...
                                <table width="300px" style="margin-top: 10px;">
                                   <tr>
                                        <td align="left" width="100px" height="25px">
                                            <span style="font-weight: bold;">[[.room.]]</span></td>
                                        <td>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input id="delete" name="delete" type="submit" value="check out" style="width: 100px; height: 40px; font-size: 16px; font-weight: bold; color: #1F6B7A; margin-bottom: 20px;" />
                                        </td>
                                    </tr> 
                                </table>
                            </div>
