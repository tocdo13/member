    ...
    <tr valign="top">
		<td align="left">
            <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
                    <td class="form-title" width="100%">[[.ticket_invoice_list.]]</td>
                    ...
                    <?php if(User::can_view(false,ANY_CATEGORY)){?><td width="1%" align="right"><a href="<?php echo URL::build_current(array('cmd'=>'list_less'));?>"  class="button-medium">[[.list_ticket_reservation_less_than_200,000.]]</a></td><?php }?>
					<!--
...
//						{
					...
					<tr bgcolor="<?php if(URL::get('just_edited_id',0)==[[=items.id=]]){ echo '#EFFFDF';} else {echo $bg_color;}?>" valign="middle" <?php Draw::hover('#EFEEEE');?> style="cursor:pointer;">
                        ...
                        <?php if(User::can_edit(false,ANY_CATEGORY)) {?> <td><a class="button-medium-add" target="_blank" href="<?php echo Url::build('vat_bill',array(  'department'=>'TICKET','cmd'=>'entry_ticket','t_r_id'=>[[=items.id=]])); ?>">[[.print_vat.]]</a></td> <?php } ?>
                    </tr>
					<!--/LIST:items-->
				</table>
                </div>
