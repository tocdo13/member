...
<span style="display:none">
	<span id="mi_ticket_sample">
		<div id="input_group_#xxxx#">
			...
			<span class="multi-input"><input  name="mi_ticket[#xxxx#][name]" style="width:200px;" class="multi-edit-text-input" type="text" id="name_#xxxx#"/></span>
            <span class="multi-input"><input  name="mi_ticket[#xxxx#][prefix]" style="width:200px;" class="multi-edit-text-input" type="text" id="prefix_#xxxx#"/></span>
...
<table cellpadding="15" cellspacing="0" width="70%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		<td width="100%" class="form-title">[[.manage_ticket_group.]]</td>
			...
			<div style="background-color:#EFEFEF;">
				<span id="mi_ticket_all_elems">
					<span style="white-space:nowrap; width:auto;">
                        ...
                        <span class="multi-input-header" style="float:left;width:200px;">[[.prefix.]]</span>
