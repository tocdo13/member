...
<span style="display:none">
	<span id="mi_area_sample">
		<div id="input_group_#xxxx#">
			...
			<span class="multi-input"><input  name="mi_area[#xxxx#][code]" type="text" id="code_#xxxx#"  tabindex="-1" style="width:80px;" /></span>
			<span class="multi-input"><input  name="mi_area[#xxxx#][name]" style="width:200px;" class="multi-edit-text-input" type="text" id="name_#xxxx#"/></span>
            <span class="multi-input">
				<select  name="mi_area[#xxxx#][area_id]" style="width:200px;" class="multi-edit-text-input"  id="area_id_#xxxx#"><option value=""></option>
					[[|area_options|]]
				</select>
            </span>
            <span class="multi-input"><input  name="mi_area[#xxxx#][printer_name]" style="width:100px;" class="multi-edit-text-input" type="text" id="printer_name_#xxxx#"/></span>
            <span class="multi-input"><input  name="mi_area[#xxxx#][privilege]" style="width:150px;background-color:#CCC;" class="multi-edit-text-input" type="text" id="privilege_#xxxx#" readonly="readonly"/></span>  
            <span class="multi-input"><input  type="button" id="shifts_#xxxx#" onclick="getUrlShift('#xxxx#');" value="[[.add_ticket_type.]]"  class="button-medium-add" style="width:120px !important;" title="[[.view_order.]]"/></span>      
...
<table cellpadding="10" cellspacing="0" width="80%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		<td width="98%" class="form-title">[[.manage_ticket_area.]]</td>
			...
			<div style="background-color:#EFEFEF;">
				<span id="mi_area_all_elems">
					<span style="white-space:nowrap; width:auto;">
						...
						<span class="multi-input-header" style="float:left;width:200px;">[[.ticket_area_name.]]</span>
                        <span class="multi-input-header" style="float:left;width:200px;">[[.area_name.]]</span>
                        <span class="multi-input-header" style="float:left;width:100px;">[[.printer_name.]]</span>
                        <span class="multi-input-header" style="float:left;width:150px;">[[.privilege.]]</span>
                        <span class="multi-input-header" style="float:left;width:120px;">[[.add_ticket_type.]]</span>
						<span class="multi-input-header" style="float:left;width:30px;text-align:center;">[[.Delete.]]?</span>
						<br clear="all"/>
					</span>
				</span>
			</div>
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('mi_area');$('code_'+input_count).focus();" class="button-medium-add">[[.Add.]]</a></div>
            </td>
        </tr>
        </table>
    </td></tr>
...
function getUrlShift(index){
	if($('id_'+index).value!='')
	{
		var url = '?page=ticket_area';
		url += '&ticket_area_id='+to_numeric($('id_'+index).value);
		url += '&cmd=add_ticket_type';
		window.open(url);
	}	
}
