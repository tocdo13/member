...
<span style="display:none">
	<span id="mi_ticket_sample">
		<div id="input_group_#xxxx#">
            ...
            <!--<span class="multi-input"><input  name="mi_ticket[#xxxx#][name]" style="width:180px; background-color: #CCC;" class="multi-edit-text-input" type="text" id="name_#xxxx#" readonly="readonly"/></span>-->
            ...
            <span class="multi-input"><input  name="mi_ticket[#xxxx#][quantity]" onkeyup="calc_total(#xxxx#);" onblur="calc_total(#xxxx#);" style="width:60px;text-align: right;" class="multi-edit-text-input input_number format_number" type="text" id="quantity_#xxxx#"/></span>
            <span class="multi-input"><input  name="mi_ticket[#xxxx#][discount_quantity]" onkeyup="calc_total(#xxxx#);" onblur="calc_total(#xxxx#);" style="width:60px;text-align: right;" class="multi-edit-text-input input_number format_number" type="text" id="discount_quantity_#xxxx#"/></span>
            ...
            <!--<span class="multi-input"><input  name="mi_ticket[#xxxx#][discount_cash]" onkeyup="calc_total(#xxxx#);" onblur="calc_total(#xxxx#);" style="width:80px;text-align: right;" class="multi-edit-text-input input_number format_number" type="text"  id="discount_cash_#xxxx#"/></span>-->
            <span class="multi-input"><input  name="mi_ticket[#xxxx#][total]" style="width:80px;text-align: right; background-color: #CCC" class="total" type="text" id="total_#xxxx#" readonly="readonly"/></span>
            <!--IF:delete(User::can_delete(false,ANY_CATEGORY))-->
			<span class="multi-input" style="width:20px; text-align:center;"><img tabindex="-1" src="packages/core/skins/default/images/buttons/delete.gif" onClick="if(Confirm('#xxxx#')){ mi_delete_row($('input_group_#xxxx#'),'mi_ticket','#xxxx#','');event.returnValue=false; updateTotal_Lang();}" style="cursor:pointer;"/></span>   
			<!--/IF:delete-->
            <br clear="all" />
        </div>
	</span>
...
<fieldset>
    ...
    <table>
        <tr>
            <th>[[.guest.]]</th>
            <td >
                <input name="customer_name" type="text" id="customer_name" style="" />
                <input name="customer_id" type="hidden" id="customer_id" class=""/>
        ...
        <tr>
            <th>[[.discount_rate.]]</th>
            <td><input type="text" id="discount_rate" name="discount_rate" style="width: 30px; text-align: right;" class="multi-edit-text-input input_number format_number" onkeyup="updateTotal_Lang();" onblur="updateTotal_Lang();"/></td>
        </tr>		
    </table>
    </div>
    </fieldset>
...
<div style="width:200px; height:50px; margin-left: 350px; display: block;">
    <span style="float: left; margin-right:10px;">[[.total_money.]] : </span>
    <span><p id="total_all" style="text-decoration: underline;"></p>
</div>
<script>
...
function Confirm(index)
{
	...
	return confirm('[[.Do you Want To Delete Ticket.]] '+ mi_ticket_name+'?');
}
function calc_total(index)
{
    ...
    jQuery('#total_all').html(number_format(old_total_all - old_total + total)); 
    updateTotal_Lang();
}
//update total
function updateTotal_Lang()
{
    ...
    jQuery('#total_all').html(number_format(new_total_all));
}
//update ticket
