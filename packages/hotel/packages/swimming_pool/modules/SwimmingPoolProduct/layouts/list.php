...
<form name="ListSwimmingPoolProductForm" method="post">
	<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr>
			...
			<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><a href="javascript:void(0)" onclick="if(!confirm('[[.are_you_sure.]]')){return false};ListSwimmingPoolProductForm.cmd.value='delete';ListSwimmingPoolProductForm.submit();"  class="button-medium-delete">[[.Delete.]]</a></td><?php }?>
        </tr>
    </table>        
	<div class="content">
		<fieldset>
...
<script type="text/javascript">
	jQuery("#delete_button").click(function (){
		ListSwimmingPoolProductForm.cmd.value = 'delete';
		ListSwimmingPoolProductForm.submit();
	});
