...
<div class="swimming_pool-type-supplier-bound">
<form name="ListSwimmingPoolForm" method="post">
	<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr>
			...
			<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><a href="javascript:void(0)" onclick="if(!confirm('[[.are_you_sure.]]')){return false};ListSwimmingPoolForm.cmd.value='delete';ListSwimmingPoolForm.submit();"  class="button-medium-delete">[[.Delete.]]</a></td><?php }?>
        </tr>
    </table>        
	<div class="content">
		<table width="100%" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
			<tr bgcolor="#F1F1F1">
              ...
              <th width="20%" align="left">[[.swimming_pool_name.]]</th>
			  <th width="20%" align="left">[[.swimming_pool_type_name.]]</th>
...
<script type="text/javascript">
	jQuery("#delete_button").click(function (){
		ListSwimmingPoolForm.cmd.value = 'delete';
		ListSwimmingPoolForm.submit();
	});
