...
<div class="SwimmingPoolGuest-type-supplier-bound">
<form name="ListSwimmingPoolGuestForm" method="post">
	<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr>
            ...
            <td width="20%" align="right" nowrap="nowrap">
				...
				<?php if(User::can_delete(false,ANY_CATEGORY)){?><a href="javascript:void(0)" onclick="if(!confirm('[[.are_you_sure.]]')){return false};ListSwimmingPoolGuestForm.cmd.value='delete';ListSwimmingPoolGuestForm.submit();"  class="button-medium-delete">[[.Delete.]]</a><?php }?>
            </td>
        </tr>
    </table>        
	<div class="content">
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
			<tr bgcolor="#F1F1F1">
			  ...
			  <th width="5%" align="left">[[.group.]]</th>
		  ...
		  <!--LIST:items-->
			<tr>
			  ...
			  <td>[[|items.i|]]</td>
			  <td><span id="category_[[|items.id|]]">[[|items.category|]]</span></td>
			  <td><span id="code_[[|items.id|]]">[[|items.code|]]</span></td>
...
<script type="text/javascript">
	jQuery("#delete_button").click(function (){
		ListSwimmingPoolGuestForm.cmd.value = 'delete';
		ListSwimmingPoolGuestForm.submit();
	});
