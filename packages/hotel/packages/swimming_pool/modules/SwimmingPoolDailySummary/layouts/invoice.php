...
<link href="skins/default/swimming_pool.css" rel="stylesheet" type="text/css">
...
.swimming_pool-item-detail li span{
	float:right;
	width:100px;
	height:25px;
}
.swimming_pool-item-detail li span.label{
	float:left;
	width:400px;
	text-align:right;
}
			...
			<tr>
				...
				<tr>
					<td colspan="3" class="data_title" align="center">
						Hotel <?php echo date('d/m/Y H:i',time());?> SWIMMING POOL SERVICE
						<p>&nbsp;</p></td>
				</tr>
				</table>
				...
				<tr>
					<td align="left" width="50%" class="data_title" style="padding-left:10px">
						<!--IF:cond([[=hotel_swimming_pool_number=]])-->
							Ph&ograve;ng kh&aacute;ch s&#7841;n / Hotel Room: [[|hotel_swimming_pool_number|]]
						<!--/IF:cond-->
						<div>B&#7875; / Swimming pool:&nbsp;[[|swimming_pool_number|]]</div>
