	...
	<div class="content">
		...
		<fieldset>
			...
			<table width="700" border="0" cellspacing="0" cellpadding="2">
				...
				<tr>
				  <td align="right" class="label">[[.swimming_pool.]]:</td>
				  <td><strong>[[|swimming_pool_number|]]</strong></td>
				  <td align="right">[[.status.]]:</td>
				  <td align="left"><select name="status" id="status"></select></td>
			  </tr>
				<tr>
				  <td align="right" class="label">[[.guest_code.]]:</td>
				  <td><input name="guest_id" type="text" id="guest_id" style="display:none;"><input name="code" type="text" id="code" onclick="window"><a href="#" onclick="window.open('?page=swimming_pool_guest&amp;action=select_guest','guest')"><img src="skins/default/images/cmd_Tim.gif" /></a> <img width="15" src="packages/core/skins/default/images/buttons/delete.gif" onClick="$('full_name').value='';$('guest_id').value=0;$('code').value=''" style="cursor:pointer;"></td>
				...
				<tr>
				  ...
				  <td align="left"><input name="people_number" type="text" id="people_number" onchange="updateTotalPayment();" />
				  </td>
			  </tr>
				<tr>
...
<script type="text/javascript">
	...
	function updateTotalPayment(){
		var total_payment = 0;
		var price = 0;
		if(jQuery("#price").val() && jQuery("#people_number").val()){
			price += stringToNumber(jQuery("#price").val())  * stringToNumber(jQuery("#people_number").val());
			if(jQuery("#tax").val()){
