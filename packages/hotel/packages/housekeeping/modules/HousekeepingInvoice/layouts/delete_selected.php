		...
		<td width="100%">
			...
			<tr>
				<td width="100%">
					...
					<form name="DeleteSelectedHousekeepingInvoiceForm" method="post">
			...
			<p>
			<table><tr>
				<td><?php Draw::button(Portal::language('delete_selected'),'confirm',false,true,'DeleteSelectedHousekeepingInvoiceForm');?></td>
