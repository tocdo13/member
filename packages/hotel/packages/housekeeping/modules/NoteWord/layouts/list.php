...
<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		<td width="75%" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;">[[.manage_note_for_work.]]</td>
...
<fieldset>
        	<legend class="title"><b>[[.search_options.]]</b></legend>
            <table>
               
                	<tr>

                		<td nowrap>From Date:<input name="from_date" type="text" id="from_date" value="<?php if(isset([[=from_date=]]))echo [[=from_date=]];?>" /></td>
                	
                		<td>To Date:<input name="to_date" type="text" id="to_date" value="<?php if(isset([[=to_date=]]))echo [[=to_date=]];?>" /></td>
                        <td>
  ...
  <table width="100%" cellpadding="5" cellspacing="0" border="1" bordercolor="#CCCCCC">
    		<tbody>
                    ...
                    <?php
                    //System::debug([[=note_tree=]]);die;
                    foreach([[=note_tree=]] as $key=>$val){
                        ...
                        foreach($val as $v){
                            ?>
                            <tr <?php if($v['status']==1){echo 'bgcolor="#B0C4DE"';} if($v['start_time']>[[=date_now=]]){ echo 'bgcolor="#20B2AA"';} if($v['start_time']<[[=date_now=]] && $v['status']==0){ echo 'bgcolor="#F4A460"';} ?>>
                            <?php
                             echo ' 
                			<td>
