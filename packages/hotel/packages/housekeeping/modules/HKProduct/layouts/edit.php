...
<span style="display:none">
	<span id="mi_product_sample">
		<span id="input_group_#xxxx#">
            ...
            <span class="multi_input">
					<input  name="mi_product[#xxxx#][product_index]" style="width:40px;" type="text" id="product_index_#xxxx#"  onkeypress="if((event.keyCode<48 || event.keyCode>57) && event.keyCode!=46 && event.keyCode!=44 && event.keyCode!=45)event.returnValue=false;">
			</span>            
		...
		<fieldset>
            ...
            <span id="mi_product_all_elems">
                <span>
                    ...
                    <span class="multi-input-header"><span style="width:40px;">[[.index.]]</span></span>
