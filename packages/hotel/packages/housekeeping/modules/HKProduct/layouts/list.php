		...
		<td align="left">
            <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
					...
					<?php if(User::can_add(false,ANY_CATEGORY)){?><td width="1%" align="right"><a href="<?php echo URL::build('product',array('cmd'=>'syn','func'=>'hk_product'));?>"  class="button-medium-add">[[.add.]]</a></td><?php }?>
					...
					<table width="100%" cellpadding="5" cellspacing="0" border="1" style="border-collapse:collapse" bordercolor="#C6E2FF">
						<tr class="table-header">
							...
							<th nowrap align="left" >
								<a href="<?php echo URL::build_current(((URL::get('order_by')=='hk_product.id' and URL::get('order_dir')!='desc')?array('order_dir'=>'desc'):array())+array('order_by'=>'hk_product.id'));?>" title="[[.sort.]]">
								<?php if(URL::get('order_by')=='hk_product.id') echo '<img src="skins/default/images/'.((URL::get('order_dir')!='desc')?'down':'up').'_arrow.gif">';?>[[.code.]]
								</a>
							</th><th nowrap align="left">
								<a title="[[.sort.]]" href="<?php echo URL::build_current(((URL::get('order_by')=='hk_product.name_'.Portal::language() and URL::get('order_dir')!='desc')?array('order_dir'=>'desc'):array())+array('order_by'=>'hk_product.name_'.Portal::language()));?>" >
								<?php if(URL::get('order_by')=='hk_product.name_'.Portal::language()) echo '<img src="skins/default/images/'.((URL::get('order_dir')!='desc')?'down':'up').'_arrow.gif">';?>[[.name.]]
								</a>
                            ...
                            <th nowrap align="left" >
								<a href="<?php echo URL::build_current(((URL::get('order_by')=='hk_product.type' and URL::get('order_dir')!='desc')?array('order_dir'=>'desc'):array())+array('order_by'=>'hk_product.type'));?>" title="[[.sort.]]">
								<?php if(URL::get('order_by')=='hk_product.type') echo '<img src="skins/default/images/'.((URL::get('order_dir')!='desc')?'down':'up').'_arrow.gif">';?>[[.type.]]
								</a>
							</th>
                            <th>[[.index.]]</th>
