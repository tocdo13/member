...
<?php System::set_page_title(HOTEL_NAME.' - '.Portal::language('delete_title'));?><table cellspacing="0" width="100%">
	<tr valign="top">		
		<td align="left" colspan="3">
			<table cellpadding="15" cellspacing="0" width="99%" border="0" bordercolor="#CCCCCC" class="table-bound">
				<tr>
					<td class="form-title" width="100%">[[.delete_minibar_invoice.]]</td>
				</tr>
			</table>		</td>
	</tr>
	...
	<input type="hidden" name="id" value="[[|id|]]"><input type="hidden" name="cmd" value="delete">
		...
		<tr bgcolor="#EEEEEE" valign="top">
			<td nowrap align="right"><span style="line-height:24px;"><strong>[[.minibar_id.]]</strong></span></td>
			<td bgcolor="#ECE9D8" align="center">:</td>
	...
	<tr bgcolor="#EEEEEE">
		<td bgcolor="#EEEEEE" colspan="3">
			...
			<tr><td>
				...
				<?php Draw::button(Portal::language('list'),URL::build_current(array('housekeeping_invoice_reservation_id', 'housekeeping_invoice_minibar_id', 'housekeeping_invoice_employee_id', 
