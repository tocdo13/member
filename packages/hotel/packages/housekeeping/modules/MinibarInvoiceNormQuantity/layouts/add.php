...
function recalculate_housekeeping_invoice_detail(obj)
{
	if(parseInt(jQuery(obj).val()) > parseInt(jQuery(obj).parent().prev().html()))
	{
		...
		alert('Số lượng nhập không được lớn hơn số lượng hiện có trong minibar.');
...
<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		...
		<td align="left"  width="100px">
			<input type="button" name="list" class="button-medium-list" onclick="window.location='<?php echo Url::build_current();?>'" style="border:1px solid #999999; background:#FFF; width:100px; padding:0px 15px;" value="[[.List.]]" />
		</td>
	</tr>
</table>
		...
		<table width="100%" border="1" bordercolor="#000000" style="border-collapse:collapse" cellspacing="0" cellpadding="5px">
          <tr>
            <th colspan="3" scope="col"><div align="left">[[.room_no.]]: 
              <select name="minibar_id" id="minibar_id" onchange="this.form.form_block_id.value=0;this.form.submit();">
              </select>
            </div></th>
            <th colspan="3" scope="col">Date: [[|date|]]</th>
          </tr>
          <tr>
		  ...
		  <tr>
            ...
            <td width="35px" align="center" id="norm_quantity_<?php echo $i; ?>">[[|items.norm_quantity|]]</td>
            <td width="50px"><input type="text" value="[[|items.quantity|]]" name="items[[[|items.id|]]][quantity]" id="quantity_[[|items.no|]]" onkeydown="hk_invoice_check(this)" onkeyup="recalculate_housekeeping_invoice_detail(this)" style="width:40px;text-align:center"/></td>
            <td width="100px">[[|items.name|]]</td>
            <td width="70px" align="right"><input type="text" name="items[[[|items.id|]]][price]" id="price_[[|items.no|]]" readonly="readonly" style="width:70px;border:0 solid white;text-align:right" value="[[|items.price|]]"/></td>
		  ...
		  <tr>
		  	<td width="290" align="right">
				[[.total_before_tax.]]			</td>
			<td>
				<input type="text" name="total_before_tax" id="total_before_tax" readonly="readonly" style="width:100%;border:0 solid white;text-align:right"/>			</td>
		  </tr>
		  <tr>
            <td align="right"> [[.discount.]]
              ...
              %) </td>
		    <td><input  name="total_discount" type="text" id="total_discount" readonly="readonly" style="width:99%;border:0 solid white;text-align:right"/>
            </td>
		    </tr>
		  <tr>
		  	<td width="290" align="right">
				[[.fee.]]
				(<input type="text" name="fee_rate" id="fee_rate" style="width:20px; text-align:center; border:0px #FFFFFF" value="[[|service_charge|]]" onkeyup="calculate_housekeeping_invoice_detail();" />%)			</td>
			<td>
				<input type="text" name="total_fee" id="total_fee" readonly="readonly" style="width:100%;border:0 solid white;text-align:right"/>			</td>
		  </tr>
		  <tr>
		  	<td width="290" align="right">
				[[.tax_rate.]]
				(<input type="text" name="tax_rate" id="tax_rate" style="width:20px; text-align:center; border:0px #FFFFFF" value="[[|tax_rate|]]" onkeyup="calculate_housekeeping_invoice_detail();" />%)			</td>
			<td align="center">
				<input type="text" name="total_tax" id="total_tax" readonly="true" style="width:100%;border:0 solid white;text-align:right" />			</td>
		  </tr>
		  <tr>
		  	<td width="290" align="right">
				[[.total.]]			</td>
