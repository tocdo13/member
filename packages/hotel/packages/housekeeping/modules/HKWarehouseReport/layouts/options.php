...
<form name="HKWarehouseReportOptionsForm" method="post" onsubmit="return checkDate();">
<?php if(Form::$current->is_error()){?><div><br><?php echo Form::$current->error_messages();?></div><?php }?>
	...
	<div class="content">
		...
		<!--IF:cond(Url::get('page')=='housekeeping_warehouse_report')-->
		<table width="400" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
          <tr>
		...
		<!--/IF:cond-->
		<!--IF:cond(Url::get('page')=='housekeeping_warehouse_book')-->
		<table width="400" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
          <tr>
