...
<div style="background-color:#FFFFFF;width:100%;">
    <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
        <tr>
    		<td align="left" style="width: 350px; text-transform: uppercase; font-size: 18px; padding-left: 15px;">[[.add_used_quantity.]]</td>
    		<td align="left">
                <input name="update" type="submit" id="btnsave" value="[[.save.]]" onclick="checksubmit();" class="w3-btn w3-orange w3-text-white" style="text-transform: uppercase; margin-right: 5px;"/>
                <input name="back" type="button" value="[[.back.]]" style="text-transform: uppercase; margin-right: 5px;" class="w3-btn w3-green w3-text-white" onclick="window.location='<?php echo Url::build_current(); ?>'"/>
            </td>        
    	</tr>
    </table>
            ...
            <tr>
                ...
                <!--LIST:rooms.products-->
                    ...
                    <td align="center" style="color:red;">
                        <input name="[[|rooms.id|]]_[[|rooms.products.product_id|]]" type="text" id="[[|rooms.id|]]_[[|rooms.products.product_id|]]" style="width: 50px;text-align: center;" class="input_number" oninput="update_total(this);" />
                    </td> 
                    <!--ELSE-->
