...
<div style="background-color:#FFFFFF;width:100%;">
    <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
        <tr>
    		<td align="left" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px; width: 400px;">[[.view_detail.]]</td>
    		<td align="left">
                <input name="back" type="button" value="[[.back.]]" class="w3-green w3-btn" style="text-transform: uppercase;" onclick="window.location='<?php echo Url::build_current(); ?>'"/>
            </td>        
    	</tr>
    </table>
    ...
    jQuery(document).ready(function(){
        ...
        jQuery("#tblExport tbody tr:first-child td").not("td:first-child").each(function(){
            ...
            jQuery("#tblExport tbody tr").not("tr:last-child").each(function(){
                ...
                if(jQuery(this_element).find("span").length>0)
                {
                    total += to_numeric(jQuery(this_element).find("span").html());
                }
            });
