...
<tr><td>
	...
	<td>
        ...
        <font class="report_title">[[.housekeeping_revenue_report_minibar.]]</font>
        <?php }
        else { ?>
        <font class="report_title">[[.housekeeping_revenue_report_laundry.]]</font>
        <?php } ?>
		<br>
...
padding: 13px;">
                    ...
                    <div class="invoce_div">
                        <label class="invoce_2 ">[[.from_date.]]:</label>
                         <input name="date_from" type="text" id="date_from" style="width: 80px;" onchange="changevalue();" />
                          ...
                          <input name="hour_from" type="text" id="hour_from" style="width: 40px;"/>
                    </div>
                    <div>
        ...
        <div class="c10px"><label for="hotel_id" class="c75px">[[.Hotel.]]:</label> 
        <select name="hotel_id" id="hotel_id" class="leftalign"></select>
        
        <?php }?>
		<select  name="group" id="group" style="margin:6px 0px;">
        <option value="1">[[.by_product.]]</option>
        <option value="2" <?php if(Url::get('group')==2) echo 'selected="selected"'; ?> >[[.by_invoice.]]</option>
        </select>
        </div>
        
       
            <div class="c10px">
                <label class="c75px">[[.recode.]]</label>
                <input name="res_id" type="text" id="res_id" class="input_number" style="width:85px;" />(*[[.only_number.]])
            </div>
            <div class="c10px">
                <label class="c75px">[[.product_id.]]</label>
                <input name="product_id" type="text" id="product_id" style="width:85px;" />
            </div>
		   ...
		   <fieldset style="margin: 5px 0px 15px;border: 1px solid #AEA8A8;padding:10px" >
                    ...
                    <div class="invoce_div">
                        <label class="invoce_1 ">[[.invoice_id.]]:</label> 
                        <input name="from_code" type="text" id="from_code" class="input_number b_blur" style="width:45px;" readonly />
                        <label class=" ">[[.to.]]:</label>
                        <input name="to_code" type="text" id="to_code" class="input_number b_blur" style="width:45px;" readonly />(*[[.only_number.]])
                    </div>
