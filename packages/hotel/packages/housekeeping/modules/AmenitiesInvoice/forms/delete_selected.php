<?php
class DeleteSelectedAmenitiesInvoiceForm extends Form
{
	function DeleteSelectedAmenitiesInvoiceForm()
	{
		Form::Form("DeleteSelectedAmenitiesInvoiceForm");
	...
	function on_submit()
	{
		if(Url::get('confirm'))
		{
			...
			{
				DeleteAmenitiesInvoiceForm::delete($id);
			}
