...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="font-size:11px;">
	<tr bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" width="30px">[[.room_type.]]</th>
		...
		<th class="report_table_header" width="40px">[[.country.]]</th>  
	...
	<tr bgcolor="white">
        ...
        <a href="<?php echo Url::build('reservation',array('cmd'=>'edit','id'=>[[=items.reservation_id=]],'r_r_id'=>[[=items.reservation_id=]]));?>" target="_blank">[[|items.reservation_id|]]</a></td>
        <td align="center" class="report_table_column" rowspan="<?php echo $k; ?>">[[|items.room_name|]]</td>
        <td align="center" class="report_table_column" rowspan="<?php echo $k; ?>">[[|items.room_level|]]</td>           
        ...
        <span 'location'="<?php echo Url::build('traveller',array('id'=>[[=items.traveller_id=]]));?>" target="_blank">[[|items.fullname|]]</span>
        </td>
