...
<table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC">
	<tr height="40">
		<td width="60%" class="" style="font-size: 18px; text-transform: uppercase; padding-left: 15px;"><i class="fa fa-plus-square w3-text-orange" style="font-size: 24px;"></i> [[.add_new_forgot_object.]]</td>
		<td style="width: 40%; text-align: right; padding-right: 30px;"><input type="submit" value="[[.Save_and_close.]]" class="w3-btn w3-orange" style="text-transform: uppercase; margin-right: 5px;"/>
		<input type="button" value="[[.List.]]" class="w3-btn w3-green" onclick="window.location='<?php echo Url::build_current();?>'" style="text-transform: uppercase;"/></td>
	</tr>
</table>
...
<tr>
	...
	<?php 
		...
		<table>
		<tr>
		  <td nowrap="nowrap"><strong>[[.room_id.]]</strong></td>
		  <td >:</td>
		  <td><select name="room_id" id="room_id">
		    </select>
          </td>
		  <td nowrap><strong>[[.forgot_time.]]</strong></td>
		  <td >:</td>
		  <td>
			<select  name="hour">
			<script>
			...
			<strong>[[.date.]]</strong>
			<input name="time" type="text" id="time" size="12" value="[[|time|]]">
			</td>
		  <td><strong>[[.employee_id.]]</strong></td>
		  <td >:</td>
		  <td><input name="employee_name" type="text" id="employee_name" style="width:200px" /></td>
		</tr>
		</table>
		</fieldset><br />
		<table width="100%">
			...
			<td colspan="9">
				<fieldset>
					<span id="mi_forgot_object_all_elems" style="text-transform: uppercase;">
							...
							<span class="multi-input-header" style="width:150px;">[[.object_type.]]</span>
							<span class="multi-input-header" style="width:70px;">[[.quantity.]]</span>
							<span class="multi-input-header" style="width:70px;">[[.unit.]]</span>
                            <span class="multi-input-header" style="width:70px;">[[.object_code.]]</span>
                            <span class="multi-input-header" style="width:200px;">[[.reason.]]</span>
                            <span class="multi-input-header" style="width:70px;">[[.position.]]</span>
                            <span class="multi-input-header" style="width:100px;">[[.guest_name.]]</span>
                            <span class="multi-input-header" style="width:100px;">[[.company_name.]]</span>
							<span class="multi-input-header" style="width:20px;"><img src="skins/default/images/spacer.gif"/></span><br clear="all">
					</span>
					<input class="w3-btn w3-gray" type="button" value="[[.add_item.]]" onclick="mi_add_new_row('mi_forgot_object');" style="margin-top: 5px;"/>
				</fieldset></td>
		</tr>
		</table>
		</form>
