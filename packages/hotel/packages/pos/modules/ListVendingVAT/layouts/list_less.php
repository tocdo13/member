		...
		<td align="left">
            <table cellpadding="10" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
                    ...
                    <?php if(User::can_view(false,ANY_CATEGORY)){?><td width="1%" align="right"><a href="<?php echo URL::build_current(array());?>"  class="button-medium">[[.list_bar_reservation_more_than_200.]]</a></td><?php }?>                   
                </tr>
            </table>
		</td>
	</tr>
