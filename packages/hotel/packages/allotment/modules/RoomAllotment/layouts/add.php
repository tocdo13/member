...
<form name="AddRoomAllotmentForm" method="POST" enctype="multipart/form-data">
    ...
    <div class="w3-container w3-margin-bottom" style="max-width: 1200px; margin: 0px auto;">
        <div class="w3-row">
            <h3 class="w3-left w3-margin-left" style="color: #f27173;"><i class="fa fa-braille fa-fw" style="color: #f27173;"></i> [[.create_allotment.]]</h3>
        ...
        <div class="w3-row w3-margin-top">
            <div class="w3-third w3-padding">
                ...
                <p><b class="w3-text-blue">[[.room_level.]]</b></p>
                ...
                <p><b class="w3-text-blue">[[.start_date.]]</b></p>
                <input name="start_date" type="text" id="start_date" class="w3-input w3-border" autocomplete="OFF" maxlength="12" placeholder="[[.start_date.]]" readonly="" />
                
                <p><b class="w3-text-blue">[[.end_date.]]</b></p>
                <input name="end_date" type="text" id="end_date" class="w3-input w3-border" autocomplete="OFF" maxlength="12" placeholder="[[.end_date.]]" readonly="" />
                
                <hr />
                
                <p><b class="w3-text-blue">[[.room_availability_default.]]</b></p>
                <input name="availability_default" type="text" id="availability_default" class="w3-input w3-border input_number" autocomplete="OFF" maxlength="255" placeholder="[[.room_availability_default.]]" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val())));" />
                
                <p><b class="w3-text-blue">[[.rate_default.]]</b></p>
                <input name="rate_default" type="text" id="rate_default" class="w3-input w3-border input_number" autocomplete="OFF" style="text-align: right;" maxlength="255" placeholder="[[.rate_default.]]" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val())));" />
                
                <p><b class="w3-text-blue"><input name="auto_reset_avail" type="checkbox" id="auto_reset_avail" checked="checked" /> [[.auto_reset_availability.]]</b></p>
                <p><b class="w3-text-blue">[[.cut_of_date.]] [[.auto_reset_availability.]]</b></p>
                <input value="2" name="day_reset_avail" type="text" id="day_reset_avail" class="w3-input w3-border input_number" autocomplete="OFF" maxlength="17" placeholder="[[.cut_of_date.]] [[.auto_reset_availability.]]" />
                
                
                <!--
                <p><b class="w3-text-blue">Deposit</b></p>
                <input name="deposit" type="text" id="deposit" class="input_number" autocomplete="OFF" placeholder="$" style="padding: 7px; width: 70%; border: 1px solid #ccc; text-align: right;" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val())));" />
                <b style="color: #f27173;">[[|deposit_currency|]]</b>
                -->
            </div>
            <div class="w3-twothird w3-padding">
                <p><b class="w3-text-blue">[[.setup_availability.]]</b><br /><span><i>(Không áp dụng với ngày quá khứ)</i></span></p>
                ...
                <p><b class="w3-text-blue">[[.setup_rate.]]</b><br /><span><i>(Không áp dụng với ngày quá khứ)</i></span></p>
