...
<form name="AddAllRoomAllotmentForm" method="POST" enctype="multipart/form-data">
    ...
    <div class="w3-container w3-margin-bottom" style="max-width: 1200px; margin: 0px auto;">
        ...
        <div class="w3-row w3-margin-top">
            ...
            <p><input value="2" name="day_reset_avail" type="text" id="day_reset_avail" class="w3-input w3-border input_number" style="width: 50px;" autocomplete="OFF" maxlength="17" placeholder="[[.cut_of_date.]] [[.auto_reset_availability.]]" /></p>
            <hr />
            
            <p><b class="w3-text-blue">[[.setup_allotment.]]</b><br /><span><i>(Không áp dụng với ngày quá khứ)</i></span></p>
...
<table id="DateRangeGroupAvailTemp" style="display: none;">
    <tr id="DateRangeGroupAvail_X######X">
        <td><select id="bulk_room_level_id_X######X" name="bulkrangeavail[X######X][room_level_id]" class="w3-input w3-border">[[|room_level_option|]]</select></td>
