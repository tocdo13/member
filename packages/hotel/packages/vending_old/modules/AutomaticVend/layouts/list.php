				...
				<div id="product_select_expansion">
                    ...
                    <div class="select-menu-bound">
						...
						<div>
                            ...
                            <div class="body" style="width: 520px;">[[|products|]]</div>
                        </div>
				    </div>
                    <!--End:Thanh search-->
            ...
            <td class="info-right" id="expan_display">
                ...
                <div id="menu_extra">
                	<ul id="menu_extra_ul" style="float:left;">
                        ...
                        <li class="menu_extra_li" id="li_deposit" onclick="fun_submit_open('deposit');" <?php if(Url::get('cmd')=='add'){ echo 'style="cursor: default; background: rgb(214, 214, 214);"';} ?>><img src="packages/hotel/skins/default/images/iosstyle/7.png" /></li>
                        <li class="menu_extra_li" id="li_payment" onclick="fun_submit_open('payment')" <?php if(Url::get('cmd')=='add'){ echo 'style="cursor: default; background: rgb(214, 214, 214);"';} ?>><img src="packages/hotel/skins/default/images/iosstyle/8.png" /></li>
                    ...
                    <fieldset style="text-align:left; margin-bottom:10px;margin-top:10px;">
            			...
            			<table cellpadding="3" width="100%">
                            <tr>
                                ...
                                <td  colspan="2">
                                <!-- M?nh thêm ô nh?p mã thành viên d? th?c hi?n tích di?m -->
            ...
            if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
                ...
                for(obj in otbjs){
                    if(otbjs[obj]['no_member']==0){
                        alert("mã thành viên không t?n t?i, vui lòng nh?p l?i mã!");
                        return;
                    }else{
...
function fun_view_info_member(){
    ...
    if(member_level_id == ''){
        alert("không có chuong trình gi?m giá gi?m giá! ki?m tra l?i mã thành viên!");
    }else{
    if (window.XMLHttpRequest){
            xmlhttp=new XMLHttpRequest();
        }
        ...
        xmlhttp.onreadystatechange=function()
        {
            if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
                ...
                if(otbjs['info_member']['no_discount']==0){
                    alert("Không có chuong trình gi?m giá cho h?ng thành viên này!");
                    return;
                }else{
