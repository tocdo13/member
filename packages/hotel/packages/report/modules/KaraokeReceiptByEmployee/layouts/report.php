...
<style>
    ...
    <!--LIST:users-->
		...
		<?php if([[=users.id=]] == [[=items.receptionist_id=]]){
				...
				<span style="float:left;font-weight:bold;margin-bottom:10px;">[[.employee.]]: [[|users.full_name|]]</span>
    ...
    <!--/LIST:users-->
        ...
        <br />
        <div><strong>[[.total_revenue.]]: <?php echo $total_revenue?System::display_number($total_revenue):0 ?></strong></div>
</div>
</div>
