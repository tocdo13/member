<?php   //System::debug([[=last_group_function_params=]]); System::debug([[=group_function_params=]]); ?>
<!---------REPORT----------->
...
<!---------CELLS----------->
	<tr bgcolor="white">
        ...
        <td align="center" class="report_table_column"><a target="_blank" href="<?php echo Url::build('touch_karaoke_restaurant',array('karaoke_reservation_karaoke_id', 'karaoke_reservation_receptionist_id')+array('cmd'=>'edit','id'=>[[=items.id=]],'karaoke_id'=>[[=items.karaoke_id=]])); ?>">[[|items.code|]]</a></td>  
	</tr>
	<!--/LIST:items-->
