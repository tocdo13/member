...
class RoomRevenueComparingBarChartReportForm extends Form{
	...
	function draw()
    {
        ...
        $this->parse_layout('report',array('items_month_detail'=>String::array2js($items),'items_months'=>String::array2js($data),'type'=>String::array2js($reservation_types),"tax_check"=>$check)+$this->map);
	}
}
?>
<!--
