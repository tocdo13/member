...
<form name="SearchForm" method="post">
    <table style="width:100%;" id="report">
        ...
        <tr>
            ...
            <font class="report_title"><strong>[[.revenue_summary_by_day_report.]]</strong></font><br /><br />
            <label id="date_moth">[[.date.]]: <?php echo date('d/m/Y',Date_time::to_time([[=from_date=]])); ?></label>
                ...
                <div style="width:100%; padding-bottom:10px; font-size:11px;">        
                    <table id="tblExport" style="width:100%; border:1px solid #ccc; margin-top:10px; font-size:11px;border-collapse: collapse;" border="1">
                       <tr valign="middle" bgcolor="#EFEFEF" style="padding-left:10px; height:30px;">
                            ...
                            <th style="text-align:center; width:10%;">[[.to_day1.]]</th>
                            <th style="text-align:center; width:3%;">%</th>
                            <th style="text-align:center; width:10%;">[[.last_month.]]</th>
                            <th style="text-align:center; width:3%;">%</th>
                            <th style="text-align:center; width:10%;">[[.last_year.]]</th>
                            <th style="text-align:center; width:3%;">%</th>
