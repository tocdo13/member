...
<table cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC">
	<tr valign="middle" bgcolor="#EFEFEF">
		...
		<th rowspan="2" width="4%" align="center"  class="report_table_header" >[[.recode.]]</th>
...
<!--LIST:items-->
	<tr bgcolor="white">
        ...
        <!--IF:cond2(isset([[=num_services=]]) and !empty([[=num_services=]]))-->
        	<!--LIST:num_services-->
                ...
                <td align="right" valign="top" nowrap class="report_table_column"><?php $service_id = [[=num_services.id=]];  if(isset($this->map['items']['current'][$service_id])){echo System::display_number($this->map['items']['current'][$service_id]);} else echo '';?></td>
      		<!--/LIST:num_services-->
        <!--/IF:cond2-->
	...
	<tr>
        ...
        <!--IF:cond2(isset([[=num_services=]]) and !empty([[=num_services=]]))-->
            <!--LIST:num_services-->
    	 		 <td align="right" class="report_table_column"><b><?php $service_id= [[=num_services.id=]]; if(isset([[=group_function_params=]][$service_id]) && [[=group_function_params=]][$service_id]!=0) { echo System::display_number([[=group_function_params=]][$service_id]); } ?></b></td>
          	<!--/LIST:num_services-->
        <!--/IF:cond2-->
		<td align="right"><b><?php echo System::display_number($total_revenue);?></b></td>
	</tr>	
