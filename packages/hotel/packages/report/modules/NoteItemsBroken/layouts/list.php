                    ...
                    <?php
                        ...
                        if($date_ws!=[[=items.date_ws=]]) 
                        {
                            ...
                            <tr>
                                ...
                                <td align="center"><?php if(User::can_edit(false,ANY_CATEGORY)){?><a href="<?php echo Url::build_current(array('cmd'=>'edit','ws_daily_staff_id'=>[[=items.staffs.ws_daily_staff_id=]],'date_ws'=>[[=items.date_ws=]]));?>"><i class="fa fa-pencil w3-text-orange" style="font-size: 18px;"></i></a><?php }?></td>
                                <td align="center">
