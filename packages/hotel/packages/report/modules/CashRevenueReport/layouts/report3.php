...
<table cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound">
	<tr valign="middle" bgcolor="#EFEFEF">
		<th rowspan="2" width="0%" align="center"  class="report_table_header" >[[.stt.]]</th>
		<th rowspan="2" width="1%" align="center"  class="report_table_header" >[[.code.]]</th>
		<th rowspan="2" class="report_table_header" width="300">[[.room_info.]]</th>
		<th rowspan="2"  class="report_table_header">[[.arrival_time.]] <br /> 
	    [[.departure_time.]]</th>
		<th  colspan="<?php echo (9+$cols);?>" align="center">[[.revenue.]]</th>
	</tr>
	<tr>
		<th width="50" class="report_table_header" >[[.room_total.]]</th>		
		<th width="100" class="report_table_header">[[.restaurant_total.]]</th>
		<th width="50" class="report_table_header">[[.minibar_total.]]</th>
		<th width="50" class="report_table_header">[[.laundry_total.]]</th>
		<th width="50" class="report_table_header">[[.compensation_total.]]</th>
		<th width="50" class="report_table_header">[[.housekeeping_total.]]</th>
		<!--IF:cond(HAVE_KARAOKE)--><th width="50"class="report_table_header">[[.total_karaoke.]]</th><!--/IF:cond-->
		<!--IF:cond(HAVE_MASSAGE)--><th width="100"class="report_table_header">[[.total_massage.]]</th><!--/IF:cond-->
		<!--IF:cond(HAVE_TENNIS)--><th width="50"class="report_table_header">[[.total_tennis.]]</th><!--/IF:cond-->
		<!--IF:cond(HAVE_SWIMMING)--><th width="25"class="report_table_header">[[.swimming.]]</th><!--/IF:cond-->
		<th width="25" class="report_table_header">[[.other_service.]]</th>
	  <th width="70" class="report_table_header">[[.extra_service.]]</th>
		<th width="100"  class="report_table_header">[[.total.]]</th>
	</tr>
...
<!---------CELLS----------->
	<tr bgcolor="white">
		...
		<td align="left" valign="top" class="report_table_column"><div><strong>[[|items.room_name|]]</strong></div>
		  ...
		  <div>[[.customer_stay.]]: [[|items.customer_stay|]] | [[.customer_book.]]: [[|items.customer_name|]] | [[.tour.]]:[[|items.tour_name|]]</div>
		...
		<td align="right" valign="top" nowrap class="report_table_column">[[|items.housekeeping_total|]]</td>
	...
	<tr>
		...
		<td align="right" class="report_table_column"><b><?php echo System::display_number([[=group_function_params=]]['housekeeping_total']);?></b></td>
