...
<div id="content_search" style="margin: 5px auto; width: 500px; border: 1px solid #999; border-radius:10px;">
    <h1 style="text-transform: uppercase; width: 100%; text-align: center; margin: 10px auto;">[[.summary_customer_report.]]</h1>
    ...
    <fieldset style="width: 300px; margin: 10px auto; background: #fff;">
        ...
        <table>
            ...
            <tr>
                ...
                <td nowrap="nowrap"><p><select name="customer_id" id="customer_id" style="width: 100px;"></select></p></td>
            </tr>
            <!-- code sale
            <tr>
