...
<tr><td>
	...
	<td align="center">
		<p>&nbsp;</p>
        <h2 class="report-title-new">[[.restaurant_order_revenue_less_than_200_report.]]</h2>
		<br/>
		...
		<table border="0">
            ...
            <tr>
             ...
             <tr>
                    <td></td>
             		<td  style="width: 25px;"> <input name="checked_all" type="checkbox" id="checked_all" onclick="jQuery('.check_box').attr('checked',jQuery(this).attr('checked'));" /></td> 
