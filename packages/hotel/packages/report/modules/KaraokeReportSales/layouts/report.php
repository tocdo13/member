...
<table cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound">
	<tr valign="middle" bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" width="450" align="left">[[.product_name.]]</th>
		<th class="report_table_header" width="50" align="center">[[.unit.]]</th>
        <th class="report_table_header" width="100">[[.price.]]</th>
		<th align="center" class="report_table_header" width="50">[[.quantity.]]</th>
...
<!---------CELLS----------->
	...
	<tr bgcolor="white">
        ...
        <td align="center" class="report_table_column" >[[|items.name_1|]]</td>
...
<table width="100%" style="font-family:'Times New Roman', Times, serif">
		<tr>
            <td colspan="4"><strong>Tổng Tiền Bằng Chữ: </strong><i><?php echo currency_to_text([[=group_function_params=]]['total']);?></i></td>
        </tr>
        <tr>
		...
		<tr valign="top">
			...
			<td width="25%" align="center">[[.accountancy.]]</td>
			<td width="25%" align="center">[[.kitchen.]]</td>
			<td width="25%" align="center">[[.cashier.]]</td>
		</tr>
		</table>
