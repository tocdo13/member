            ...
            <div id="button_n">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="text-align: right;" width="100px" ><input type="submit" name="export_repost" id="export_repost"  value="Xuất excel" style="width: 100px; height: 30px; background: #fff; border: 1px solid #eeeeee; box-shadow: 0px 0px 3px #555555; border-radius: 10px;" />
