                ...
                <tr>
                    ...
                    <td>
                        <div style="width:75%; text-align:center;">
                            <font class="report_title specific" >[[.guest_type_report.]]<br /></font>
...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound">
	<tr bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" colspan="<?php echo count([[=guest_type=]])+1;?>">[[.guest_checkin_today.]]</th>
        ...
        <th class="report_table_header" colspan="<?php echo count([[=guest_type=]])+1;?>">[[.guest_old_and_checkin_today.]]</th>
        ...
        <th class="report_table_header total" rowspan="3" width="60px">[[.total.]]<br /> (<?php echo (5+1+$count_group_name+4+$count_group_name); ?>)</th>
    </tr>
    <?php $i=2; ?>
    <tr>
        <?php $group_name = '';?>
    ...
    <?php
        ...
        //echo'<td class="total">'.([[=total=]]['TOTAL NIGHT GUEST']?[[=total=]]['TOTAL NIGHT GUEST']:'').'</td>';
