...
<tr><td>
	...
	<tr>
		...
		<p>&nbsp;</p>
		<font class="report_title">[[.reservation_summary_by_seller.]]</font>
		<br/>
		...
		<tr>
			  ...
			  <td nowrap="nowrap">&nbsp;</td>
			  <td nowrap="nowrap">[[.view_by_arrival_time.]] <input type="checkbox" name="view_by_arrival_time" value="1"></td>
			  <td nowrap="nowrap">&nbsp;</td>
		  </tr>
		 </table>
		 <br>
			...
			<tr>
			  <td align="center" nowrap="nowrap">
                ...
                <tr>
					...
					<td><select name="customer_group" id="customer_group" style="width: 185px;"></select></td>
				<tr>
				<tr>
					<td align="right">[[.company.]]:&nbsp;</td>
					<td><input name="customer_name" type="text" id="customer_name" style="width:180px;" onfocus="customerAutocomplete();"/></td>
				<tr>
                  <td align="right">[[.booking_code.]]:&nbsp;</td>
				  <td><input name="booking_code" type="text" id="booking_code" style="width:180px;" /></td>
				  </tr>
				<tr>
				...
				<tr>
					...
					<td> <select name="user_id" id="user_id" style="width:185px;"></select>	</td>
				</tr>
				</table>
				 </td>
			  </tr>
