		  ...
		  <table border="0">
			<tr>
              ...
              <tr>
                  ...
                  <td align="left"><input name="from_code" type="text" id="from_code" class="input_number" style="width:35px;"> [[.to.]]: <input name="to_code" type="text" id="to_code" class="input_number" style="width:35px;"></td>
              </tr>
              </table>
			<table border="0">
			<tr>
