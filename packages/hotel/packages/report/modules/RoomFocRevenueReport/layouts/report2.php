<!---------REPORT----------->	
<table cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" style="font-size:10px; border-collapse:collapse;">
	<tr valign="middle">
	  <th width="15px" align="center"  class="report-table-header" >[[.stt.]]</th>
	  <th width="15px" align="center"  class="report-table-header" >[[.recode.]]</th>
	  <th width="400px" class="report-table-header">[[.room_info.]]</th>
	  <th width="50px" class="report-table-header">[[.arrival_time.]]<br />[[.departure_time.]]</th>
	  <th width="80px" nowrap="nowrap"  class="report-table-header">[[.room_total.]]</th>
	  <th width="80px" nowrap="nowrap"  class="report-table-header">[[.extra_service.]]</th>
	  <th width="80px" nowrap="nowrap"  class="report-table-header">[[.total.]]</th>
...
<!---------LAST GROUP VALUE----------->	
		<tr><td colspan="4" class="report_sub_title" align="right"><b>[[.last_page_summary.]]</b></td>
		    ...
		    <td align="right"><b><?php echo System::display_number(round([[=last_group_function_params=]]['room_total']+[[=last_group_function_params=]]['room_service_total']+[[=last_group_function_params=]]['service_other_total']+[[=last_group_function_params=]]['extra_service_total_with_room']+[[=last_group_function_params=]]['extra_service_total_with_service']),1);?></b></td>
            <td></td>
		</tr>
	<!--/IF:first_page-->	
...
<!---------CELLS----------->
	<tr bgcolor="white">
		...
		<td align="left" valign="top" class="report_table_column">
            <div style="font-size:12px;"><strong>[[|items.room_name|]]</strong>&nbsp;[[|items.brief_name|]] | [[.customer_stay.]]: <strong>[[|items.customer_stay|]]</strong> | [[.customer_book.]]: <strong>[[|items.customer_name|]]</strong> [[.tour.]]: <strong>[[|items.tour_name|]]</strong></div></td>
	  ...
	  <td align="right" valign="top" nowrap class="report_table_column"> <?php echo System::display_number(round([[=items.room_total=]]),1);?></td>
		...
		<td align="right" valign="top" nowrap class="report_table_column"><?php echo System::display_number(round([[=items.room_total=]]+[[=items.room_service_total=]]+[[=items.service_other_total=]]+[[=items.extra_service_total_with_service=]]),1);?></td><!-- +[[=items.extra_service_total_with_room=]] -->
		<td align="left" class="report_table_column">
			[[|items.note|]]		</td>
	</tr>
	<!--/LIST:items-->
	<!---------TOTAL GROUP FUNCTION----------->	
		<tr style="font-size:9px;"><td colspan="4" class="report_sub_title" align="right"><b><?php if([[=page_no=]]==[[=total_page=]])echo Portal::language('summary');else echo Portal::language('next_page_summary');?></b></td>
			...
			<td align="right"><b><?php echo System::display_number(round([[=group_function_params=]]['room_total']+[[=group_function_params=]]['room_service_total']+[[=group_function_params=]]['extra_service_total_with_service']),1);?></b></td><!--+[[=group_function_params=]]['service_other_total']+[[=group_function_params=]]['extra_service_total_with_room']-->
			<td colspan="1">&nbsp;</td>
		</tr>	
