	...
	<td align="center">
		...
		<tr valign="top">
			...
			<!--<em>&#272;&#417;n v&#7883; t&iacute;nh: <?php //echo HOTEL_CURRENCY;?></em></td>-->
              ...
              <!--
		<div class="report_title" style="text-transform:uppercase"><?php if(Url::get('type')==1){echo Portal::language('hotel_foc_revenue_report');}elseif(Url::get('type')==2){echo Portal::language('room_revenue_report');}else{echo Portal::language('reception_report_foc'); }?></div>
               -->
               <div style="text-align: center;"><h2 style="text-transform: uppercase;">[[.income_by_reception.]]  FOC</h2></div>
