...
<tr><td align="center">
	...
	<tr>
	<td width="60px">&nbsp;</td>
	<td align="center"><span class="report_title">[[.summary_report.]]</span>
		<form name="SearchForm" method="post"><br /><br />
        	<fieldset style="width:300px">
              <table border="0">
                ...
                <tr>
                  <td width="100"><p>[[.date.]]</p></td>
                  <td><p><select name="date" id="date"></select></p></td>
                  <!--<td><p><input name="date" type="text" id="date"/></p></td>-->
                  </tr>
              </table>
             </fieldset>
			<p>
...
<script>
 jQuery('#date').datepicker({ yearRange: '2008:2020' });
</script>