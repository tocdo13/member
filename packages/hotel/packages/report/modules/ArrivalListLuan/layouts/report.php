                        ...
                        <form name="SearchForm" method="post">
                            <table style="margin: 0 auto;">
                                <tr>
                                    ...
                                    <td>[[.status.]]</td>
                                	<td><select name="status" id="status" style="width: 120px;"></select></td>
                                    <td>[[.customer.]]</td>
...
<table id="tblExport" cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="border-collapse: collapse;">
    <tr bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" width="130px">[[.company.]]</th>   
            ...
            <!--LIST:items.room.traveller-->
                <tr>
                    ...
                    <?php if([[=items.room.id=]]!=$rr_id){ $rr_id=[[=items.room.id=]];?>
                        ...
                        <!--<td rowspan="<?php echo [[=items.room.count=]];?>"><?php if([[=items.room.extrabed=]]>0){ echo "Yes".'('.[[=items.room.extrabed=]].')'; } else{ echo " "; }  ?></td>
                        ...
                        <td rowspan="<?php echo [[=items.count=]];?>">[[|items.room.booking_code|]]</td>
                        <td rowspan="<?php echo [[=items.count=]];?>">[[|items.room.booker|]]</td>
                        <?php }?>
                    <?php }?>
                    <td style="text-align: left;"><a href="<?php echo Url::build('traveller',array('id'=>[[=items.room.traveller.traveller_id=]]));?>" target="_blank">[[|items.room.traveller.fullname|]] [[|items.room.traveller.count_reservation|]]</a></td>
