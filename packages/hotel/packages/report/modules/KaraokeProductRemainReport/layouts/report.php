	...
	<td align="center">      
		...
		<!--LIST:items-->
			<tr bgcolor="white">
				...
				<td class="report_table_column" style="width: 60px; text-align: center;"><a href="<?php echo Url::build('karaoke_touch',array(  'karaoke_reservation_karaoke_id', 'karaoke_reservation_receptionist_id')+array('cmd'=>'edit','id'=>[[=items.br_id=]])); ?>">[[|items.br_id|]]</a></td>
		...
		<!---------TOTAL GROUP FUNCTION----------->	
			<tr>
                <td colspan="7" class="report_sub_title" align="right"><b><?php echo Portal::language('summary');?></b></td>
