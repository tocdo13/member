...
<table  cellpadding="5" cellspacing="0" width="80%" border="1" bordercolor="#CCCCCC" class="table-bound">
    ...
    <tr>
        ...
        <td align="center" class="report_table_column"><?php echo [[=summary=]]['no_of_room']; ?></td>
    ...
    <tr>
        ...
        <td class="report_table_column" align="right"><?php echo System::display_number([[=summary=]]['revenue']); ?></td>
    </tr>
