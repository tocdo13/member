                        ...
                        <form name="SearchForm" method="post">
                            <table style="margin: 0 auto">
                                <tr>        
                                    ...
                                    <td>[[.Recode.]]</td>
                                	<td><input name="recode" type="text" id="recode" size="4"/></td>
...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="width: 100%;">
	<tr bgcolor="#EFEFEF">
		<th class="report_table_header" width="20px">[[.stt.]]</th>
		<th class="report_table_header" width="30px">[[.reservation_room_code.]]</th>
        <th class="report_table_header" width="60px">[[.tour.]], [[.company.]]</th>
        <th class="report_table_header" width="150px">[[.note.]]</th>
		<th class="report_table_header" width="100px">[[.customer_name.]]</th>
		<th class="report_table_header" width="70px">[[.nationality.]]</th>
        <th class="report_table_header" width="100px">[[.room_level.]]</th>
        <th class="report_table_header" width="40px">[[.room.]]</th>
        <th class="report_table_header" width="40px">[[.status.]]</th>
	...
	<tr bgcolor="white" style="font-size:11px;">
        <?php $k = $this->map['count_traveller'][[[=items.reservation_room_code=]]]['num'];
        if($is_rowspan == false)
        {
        ?>
        <?php if($num_reservation!=[[=items.reservation_id=]]){ 
         ...
         ?>        
            ...
            <td class="report_table_column" width="60px" style="white-space: normal; text-align: left;" rowspan="<?php echo $n_r; ?>">[[|items.note|]]</td>
            <td class="report_table_column" width="150px" rowspan="<?php echo $n_r; ?>"  align="center"><div style="font-size:11px;">[[|items.reservation_note|]]</div></td>
        <?php } ?>
        <?php } ?>
        ...
        <?php if($is_rowspan == false){ ?>
            <td class="report_table_column" width="100px" rowspan="<?php echo $k; ?>" align="center">[[|items.room_level|]]</td>
            <td class="report_table_column" width="40px" rowspan="<?php echo $k; ?>" align="center">[[|items.room_name|]]</td>
            <td class="report_table_column" width="40px" rowspan="<?php echo $k; ?>" align="center">[[|items.status|]]</td>
        ...
        <?php if([[=items.time_out=]]=='' &&  [[=items.time_out_room=]] != 0 ){?>
            <td class="report_table_column" rowspan="</?php echo $k; ?>" align="center"><div style="font-size:11px;">
                <?php echo date('d/m/Y H:i',[[=items.time_in_room=]]);?></div> 
            </td>
    		<td class="report_table_column" rowspan="</?php echo $k; ?>" align="center"><div style="font-size:11px;">
                <?php echo date('d/m/Y H:i',[[=items.time_out_room=]]);?></div> 
            </td>
        <?php } ?>
        <?php } ?>
	...
	<tr bgcolor="white" style="font-size:11px;">
        ...
        <td colspan="4" class="report_table_column"></td>
