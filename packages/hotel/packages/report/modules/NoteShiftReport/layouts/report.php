                ...
                <tr>
    				<td colspan="2"> 
                        <div style="width:100%; text-align:center;">
                            <font class="report_title specific" >[[.note_shift_report.]]<br /></font>
...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="margin:auto;">
	<tr bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" width="10%">[[.room.]]</th>
        <th class="report_table_header" width="90%">[[.note.]]</th>
    </tr>
...
<!---------LAST GROUP VALUE----------->	        
    <tr>
        <td class="report_sub_title" align="right"><b>[[.last_page_summary.]]</b></td>
    ...
    <tr bgcolor="white">
        ...
        <td align="center" class="report_table_column">[[|items.name|]]</td>
        <td align="left" class="report_table_column" style="padding-left:2%;">[[|items.note|]]</td>
	</tr>
	<!--/LIST:items-->
    <tr>
        <td align="right" class="report_sub_title" ><b><?php if([[=page_no=]]==[[=total_page=]])echo Portal::language('summary');else echo Portal::language('next_page_summary');?></b></td>        
        <td style="text-align:left;padding-left:2%;" class="report_table_column"><strong><?php echo System::display_number([[=group_function_params=]]['total']);?></strong></td>
