...
<tr>
    ...
    <table id="table_export">
        <tr>
            <td>
		<div class="report_title" style="text-transform:uppercase; margin-bottom: 20px;margin-top: 20px; text-align: center;">[[.extra_service_revenue_report.]]</div>
        ...
        <?php }?>
         ...
         <input name="export_repost" type="submit" id="export_repost" class="export_repost"  value="[[.export.]]" />
         </form>
         </div>
 <br />
