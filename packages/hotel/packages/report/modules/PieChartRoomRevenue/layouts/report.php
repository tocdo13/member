...
<tr>
	...
	<tr>
	<td align="center">
		<font class="report_title" style="font-size:20px; text-align:center;"><b>[[.piechart_room_revenue.]]</b></font>
		<br><br />
			...
			tooltip: {
				formatter: function() {
					...
					return '<b>'+ this.point.name +'</b>:'+ roundNumber(this.percentage,1) +' % <br/>'+
							'[[.room_revenue.]]:<b>' + number_format(Math.round(this.y)*1000)+'</b><br/>'
							+'[[.total.]]: <b>' +number_format(Math.round(tong)*1000)+'</b>';
				}
			},
			plotOptions: {
				pie: {
