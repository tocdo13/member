    			...
    			<tr>
    				...
    				<td> 
                        <div style="width:75%; text-align:center;">
                            <font class="report_title specific" >[[.reservation_list.]]<br /></font>
...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound">
	<tr bgcolor="#EFEFEF">
		...
		<th class="report_table_header">[[.create_time.]]</th>
    ...
    <tr bgcolor="white">
		...
		<td class="report_table_column" width="40px" rowspan="<?php echo $k; ?>">[[|items.room_type_name|]]</td>
		...
		<td class="report_table_column" width="60px" style="white-space: normal;">[[|items.nationality|]]</td>
        <?php
            $i++;
            }
        ?>
        <?php 
            ...
            {
        ?>
		<td class="report_table_column" width="100px" rowspan="<?php echo $k; ?>"><?php echo date('d/m/Y H:i',[[=items.time=]]);?></td>
		<td class="report_table_column" width="100px" rowspan="<?php echo $k; ?>"><?php echo date('d/m/Y H:i',[[=items.time_in=]]);?></td>
		<td class="report_table_column" width="100px" rowspan="<?php echo $k; ?>"><?php echo date('d/m/Y H:i',[[=items.time_out=]]);?></td>
        <td class="report_table_column" width="20px" rowspan="<?php echo $k; ?>">[[|items.night|]]</td>
        <td class="report_table_column" style="white-space: normal; text-align: left;" rowspan="<?php echo $k; ?>">[[|items.note|]]</td>
        <td class="report_table_column" width="20px" rowspan="<?php echo $k; ?>">[[|items.status|]]</td>
        <?php
            $is_rowspan = true;
            } 
            if($k ==0 || $k ==1 || $i>$k)
	...
	<tr bgcolor="white">
		...
		<td colspan="5" class="report_table_column">&nbsp;</td>
