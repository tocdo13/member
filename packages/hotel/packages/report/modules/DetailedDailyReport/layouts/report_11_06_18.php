...
<table cellpadding="5" cellspacing="0" width="300px" border="1" bordercolor="#CCCCCC" class="table-bound" style="font-size:12px;">
	...
	<tr bgcolor="white">
        ...
        <td align="right" ><?php echo System::display_number(round([[=summary=]]['FOOD']['price'])); ?></td>        
	</tr>
    ...
    <tr bgcolor="white">
        ...
        <td align="right" ><?php echo System::display_number(round([[=summary=]]['DRINK']['price'])); ?></td>        
	</tr>
    
    <tr bgcolor="white">
        <td align="center"  colspan="2" ><strong>[[.total.]]</strong></td>  
        <td align="right" ><?php echo System::display_number(round([[=summary=]]['DRINK']['price']+[[=summary=]]['FOOD']['price'])); ?></td>        
	</tr>
    
    <tr bgcolor="white">
        <td align="center"  colspan="2" ><strong>[[.charge.]]</strong></td>  
        <td align="right" ><?php echo System::display_number(round([[=summary=]]['DRINK']['charge']+[[=summary=]]['FOOD']['charge'])); ?></td>        
	</tr>
    
    <tr bgcolor="white">
        <td align="center"  colspan="2" ><strong>[[.tax.]]</strong></td>  
        <td align="right" ><?php echo System::display_number(round([[=summary=]]['DRINK']['tax']+[[=summary=]]['FOOD']['tax'])); ?></td>        
	</tr>

    <tr bgcolor="white">
        <td align="center"  colspan="2" ><strong>[[.total_after_tax.]]</strong></td>  
        <td align="right" ><?php echo System::display_number(round([[=summary=]]['DRINK']['total_after_tax']+[[=summary=]]['FOOD']['total_after_tax'])); ?></td>        
	</tr>
...
<table cellpadding="5" cellspacing="0" width="300px" border="1" bordercolor="#CCCCCC" class="table-bound">
	...
	<tr bgcolor="white">
        ...
        <td align="right"  ><?php echo System::display_number(round([[=product.total_after_tax=]]));?></td>        
	</tr>
	<!--/LIST:product-->
</table>
<br />