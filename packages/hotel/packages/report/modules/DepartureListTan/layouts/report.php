...
<table id="tblExport" cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound">
    <tr bgcolor="#EFEFEF">
        ...
        <th width="100px" style="text-align: center;">[[.company.]]</th> 
        ...
        <th width="60px" style="text-align: center;">[[.arrival_date.]]</th>
        <th width="60px" style="text-align: center;">[[.departure_date.]]</th>
        <th width="60px" style="text-align: center;">[[.flight_code_departure.]]</th>
        <th width="60px" style="text-align: center;">[[.flight_departure_time.]]</th>
        <th width="60px" style="text-align: center;">[[.car_note_departure.]]</th>
    </tr>
    <?php $r_id = '';$rr_id='';
    ?>
    <!--LIST:items-->
            ...
            <!--LIST:items.room.traveller-->
                <tr>
                    <?php if([[=items.id=]]!=$r_id){ $r_id=[[=items.id=]];?>
                        ...
                        <td rowspan="<?php echo [[=items.count=]];?>" style="text-align: left;"><div style="font-size:13px;"><b>[[|items.note|]]</b><br/><i>[[|items.reservation_note|]]</i></div></td>
                    <?php }?>
                    ...
                    <td style="text-align: center;">[[|items.room.traveller.flight_code_departure|]]</td>
                    <td style="text-align: center;"><?php echo ([[=items.room.traveller.flight_departure_time=]]!='' and [[=items.room.traveller.flight_departure_time=]]!=0)?date('d/m/Y H:i',[[=items.room.traveller.flight_departure_time=]]):'';?></td>
                    <td style="text-align: center;">[[|items.room.traveller.car_note_departure|]]</td>
                </tr>
            <!--/LIST:items.room.traveller-->
        <!--/LIST:items.room-->
    <!--/LIST:items-->
