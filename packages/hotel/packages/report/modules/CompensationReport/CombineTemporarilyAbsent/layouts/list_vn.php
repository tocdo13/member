	...
	<td>
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		  <tr>
		   ...
		   <tr>
			<td>
				<table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#CCCCCC" style="font-size:11px;">
				  <tr>
					<th align="center" width="30px"><strong>[[.stt.]]</strong></th>
					<th align="center" width="200px"><strong>[[.full_name.]]</strong></th>
                    <th align="center" width="40px"><strong>[[.gender.]]</strong></th>
					<th align="center" width="50px"><strong>[[.birth_day.]]</strong></th>
					<th align="center" width="100px">[[.national.]]</th>
					<th align="center" width="100px"><strong>Số CMND/Hộ Chiếu</strong></th>
                    <th align="center" width="200px"><strong>Nơi đăng ký hộ khẩu thường trú</strong></th>
					<th align="center" width="70px">[[.arrival_time.]]</th>
					<th align="center" width="70px"><strong>[[.departure_time.]]</strong></th>
					<th align="center" width="30px">[[.room.]]</th>
                    <th align="center" width="200px">[[.Họ và tên người thông báo lưu trú.]]</th>
                    <th align="center" width="300px">[[.Họ và tên cán bộ công an tiếp nhận thông báo.]]</th>
					<th align="center" width="100px">[[.note.]]</th>
				  </tr>
				  <?php $i=0;?>
				  <!--LIST:items-->
				  <tr>
					...
					<td align="center"><?php echo Date_Time::convert_orc_date_to_date([[=items.arrival_time=]],'/');?></td>
					<td align="center"><?php echo Date_Time::convert_orc_date_to_date([[=items.departure_time=]],'/');?></td>
...
<td colspan="3" align="center">
 <?php $j=0;?>
	<table id="count_national" style="font-size:11px;">
    	<tr>
