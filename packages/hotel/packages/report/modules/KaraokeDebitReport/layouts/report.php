...
<!---------LAST GROUP VALUE----------->	
		<tr><td colspan="5" class="report_sub_title" align="right"><b>[[.last_page_summary.]]</b></td>
			<td align="right" class="report_table_column"><?php echo System::display_number_report([[=last_group_function_params=]]['debit']);?></td>
		</tr>
	<!--/IF:first_page-->
	<!--LIST:items-->
...
<!---------CELLS----------->
	<tr bgcolor="white">
        ...
        <td nowrap align="center" class="report_table_column" width="100"><a href="<?php echo Url::build('karaoke_touch',array(  'karaoke_reservation_karaoke_id', 'karaoke_reservation_receptionist_id')+array('cmd'=>'edit','id'=>[[=items.id=]])); ?>">[[|items.code|]]</a></td>
