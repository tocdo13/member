        ...
        <div class="w3-round w3-padding w3-margin">
            ...
            <table class="w3-table-all w3-margin">
                    <tr class="w3-light-grey">
                        <td colspan="2" style="cursor: pointer;" onclick="EditRoomType([[|items.id|]]);"><h5><span><i class="fa fa-fw fa-hotel"></i></span> <b>[[|items.type_name|]]</b> [[|items.description|]]</h5></td>
                        <td style="text-align: right; width: 10%;">
                            <div class="w3-button  w3-white w3-hover-white w3-border w3-right" onclick="AddNewRoomRate('[[|items.type_name|]]',[[|items.id|]]);">
                    ...
                    <tr class="w3-white">
                        <td style="padding-left: 50px; width: 30%;">
                            <span style="cursor: pointer;" onclick="EditRoomRate('[[|items.type_name|]]',[[|items.id|]],'[[|items.child.rate_plan_code|]]','[[|items.child.rate_name|]]','[[|items.child.availability|]]','[[|items.child.default_min_stay|]]','[[|items.child.default_stop_sell|]]','[[|items.child.rate_config_manual|]]','[[|items.child.manual_rack_rate|]]','[[|items.child.rate_config_derive|]]','[[|items.child.derive_from_rate_id|]]','[[|items.child.daily_rate|]]','[[|items.child.amount_inc|]]','[[|items.child.amount_dec|]]','[[|items.child.amount_adjust|]]','[[|items.child.percent_inc|]]','[[|items.child.percent_dec|]]','[[|items.child.percent_adjust|]]','[[|items.child.id|]]','[[|items.child.auto_set_avail|]]','[[|items.child.overbook_quantity|]]');">[[|items.child.rate_plan_code|]]: [[|items.child.rate_name|]]</span> 
                            <span style="cursor: pointer;" class="w3-text-teal" onclick="GetChannel([[|items.child.id|]]);"> <i class="fa fa-plug fa-fw"></i> Map to Channel <?php echo sizeof([[=items.child.child=]])!=0?'<span class="w3-tag w3-round-large w3-green w3-center">'.sizeof([[=items.child.child=]]).'</span>':''; ?></span>
                        </td>
                        <td colspan="2" style="border-left: 1px solid #CCC;">
                            <span style="cursor: pointer;" onclick="EditRoomRate('[[|items.type_name|]]',[[|items.id|]],'[[|items.child.rate_plan_code|]]','[[|items.child.rate_name|]]','[[|items.child.availability|]]','[[|items.child.default_min_stay|]]','[[|items.child.default_stop_sell|]]','[[|items.child.rate_config_manual|]]','[[|items.child.manual_rack_rate|]]','[[|items.child.rate_config_derive|]]','[[|items.child.derive_from_rate_id|]]','[[|items.child.daily_rate|]]','[[|items.child.amount_inc|]]','[[|items.child.amount_dec|]]','[[|items.child.amount_adjust|]]','[[|items.child.percent_inc|]]','[[|items.child.percent_dec|]]','[[|items.child.percent_adjust|]]','[[|items.child.id|]]','[[|items.child.auto_set_avail|]]','[[|items.child.overbook_quantity|]]');"><!--IF:cond([[=items.child.description=]]!='')--><i class="fa fa-link fa-fw"></i>[[|items.child.description|]]<!--/IF:cond--></span>
                            <!--IF:cond([[=items.child.rate_config_derive=]]==1)--> 
                                <span style="cursor: pointer;" class="w3-text-pink" onclick="RateOverride([[|items.child.id|]]);"><i class="fa fa-fw fa-plus"></i>Add Rate Override</span>
                            <!--/IF:cond-->
                        </td>
                    </tr>
                        <!--LIST:items.child.child-->
                        <tr class="w3-pale-green  RoomRateItems_[[|items.child.id|]]">
                            <td style="padding-left: 100px; width: 30%;">
                                <span style="cursor: pointer;" onclick="EditRoomRateOta([[|items.child.child.id|]]);" class="w3-text-teal"><b> - [[|items.child.child.ota_name|]]</b></span> 
                            </td>
                            <td colspan="2" style="padding-left: 50px; border-left: 1px solid #CCC;">
                                <span style="cursor: pointer;" onclick="EditRoomRateOta([[|items.child.child.id|]]);"><!--IF:cond([[=items.child.child.description=]]!='')--><i class="fa fa-link fa-fw"></i>[[|items.child.child.description|]]<!--/IF:cond--></span>
                                <!--IF:cond([[=items.child.child.manual_derive=]]=='DERIVE')--> 
                                    <span style="cursor: pointer;" class="w3-text-pink" onclick="ChannelOverride([[|items.child.id|]]);"><i class="fa fa-fw fa-plus"></i>Add Rate Override</span>
                                <!--/IF:cond-->
                            </td>
                        </tr>
                        <!--/LIST:items.child.child-->
