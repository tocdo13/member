...
<table cellpadding="10" cellspacing="10">
	<tr height="40">
		<td class="form-title">[[.manage_hole.]]</td>
		<?php if(User::can_edit(false,ANY_CATEGORY) || User::can_delete(false,ANY_CATEGORY)|| User::can_add(false,ANY_CATEGORY)){?>
            <td><input name="save" type="submit" id="save" value="[[.save.]]" class="w3-button w3-amber"/></td>
        <?php }?>
		<?php if(User::can_delete(false,ANY_CATEGORY)){?>
            <!--<td width="1%"><a href="javascript:void(0);" onclick="DeleteSelected();" class="button-medium-delete">[[.Delete.]]</a></td>-->
            <td style="text-align: right;"><input type="button" value="[[.delete.]]" onclick=" DeleteSelected();"  class="w3-button w3-pink" /></td>
        <?php }?>
	</tr>
    <tr>
        <td colspan="3">
...
<table cellspacing="0" width="100%">
	...
	<tr>
        <td style="padding-bottom:30px">
            ...
            <input name="structure_id" type="hidden" id="structure_id" value="[[|structure_id|]]" />
            ...
            <?php //if(Form::$current->is_error()){echo Form::$current->error_messages();}?>
                <tr valign="top">
                    <td style="">
            			<div>
            				<span id="mi_hole_all_elems">
            					<span>
            						...
            						<span class="multi-input-header" style="width:35px; height: 40px; line-height: 40px; text-align: center;">[[.ID.]]</span>
            						<span class="multi-input-header" style="width:100px; height: 40px; line-height: 40px; text-align: center;">[[.code.]]</span>
            						<span class="multi-input-header" style="width:150px; height: 40px; line-height: 40px; text-align: center;">[[.name.]]</span>
            						<span class="multi-input-header" style="width:100px; height: 40px; line-height: 40px; text-align: center;">[[.num_hole.]]</span>            						
            						<span class="multi-input-header" style="width:70px; height: 40px; line-height: 40px; text-align: center;">[[.Delete.]]</span>
            					</span>
                                <br clear="all"/>
            				</span>
            			</div>
                        ...
                        { 
                        ?>
            			<div><a href="javascript:void(0);" onclick="mi_add_new_row('mi_hole');document.getElementById('num_'+ input_count).value=0;" class="w3-button w3-blue">[[.Add.]]</a></div>
                        <?php 
                        }
                        ?>
                    </td>
