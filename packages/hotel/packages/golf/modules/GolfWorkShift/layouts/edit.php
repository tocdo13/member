        ...
        <div class="w3-row w3-padding" style="min-width: 600px!important; max-width: 1420px; margin: 0px auto; background: #FFFFFF;">
            <div class="w3-row">
                <div class="w3-button w3-margin w3-left" style="font-weight: bold; text-transform: uppercase; background: none!important;">
                    <i class="fa fa-fw fa-calendar"></i> [[.golf_work_shift.]]
                </div>
            </div>
            <div class="w3-row">
                <table id="Calendar" style="margin: 0px auto;">
                        ...
                        <th colspan="7">
                            <table class="w3-right">
                                <tr>
                                    ...
                                    <th>
                                        <select name="month" id="month" class="w3-select" style="background: none; border: none; width: 80px;color: #555;"></select>
                                    </th>
                                    <th>
                                        <select name="year" id="year" class="w3-select" style="background: none; border: none; width: 90px;color: #555;"></select>
                                    </th>
                                    <th>
                    ...
                    <tr style="text-align: center;">
                        <!--LIST:timeline.week-->
                            <td>
                                <!--IF:cond(isset([[=timeline.week.mday=]]))-->
                                    <div onclick="SelectDay([[|timeline.week.mday|]]);" id="items_[[|timeline.week.mday|]]" class="itemday" lang="[[|timeline.week.id|]]" style="margin: 5px; padding: 5px;<!--IF:condInDate([[=timeline.week.id=]]==Date_Time::to_time(date('d/m/Y')))--> border: 1px solid pink; background: pink; <!--ELSE--> border: 1px solid #f2f2f2; <!--/IF:condInDate--> overflow: hidden; border-radius: 10px; font-weight: bold;">
                                        [[|timeline.week.mday|]]
                                    </div>
                                <!--/IF:cond-->
                            </td>
            ...
            <div class="w3-row w3-margin w3-padding" style="background: #FAFAFA;">
                <p><i class="fa fa-fw fa-info-circle"></i>[[.info.]]</p>
                <hr />
    ...
    <div id="LightBoxCentralContent" style="min-width: 320px; max-width: 640px; min-height: 50px; z-index: 99; margin: 100px auto; background: white;">
        ...
        <div class="w3-row w3-padding">
            <table class="w3-table">
                <tr>
                    <tr>
                        <td style="width: 50%;">[[.start_time_open.]]</td>
                        <td>[[.end_time_open.]]</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>[[.minute_in_one_ball.]]</td>
                        <td>[[.num_people_of_group.]]</td>
                    </tr>
                    <tr>
    					...
    					success:function(html)
                        {
                            ...
                            for(var i in obj){
                                if(to_numeric(obj[i]['status'])==1){
                                    ...
                                    $content += '<input type="button" value="[[.edit.]]" class="w3-button w3-blue w3-hover-blue" />';
                                }else{
