	...
	<span id="mi_group_sample">
		<div id="input_group_#xxxx#">
			...
			<span class="multi-input">
                <select  name="mi_group[#xxxx#][group_id]" style="width:200px;"  id="group_id_#xxxx#">
					[[|group_id_options|]]
				</select>
            </span>
			<span class="multi-input">
                <select  name="mi_group[#xxxx#][status]" style="width:60px;"  id="status_#xxxx#">
...
<form name="RevenAndExpenItemForm" method="post" >
<table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr height="40">
		<td width="98%" class="form-title">[[.REVENUE_EXPENDITURE.]]</td>
			...
			<div style="background-color:#EFEFEF;">
				<span id="mi_group_all_elems">
					<span style="white-space:nowrap; width:auto;">
                        ...
                        <span class="multi-input-header" style="float:left;width:196px;">[[.group.]]</span>
                        <span class="multi-input-header" style="float:left;width:56px;">[[.status.]]</span>
                        <!--IF:delete(User::can_delete(false,ANY_CATEGORY))-->
