                ...
                <td colspan="6">
                    ...
                    <table id="list_product" style="width: 100%; margin: 0px auto;" cellspacing="2" cellpadding="2" border="1" bordercolor="#DDDDDD">
                        ...
                        <tr id="mi_list_product_<?php echo $i; ?>" style="text-align: center; font-weight: normal;">
                            ...
                            <th style="font-weight: normal;width: 80px;"><input id="price_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][price]" style="width: 100%; text-align: right;"  value="[[|mi_list_product.price|]]" <?php if([[=status=]]==4){ echo 'readonly=""'; } ?> onkeyup="jQuery('#price_<?php echo $i; ?>').val(number_format(to_numeric(jQuery('#price_<?php echo $i; ?>').val())));get_total_amount();CountPrice(<?php echo $i; ?>);" /></th>
                            <th style="font-weight: normal;width: 50px;"><input id="tax_percent_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][tax_percent]" style="width: 100%; text-align: right;"  value="[[|mi_list_product.tax_percent|]]" <?php if([[=status=]]==4){ echo 'readonly=""'; } ?> onkeyup="get_total_amount();CountPrice(<?php echo $i; ?>);" /></th>
                            <th style="font-weight: normal;width: 80px;"><input id="tax_amount_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][tax_amount]" class="readonly" style="width: 100%; text-align: right;" value="[[|mi_list_product.tax_amount|]]"
                                readonly="readonly" 
                                  onkeyup="jQuery('#tax_amount_<?php echo $i; ?>').val(number_format(to_numeric(jQuery('#tax_amount_<?php echo $i; ?>').val())));get_total_amount();" /></th>
                            <th style="font-weight: normal;width: 100px;"><input id="total_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][total]" class="readonly" style="width: 100%; text-align: right;" value="[[|mi_list_product.total|]]" readonly="" /></th>
