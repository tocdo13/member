...
<form name="AddPcOrderForm" method="POST">
    <div style="width: 100%; height: auto; background: #EAE9E9;">
        <table style="width: 100%;">
            <tr>
                <td>
                    ...
                    <h3 style="float: left; text-transform: uppercase; font-size: 21px;">[[.create_order.]]</h3>
                </td>
                <td style="text-align: right;">
                    ...
                    <input class="w3-btn w3-cyan w3-text-white" name="save" id="save" type="button" onclick="fun_checksubmit('creater');" value="[[.create_order.]]" style="text-transform: uppercase;" />
                    <?php } ?>
                </td>
            </tr>
        ...
        <table style="width: 100%; margin: 1px auto;" cellspacing="2" cellpadding="2"  >
            <tr>
                ...
                <td style="width: 300px;">
                    <input name="pc_supplier_name" type="text" id="pc_supplier_name" onfocus="Autocomplete();" autocomplete="off" style="width:100%;height: 24px;"/>
                    <input name="pc_supplier_id" type="text" id="pc_supplier_id" style="display: none;" />
                </td>
            </tr>
            <tr style="padding-bottom: 5px;">
                ...
                <td style="width: 130px;"> 
                    <input name="receiver" type="text" id="receiver" class="ipt_style" style="width: 100%;height: 24px;" />
                </td>
                <td style="width: 80px;">
                    <label >[[.place_of_receipt.]]</label> : 
                </td>
                <td style="width: 130px;">
                    <input name="place_of_receipt" type="text" id="place_of_receipt" class="ipt_style" style="width: 100%;height: 24px;" />
                </td>
                <td style="width: 100px;">
                    <label >[[.tel_of_receipt.]]</label> : 
                </td>
                <td style="width: 150px;">
                    <input name="tel_of_receipt" type="text" id="tel_of_receipt" class="ipt_style" style="width: 100%;height: 24px;" />
                </td>
                <td style=" width: 100px;" >
                    ...
                    <table style="width: 70%; background: url('packages/hotel/packages/purchasing/skins/default/images/partent.png') top left repeat;">
                        <tr style="text-transform: uppercase;">
                            <td style="text-align: left; width: 400;">
                                <b>[[.supplier_name.]]:</b> <label id="supplier_name"></label>                                                          
                            </td >
                            <td style="text-align: left; width: 200;">
                                <b>[[.supplier_tax_code.]]:</b> <label id="supplier_tax_code"></label>
                            </td>                                
                            <td style="text-align: left; width: 200;">
                                <b>[[.total_order.]]:</b> <label id="total_order"></label>
                            </td>                            
                        </tr>
                        <tr style="text-transform: uppercase;">
                            <td style="text-align: left; width: 400;">                                
                                <b>[[.supplier_address.]]:</b> <label id="supplier_address"></label>                               
                            </td >
                            <td style="text-align: left; width: 200;">
                                <b>[[.supplier_phone.]]:</b> <label id="supplier_phone"></label>
                            </td>                                   
                            <td style="text-align: left; width: 200;">
                                <b>[[.product.]]:</b> <label id="quantity_product"></label></td>
                            </td>                                                                
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="8" style="">
                    ...
                    <legend class="title">[[.choose_group_by.]]</legend>
                    <label style="float: left;height: 18px; margin-top: 2px; ">[[.group_category.]] &nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <div class="multiselect">
                        <div class="selectBox" >
                          <select name="category_id_1" id="" style="height: 24px;"></select>
                          <div class="overSelect"></div>
                        </div>
                        <div id="checkboxes">
                          <!--LIST:category_name-->
                          <label >
                            <input name= "[[|category_name.name|]]" type="checkbox" id="checkbox_P_C_[[|category_name.id|]]" lang="[[|category_name.id|]]" class="itemcheckbox" onclick="FunCheckCategory(this);" style="height: 24px;" />
                            [[|category_name.indent|]]
				            [[|category_name.indent_image|]]
                            [[|category_name.name|]]
                          </label>
                            <!--/LIST:category_name-->
                        </div>
                   ...
                   <label>&nbsp;&nbsp; [[.department_recommend.]] &nbsp;&nbsp;<select name="department1" id="department1"   onchange="search_department(this)" style="height: 24px;"></select></label>
                    
                    <input style="display: none;" type="checkbox" name="chbmerge" id="chbmerge" onclick="get_product_department(this);" />
                    <label style="display: none;" for="chbmerge">[[.merge_quantity_pc.]]</label>
                    <br/>                                   
                    <div style="font-weight: bold; display: none;">[[.merge_quantity_pc_note.]]
                    </div>
                    </fieldset>
      ...
      <label class="w3-blue" style="text-transform: uppercase; padding: 3px;">[[.list_product_recommend.]]</label><br />  
     <table id="list_product" cellspacing="5" cellpadding="5" border="1" bordercolor="#DDDDDD">
                        <tr id="head_product" style="background: #DDDDDD; text-align: center; text-transform: uppercase;">
                            ...
                            <th style="white-space: nowrap;">[[.product_code.]]</th>
                            <th style="white-space: nowrap;">[[.product_name.]]</th>
                            <th>[[.DVT.]]</th>
                        ...
                        <tr id="mi_list_product_<?php echo $i; ?>"  class="items_category_id_[[|mi_list_product.category_id|]] item_department_[[|mi_list_product.portal_department_id1|]] tr-content" style="text-align: center; font-weight: normal; display: ;">
                            <th style="font-weight: normal;">
                                <input class="check_box_child check_box_child_[[|mi_list_product.category_id|]]" id="check_<?php echo $i; ?>" name="check_<?php echo $i; ?>" type="checkbox" onclick="get_total_amount();" />
                                <input id="pc_recommend_detail_id_list_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][pc_recommend_detail_id_list]" style="display: none;" value="[[|mi_list_product.pc_recommend_detail_id_list|]]" />
                            </th>
                            <th style="font-weight: normal; white-space: nowrap;text-align: left;"><input id="product_id_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][product_id]" style="display: none;" value="[[|mi_list_product.product_id|]]" />[[|mi_list_product.product_id|]] <br /><!--IF:view(User::can_view(false,ANY_CATEGORY))--><span style="margin: 0 auto; cursor: pointer;"  onclick="purchase_history(<?php echo $i; ?>)"><img  src="packages/core/skins/default/images/buttons/view.png"/></span><!--/IF:view--></th>

                            <th style="font-weight: normal; white-space: nowrap; text-align: left;"><input id="product_name_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][product_name]" style="display: none;" value="[[|mi_list_product.product_name|]]" /><div id="myDIV">[[|mi_list_product.product_name|]]</div></th>

                            <th style="font-weight: normal;"><input id="unit_id_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][unit_id]" style="display: none;" value="[[|mi_list_product.unit_id|]]" />[[|mi_list_product.unit_name|]]</th>
                            ...
                            <th style="font-weight: normal;"><input id="tax_percent_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][tax_percent]" class="ipt_style" style="width: 40px; text-align: right;" value="<?php echo [[=mi_list_product.tax_percent=]];?>" onchange="get_total_amount();CountPrice(<?php echo $i; ?>);" /></th>
                            ...
                            <th style="font-weight: normal;"><input id="delivery_date_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][delivery_date]" class="ipt_style" style="width: 60px; text-align: center;display: none;" value="<?php echo [[=mi_list_product.delivery_date=]]; ?>" readonly="" /><?php echo date('d/m/Y',[[=mi_list_product.delivery_date=]]); ?></th>
                            ...
                            <th style="font-weight: normal;width:200px "><input id="note_<?php echo $i; ?>" type="text" name="mi_list_product[<?php echo $i; ?>][note]" class="ipt_style "  style="width: auto; text-align: center;display: none" value="<?php echo [[=mi_list_product.note=]]; ?>" readonly="" /><?php echo [[=mi_list_product.note=]]; ?></th>
