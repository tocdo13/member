...
<fieldset id="report_order" style="text-align: center; width: 800px; background: #ffffff; margin: 40px auto; border: 3px solid #2ab2be; background: #09435b; box-shadow: 0px 0px 5px #09435b;">
    ...
    <div style="width: 100%; margin: 0px auto; height: 35px; text-align: center; border-bottom: 1px dashed #FFFFFF;"><h3 style="color: #ffffff; text-transform: uppercase; font-size: 30px; text-shadow: 0px 5px 5px #171717;">[[.purchases_order_from.]]</h3></div>
    <table class="tital" cellpadding="5" cellspacing="5" style="width: 95%; margin: 0px auto; text-align: left; color: #ffffff; font-size: 14px;">
        ...
        <tr>
            <td><span>[[.product_code.]] :</span> [[|product_code|]]</td>
            <td><span>[[.product_name.]] :</span> [[|product_name|]]</td>
        </tr>
        <tr>
    ...
    <table id="repot" cellpadding="5" cellspacing="5" border="3" bordercolor="#f04d4e" style="width: 95%; margin: 10px auto; text-align: left; color: #ffffff; font-size: 12px;">
        ...
        <tr style="text-align: center;">
            <td><?php echo $stt; ?></td>
            <td><a href="?page=purchases_detail&cmd=edit&id=[[|child.purchases_id|]]">ĐX_[[|child.purchases_id|]]</a></td>
            <td>[[|child.unit_name|]]</td>
            <td>[[|child.product_category_name|]]</td>
            <td>[[|child.supplier_name|]]</td>
            <td>[[|child.quantity|]]</td>
            <td style="text-align: right;"><?php echo System::display_number([[=child.price=]]); ?></td>
