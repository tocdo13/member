...
<table width="100%">
    ...
    <table>
        <tr>
            ...
            <td width="320px" align="center" style="font-size: 20px;"><strong>PHIẾU YÊU CẦU MUA HÀNG</strong><br /><span style="font-size: 12px;"><?php $date_create = explode("/",[[=recommend_date=]]); echo Portal::language('date')." ".$date_create[0]." ".Portal::language("month")." ".$date_create[1]." ".Portal::language('year')." ".$date_create[2]; ?></span></td>
    ...
    <table style="width: 100%; margin: 0px auto;">
        <tr>
            <td style="font-size: 12px;"><strong>Người yêu cầu: </strong>[[|person_recommend|]]</td>
            <td style="font-size: 12px;"><strong>Ngày yêu cầu: </strong><?php echo [[=recommend_date=]] .' ' . [[=recommend_time=]] ?></td>
        </tr>
        <tr>
            <td style="font-size: 12px;"><strong>Bộ phận: </strong>[[|department_name|]]</td>
            <td style="font-size: 12px;"><strong>Ngày giao hàng mong muốn: </strong>[[|delivery_date|]]</td>            
        </tr>
    </table>
    <table style="width: 100%; margin: 0px auto;">
        <tr>
            <td style="font-size: 12px;"><strong>Diễn giải: </strong>[[|description|]]</td>
        </tr>
    </table>
    <br />
    <table border="1" style="width: 100%; margin: 0px auto; border-collapse: collapse;">
        <tr style="text-align: center;font-size:12px;">
            ...
            <tr style="font-size:12px;">
                <td style="text-align: center; font-size:12px;">[[|products.index|]]</td>
                <td style="font-size:12px;">[[|products.product_id|]]</td>
                <td style="font-size:12px;">[[|products.product_name|]]</td>
                <td style="font-size:12px; text-align: right;">[[|products.remain_department|]]</td>
                <td style="font-size:12px; text-align: right;">[[|products.quantity|]]</td>
                <td style="font-size:12px;"></td>
                <td style="font-size:12px;">[[|products.delivery_date|]]</td>
                <td style="font-size:12px;"></td>
                <td style="font-size:12px;"></td>
                <td style="font-size:12px;"></td>
                <td style="font-size:12px;"></td>
                <td style="font-size:12px;">[[|products.note|]]</td>
            </tr>
            <!--/LIST:products-->
            <tr>
