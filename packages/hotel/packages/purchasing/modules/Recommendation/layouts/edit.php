...
<span style="display:none;">
     <span id="products_sample">
        <div id="input_group_#xxxx#" style="text-align:left;">
            ...
            <!--IF:view(User::can_view(false,ANY_CATEGORY))-->
...
<input  name="group_deleted_ids" id="group_deleted_ids" type="hidden" value="<?php echo URL::get('deleted_ids');?>">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
        <tr height="40">
            ...
            <td width="40%" align="right" nowrap="nowrap" style="padding-right: 30px;">
                <input name="save" type="submit" value="[[.Save_and_close.]]" class="w3-btn w3-orange w3-text-white" onclick="return check_input();" style="text-transform: uppercase; margin-right: 5px;"/>
                <input name="move" type="submit" value="[[.pc_move.]]" class="w3-btn w3-lime" onclick="return check_input();"style="text-transform: uppercase; margin-right: 5px;"/>
                <a href="<?php echo Url::build_current(array('group_id','act'));?>"  class="w3-btn w3-green"style="text-transform: uppercase; margin-right: 5px; text-decoration: none;">[[.back.]]</a>
                <input name="delete" type="submit" onclick="return check_delete();" value="[[.delete.]]"  class="w3-btn w3-red"style="text-transform: uppercase; "/>
            </td>
        </tr>
    </table>
            ...
            <tr valign="top">
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="2">
                        <tr>
                            <td class="label">[[.recomment_date.]]<span style="color: red;">(*)</span>:</td>
                            <td><input name="recommend_date" type="text" id="recommend_date" style="width: 80px; height: 24px;" value="<?php echo [[=recommend_date=]]?>" />
                            <input name="recommend_time" type="text" id="recommend_time" style="width: 50px; height: 24px;" value="<?php echo [[=recommend_time=]]?>"/></td>
                            <td class="label">[[.person_recomment.]]<span style="color: red;">(*)</span>:</td>
                            <td><input name="person_recommend" type="text" id="person_recommend" style="width: 150px; height: 24px; background-color: #CCC;" readonly="readonly" value="<?php echo [[=person_recommend=]]?>"/></td>
                            <td class="label">[[.department.]]<span style="color: red;">(*)</span>:</td>
                            <td >
                            <select name="department_id" id="department_id" style="width: 150px; height: 24px;background-color: #CCC;" onchange="Check_Product(); Check_Warehouse(); ChangeStyle();">
                            [[|department_list|]]
                            </select>
                            <input type="hidden" name="portal_department_id" id="portal_department_id" value="[[|department_id|]]" style=" height: 24px;" />
                            <script type="text/javascript">
                            document.getElementById("department_id").value ='<?php  echo isset([[=department_id=]])? [[=department_id=]]:'';?>';
                            </script>
                            <input name="warehouse_name" type="text" id="warehouse_name" readonly="readonly" style="background-color: #CCC; height: 24px;" />
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                            <input name="description" type="text" id="description" style="width: 770px;  height: 24px;" value="<?php echo isset([[=description=]])?[[=description=]]:'';?>" />
                    ...
                    <fieldset class="check_select_department upload" style="display: none;">
                        ...
                        <table width="1100" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
                            <tr>
                                <td style="width: 80px;"><input name="template" type="button" id="template" onclick="window.open('packages/hotel/packages/purchasing/modules/Recommendation/recommendation.rar');" value="Tải file mẫu" /></td>
                                <td style="width: 120px;"><input name="data" type="file" id="data" /></td>
                                <td><input name="check_file" type="submit" id="check_file"  value="Duyệt file" /></td>
                            </tr>
                        </table>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div>
                            <span id="products_all_elems" style="text-transform: uppercase;">
                                ...
                                <span class="multi-input-header" style="width:35px;text-align: center; height: 24px; padding-top: 4px;">[[.stt.]]</span>
                                <span class="multi-input-header" style="width:87px;text-align: center; height: 24px; padding-top: 4px;">[[.product_code.]]</span>
                                <span class="multi-input-header" style="width:155px;text-align: center; height: 24px; padding-top: 4px;">[[.name_product.]]</span>
                                <span class="multi-input-header" style="width:105px;text-align: center; height: 24px; padding-top: 4px;">[[.unit.]]</span>
                                <span class="multi-input-header" style="width:85px;text-align: center; height: 24px; padding-top: 4px;">[[.quantity.]]</span>

                                <span class="multi-input-header" style="width:105px;text-align: center; height: 24px; padding-top: 4px;">[[.delivery_date.]]</span>
                                <span class="multi-input-header" style="width:100px;text-align: center; height: 24px; padding-top: 4px;">[[.remain_product.]]</span>
                                <span class="multi-input-header" style="width:105px;text-align: center; height: 24px; padding-top: 4px;">[[.remain_total_other.]]</span>
        
                                <span class="multi-input-header" style="width:205px;text-align: center; height: 24px; padding-top: 4px;">[[.note.]]</span>
                                <span class="multi-input-header" style="width:150px;text-align: center; height: 24px; padding-top: 4px;">[[.purchase_history.]]</span>
                                <span class="multi-input-header" style="width:40px;text-align: center; height: 24px; padding-top: 4px;">[[.Delete.]]</span>
                                <br clear="all"/>
                            </span>
                        </div>
                        <div class="check_select_department after_upload" style="display: none;"><a href="javascript:void(0);" onclick="if(jQuery('#department_id').val()==0){ alert('Bạn chưa chọn bộ phận đề xuất!');document.getElementById('department_id').focus();document.getElementById('department_id').style.backgroundColor = 'yellow'; }else{mi_add_new_row('products');} change_index();refresh_remain_product();" class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; text-decoration: none; margin-top: 5px;">[[.Add.]]</a></div>     
    ...
    <input name="person_edit" type="hidden" id="person_edit" value="[[|person_edit|]]" />
</form> 
</div>
...
var get_warehouse_list =[[|get_warehouse_list|]];
