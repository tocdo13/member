...
<div class="product-report-bound">
    ...
    <div style="width:720px;">
    	<div style="text-align:center;">
    		<div class="report_title">[[.imported_report_from_supplier.]] </div><br/>
    	...
    	<div>
    		<table cellpadding="2" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" border="1" width="100%">
    			...
    			<tr bgcolor="#EFEFEF">
    				<td colspan="8" class="category-group">[[|products.create_date|]]</td>
    			...
    			<tr>
    				<td colspan="9"><strong>H&agrave;ng h&oacute;a xu&#7845;t tr&#7843; l&#7841;i </strong></td>
    			</tr>
    			<?php $create_date = '';?>
    			<!--LIST:back_products-->
    			<?php if($create_date != [[=back_products.create_date=]]){$create_date = [[=back_products.create_date=]];?>
    			<tr bgcolor="#EFEFEF">
    				<td colspan="8" class="category-group">[[|back_products.create_date|]]</td>
    			...
    			<tr bgcolor="white">
                    ...
                    <td align="right" nowrap class="report_table_column">([[|back_products.amount|]])</td>
    			</tr>
    			<!--/LIST:back_products-->
    			<!--/IF:back_products-->
                <tr bgcolor="white">
                    <td colspan="8" align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[.total.]] </strong></td>
                ...
                <tr bgcolor="white">
                    <td colspan="8" align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[.total_before_vat.]] </strong></td>
                    <td align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[|total_before_tax|]]</strong></td>
                </tr>
                <!--/IF:total_before_tax-->
                <!--IF:commission([[=commission=]])-->
                <tr bgcolor="white">
                    <td colspan="8" align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[.total_commission.]] [[|commission|]]% </strong></td>
                    <td align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[|total_commission|]]</strong></td>
                </tr>
                <tr bgcolor="white">
                    <td colspan="8" align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[.total_after_commission.]] </strong></td>
                ...
                <tr bgcolor="white">
                    <td colspan="8" align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[.shipping_fee.]] </strong></td>
                ...
                <!--IF:grand_total([[=commission=]] or [[=shipping_fee=]])--><tr bgcolor="white">
                    <td colspan="8" align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[.total_before_tax_commission.]] </strong></td>
                    <td align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[|total_before_tax_commission|]]</strong></td>
                </tr>
                <tr bgcolor="white">
                    <td colspan="8" align="right" nowrap="nowrap" bgcolor="#F1F1F1" class="report_table_column"><strong>[[.grand_total.]] </strong></td>
