...
<table cellspacing="0" width="100%">
	<tr valign="top" bgcolor="#FFFFFF">
		<td align="left">
            <table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
                    <td class="form-title" width="100%">[[.delete_product.]]</td>
                </tr>
            </table>
		</td>
	</tr>
	...
	<table>
		<tr bgcolor="#EFEFEF" valign="top">
			...
			<td nowrap align="right"><span style="line-height:24px;"><strong>[[.direct_export.]]</strong></span></td>
			<td align="center"><div style="width:10px;">:</div></td>
			<td>
				<div class="detail_box">[[|direct_export|]]</div>
			</td>
		</tr>
	<tr bgcolor="#EFEFEF" valign="top">
	...
	<tr bgcolor="#EFEFEF">
		<td>
			...
			<table>
			<tr><td>
				<?php Draw::button(Portal::language('delete_complate'),'confirm',false,true,'DeleteProductForm');?></td><td>
				<?php Draw::button(Portal::language('nouse'),'edit',false,true,'DeleteProductForm');?></td><td>
