    ...
    <div style="width:720px;">
    	...
    	<div>
            <table cellpadding="2" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" border="1" width="100%">
    			...
    			<tr bgcolor="white">
    				...
    				<td width="100" align="right" nowrap bgcolor="#F1F1F1" class="report_table_column">&nbsp;</td>
    				<td width="100" align="right" nowrap bgcolor="#F1F1F1" class="report_table_column">&nbsp;</td><td width="100" align="right" nowrap bgcolor="#F1F1F1" class="report_table_column"><strong><?php echo round([[=end_remain=]],2)?></strong></td>
    			</tr>
    		</table>
    	</div>
    	<div>
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="center" width="45%"><em>[[.date.]]: <?php echo date('d/m/Y') ?></em></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
