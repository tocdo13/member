	...
	<div style="width:100%;" >
	    ...
	    <div style="text-align:left;">
            ...
            <tr>
                ...
                <td align="right"><?php echo round([[=products.start_term_quantity=]],2);?></td>
                <td align="right">
                    <div class="price">
                    <?php $grand_total_start_term_money =  (isset([[=products.total_start_term_money=]])?round([[=products.total_start_term_money=]],2):0);
                ...
                <td align="right"><?php echo [[=products.import_number=]];?></td>
                <td align="right">
                    <div class="price">
                    <?php 
                                       $grand_total_import_money = round([[=products.total_import_money=]],2);  
                                       $total_import_money += $grand_total_import_money;  
                                       echo  System::display_number($grand_total_import_money);?>
                    </div>
                </td>
                <td align="right"><?php echo [[=products.export_number=]];?></td>
                <td align="right">
                    <div class="price">
                    <?php 
                                        $grand_total_export_money = round([[=products.total_export_money=]],2);
                                        $total_export_money += $grand_total_export_money;   
                                        echo System::display_number($grand_total_export_money);?>
                       </div>                  
                </td>
                <td align="right"><?php echo round([[=products.remain_number=]],2);?></td>
                <td  align="right">
                    <div class="price">
                    <?php
                    ...
                    echo (round([[=products.remain_number=]],2)>0)?System::display_number($total_remain_money):0; 
                    ?>
                    </div>
                </td>
            </tr>
