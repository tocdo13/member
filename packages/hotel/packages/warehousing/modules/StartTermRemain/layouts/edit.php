    ...
    <span id="mi_product_group_sample">
        <div id="input_group_#xxxx#" style="text-align:left;display:block;">
            ...
            <span class="multi-input">
                ...
                <select  name="mi_product_group[#xxxx#][units_id]" id="units_id_#xxxx#" style="display:none;width:60px;" onchange="$('unit_id_#xxxx#').value = this.value;"  tabindex="3_#xxxx#">[[|units_id|]]</select>
            </span>
            <span class="multi-input">
                ...
                <select  name="mi_product_group[#xxxx#][types_id]" id="types_id_#xxxx#" style="display:none;width:83px;" onchange="$('type_#xxxx#').value = this.value;"  tabindex="5_#xxxx#">[[|types_id|]]</select>
            </span>
            <span class="multi-input">
                ...
                <select  name="mi_product_group[#xxxx#][categorys_id]" id="categorys_id_#xxxx#" style="display:none;width:144px;" onchange="$('category_id_#xxxx#').value = this.value;"  tabindex="4_#xxxx#">[[|categorys_id|]]</select>
            </span>
            <span class="multi-input">
...
<form name="EditStartTermRemainForm" method="post">
    ...
    <table cellpadding="15" cellspacing="0" width="70%" border="0" bordercolor="#CCCCCC" class="table-bound">
        <tr>
            ...
            <?php if(User::can_add(false,ANY_CATEGORY)){?><input name="save" type="submit" value="[[.Save_and_close.]]" class="w3-btn w3-orange w3-text-white" style="text-transform: uppercase; margin-right: 5px;"/><?php }?>
            <?php if(User::can_add(false,ANY_CATEGORY)){?><input name="import_from_excel" type="button" value="[[.import_from_excel.]]" onclick="window.location='<?php echo Url::build_current(array('cmd'=>'import'));?>'" class="w3-btn w3-lime" style="text-transform: uppercase; margin-right: 5px;"/><?php }?>
            <?php if(User::can_delete(false,ANY_CATEGORY)){?><a href="<?php echo Url::build_current(array('type'));?>"  class="w3-btn w3-green" style="text-transform: uppercase; text-decoration: none;">[[.back.]]</a><?php }?>
            </td>
        </tr>
    </table>
    <div class="content">
        ...
        <fieldset>
            <legend class="title">[[.warehouse.]]</legend>
            <table border="0" cellspacing="0" cellpadding="2">
                <tr>
                    <td class="label">&nbsp;</td>
                    <td><select name="warehouse_id" id="warehouse_id" style="height: 24px;"></select></td>
                    <!--/IF:cond-->
                </tr>
            </table>
        </fieldset>    
        ...
        <fieldset>
            ...
            <span id="mi_product_group_all_elems" style="text-align:center; text-transform: uppercase;">
                <span class="multi-input-header" style="width:100px; height: 24px; padding-top: 3px;">[[.code.]]</span>
                <span class="multi-input-header" style="width:200px; height: 24px; padding-top: 3px;">[[.name.]]</span>
                <span class="multi-input-header" style="width:100px; height: 24px; padding-top: 3px;">[[.number.]]</span>
                <span class="multi-input-header" style="width:150px; height: 24px; padding-top: 3px;">[[.total_start_term_price.]]</span>
                <span class="multi-input-header" style="width:52px; height: 24px; padding-top: 3px;">[[.unit.]]</span>
                <span class="multi-input-header" style="width:82px; height: 24px; padding-top: 3px;">[[.type.]]</span>
                <span class="multi-input-header" style="width:144px; height: 24px; padding-top: 3px;">[[.category.]]</span>
                <br clear="all"/>
            </span>
            <input class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; margin-top: 5px;" type="button" value="[[.add_product.]]" onclick="mi_add_new_row('mi_product_group');myAutocomplete(input_count);jQuery('#total_start_term_price_'+input_count).FormatNumber();jQuery('#total_start_term_price_'+input_count).ForceNumericOnly();jQuery('#quantity_'+input_count).FormatNumber();jQuery('#quantity_'+input_count).ForceNumericOnly();" style="width:auto;"/>
        </fieldset>    
