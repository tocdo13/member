	...
	<div class="content">
        ...
        <table width="400" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
            ...
            <tr>
                ...
                <td><input name="from_date" type="text" id="from_date" tabindex="1" onchange="changevalue();"/></td>
            </tr>
            <tr>
                <td align="right" width="30%">[[.to_date.]]</td>
                <td><input name="to_date" type="text" id="to_date" tabindex="1" onchange="changefromday();"/></td>
            </tr>
        ...
        <table width="400" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
            <tr>
                <td bgcolor="#EFEFEF"><strong>[[.choose_department.]] :</strong></td>
            </tr>
            <tr>
                <td align="center"><select name="wh_receiver_name" id="wh_receiver_name" style="margin:0px;padding:0px;"></select></td>
            </tr>
        </table>
        <br/>
        <table width="400" border="1" cellspacing="0" cellpadding="5" bordercolor="#CCCCCC">
