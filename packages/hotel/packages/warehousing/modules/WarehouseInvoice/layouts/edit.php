		...
		<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
            <tr>
            	...
            	<td  width="40%" align="right" nowrap="nowrap" style="padding-right: 30px;">
            		<?php if(User::is_admin() or Url::get('cmd') == 'add'){ ?><input style="text-transform: uppercase; margin-right: 5px;" name="save" id="save" type="button" onclick="fun_submit('save');" value="[[.save.]]" class="w3-btn w3-blue"/><?php }?>
                    <?php if(User::is_admin() or Url::get('cmd') == 'add'){ ?><input name="save" id="save_and_input" style="text-transform: uppercase; margin-right: 5px;" type="button" onclick="fun_submit('save_and_import');" value="[[.save_and_import.]]"  class="w3-btn w3-lime"/><?php }?>
