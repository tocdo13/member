                ...
                <tr>
    				<td colspan="2"> 
                        <div style="width:100%; text-align:center;">
                            <font class="report_title specific" >[[.guest_massage_report.]]<br /></font>
...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="font-size:11px; border-collapse:collapse;">
	<tr bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" width="300px">[[.traveller_name.]]</th>
        <th class="report_table_header" width="70px">[[.invoice_date.]]</th>
        <th class="report_table_header" width="70px">[[.minuties.]]</th>
        <th class="report_table_header" width="100px">[[.status.]]</th>
        <th class="report_table_header" width="150px">[[.total_price.]]</th>
    </tr>
...
<!---------LAST GROUP VALUE----------->	        
	...
	<!--LIST:items-->
    <tr bgcolor="white">
		<td align="center" class="report_table_column"><?php echo ++$i;?></td>
        <td align="left" class="report_table_column">[[|items.traveller_name|]][[|items.traveller_name_1|]]</td>
        <td align="center" class="report_table_column"><?php echo date('d/m/Y',[[=items.time_out=]]);?></td>
        <td align="center" class="report_table_column">[[|items.minutes|]]</td>
        <td align="center" class="report_table_column">[[|items.status|]]</td>
        <td align="right" class="report_table_column"><?php echo System::display_number([[=items.total_amount=]]); ?></td>
	</tr>
	<!--/LIST:items-->
    <tr>
