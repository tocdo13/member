...
<?php }?>
<form name="SplitBarInvoiceForm" method="post">
    	...
    	<div class="search-box">
            ...
            <fieldset>
                ...
                <table border="0" cellpadding="3" cellspacing="0">
						<tr>
    						<td align="right" nowrap style="font-weight:bold">[[.select_bar.]]</td>
    						<td>:</td>
    						<td nowrap>
    							<select  name="bar_id" id="bar_id" style="width:120px;" onchange="SplitBarInvoiceForm.submit();">
                                		<option value="0">---All---</option>
                                	<!--LIST:bars-->
                                    	<option value="[[|bars.id|]]">[[|bars.name|]]</option>
                                    <!--/LIST:bars-->
                                </select>
    						</td>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolor="#CCCCCC">
            ...
            <tr class="[[|items.row_class|]]" <?php Draw::hover('#E2F1DF');?>>  
                ...
                <td style="cursor:pointer;" align="center">
                    <a href="<?php echo Url::build('touch_bar_restaurant',array('cmd'=>'edit','id'=>[[=items.id=]]));?>" target="_blank">[[|items.code|]]</a>
                </td>
...
<script type="text/javascript">
	...
	var bar_id = <?php echo (Session::get('bar_id')?Session::get('bar_id'):0);?>;
	if(bar_id>0){
