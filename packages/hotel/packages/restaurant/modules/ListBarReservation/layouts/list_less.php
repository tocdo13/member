		...
		<td align="left">
            <table cellpadding="10" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
                <tr>
                    ...
                    <?php if(User::can_view(false,ANY_CATEGORY)){?><td><a href="<?php echo Url::build('vat_bill',array('department'=>'RESTAURANT'));?>"  class="button-medium-add" target="_blank">[[.list_vat_printed.]]</a></td><?php }?>
			...
			<td>
				...
				<table width="100%" cellpadding="2" cellspacing="0" bordercolor="#CECFCE" border="1" style="border-collapse:collapse">
					<tr class="table-header">
						...
						<th align="center" width="80px">[[.table_number.]]</th>
						<th align="center" width="80px">[[.total.]]</th>
						<th align="center" width="60px">[[.time_length.]]</th>
                    ...
                    <?php
						...
						?>
					<tr bgcolor="<?php if(URL::get('just_edited_id',0)==[[=items.id=]]){ echo '#EFFFDF';} else {echo $bg_color;}?>" valign="middle" <?php Draw::hover('#EFEEEE');?> style="cursor:pointer;<?php if([[=items.status=]]=='CHECKIN'){?>font-weight:bold;<?php }?>">
                        <td><input name="selected_ids[]" type="checkbox" value="[[|items.id|]]" class="item-check-box" onclick="just_click=true;"/></td>
                        <td align="left">[[|items.arrival_date|]]</td>
                        <td align="left">[[|items.code|]]</td>
                        <td align="left">[[|items.agent_name|]]</td>
                        <td align="center">[[|items.room_name|]]</td>
                        <td align="center">[[|items.table_name|]]</td>
                        <td align="right">[[|items.total|]]</td>
                        <td align="center">[[|items.time_length|]]</td>
                        <td align="left">[[|items.status|]]</td>
