...
<span style="display:none">
	<span id="mi_bar_sample">
		<div id="input_group_#xxxx#">
            ...
            <span class="multi-input"><select  name="mi_bar[#xxxx#][department_id]" style="width:105px; height: 24px;" id="department_id_#xxxx#">[[|department_id_options|]]</select></span>    
               ...
               <span class="multi-input">
    			<select  name="mi_bar[#xxxx#][paper]" style="width:50px; height: 24px;" class="multi-edit-text-input"  id="paper_#xxxx#">
                    <option value="">[[.select_paper.]]</option>
   				    <option value="K8">[[.k8_paper.]]</option>
                    <option value="A5">[[.a5_paper.]]</option>
                    <option value="A4">[[.a4_paper.]]</option>
    			</select>
            </span> 
               <span class="multi-input">
...
<table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr height="40">
		<td width="60%" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;"><i class="fa fa-file-text w3-text-orange" style="font-size: 26px;"></i> [[.manage_bar.]]</td>
		...
		<?php if(User::can_delete(false,ANY_CATEGORY)){?><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('mi_bar');" class="w3-btn w3-red" style="text-decoration: none; text-transform: uppercase;">[[.Delete.]]</a></td><?php }?>
...
<table cellspacing="0">
	...
	<tr><td style="padding-bottom:30px">
		...
		<tr bgcolor="#EEEEEE" valign="top">
			...
			<div style="background-color:#EFEFEF;">
				<span id="mi_bar_all_elems">
					<span style="white-space:nowrap; width:auto;">
                        ...
                        <span class="multi-input-header" style="float:left;width:105px;">[[.department.]]</span>
						<span class="multi-input-header" style="float:left;width:100px;">[[.print_kitchent_name.]]</span>
                        <span class="multi-input-header" style="float:left;width:100px;">[[.kitchen_ip_address.]]</span>
						<span class="multi-input-header" style="float:left;width:100px;">[[.print_bar_name.]]</span>
                        <span class="multi-input-header" style="float:left;width:100px;">[[.bar_ip_address.]]</span>
                        <span class="multi-input-header" style="float:left;width:50px;">[[.paper.]]</span> 
                        <span class="multi-input-header" style="float:left;width:50px;">[[.area.]]</span>                                                                    
                        <span class="multi-input-header" style="float:left;width:55px;">[[.full_charge.]]</span>
                        <span class="multi-input-header" style="float:left;width:82px;">[[.full_rate.]]</span>
                        <span class="multi-input-header" style="float:left;width:100px;">[[.discount_after_tax.]]</span>
                       <!-- <span class="multi-input-header" style="float:left;width:90px;">[[.add_charge.]]</span>
			...
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('mi_bar');$('name_'+input_count).focus();jQuery('#add_charge_'+input_count).ForceNumericOnly();" class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; text-decoration: none; margin-top: 5px;">[[.Add.]]</a></div>
