			...
			<tr height="25">
				...
				<tr>
					...
					<td width="50%" align="center">
						<font style="font-size:20px;text-transform:uppercase;"><b>[[.bar_reservation_edit.]]</b></font>
					</td>
					...
					<tr>
                      ...
                      <input type="button" value="   [[.add_item.]]   " onclick="mi_add_new_row('mi_product');autocomplete('product_id_'+input_count);">                      
						  ...
						  <tr>
							...
							<td>&nbsp;</td>
                            <td align="right">&nbsp;</td>
                            <td align="right" nowrap="nowrap"><input type="checkbox" id="cb_barfee" onclick="check_barfee(); calculate_checkin();" <?php echo [[=bar_fee_rate=]]!=0?' checked':'';?>>[[.bar_fee.]]</td>
                            <td align="right" nowrap="nowrap">
