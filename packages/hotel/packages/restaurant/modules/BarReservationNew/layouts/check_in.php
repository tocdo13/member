	...
	<span id="mi_product_sample">
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    <td width="90">
                    	<input name="mi_product[#xxxx#][product_id]" type="text" id="product_id_#xxxx#" class="bar-product-id" style="width:96%;" onKeyUp="update_product(this);calculate();" onblur="update_product(this);calculate();" AUTOCOMPLETE=OFF>
                    </td>
							  ...
							  <table cellpadding="1" cellspacing="0">
								...
								<!--/LIST:category_items-->
									...
									<td width="35%" colspan="2" rowspan="9" align="left" nowrap="nowrap" bgcolor="#EFEFEF" style="border-bottom:1px 999999 #000000"><table width="100%" border="0" cellpadding="2">
									  ...
									  <tr>
									    <td align="right" nowrap="nowrap" bgcolor="#EFEFEF"><input name="checkbox"  type="checkbox" id="cb_barfee" onclick="check_barfee(<?php echo RES_SERVICE_CHARGE;?>); calculate_checkin();" <?php echo [[=bar_fee_rate=]]!=0?' checked':'';?> />
									      [[.bar_fee.]]<input name="bar_fee_rate" type="text" id="bar_fee_rate" style="text-align:right;width:28px" value="[[|bar_fee_rate|]]"  onkeyup="calculate_checkin();" onkeypress="if((event.keyCode&lt;48 || event.keyCode&gt;57) &amp;&amp; event.keyCode!=46 &amp;&amp; event.keyCode!=44)event.returnValue=false;">%</td>
										<td align="right" nowrap="nowrap" bgcolor="#EFEFEF"><input name="bar_fee" type="text" id="bar_fee" size="12" style="text-align:right" value="[[|bar_fee|]]" class="readonly_class"></td>
									  </tr>
									  <tr>
