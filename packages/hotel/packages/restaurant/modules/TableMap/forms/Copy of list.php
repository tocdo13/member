	...
	{  
		...
		$status_tables_others = DB::fetch_all('
			...
			WHERE
				...
				AND bar_reservation.arrival_time >='.Date_Time::to_time(Url::get('in_date')).' AND bar_reservation.arrival_time <'.(Date_Time::to_time(Url::get('in_date'))+24*3600).' '.$cond.'
			ORDER BY
		...
		$sql = '
			...
			WHERE
				...
				AND bar_reservation.arrival_time >='.Date_Time::to_time(Url::get('in_date')).' AND bar_reservation.arrival_time <'.(Date_Time::to_time(Url::get('in_date'))+24*3600).' '.$cond.') OR (bar_reservation.status = \'BOOKED\'
