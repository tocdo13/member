		...
		<td width="100%">
			...
			<tr>
				<td width="100%">
					...
					<form name="DeleteSelectedBarReservationForm" method="post">
			...
			<p>
			<table><tr>
				<td><?php Draw::button(Portal::language('delete_selected'),'',false,true,'DeleteSelectedBarReservationForm');?></td>
