						...
						<!--/IF:check_listproduct-->  
						  <table width="100%" border="0" cellpadding="3">
                           <tr>
                            ...
                            <td width="20%" align="right" nowrap="nowrap">[[.sumary.]]</td>
							<td width="5%">&nbsp;</td>
                          </tr>
                           <tr>
                             <td></td>
                          ...
                          <!--IF:cond_fee(String::to_number([[=bar_fee=]]))-->
						  <tr>
						    <td align="right" nowrap="nowrap"></td>
						    <td>&nbsp;</td>
						    <td>&nbsp;</td>
							...
							<td>&nbsp;</td>
                            <td align="right">&nbsp;</td>
                            <td align="right" nowrap="nowrap">[[.bar_fee.]] (5%)</td>
                            <td align="right"><span class="room_input_class" style="height:20px; width:120px; letter-spacing:1px;">[[|bar_fee|]]</span></td>
                            <td></td>
                          </tr>
						  <tr>
