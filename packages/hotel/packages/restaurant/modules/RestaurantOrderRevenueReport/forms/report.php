			...
			{			 
				$bill_id .='or payment.bill_id = '.$value['id'];
                    ...
                    if($value['discount_after_tax']==1)
                    {
                        ...
                        $after_fee = $total_before_discount-$product_discount;
                        ...
                        $report->items[$key]['total'] = $total_before_discount+$report->items[$key]['fee_rate']+$report->items[$key]['tax'];
                        
                        $report->items[$key]['total_discount_after_tax'] = ($report->items[$key]['total']*($value['discount_percent'])/100)+$value['discount'];  
                    ...
                    else
                    {
                        ...
                        //so tien giam gia   
                        $report->items[$key]['total_discount_after_tax'] = 0;                                     
                        $report->items[$key]['total_discount'] = ($total_price_dp*$value['discount_percent']/100 + $value['discount']);                    
...
//		}
		...
		foreach($items as $item)
		{
            ...
            if($temp = $item['total_discount_after_tax']){
				$this->group_function_params['total_discount_after_tax'] += $temp;
			}
