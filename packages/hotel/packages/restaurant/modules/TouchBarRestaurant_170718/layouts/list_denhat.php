                        ...
                        <table class="general-info" align="center" border="1" cellpadding="3" cellspacing="3" width="100%" >
                           ...
                           <tr>
                                ...
                                <td>
                                    ...
                                    <input name="discount" type="text" id="discount" value="[[|discount|]]" class="input_number"  maxlength="200" style="width:125px !important;text-align:right;display: none;" onkeyup="this.value=number_format(this.value);GetTotalPayment(); CheckDiscount();if(to_numeric(this.value)>0 && to_numeric(jQuery('#total_amount').val())<0){this.value='';GetTotalPayment();}" onblur="GetTotalPayment();" placeholder="[[.discount_cash.]]" /></td>
                                </td>
                            </tr>
                             <tr>
