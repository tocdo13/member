...
<div style="padding:0px;">
    ...
    <div style="float:right; width:100%;margin-right:0px;text-align:right;white-space:nowrap;margin-bottom:5px;">
        ...
        <span style="font-size:20px;text-transform:uppercase;padding-left:5px;float:left;" class="title">[[|bar_name|]]</span>
        <br />
        <span id="table_name" style="font-size:14px;text-transform:uppercase;padding-left:5px;float:left; color:#666;" class="title">[[|table_name|]]</span>
        </div>
        ...
        <input name="back" type="button" value="[[.back.]]" class="button-medium-back" onclick="window.location='<?php echo Url::build('table_map',array('bar_id'=>Session::get('bar_id'),'group'=>Url::get('bar_area_id')?Url::get('bar_area_id'):''));?>'" />
        </div>
        <div style="width: 150px; height: 45px; float: right; border: 1px solid #dddddd; text-align: center;">
        <input name="print_automatic_bill" type="checkbox" value="[[.print_automatic_bill.]]" id="print_automatic_bill" style="margin-top: 20px;" <?php if([[=print_automatic_bill=]]!=''){ echo 'checked="checked"'; } ?>  /><span style="line-height: 45px;">[[.print_automatic_bill.]]</span>
        </div>
            ...
            <table>
                <?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=0 AND [[=mice_reservation_id=]]!=''){ ?>
                        ...
                        <td align="left" style="padding-left:10px;">
                            ...
                            <input value="[[.split.]] MICE" type="button" onclick="FunctionSplitMice('[[|mice_reservation_id|]]','RES','[[|id|]]');" style="font-weight: bold; padding: 3px 10px; margin-left: 20px;" />
                        </td>
                        <td></td>
                    <?php }else{ ?>
                        <?php if([[=pay_with_room=]]!=1){ ?>
                            <td></td>
                            <!-- Minh bo add mice-->
                            <td align="right"><input value="[[.add_mice.]]" type="button" onclick="FunctionAddMice('RES','[[|id|]]');" style="font-weight: bold; padding: 3px 10px;" /></td>
                            <td align="left" style="padding-left:10px;"><input value="[[.select.]] MICE" type="button" onclick="FunctionSelectMice('RES','[[|id|]]');" style="font-weight: bold; padding: 3px 10px;" /></td>
                            <!-- Minh bo add mice-->
                            <td></td>
                        <?php } ?>
                    <?php } ?>
            ...
            <td class="info-left" id="hidden_expan" style="background:#F5F3F3;">    
              ...
              <div id="menu_extra">
                    <ul id="menu_extra_ul" style="float:right;">
                        ...
                        <li class="menu_extra_li_order1 <?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ ?>css_menu_estra_disable<?php }else{ } ?>" <?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ ?>style="cursor: default; background: rgb(214, 214, 214);"<?php }else{ } ?> id="li_deposit" onclick="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ ?>return false;<?php }else{ ?>openWindowUrl('form.php?block_id=<?php echo BLOCK_PAYMENT;?>&cmd=deposit&id=<?php if(Url::get('id')){echo Url::get('id');}else{echo '';}?>&type=BAR',Array('payment','payment_for',80,210,950,500));<?php } ?>"><img src="packages/hotel/skins/default/images/iosstyle/7.png" /></li>
                        <?php
                          if([[=status=]] && [[=status=]]!='BOOKED')
                          {  
                        ?>
                        <li class="menu_extra_li_order1 <?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ ?>css_menu_estra_disable<?php }else{ } ?>" <?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ ?>style="cursor: default; background: rgb(214, 214, 214);"<?php }else{ } ?> id="li_payment" onclick="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ ?>return false;<?php }else{ ?><?php if([[=status=]]!='CHECKOUT'){ ?>SubmitForm('payment');<?php }else{ ?>jQuery('#act').val('payment');jQuery('#password_box').show();<?php } ?><?php } ?>"><img src="packages/hotel/skins/default/images/iosstyle/8.png" /></li>
                        <?php
                          }  
                        ?>
              ...
              <!--end right-->
                ...
                <div style="margin-bottom:5px; margin-top:5px;" align="left">
                    <font style="font-size:12px; "><b>[[.total_payment_traveller.]] (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp;<input name="total_payment_traveller" id="total_payment_traveller" type="text" onkeyup=" fun_to_numer(); GetTotalPayment(); format_price_m();" value="<?php if(isset([[=total_payment_traveller=]])){echo System::display_number([[=total_payment_traveller=]]);}else{echo 0;} ?>" class="input_number" />
                </div>
                <script>
                ...
                <div id="total_mini" style="margin-bottom:5px; margin-top:5px;" align="left">
                    <font style="font-size:12px; "><b>[[.total_amount.]] (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp;<span id="amount_mini" style="font-weight: bold;">[[|remain|]]</span>
                </div>
                <div style="margin-bottom:5px; margin-top:5px;" align="left">
                    ...
                    <div id="bound_summary" class="dragclass" style="display:block; position: absolute; top:100px; left:500px;">
                        ...
                        <table class="general-info" align="center" border="1" cellpadding="3" cellspacing="3" width="100%" >
                           ...
                           <tr>
				                ...
				                <td width="1%" nowrap="nowrap">[[.discount.]](%/VND):<input name="discount_after_tax" type="checkbox" id="discount_after_tax" title="[[.discount_after_tax.]]" value="1" style="display:;" /></td>
                                <td><input name="discount_percent" type="text" id="discount_percent" value="[[|discount_percent|]]" class="input_number"  maxlength="200" style="width:30px !important;text-align:right;margin-right:5px;" onkeyup="if(to_numeric(this.value)<=100){GetTotalPayment();}else{this.value=((this.value).substr(0,((this.value).length-1)));}CheckdDiscountPercent();" /><input name="discount" type="text" id="discount" value="[[|discount|]]" class="input_number"  maxlength="200" style="width:125px !important;text-align:right; display: none;" onkeyup="this.value=number_format(this.value);GetTotalPayment(); CheckDiscount();" onblur="GetTotalPayment();" placeholder="[[.discount_cash.]]" /></td>
                            </tr>
                             <tr>
                    ...
                    <td valign="top">   
                        <table style="margin-top:20px;">
                            ...
                            <tr id="tr_return">
                                ...
                                <td> <input  name="return" type="text" id="input_radio_return" onclick="$('radio_return').checked=true;<?php if(Url::get('cmd')=='add'){?> alert('[[.khong_duoc_tra_lai_mon_chua_in_order.]]');jQuery('#input_radio_return').blur(); <?php } ?>" onchange="if(to_numeric(jQuery('#input_radio_quantity').val()) < to_numeric(jQuery('#input_radio_return').val())){ alert('[[.so_luong_tra_lai_lon_hon_so_luong_thuc_te.]]');jQuery('#input_radio_return').val(0); }" value="" style="width:100px;" class="text-right input_number" onblur="checkReturnQuantity(this);"/></td>
                            </tr>
...
<script> 
    ...
    function GetStatus(){
        ...
        if(status == 'CHECKIN'){
            ...
            jQuery('#dynamic_save_button_bound').html('<input name="cancel" type="input" value="CANCEL" onclick="SubmitForm(\'cancel\');" class="button-bar-delete" style="width:80px;" readonly="" id="cancel" >');
        ...
        if(arr['unit']=='set'){
            ...
            jQuery.ajax({
                ...
                success :function(data){
                    for(var i in data){
                        items += '<td style="display:none;"><input id="SET_'+id+'-'+data[i]["product_id"]+'" original_code="'+data[i]['product_id']+'" original_name="'+data[i]['product_name']+'" original_value="'+data[i]["original_quantity"]+'" name="set_menu_list['+id+']['+i+'][quantity]" value="'+data[i]["quantity"]+'"/></td>';
                    }
                    items += '</tr></table>'; 
    ...
    function get_set_menu_product(id){
            ...
            jQuery.ajax({
                ...
                success :function(data){
                    ...
                    var j = 1;
                    for(var i in data){
                        var value = jQuery("input#SET_"+id+"-"+data[i]['product_id']).val();                         
                        content += "<tr id='"+j+"'>"
                                +       "<td>"+j+"</td>"
                                +       "<td>"+data[i]['product_id']+"</td>"
                                +       "<td style='width:358px;'>"+data[i]['product_name']+"</td>"
                                +       "<td style='width:25px;'><input style='text-align:right; width:25px;' set_id='SET_DETAIL_"+id+"-"+data[i]['product_id']+"' set_menu_id="+id+" set_menu_product_id="+data[i]['product_id']+" original_value="+data[i]['original_quantity']+" original_code='"+data[i]['product_id']+"' original_name='"+data[i]['product_name']+"' value="+value+" /></td>"
