...
<div id="printer" style="width:300px; padding:0px; text-align:left;">
    <div class="restaurant-invoice-bound" style="width: 100%;">
        ...
        <table width="100%" cellpadding="2" cellspacing="0" border="0" bordercolor="#000000" style="font-weight: bold;">
          ...
          <tr valign="top">
            <!--
            <td width="100%" align="left" colspan="4"style="border-bottom:1px solid #B8B9BF; font-size: 17px;text-transform: capitalize;"><?php echo $i;?>. [[|product_items.product__name|]]<?php if(isset([[=product_items.chair_number=]])!='') echo '<br/>'.' Số ghế :'.[[=product_items.chair_number=]] ?></td> <!--trung add cot chair_number-->
          </tr>
          <tr>
          ...
          <tr valign="top">
          <!--
            <td width="100%" align="left" colspan="4" style="border-bottom:1px solid #B8B9BF; font-size: 17px; text-transform: capitalize;"><?php echo $i;?>. [[|product_items.product__name|]] <strong>([[.promotion.]])</strong><?php if(isset([[=product_items.chair_number=]])!='') echo '<br/>'.' Số ghế :'.[[=product_items.chair_number=]] ?></td><!--trung add cot chair_number-->
          </tr>
          <tr>
        ...
        <table width="100%" cellpadding="2" cellspacing="0" border="1" bordercolor="#000000" style="font-weight: bold; margin-top: 3px;">
            ...
            <tr>
                ...
                <td style="font-size: 15px;"><?php echo System::display_number($v['amount']); ?> <?php echo $v['currency_id'] ?></td>
            </tr>
            <?php
            }
            ?>  
