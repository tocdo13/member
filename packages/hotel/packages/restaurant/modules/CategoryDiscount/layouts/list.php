<form name="CategoryDiscountForm" method="post" action="?<?php echo htmlentities($_SERVER['QUERY_STRING']);?>">
	<div style="width:400px;float:left; margin:10px 10px 10px auto;">
    [[.category.]]: <input name="category_name" type="text" id="category_name" style="width:100px;" maxlength="200">
    [[.code.]]: <input name="category_code" type="text" id="category_code" style="width:100px;" maxlength="200">
    <input type="submit" name="search" id="search" value="[[.search.]]">
    </div>
	<?php if(User::can_edit(false,ANY_CATEGORY)){?>
		<!--IF::cond(User::can_admin(false,ANY_CATEGORY))--><div style="width: 400px; float:right; margin:10px 10px 10px auto;height:28px;"><a href="#"  class="button-medium-save" onclick="CategoryDiscountForm.submit()" style="float:right; margin-right:40px;">[[.Update.]]</a> <div style="width:50%; float:right">Chọn Bar: [[|bars|]] </div></div>
        <!--/IF::cond-->
    <?php }?>
