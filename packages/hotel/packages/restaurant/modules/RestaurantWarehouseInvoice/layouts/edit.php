...
<span style="display:none">
	<span id="mi_product_group_sample">
		<span id="input_group_#xxxx#" style="width:100%;text-align:left;">
			...
			<span class="multi-input"><input  name="mi_product_group[#xxxx#][product_id]" style="width:100px;" type="text" id="product_id_#xxxx#" onblur="getProductFromCode('#xxxx#',this.value);"></span>
...
<form name="EditRestaurantWarehouseInvoiceForm" method="post">
	...
	<div class="content">
		...
		<fieldset>
			<legend class="title">[[.products.]]</legend>
				...
				<input type="button" value="[[.add_product.]]" onclick="mi_add_new_row('mi_product_group');myAutocomplete(input_count);" style="width:auto;">
		</fieldset>	<br />
        <fieldset>
...
<script type="text/javascript">
	...
	function myAutocomplete(id)
	{
		...
		jQuery("#product_id_"+id).autocomplete(products, {
			minChars: 0,
			width: 310,
			matchContains: true,
			autoFill: false,
			...
			getProductFromCode(id,this.value);
