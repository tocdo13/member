<?php
class EditBarNoteForm extends Form
{
    function EditBarNoteForm()
    {
        Form::Form('EditBarNoteForm');
    ...
    function draw()
    {
        ...
        if(Url::get('cmd')=='edit')
        {
            $row = DB::fetch('Select * from bar_note where id = '.Url::get('id'));
