...
<table cellpadding="10" cellspacing="10">
	<tr height="40">
		<td class="form-title">[[.status_traveller_project.]]</td>
		<td><input type="submit" value="[[.Save.]]" class="w3-button w3-amber"></td>
		<td><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('status_traveller');" class="w3-button w3-pink">[[.Delete.]]</a></td>
	</tr>
</table>
...
<table cellspacing="0" width="100%">
	...
	<tr><td style="padding-bottom:30px">
		...
		<tr valign="top">
			...
			<div>
				<span id="status_traveller_all_elems">
					<span>
						...
						<span class="multi-input-header" style="width:155px; height: 40px; line-height: 40px; text-align: center;">[[.status_traveller_name.]]</span>
                        <span class="multi-input-header" style="width:155px; height: 40px; line-height: 40px; text-align: center;">[[.note.]]</span>
            ...
            <br clear="all">
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('status_traveller');$('name_'+input_count).focus();" class="w3-button w3-blue">[[.Add.]]</a></div>
...
function Confirm(index)
{
    ...
    return confirm('[[.Are_you_sure_delete_status_traveller.]]'+ status_traveller_name+'?');
}

function ConfirmDelete()
{
    return confirm('[[.Are_you_sure_delete_status_traveller_selected.]]');
}
