<span style="display:none">
    <span id="email_sample">
		<div id="input_group_#xxxx#">
            ...
            <span class="multi-input">
                <input  name="email[#xxxx#][code]" class="multi-edit-text-input code" type="text" <!--IF:Edit(!User::can_edit(false,ANY_CATEGORY))--> disabled="disabled" <!--/IF:Edit--> id="code_#xxxx#"  tabindex="-1" style="width:55px;color: red;"
                onclick="" />
            </span>
            
            <span class="multi-input">
                    <input name="choose_customer[#xxxx#][id]" class="multi-edit-text-input customer" type="button"  id="#xxxx#" style="height: 21px;" tabindex="-1" value="[[.customer.]]"
...
<form name="EditEmailForm" method="post">
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
    	<tr height="40">
    		<td width="70%" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;"><i class="fa fa-email w3-text-orange" style="font-size: 26px;"></i> [[.Group_email.]]</td>
    		<td width="30%">
                <!--IF:Edit(User::can_edit(false,ANY_CATEGORY))-->
                <input type="submit" value="[[.Save.]]" class="w3-btn w3-blue" style="text-transform: uppercase; margin-right: 5px;" />
                <!--/IF:Edit-->
            
                <!--IF:delete(User::can_delete(false,ANY_CATEGORY))-->
                <a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('email');" class="w3-btn w3-red" style="text-transform: uppercase; text-decoration: none;">[[.Delete.]]
                </a>
                <!--/IF:delete-->
            </td>
    	</tr>
            			...
            			<div>
            				<span id="email_all_elems">
            					<span>
            						...
            						<span class="multi-input-header" style="width:155px;">[[.event_name.]]</span>
                                    <span class="multi-input-header code" style="width:55px; color:red">[[.code.]]</span>
                                    <span class="multi-input-header customer" style="width:99px;">[[.customer.]]</span>
            						<span class="multi-input-header" style="width:70px; text-align: center;">[[.Delete.]]</span>
            					</span>
                                <br clear="all" />
            				</span>
            			</div>
            			 <div><a href="javascript:void(0);" onclick="mi_add_new_row('email');$('name_'+input_count).focus();jQuery('#'+i).attr('disabled','disabled').css('opacity','0.5');" class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; margin-top: 5px;">[[.Add.]]</a></div>
                        </td>
                    </tr>
                </table>
            </td>
...
<script>
    ...
    function Confirm(index)
    {
        ...
        return confirm('[[.Are_you_sure_delete_bank.]] '+ event_name+' And Email Send?');
    }
    
    
    function ConfirmDelete()
    {
        return confirm('[[.Are_you_sure_delete_bank_selected.]]'+'And Email Send');
    }
