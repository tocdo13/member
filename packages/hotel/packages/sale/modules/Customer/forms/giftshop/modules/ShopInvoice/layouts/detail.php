<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr height="25">
				...
				<tr>
					...
					<td width="50%" align="center">
						<font style="font-size:20px;text-transform:uppercase;"><b>[[.detail_title.]]</b></font>					
					</td>
					<td width="25%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
  ...
  &nbsp;</td>
					...
					<tr>
					  <td width="1%" nowrap>&nbsp;</td>
					  <td nowrap><input name="bar_name" type="text" size="20" class="room_input_class" readonly="readonly" value="[[|bar_name|]]" /></td>
					  <td nowrap>
					  <table>
						<tr>
							<td width="140">
                      ...
                      <td colspan="5"><fieldset>
						...
						<!--/LIST:product_items-->
                          ...
                          <tr>
                            ...
                            <td width="10%">&nbsp;</td>
                            <td width="7%">&nbsp;</td>
                            <td width="15%" align="right">[[.sumary.]]</td>
							<td width="20%" align="right" nowrap="nowrap"><input name="sumary" type="text" class="room_input_class" id="sumary" style="text-align:right" tabindex="1000" value="[[|sumary|]]" size="17" readonly="readonly"/></td>
							<td width="5%"></td>
                          </tr>
						  <tr>
                            <td>&nbsp;</td>
				...
				<table cellpadding=5 onDblClick="this.style.display='none'">
					<tr>
						...
						<!--IF:check_status(MAP['status']=='RESERVATION')-->
							<td><?php Draw::button(Portal::language('check_in'),URL::build_current(array('cmd'=>'check_in','id','act'=>'checkin')));?></td>
						<!--/IF:check_status-->
						...
						<!--ELSE-->
							<!--IF:check_status1(MAP['status']=='CANCELED')-->
							<td><?php Draw::button(Portal::language('set_reservation'),URL::build_current(array('cmd'=>'recover','id'=>Url::get('id'))));?></td>
							<!--ELSE-->
							<td><?php Draw::button(Portal::language('cancel'),URL::build_current(array('cmd'=>'detail','id'=>Url::get('id'),'act'=>'cancel')));?></td>
							<!--/IF:check_status1-->
							<td><?php Draw::button(Portal::language('edit'),URL::build_current(array('cmd'=>'edit','id'=>Url::get('id'))));?></td>
						<!--/IF:check_status-->
