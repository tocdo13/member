...
<input  name="group_deleted_ids" id="group_deleted_ids" type="hidden" value="<?php echo URL::get('deleted_ids');?>">
	<table cellpadding="0" cellspacing="0" width="960px" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr height="40">
        	<td width="50%" class="form-title">&nbsp &nbsp[[|title|]]</td>
            <td width="50%" style="text-align: right;">
                <?php if(User::can_add(false,ANY_CATEGORY)){?><input class="w3-btn w3-orange w3-hover-orange w3-text-white w3-hover-text-white" type="button" name="save"  value="[[.Save.]]" onclick="check_TA();" style="margin-right: 10px; padding: 5px; text-transform: uppercase;" /><?php }?>
				<input class="w3-btn w3-green w3-hover-green w3-text-white" type="button" value="[[.back.]]" onclick="window.location.href='<?php echo Url::build_current(array('group_id','act'));?>'" style="margin-right: 10px; padding: 5px; text-transform: uppercase;" />
            </td>
        </tr>
    </table>
	<div class="content" style="float: left;">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr valign="top">
            	<td>
                	<fieldset>
                    <legend class="w3-text-black w3-padding" style="text-transform: uppercase;">[[.main_infor.]] - <span style="color: red; display: none;">(*) Nguồn khách TA, OTA, KHÁCH NHÀ HÀNG, CORPORATE, BOOK QUA WEBSITE bắt buộc phải nhập Địa chỉ, Số điện thoại</span></legend>
                	<table border="0" cellspacing="0" cellpadding="2" id="style_table" style="width: 100%;">
                        ...
                        <tr class="style_tr">
                            ...
                            <td align="right">                        
                                ...
                                <input name="start_date" type="text" id="start_date" tabindex="-1" readonly="" style="border: none; float: left;" />
                                <?php }else{ ?>
                            ...
                            <td style="width: 15%;">
                                <?php if($_REQUEST['page_title']=="edit"){ ?>
                                <input name="code" type="text" id="code" tabindex="-1" readonly="" style="border: none;"/>
                                <?php }else{ ?>
                            ...
                            <td align="right" style="width: 15%;">
                                [[.style_customer.]]<span style="color: red;"> (*) </span>:
                            </td>
                            <td style="width: 15%;">
                                <select name="group_id" id="group_id" style="width:100%; height: 25px;" ></select>
                            </td>
                            <td style="width: 15%;" align="right">
                                <?php if(isset($this->map['customers'][$id]['group_id']) and ($this->map['customers'][$id]['group_id']!="WKIN")){ ?>
                                <p class="label" id="lbl_tax_code">[[.tax_code.]]<!--<span style="color: red;"> (*)  </span>-->:</p>
                            </td>
                            <td colspan="2" style="width: 15%;">
                                <input name="tax_code" type="text" id="tax_code" oninput="check_length(this.value);"  style="width:100%;"/>
                            </td>
                            <td align="right" style="width: 15%;">
                                <?php }else{ ?>                                
                                <p class="label" id="lbl_tax_code">[[.tax_code.]]:</p>
                            </td>
                            <td colspan="2" style="width: 15%;">
                                <input name="tax_code" type="text" id="tax_code" style="width:100%;"/>
                            </td>
                                <?php } ?>
                        </tr>
                        <tr class="style_tr">                            
                            <td style="width: 15%;" align="right">
                                [[.company_name_def.]]<span style="color: red;"> (*) </span>:
                            </td>
                            <td style="width: 15%;">
                                <input name="name" type="text" id="name" tabindex="-1" style="width: 100%; text-transform: uppercase;"/>
                            </td>
                            <td style="width: 15%;" align="right">
                                [[.company_name_full.]]:
                            </td>
                            <td colspan="3" style="width: 45%;">
                                <input name="def_name" type="text" id="def_name" tabindex="-1" style="width: 100%; text-transform: uppercase;"/>
                            </td>
                        </tr>
                        <tr class="style_tr">
                            <td style="width: 15%;" align="right">
                            ...
                            <td style="width: 75%;" colspan="5">
                                <input name="address" type="text" id="address" style="width:100%;" />
                            </td>
                        ...
                        <tr class="style_tr">
                            ...
                            <td style="width: 15%;">
                                <select name="country" id="country" onchange="get_city();" style="float: left; width:100%; height: 25px;"></select>
                            </td>
                            <td style="width: 15%;" align="right">
                                [[.city.]]:
                            </td>
                            <td style="width: 15%;">
                                <select name="city" id="city" style="width:100%; height: 25px;" onchange="get_district();"></select>
                            </td>
                            <td style="width: 15%;" align="right">
                                [[.district.]]:
                            </td>
                            <td style="width: 15%;">
                                <select name="district" id="district" style="width:100%; height: 25px;" ></select>
                            </td>
                        ...
                        <tr class="style_tr">
                            ...
                            <td style="width: 15%;">
                                <input name="mobile" type="text" id="mobile" oninput="check_length(this.value);"  style="width:100%;" />
                            </td>
                            <td style="width: 15%;" align="right">
                                [[.fax.]]:
                            </td>
                            <td style="width: 15%;">
                                <input name="fax" type="tel" id="fax" oninput="check_length(this.value);"  style="width:100%;"/>
                            </td>
                        </tr>
                        <tr class="style_tr">
                            <td style="width: 15%;" align="right">
                            ...
                            <td style="width: 15%;">                                
                                <input name="bank_code" type="text" id="bank_code" style="width: 100%;" />
                            </td>
                            <td style="width: 15%;" align="right">
                                [[.bank.]]:
                            </td>
                            <td style="width: 15%;">                            
                                <select name="bank_id" id="bank_id" style="float: left; width:100%; height: 25px;"></select>
                            </td>
                        ...
                        <tr class="style_tr">
                            ...
                            <td style="width: 15%;">                            
                                <select name="status" style="width:100%; height: 25px;" id="status"></select>
                            </td>
                            <td style="width: 15%;" align="right">
                                [[.creart_date.]]:
                            </td>
                            <td style="width: 15%;">                          
                                <input name="creart_date" type="text" id="creart_date" style="float: left; width: 100%; "/>
                            </td>
                            <td style="width: 15%;" align="right">
                                [[.sectors.]]:
                            </td>
                            <td style="width: 15%;">
                                <select name="sectors_id" id="sectors_id" style="width:100%; height: 25px;"></select>
                            </td>
                        </tr>
                        <tr class="style_tr">
                            <td style="width: 15%;" align="right">
                        ...
                        <tr class="style_tr">
                            ...
                            <td style="width: 15%;">
                                <select name="sale_code" id="sale_code" style="width:100%; height: 25px;"></select>
                            </td>
                            ...
                            <td>
                                <?php if($_REQUEST['page_title']=="edit"){ ?>
                                <input name="user_id" type="text" id="user_id" tabindex="-1" readonly="" style=" border: none; float: left; width:150px;"/>
                                <?php }else{ ?>
                      ...
                      <fieldset style="width: 80%; margin: 0px auto;">
                        ...
                        <table style="width: 100%;" >
                            <tr style="background: #ddd;">
                                ...
                                <th style="text-align: center;">FILE (<label id="num_file_lbl"><?php echo sizeof([[=list_file=]]); ?></label>)</th>
                            </tr>
                            <tr>
                                <td style="text-align: center;">[[.select_file.]]:<br /><input type="file" name="file" id="file" /></td>
                                <td style="border-left: 1px solid #ddd; text-align: left;">
                                    <table id="file">
                                        <!--LIST:list_file-->
                                            <tr id="tr_[[|list_file.id|]]">
                                                <td>File name: [[|list_file.file_name|]]</td>
                                                <td style="width: 50px; height: 30px; position: relative; font-family: FontAwesome;"><a href="?page=customer&cmd=download&customer_code=[[|list_file.customer_code|]]&id=[[|list_file.id|]]" target="_blank" style="height: 30px; width: auto; line-height: 30px; padding: 2px 2px; background: #00b9f2; color: #ffffff; border-radius: 5px; border: 2px solid #ffffff; box-shadow: 0px 0px 5px #000000; text-decoration: none;">[[.download.]]</a></td>
                                                <td style="width: 50px; height: 30px; position: relative; font-family: FontAwesome;"><a href="#" id="[[|list_file.id|]]" onclick="delete_file(this);" style="height: 30px; width: auto; line-height: 30px; padding: 2px 2px; background: red; color: #ffffff; border-radius: 5px; border: 2px solid #ffffff; box-shadow: 0px 0px 5px #000000; text-decoration: none;">[[.delete.]]</a></td>
                                            </tr>
                                        <!--/LIST:list_file-->
                                    </table>
                                </td>
                            ...
                            <tr style="display: none;">
                                <input name="delete_file" type="text" id="delete_file" style="display: none;" />
                            </tr>
                        </table>
                      </fieldset>
						<tr>
						...
						<fieldset>
							...
							<span>
                                <span class="multi-input-header" style="width:15%;">[[.contact_name.]]</span>
                                <span class="multi-input-header" style="width:10%;">[[.contact_brithday.]]</span>
                                <span class="multi-input-header" style="width:10%;">[[.contact_regency.]]</span>
								<span class="multi-input-header" style="width:10%;">[[.contact_phone.]]</span>
								<span class="multi-input-header" style="width:10%;">[[.contact_mobile.]]</span>
                                <span class="multi-input-header" style="width:15%;">[[.contact_email.]]</span>
                                <span class="multi-input-header" style="width:15%;">[[.contact_given.]]</span>
                                <span class="multi-input-header" style="width:10%;">[[.contact_status.]]</span>
							</span>                            
                            </span>
							<div>
                                <input type="button" value="[[.add_contact.]]" onclick="mi_add_new_row('mi_contact_group'); update_input();" class="button-medium-add"/>
                            </div>
                        </fieldset>
                        </td>
                        </tr>
