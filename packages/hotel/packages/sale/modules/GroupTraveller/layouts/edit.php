...
<table cellpadding="10" cellspacing="10">
	<tr height="40">
		<td class="form-title">[[.group_traveller_project.]]</td>
		<td><input type="submit" value="[[.Save.]]" class="w3-button w3-amber" /></td>
		<td><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('group_traveller');" class="w3-button w3-pink">[[.Delete.]]</a></td>
	</tr>
</table>
			...
			<div>
				<span id="group_traveller_all_elems">
					<span>
						...
						<span class="multi-input-header" style="width:35px; height: 45px; line-height: 45px; text-align: center;">[[.ID.]]</span>
						<span class="multi-input-header" style="width:155px; height: 45px; line-height: 45px; text-align: center;">[[.name.]]</span>
                        <span class="multi-input-header" style="width:155px; height: 45px; line-height: 45px; text-align: center;">[[.note.]]</span>
						<span class="multi-input-header" style="width:70px; height: 45px; line-height: 45px; text-align: center;">[[.Delete.]]</span>
					</span>
                    <br clear="all">
				</span>
			</div>
            <br clear="all">
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('group_traveller');$('name_'+input_count).focus();" class="w3-button w3-blue">[[.Add.]]</a></div>
...
function Confirm(index)
{
    ...
    return confirm('[[.Are_you_sure_delete_group_traveller.]]'+ group_traveller_name+'?');
}

function ConfirmDelete()
{
    return confirm('[[.Are_you_sure_delete_group_traveller_selected.]]');
}
</script>