<?php 
class MeetingCompany extends Form
{
    function MeetingCompany()
    {
        Form::Form('MeetingCompany');
		Form::Form('Meeting');
        ...
        //$this->add('product.product_id',new TextType(true,'miss_product_idiii',0,255));
...
//        $this->add('company_tax_code',new TextType(true,'miss_company_tax_code',1,255));
	...
	function draw()
	{
		...
		$promotions = DB::select_all('party_promotions','party_type_id = 5');
        $this->map['promotions'] = $promotions;
        $this->parse_layout('meeting_company',$this->map);
	}
