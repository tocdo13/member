    ...
    <tr><td width="100%">
        ...
        <fieldset>
            ...
            <div id="guest_information">
                <table width="100%" style="text-align:left;" cellpadding="5" border="0" bordercolor="#CCCCCC">
                    <tr>
                    <td >Số HD: <em style="color:red;">(*)</em></td>
                    <td colspan="3"><input name="contract_code" type="text" id="contract_code" class="input"/></td>
                    </tr>
                    <tr>
                    ...
                    <!--if COMPANY-->
                    <tr class="company">
                        <td>[[.company_name.]] <em style="color:red;">(*)</em></td>
                        <td>[[.company_address.]] <em style="color:red;">(*)</em></td>
                    </tr>
                     <tr class="company">
                    ...
                    <tr class="company">
                        <td>[[.company_phone.]] <em style="color:red;">(*)</em></td>
                        <td>[[.company_tax_code.]] <em style="color:red;">(*)</em></td>
                        <td>[[.company_representative.]]</td>
                        <td>[[.Position2.]]</td>
                    </tr>
                    <tr class="company"> 
                        <td><input name="company_phone" type="text" id="company_phone" class="input"/></td>
        ...
        <fieldset style="text-align:left;" class="meeting_info">
            ...
            <div>
                ...
                <tr>
                    ...
                    <td>[[.start_time.]] <em style="color:red;">(*)</em></td>
                    <td>[[.end_time.]] <em style="color:red;">(*)</em></td>
                    <td>[[.banquet_num_people.]] <em style="color:red;">(*)</em></td>
                </tr>
                 <tr>
               ...
               <tr>
                    ...
                    <td>[[.total_money.]] <em style="color:red;">(*)</em></td>
                    <td>[[.style_chairs.]]</td>
                </tr>
                <tr>
                    ...
                    <td><input name="style_chairs" type="text" id="style_chairs" style="text-align: right; width: 60px;" class="input" /></td>
                </tr>
                <tr>
        ...
        <fieldset style="text-align:left;" class="banquet_room">
            ...
            <div>
             <table width="100%">
                ...
                <tr>
                    <td>[[.banquet_num_people.]] <em style="color:red;">(*)</em></td>
                    <td>[[.num_table.]] <em style="color:red;">(*)</em></td>
                    <td>[[.table_reserve.]] <em style="color:red;">(*)</em></td>
                </tr>
                <tr>
        ...
        <table width="100%" border="0" cellpadding="2">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="right" nowrap="nowrap"><input name="deposit_1" type="text" id="deposit_1" style="text-align:right" size="15" maxlength="11" class="input_number format_number" onkeyup="calculate();" onfocus="calculate();getCashier1();"/></td>
            ...
            <tr bgcolor="#EFEFEF">
                <td colspan="4" bgcolor="#EEEEEE" align="center">
                    <input type="submit" name="save" value="    [[.save.]]    " tabindex="-1"/>
                    <input type="button" value="  [[.back.]]    " onclick="history.go(-1);" tabindex="-1"/>
                    <?php if(User::can_view(false,ANY_CATEGORY)) {?><input type="button" value="[[.view_contact.]]" onclick="window.location='<?php echo Url::build_current(array('cmd'=>'view_contact','id'=>Url::iget('id'))); ?>'" /><?php } ?>
                </td>
...
<script type="text/javascript">
	jQuery(document).ready(function(){  
        ...
        jQuery('#meeting_checkin_date').datepicker();
