		...
		<tr bgcolor="#F4F4F4">
    		<td bgcolor="#FFFFFF">
                ...
                <div align="left">
                    ...
                    <tr><td width="1%" align="right"><a href="#" onclick="window.location='?page=banquet_order&cmd='+$('party_type').value+'&portal=<?php echo PORTAL_ID;?>';" class="button-medium-add">Đặt tiệc</a></td></tr>
                    </table>
                </div>
    		</td>
		</tr>
