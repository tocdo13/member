		...
		<tr height="25" bgcolor="#FFFFFF">
			...
			<tr>
				...
				<td width="50%" align="center" style="padding:0px" nowrap="nowrap">
                    <font style="font-size:20px; text-transform:uppercase;">[[.meeting.]]</font>
                </td>
    		...
    		<td bgcolor="#FFFFFF">
                ...
                <div align="left">
                    <table cellpadding="3" cellspacing="0" width="100%">
                        <tr>            
                            <td>[[.banquet_category.]]: <select name="party_category" id="party_category" onchange="change_banquet_category(this.value)"></select>
            ...
            <div id="guest_information">
                <table width="100%" style="text-align:left;" cellpadding="5" border="0" bordercolor="#CCCCCC">
                    ...
                    <tr class="company"> 
                        ...
                        <td><input name="company_representative" type="text" id="company_representative" class="input"/></td>
...
<script type="text/javascript">
	...
	function MyAutocomplete(id)
	{
		jQuery("#product_id_"+id).autocomplete({
                url: 'get_product.php?bar=1&warehouse_code=NH01',
				selectFirst:false,
...
function handle_time()
{
    ...
    if(status == "CHECKIN")
    {
        ...
        jQuery("#meeting_checkin_date").val('<?php echo date('d/m/Y'); ?>');
