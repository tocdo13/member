<!---------REPORT----------->
<!--IF:check_payment_types([[=payment_types.def_code=]])-->
<style>
	.report_table_column{
		width:65px;	
	}
...
<table cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound">
	<tr valign="middle" bgcolor="#EFEFEF">
      ...
      <th width="120px" rowspan="3" class="report-table-header">[[.full_name.]]</th>
	  <th width="40px" rowspan="3" class="report-table-header" >[[.party_room.]]</th>  
...
<!---------CELLS----------->
	<tr bgcolor="white">
        ...
        <a href="<?php echo Url::build('banquet_reservation',array('cmd'=>'print_order','id'=>[[=items.id=]])); ?>">
        [[|items.code|]]</td>
