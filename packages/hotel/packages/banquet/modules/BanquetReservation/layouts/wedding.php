	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td><input name="delete_item_product" type="button" value="[[.delete.]]" class="delete_item_product_#xxxx#" onclick="mi_delete_row($('input_group_#xxxx#'),'mi_product','#xxxx#','product_');event.returnValue=false;calculate();" tabindex="-1"></td>
                </tr>
            </table>
		</span>
	</span>
	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td><input name="delete_item_product" type="button" value="[[.delete.]]" class="delete_item_product_#xxxx#" onclick="mi_delete_row($('input_group_#xxxx#'),'mi_vegetarian','#xxxx#','eating_product_');event.returnValue=false;calculate();" tabindex="-1"></td>
                </tr>
            </table>
		</span>
	</span>
	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td><input name="delete_item_product" type="button" value="[[.delete.]]" class="delete_item_product_#xxxx#" onclick="mi_delete_row($('input_group_#xxxx#'),'mi_eating_product','#xxxx#','eating_product_');event.returnValue=false;calculate();" tabindex="-1"></td>
                </tr>
            </table>
		</span>
	</span>
	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td><input name="delete_item_product" type="button" value="[[.delete.]]" class="delete_item_product_#xxxx#" onclick="mi_delete_row($('input_group_#xxxx#'),'mi_service','#xxxx#','service_');event.returnValue=false;calculate();" tabindex="-1"></td>
                </tr>
            </table>
		</span>
	</span>
	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td><input name="delete_item_product" type="button" value="[[.delete.]]" class="delete_item_product_#xxxx#" onclick="mi_delete_row($('input_group_#xxxx#'),'mi_banquet_room','#xxxx#','banquet_room_');event.returnValue=false;calculate();" tabindex="-1"></td>
                    <!--/IF:cond-->
                </tr>
            </table>
		</span>
    ...
    <tr><td width="100%">
    		...
    		<td bgcolor="#FFFFFF">
                ...
                <div align="left">
                    <table cellpadding="3" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td>
                                <?php if(Url::get('action')=='edit' and [[=use_mice=]]==1){ ?>
				<table>
            ...
            <div id="guest_information">
                <table width="100%" style="text-align:left;" cellpadding="5" border="0" bordercolor="#CCCCCC">
                    ...
                    <tr class="wedding">
                        ...
                        <td><input name="representative_phone" type="text" id="representative_phone" class="input_number no-copy-paste"/></td>
                        <td colspan="2"><input name="representative_address" type="text" id="representative_address"/></td>
                    </tr>
                </table>
            </div>
        </fieldset>
        ...
        <fieldset style="text-align:left;" class="banquet_room">
            ...
            <table width="100%">
                ...
                <tr>
                    <td><input name="checkin_date" type="text" id="checkin_date"  style="text-align: right; width: 70px;"/></td>
            ...
            <span id="mi_product_all_elems" style="padding:0px;">             
                ...
                <table width="100%" border="1" cellpadding="2" bordercolor="#999999">
                    <tr bgcolor="#EFEFEF">
                        ...
                        <td style="width: 195px;" align="right" nowrap="nowrap">[[.price.]]</td>
