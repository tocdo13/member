            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
					...
					<td width="100px" class="room_price"  <?php echo Url::get('party_category')=='FULL_PRICE'?'style="display:none;"':'';?> align="right">
                        <input name="mi_banquet_room[#xxxx#][total]" type="text" id="total_#xxxx#" class="input_number format_number" style="width:100px;text-align:right;" tabindex="-1" onkeyup="calculate(1);" group="ROOM"/>
                    </td>
                    <td width="250px">
...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
    <tr><td width="100%">
		...
		<tr height="25" bgcolor="#FFFFFF">
			...
			<tr>
				...
				<td width="50%" align="center" style="padding:0px" nowrap="nowrap">
                    <font style="font-size:20px; text-transform:uppercase;">[[.other_party.]]</font>
                </td>
        ...
        <fieldset>
            ...
            <div align="right"><img src="packages/core/skins/default/images/buttons/node_open.gif" width="15px" style="cursor:pointer" id="img_close" /></div>
            <div id="guest_information">
                <table width="100%" style="text-align:left;" cellpadding="5" border="0" bordercolor="#CCCCCC">
                    ...
                    <tr>
                        ...
                        <td ><input name="bill_number" type="text" id="bill_number" style="width:100%;" class="input"/></td>
                    </tr>
                    <tr>
                        <td>[[.cmt.]]</td>
                        <td>[[.agent_phone.]]</td>
                    ...
                    <tr class="other">
                        <td><input name="party_of_name" type="text" id="party_of_name"/></td>
                    ...
                    <tr class="other">
                        <td><input name="representative_phone" type="text" id="representative_phone" class="no-copy-paste"/></td>
        ...
        <table width="100%" border="0" cellpadding="2">
            ...
            <tr bgcolor="#EFEFEF">
                <td colspan="4" bgcolor="#EEEEEE" align="center">
                    <input type="submit" name="save" value="[[.save.]]" tabindex="-1" id="save" onclick="return check_value();" /> <!-- oanh add su kien thong bao loi khi save -->
...
//Oanh add kiem tra, dua ra thong bao thoi gian checkin, check out 
