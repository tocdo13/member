...
<table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr height="40">
		<td width="60%" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;"><i class="fa fa-file-text w3-text-orange" style="font-size: 26px;"></i> [[.manage_party_room.]]</td>
		...
		<?php if(User::can_delete(false,ANY_CATEGORY)){?><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('party_room');" class="w3-btn w3-red" style="text-transform: uppercase; text-decoration: none;">[[.Delete.]]</a></td><?php }?>
	</tr>
</table>
			...
			<div style="background-color:#EFEFEF;">
				<span id="party_room_all_elems">
					<span style="white-space:nowrap; width:auto; text-transform: uppercase;">
						...
						<span class="multi-input-header" style="float:left;width:30px; height: 24px; padding-top: 5px;">[[.order_number.]]</span>
						<span class="multi-input-header" style="float:left;width:30px; height: 24px; padding-top: 5px;">[[.code.]]</span>
						<span class="multi-input-header" style="float:left;width:150px; height: 24px; padding-top: 5px;">[[.banquet_room_name.]]</span>
                        
   						<span class="multi-input-header" style="float:left;width:100px; height: 24px; padding-top: 5px;">[[.group.]]</span>
                        <span class="multi-input-header" style="float:left;width:300px; height: 24px; padding-top: 5px;">[[.room_address.]]</span>
						<span class="multi-input-header" style="float:left;width:100px; height: 24px; padding-top: 5px;">[[.price.]]</span>
                        <span class="multi-input-header" style="float:left;width:100px; height: 24px; padding-top: 5px;">[[.price_half_day.]]</span>
                        <span class="multi-input-header" style="float:left;width:30px; height: 24px; padding-top: 5px;">[[.num.]]</span>                                                    
						<span class="multi-input-header" style="float:left;width:70px;text-align:center; height: 24px; padding-top: 5px;">[[.Delete.]]?</span>
						<br clear="all">
					</span>
				</span>
			</div>
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('party_room');$('name_'+input_count).focus();jQuery('#price_'+input_count).ForceNumericOnly();jQuery('#price_half_day_'+input_count).ForceNumericOnly();jQuery('#price_'+input_count).FormatNumber();jQuery('#price_half_day_'+input_count).FormatNumber();" class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; text-decoration: none; margin-top: 5px;">[[.Add.]]</a></div>
...
function Confirm(index){
	...
	return confirm('[[.Are_you_sure_delete_party_room_name.]] '+ party_room_name+'?');
}
var DeleteMessage = '[[.Delete_party_room_which_is_used_cause_error_for_report_and_statistic.]]\n';
DeleteMessage += '[[.You_should_delete_when_you_sure_party_room_that_you_choose_never_in_used.]]';
