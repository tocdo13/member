	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
					...
					<td style="width: 60px;">
                        <input  style="width:72px;" name="mi_product[#xxxx#][unit]" type="text" id="unit_#xxxx#" class="readonly_input" tabindex="-1"/>
                    </td>
                    ...
                    <td width="46px" class="room_discount_percent" align="right">
                        <input name="mi_product[#xxxx#][discount_percent]" type="text" id="discount_percent_#xxxx#" class="input_number format_number" style="width:46px;text-align:right;" tabindex="-1" onkeyup="calculate(1);" group="ROOM"/>
                    </td>
                    <td style="width: 190px;" align="right"><input name="mi_product[#xxxx#][total]" type="text" id="total_#xxxx#" style="text-align:right;width:147px;" readonly="readonly" class="readonly_input" tabindex="-1" group="MENU"/></td>
	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td width="180"><input name="mi_vegetarian[#xxxx#][name]" type="text" id="name_#xxxx#" style="width:170px;"  class="readonly_input" tabindex="-1"/></td>
					<td width="60">
                        <input name="mi_vegetarian[#xxxx#][unit]" type="text" id="unit_#xxxx#" style="width:72px;"  class="readonly_input" tabindex="-1"/>
                    </td>
					...
					<td style="width: 105px;" align="right"><input name="mi_vegetarian[#xxxx#][price]" type="text" id="price_#xxxx#" 
                        ...
                        style="text-align:right;width:186px;" tabindex="-1" onchange="UpdatePriceOutSide(this,$('product_id_#xxxx#'),$('quantity_#xxxx#'),$(total_#xxxx#));"/></td>
                    <td width="46px" class="room_discount_percent" align="right">
                        <input name="mi_vegetarian[#xxxx#][discount_percent]" type="text" id="discount_percent_#xxxx#" class="input_number format_number" style="width:46px;text-align:right;" tabindex="-1" onkeyup="calculate(1);" group="ROOM"/>
                    </td>
	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td width="180"><input name="mi_eating_product[#xxxx#][name]" type="text" id="name_#xxxx#" style="width:170px;" class="readonly_input" tabindex="-1"/></td>
					<td width="60">
                        <input name="mi_eating_product[#xxxx#][unit]" type="text" id="unit_#xxxx#" style="width:72px;"  class="readonly_input" tabindex="-1"/>
                    </td>
					...
					<td style="width: 105px;" align="right"><input name="mi_eating_product[#xxxx#][price]" type="text" id="price_#xxxx#" 
                        ...
                        style="text-align:right;width:186px;" tabindex="-1" onchange="UpdatePriceOutSide(this,$('product_id_#xxxx#'),$('quantity_#xxxx#'),$(total_#xxxx#));"/></td>
                    <td width="46px" class="room_discount_percent" align="right">
                        <input name="mi_eating_product[#xxxx#][discount_percent]" type="text" id="discount_percent_#xxxx#" class="input_number format_number" style="width:46px;text-align:right;" tabindex="-1" onkeyup="calculate(1);" group="ROOM"/>
                    </td>
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
					...
					<td style="width: 105px;" align="right"><input name="mi_service[#xxxx#][price]" type="text" id="price_#xxxx#" 
                        ...
                        style="text-align:right;width:186px;" tabindex="-1" onchange="UpdatePriceOutSide(this,$('product_id_#xxxx#'),$('quantity_#xxxx#'),$(total_#xxxx#));"/></td>
                    <td width="46px" class="room_discount_percent" align="right">
                        <input name="mi_service[#xxxx#][discount_percent]" type="text" id="discount_percent_#xxxx#" class="input_number format_number" style="width:46px;text-align:right;" tabindex="-1" onkeyup="calculate(1);" group="ROOM"/>
                    </td>
	    ...
	    <span id="input_group_#xxxx#">    
            ...
            <table width="100%" cellpadding="2" border="1" bordercolor="#999999" style="border-top:1px solid #FFFFFF;">
                <tr>
                    ...
                    <td width="180px">
                        <input name="mi_banquet_room[#xxxx#][group_name]" type="text" id="group_name_#xxxx#" readonly="readonly" style="width:170px;" class="readonly_input" tabindex="-1"/>
                    </td>
                        <input name="mi_banquet_room[#xxxx#][total]" type="text" id="total_#xxxx#" style="display: none;" />
                    <td width="100px" class="room_price"  <?php echo Url::get('party_category')=='FULL_PRICE'?'style="display:none;"':'';?> align="right">
                        <input name="mi_banquet_room[#xxxx#][price]" type="text" id="price_#xxxx#" class="input_number format_number" style="width:104px;text-align:right;" tabindex="-1" onkeyup="calculate();" group="ROOM"/>
                    </td>
                    <td width="50px" class="room_discount_percent" align="right">
                        <input name="mi_banquet_room[#xxxx#][discount_percent]" type="text" id="discount_percent_#xxxx#" class="input_number format_number" style="width:50px;text-align:right;" tabindex="-1" onkeyup="calculate();" group="ROOM"/>
                    </td>
                    <td width="250px">
    ...
    <tr><td width="100%">
    		...
    		<td bgcolor="#FFFFFF">
                ...
                <div align="left">
                    <table cellpadding="3" cellspacing="0" width="100%">
                        <tr>            
                            <td>
                            	[[.time_type.]]: <select name="time_type" id="time_type" onchange="calculate();" style="padding: 5px;"></select>
                            </td>
                            <td align="right">[[.status.]] <em style="color:red;">(*)</em>: <select name="status" id="status" onchange="handle_time();show_cancel_charge();" style="padding: 5px;"></select></td>
                        </tr>
                        <tr>
                            <td>
				...
				<?php } ?>                            
                            ...
                            <td align="right">
                                <label>[[.booking_cut_off_date.]]: </label>
                                <input name="cut_of_time" type="text" id="cut_of_time" style="text-align: center; width: 35px; padding: 5px;" />
                                <input name="cut_of_date" type="text" id="cut_of_date" style="text-align: center; width: 80px; padding: 5px;" />
                                <label>[[.confirm.]]: </label>
                                <input name="confirm" type="checkbox" value="confirm_cut_of_date" <?php if(isset([[=confirm=]]) AND [[=confirm=]]==1){ echo 'checked="checked"'; } ?> />
                                
                            </td>
                        </tr>
                        <tr>
                            <td id="cancel_charge" colspan="2" style="text-align: right;display: none;">
                            [[.cancel_charge.]]:
                            <input name="cancel_charge_percent" type="text" id="cancel_charge_percent" oninput="cancel_percent();" size="3" style="text-align: right;"/>%&nbsp;&nbsp;&nbsp;
                            <input name="cancel_charge_amount" type="text" id="cancel_charge_amount" oninput="cancel_amount();" size="15" class="input_number format_number" style="text-align: right;"/>[[.amount.]]
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div id="guest_information">
                <table width="100%" style="text-align:left;" cellpadding="5" border="0" bordercolor="#CCCCCC">
                    ...
                    <tr>
                        ...
                        <!--Oanh add nguon khach -->
                        <td >
                            <input  name="customer_name" type="text" id="customer_name" value="[[|customer_name|]]" class="input" onfocus="customerAutocomplete();" /> 
                            <input name="customer_id" type="hidden" id="customer_id" class="input"/>
                            <!--IF:pointer(User::can_edit(false,ANY_CATEGORY))-->
                            <a href="#" onclick="window.open('?page=customer&amp;action=select_customer&type=banquet','customer')">  
                                <img src="skins/default/images/cmd_Tim.gif" />
                            </a> 
                            <img width="15" src="packages/core/skins/default/images/buttons/delete.gif" onclick="$('customer_name').value='';$('customer_id').value=0;$('customer_address').value='';" style="cursor:hand;"/>
                           <!--/IF:pointer-->
                        </td> 
                    ...
                    <tr>
                        ...
                        <td><input name="email" type="text" id="email" style="width:100%;" class="input"/></td>
                    </tr>                  
                    <!--if WEDDING-->
                    <tr class="wedding">
                        <td>[[.groom_name.]]</td>
            ...
            <span id="mi_banquet_room_all_elems" style="padding:0px;">
                <table width="100%" border="1" cellpadding="2" bordercolor="#999999">
                    <tr bgcolor="#EFEFEF">
                        ...
                        <td width="50px">[[.discount_percent.]]</td>
        ...
        <fieldset style="text-align:left;" class="banquet_menu">
            ...
            <p><b>[[.eating_menu.]]</b></p>
             ...
             <!--Phục vụ đồ chay--> 
                ...
                <!-- Oanh comment do lay sai MyAutocomplete
                ...
                -->
                <input type="button" value="   [[.add_product.]]   " onclick="mi_add_new_row('mi_vegetarian');MyAutocomplete(input_count,'PRODUCT');jQuery('#quantity_'+input_count).ForceNumericOnly();jQuery('#quantity_'+input_count).FormatNumber();"/>
                <!--//Phục vụ đồ chay--> 
                <br /> 
            ...
            <span id="mi_product_all_elems" style="padding:0px;">             
                ...
                <table width="100%" border="1" cellpadding="2" bordercolor="#999999">
                    <tr bgcolor="#EFEFEF">
                        ...
                        <td style="width: 190px;" align="right" nowrap="nowrap">[[.price.]]</td>
                        <td width="50px">[[.discount_percent.]]</td>
                        <td style="width: 190px;" align="right" nowrap="nowrap">[[.total.]]</td>
                        <td></td>
                    </tr>
                </table>
                <!--//Phục vụ đồ uống--> 
        ...
        <table width="100%" border="0" cellpadding="2">
            <tr>
                ...
                <td colspan="3" width="50%" align="right" nowrap="nowrap">[[.summary.]]</td>
            </tr>
            <tr>
                <td width="50%" align="right"></td>
                <td colspan="3" align="right" nowrap="nowrap"><input name="summary" type="text" id="summary" readonly="readonly" style="text-align:right;" class="readonly_class" /></td>
            </tr>
            <!-- Oanh add giam gia tong hoa don-->
            <tr>
                <td colspan="4" align="right" nowrap="nowrap" onkeyup="calculate();">
                    [[.discount_before_tax.]]: 
                    <input name="discount_percent" type="text" id="discount_percent"  style="text-align:right; width: 30px;" class="input_number format_number" oninput="cancel_percent();" />(%)
                    &nbsp;&nbsp;
                    <input name="discount" type="text" id="discount"  style="text-align:right;width: 90px;"    oninput="cancel_amount();"/>(VNĐ)
                </td>
            </tr>
            <!-- End Oanh giam gia tong hoa don -->
            <tr>
                <td width="50%" align="right">&nbsp;</td>
                <td colspan="3" align="right" nowrap="nowrap">[[.service_rate.]]</td>
            </tr>                          
            <tr>
                <td width="50%">&nbsp;</td>
                <td colspan="3" align="right" nowrap="nowrap"><select name="service_rate" id="service_rate" onchange="calculate();"></select> <input name="service_total" type="text" id="service_total"  readonly="readonly" style="text-align:right;" class="readonly_class"   /></td>
            </tr>
            <tr>
                <td width="50%" align="right">&nbsp;</td>
                <td colspan="3" align="right" nowrap="nowrap">[[.tax.]]</td>
            </tr>                          
            <tr>
                
                <td width="50%" align="right">&nbsp;</td>
                <td colspan="3" align="right" nowrap="nowrap"><select name="vat" id="vat" onchange="calculate();"></select> <input name="tax_total" type="text" id="tax_total"  readonly="readonly" style="text-align:right;" class="readonly_class"   /></td>
            </tr>
              <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">                        
 
                <td width="50%" nowrap="nowrap"></td>
                <td width="15%">[[.deposit_1.]]</td>
                <td width="20%">[[.cashier.]] 1</td>
                <td width="15%">[[.deposit_1_date.]]</td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">
                <td width="50%" nowrap="nowrap"></td>
                <td width="15%"><input name="deposit_1" type="text" id="deposit_1" style="text-align:right" size="15" maxlength="11" class="input_number format_number" onkeyup="calculate();getCashier1();"/></td>
                <td width="20%"><input name="cashier_1" type="text" id="cashier_1" readonly="readonly"  /></td>
                <td width="15%"><input name="deposit_1_date" type="text" id="deposit_1_date" style="text-align:right" size="15" maxlength="11" class="deposit_date"/></td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">                        
                <td width="50%" nowrap="nowrap">&nbsp;</td>
                <td width="15%">[[.deposit_2.]]</td>
                <td width="20%">[[.cashier.]] 2</td>
                <td width="15%">[[.deposit_2_date.]]</td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">
                <td>&nbsp;</td>
                <td width="15%"><input name="deposit_2" type="text" id="deposit_2" style="text-align:right" size="15" maxlength="11" class="input_number format_number" onkeyup="calculate();getCashier2();"/></td>
                <td width="20%"><input name="cashier_2" type="text" id="cashier_2" readonly="readonly"  /></td>
                <td width="15%"><input name="deposit_2_date" type="text" id="deposit_2_date" style="text-align:right" size="15" maxlength="11" class="deposit_date"/></td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">                        
                <td width="50%">&nbsp;</td>
                <td width="15%">[[.deposit_3.]]</td>
                <td width="20%">[[.cashier.]] 3</td>
                <td width="15%">[[.deposit_3_date.]]</td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">
                <td width="50%">&nbsp;</td>
                <td width="15%"><input name="deposit_3" type="text" id="deposit_3" style="text-align:right" size="15" maxlength="11" class="input_number format_number" onkeyup="calculate();getCashier3();"/></td>
                <td width="20%"><input name="cashier_3" type="text" id="cashier_3" readonly="readonly"  /></td>
                <td width="15%"><input name="deposit_3_date" type="text" id="deposit_3_date" style="text-align:right" size="15" maxlength="11" class="deposit_date"/></td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">                        
                <td width="50%">&nbsp;</td>
                <td width="15%">[[.deposit_4.]]</td>
                <td width="20%">[[.cashier.]] 4</td>
                <td width="15%">[[.deposit_4_date.]]</td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo "display: none;"; } ?>">
            <tr>
                <td width="50%">&nbsp;</td>
                <td width="15%"><input name="deposit_4" type="text" id="deposit_4" style="text-align:right" size="15" maxlength="11" class="input_number format_number" onkeyup="calculate();getCashier4();"/></td>
                <td width="20%"><input name="cashier_4" type="text" id="cashier_4" readonly="readonly"  /></td>
                <td width="15%"><input name="deposit_4_date" type="text" id="deposit_4_date" style="text-align:right" size="15" maxlength="11" class="deposit_date"/></td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo ""; } ?> display: none;">
                <td width="50%">&nbsp;</td>
                <td width="15%">[[.advance_payment.]]</td>
                <td width="20%">[[.cashier.]]</td>
                <td width="15%">[[.date.]] [[.advance_payment.]]</td>
            </tr>
            <tr style="<?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=''){ echo ""; } ?> display: none;">
                <td width="50%">&nbsp;</td>
                <td width="15%"><input name="advance_payment" type="text" id="advance_payment" style="text-align:right" size="15" maxlength="11" class="input_number format_number" onkeyup="calculate();getCashier5();"/></td>
                <td width="20%"><input name="advance_payment_cashier" type="text" id="advance_payment_cashier" readonly="readonly"  /></td>
                <td width="15%"><input name="advance_payment_date" type="text" id="advance_payment_date" style="text-align:right" size="15" maxlength="11" class="deposit_date"/></td>
            </tr>
            <tr>
                <td width="50%">Người đặt: [[|creater|]]</td>
                <td colspan="3" align="left" nowrap="nowrap"><span>[[.payment_info.]]</span><span style="text-align: right;">[[.sum_total.]]</span></td>
            </tr>
            <tr>
                <td width="50%"></td>
                <td colspan="3" align="right" nowrap="nowrap">
                    <input name="payment_info" type="text" id="payment_info" size="33"/>
                    <input name="sum_total" type="text" id="sum_total" style="text-align:right" readonly="readonly" class="readonly_class" tabindex="-1"/>
                </td>
            </tr>
            <tr bgcolor="#EFEFEF">
                <td colspan="4" bgcolor="#EEEEEE" align="center">
                    <?php if([[=night_audit_date=]] ==''){?>
		    <?php if([[=close_mice=]]==0){ ?>
                    <input type="submit" name="save" value="[[.save.]]" tabindex="-1" id="save" style="padding: 5px;" onclick="return check_value();"/>
		    <?php }?>	
                    <?php }?>
                    <input type="button" value="[[.back.]]" onclick="history.go(-1);" tabindex="-1" style="padding: 5px;"/>
                </td>
			</tr>
        </table>
        </div>
...
<script type="text/javascript">
    ...
    jQuery("#customer_name").autocomplete({
             ...
             get_customer(item.data[0]);
            }
        });
    }
    function get_customer(value)
    {
...
function getCashier5()
{
    jQuery("#advance_payment_cashier").val('<?php $user = Session::get('user_data'); echo $user['full_name'];?>');
}
function cancel_percent()
{
    if(jQuery('#discount_percent').val()<0 || jQuery('#discount_percent').val() >100)
    {
        alert('[[.giam_gia_phai_lon_hon_0_va_nho_hon_100.]]');
        return false;
    }
    else
    {
        if(jQuery('#discount_percent').val()!=0)
        {
            jQuery('#discount').val('');
        }
    }
...
{
    if(jQuery('#discount').val()!=0)
    {
        jQuery('#discount_percent').val('');
    }
    
    var discount_amount = jQuery('#discount').val();
    var summary = jQuery('#summary').val()
    if(to_numeric(discount_amount)>to_numeric(summary))
    {
         alert('[[.giam_gia_khong_duoc_lon_hon_tong_tien.]]<br/>[[.moi_nhap_lai.]]');
         return false;
    }
}
if(jQuery('#status').val()=='CANCEL')
    {
        jQuery('#cancel_charge').css('display','');
    }
function show_cancel_charge()
{
    if(jQuery('#status').val()=='CANCEL')
    {
        jQuery('#cancel_charge').css('display','');
    ...
    else
    {
        ...
        jQuery('#cancel_charge_amount').val('');
        jQuery('#cancel_charge_percent').val('');
    }
}

//Oanh add kiem tra, dua ra thong bao loi thoi gian checkin checkout
