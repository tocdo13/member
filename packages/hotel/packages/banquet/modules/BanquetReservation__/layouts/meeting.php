            ...
            <div>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><input name="style_chairs" type="text" id="style_chairs" style="text-align: right; width: 60px;" value="[[|style_chairs|]]"/></td>
                </tr>
...
//Oanh add kiem tra, dua ra thong bao thoi gian checkin, checkout
function check_value()
{
    ...
    else
    {
        ...
        if(to_numeric(num_checkout)<= to_numeric(num_check_in))
        {
            ...
            document.getElementById('meeting_checkout_hour').focus();
