...
<table cellpadding="4" cellspacing="0" width="100%" style="#width:99%;margin-top:2px;" border="1" bordercolor="#E7E7E7" align="center">
	<tr bgcolor="#EFEFEF" valign="top">		
        ...
        <th width="1%"><input type="button"  value="[[.privilege_list.]]" onclick="window.location='<?php echo Url::build('privilege');?>'" class="button-medium-back"></th>
    </tr>
</table>
<table cellpadding="4" cellspacing="0" width="100%" style="#width:99%;margin-top:2px;" border="1" bordercolor="#E7E7E7" align="center">
  <tr>
    <td width="17%" valign="top">
    	<input name="privilege_id" type="hidden" id="privilege_id" size="40">
        [[.Privilege_name.]] : <strong>[[|privilege_name|]]</strong> -- 
		[[.portal_name.]]:
		<input name="portal_id" type="hidden" id="portal_id" /><strong>[[|portal_name|]]</strong>
       </td>
    </tr>
    ...
    <td width="17%" valign="top">
		...
		<tr bgcolor="#EFEFEF" align="center">
			<th width="6%" nowrap="nowrap"><a href="javascript:void(0)" onclick="select_all_module('show');">[[.view.]]</a><br /><input name="select_all"  type="checkbox" id="show" class="column_select_all" onclick="select_all_module('show');"></th>
			<!--<th width="6%" nowrap="nowrap"><a href="javascript:void(0)" onclick="select_all_module('view');">[[.view.]]</a><br /><input name="select_all" type="checkbox" id="view" class="column_select_all" onclick="select_all_module('view');"></th>-->
			<th width="6%" nowrap="nowrap"><a href="javascript:void(0)" onclick="select_all_module('add');">[[.add.]]</a><br /><input name="select_all" type="checkbox" id="add" class="column_select_all" onclick="select_all_module('add');"></th>
			<th width="6%" nowrap="nowrap"><a href="javascript:void(0)" onclick="select_all_module('edit');">[[.edit.]]</a><br /><input name="select_all" type="checkbox" id="edit" class="column_select_all" onclick="select_all_module('edit');"></th>
			<th width="6%" nowrap="nowrap"><a href="javascript:void(0)" onclick="select_all_module('delete');">[[.delete.]]</a><br /><input name="select_all" type="checkbox" id="delete" class="column_select_all" onclick="select_all_module('delete');"></th>
			<th width="3%" nowrap="nowrap"><a href="javascript:void(0)" onclick="select_all_module('admin');">[[.admin.]]</a><br /><input name="select_all" type="checkbox" id="admin" class="column_select_all" onclick="select_all_module('admin');"></th>
		  ...
		  <tr  style="cursor:hand;<?php if(!($i%2)){echo 'background-color:'.'#EFEFEF';}?>"  <?php Draw::hover('#EFEFEF');?>>	
			...
			<?php if(isset($_REQUEST['privilege_group_id_'.[[=items.id=]].'_'])){?>
			<input name="privilege_group_id_[[|items.id|]]_"  value="<?php echo Url::get('privilege_group_id_'.[[=items.id=]].'_');?>" type="hidden">
			<?php }?>			</td>
			...
			<td align="center"><input name="select_all_[[|items.id|]]_" <?php if(Url::get('select_all_'.[[=items.id=]].'_')){echo 'checked="checked"';}?> type="checkbox" id="select_all_[[|items.id|]]_" class="select_all_check_column" onclick="select_all_column('[[|items.id|]]')"></td>
		  </tr>
  		  <!--/LIST:items-->
		</table>
	</td>
