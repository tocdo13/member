    ...
    <!--start: module -->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2" align="left">
            <tr>
                ...
                <td><input name="title_module" type="text"  id="title_module" readonly="readonly" style="width:80%; height: 26px; background-color: #EDE8E4; border: 0px;" /></td>                              
            </tr>
            <tr>
                <td valign="top"><span style="font-weight: bold;">Mô tả quy trình:</span></td>
                <td><textarea name="description_module"  id="description_module" rows="5" readonly="readonly" style="padding:0px;margin:0px;width:98%; height: 250px; background-color: #EDE8E4; border: 0px;" ></textarea></td>                              
            </tr>
            <tr>
                <td valign="top"><span style="font-weight: bold;">Ghi chú:</span></td>
                <td><textarea name="note_module"  id="note_module" rows="5" readonly="readonly" style="padding:0px;margin:0px;width:80%; height: 100px; background-color: #EDE8E4; border: 0px;"></textarea></td>                              
            </tr>
        </table>
        ...
        <fieldset>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2" align="left">
                ...
                <tr>
                    <td valign="top"><span style="font-weight: bold;">Mô tả quy trình:</span></td>
                    <td><textarea name="description_form"  id="description_form" onkeyup="textAreaAdjust(this)"  rows="5" readonly="readonly" style="padding:0px;margin:0px;width:98%; height: 250px; background-color: #EDE8E4;" >[[|items.description_form|]]</textarea></td>                              
                </tr>
