...
<form name="ViewModuleForm" method="post">
    <table cellpadding="0" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
        <tr height="40">
            <td width="80%" class="form-title"><?php if(Url::get('cmd')=='edit_module'){ echo 'Cập nhật '; }else { echo 'Thêm mới ';}?> module <strong style="color: blue; font-weight: bold;"><?php if(isset($_REQUEST['name'])) { echo $_REQUEST['name']; }?></strong></td>
            <td class="form_title_button"><input class="button-medium-save" name="save" type="submit" value="[[.save.]]"/></td>
            <td>
            <a href="<?php echo Url::build_current(array('cmd'=>'view_module','module_id'=>Url::get('id')));?>" class="button-medium-back" style="margin-right: 30px;">Quay lại</a>
            </td>
        </tr>
    </table>
    <div class="content">
    ...
    <fieldset>
        <table width="100%" border="0" cellspacing="0" cellpadding="2" align="left">
            ...
            <td>
                ...
                <span class="items_edit_module" style="width:200px; display: none;">Category:<select name="category" id="category" style="width:200px; " ></select></span>
            ...
            <tr>
                ...
                <td><input name="title_module" type="text"  id="title_module" style="padding:0px;margin:0px;width:80%; height: 26px;" /></td>                              
            </tr>
            <tr>
                <td valign="top"><span style="font-weight: bold;">Mô tả quy trình:</span></td>
                <td><textarea name="description_module"  id="description_module" onkeyup="textAreaAdjust(this)" rows="5"  style="padding:0px;margin:0px;width:98%; height: 250px;" ></textarea></td>                              
            </tr>
            <tr>
