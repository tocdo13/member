<div class="hotel-banner">
     <div class="banner-logo"><div class="sign-in">
      <!--IF:login(User::is_login())-->
           <a href="<?php echo Url::build('personal')?>"><?php echo Session::get('user_id'); ?></a> | <a href="<?php echo Url::build('select_portal')?>">[[|current_portal|]]</a>  | <a class="log-out" href="<?php echo Url::build('sign_out',array()); ?>">[[.sign_out.]]</a><!--ELSE--><a href="<?php echo Url::build('sign_in',array()); ?>">[[.sign_in.]]</a>
       <!--/IF:login-->
      </div>
</div>
        ...
        <li class="menumain">
			...
			if(![[=categories.child.url=]]) [[=categories.child.url=]] = 'javascript:void(0)';?>
            	<li>
                    ...
                    <ul><?php $sub_group = false; ?><!--LIST:categories.child.child--><?php	if($sub_group != [[=categories.child.child.group_name=]]){if($sub_group!="") echo '<li></li>';$sub_group = [[=categories.child.child.group_name=]];}?>	
                    	<li>
