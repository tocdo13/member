...
<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr height="40">
		<td width="90%" class="form-title">[[.manage_room.]]</td>
		<?php if(User::can_add(false,ANY_CATEGORY)){?><td width="1%"><input type="submit" value="[[.Save.]]" class="button-medium-save" onclick="return check_validate_position();"/></td><?php }?>
		<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('room');" class="button-medium-delete">[[.Delete.]]</a></td><?php }?>
	</tr>
</table>
			...
			<div>
				<span id="room_all_elems">
					<span>
                        ...
                        <span class="multi-input-header" style="width:30px; text-align: center;">[[.stt.]]</span>
						<span class="multi-input-header" style="width:155px; text-align: center;">[[.Room_name.]]</span>
						<span class="multi-input-header" style="width:160px; text-align: center;">[[.room_level.]]</span>
						<span class="multi-input-header" style="width:100px; text-align: center;">[[.bed_type.]]</span>
                        <!--<span class="multi-input-header" style="width:150px; text-align: center;">[[.area.]]</span>-->
						<span class="multi-input-header" style="width:150px; text-align: center;">[[.Floor.]]</span>
                        <!--<span class="multi-input-header" style="width:150px; text-align: center;">[[.house.]]</span>-->
						<span class="multi-input-header" style="width:70px; text-align: center;">[[.Position.]]</span>
                        <span class="multi-input-header" style="width:70px;">[[.coordinates.]]</span>
                        <span class="multi-input-header" style="width:100px; text-align: center;">[[.status.]]</span>
						<span class="multi-input-header" style="width:70px; text-align: center;">[[.Have_Minibar.]]</span>
						<span class="multi-input-header" style="width:70px; text-align: center;">[[.Delete.]]</span>
					</span>
                    <br clear="all">
				</span>
			</div>
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('room');$('name_'+input_count).focus();" class="button-medium-add">[[.Add.]]</a></div>
...
function Confirm(index){
	...
	return confirm('[[.Are_you_sure_delete_room.]] '+room_name+'?');
}
