	...
	<span id="mi_reservation_room_sample">
		<div id="input_group_#xxxx#"  onblur="updateRoomForTraveller('#xxxx#');" onmouseover="updateRoomForTraveller('#xxxx#');">
            ...
            <span class="multi-input">
					<input  name="mi_reservation_room[#xxxx#][adult]" type="text" id="adult_#xxxx#" style="width:29px;" AUTOCOMPLETE=OFF /><img src="packages/core/skins/default/images/buttons/adult.png" align="top"/></span>
            ...
            <span class="multi-input">
					<input  name="mi_reservation_room[#xxxx#][child]" type="text" id="child_#xxxx#" style="width:28px;" AUTOCOMPLETE=OFF /><img src="packages/core/skins/default/images/buttons/child.png" align="top"/></span>
            <!--trung add:tr.e<5-->
            <span class="multi-input">
					<input  name="mi_reservation_room[#xxxx#][child_5]" type="text" id="child_#xxxx#" style="width:33px;" AUTOCOMPLETE=OFF /><img src="packages/core/skins/default/images/buttons/child.png" align="top"/></span>        
			<!--trung add:tr.e<5-->
            <span class="multi-input">
			...
			<span id="mi_reservation_room_sample_#xxxx#" style="display:none;">
                <div class="room-extra-info" id="room_extra_info_#xxxx#" >
                    ...
                    <div class="w3-right" style="padding-right: 50px;">
                        <span class="w3-text-blue">
                        		<span class="label">[[.Remarks_for_room.]]</span>
                                <input  id="note_#xxxx#" name="mi_reservation_room[#xxxx#][note]" type="text" style="width: 450px; " />
                        </span>
                    </div>
                    <br clear="all">
		...
		<fieldset style="background:#E5E5E4" id="reservation_room">
			...
			<span id="mi_reservation_room_all_elems">
				<span>
                    ...
                    <span class="multi-input-header" style="width:40px;">[[.child.]]</span>
