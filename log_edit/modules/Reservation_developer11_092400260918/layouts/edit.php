...
<span style="display:none;">
	<span id="mi_reservation_room_sample">
		...
		<div id="reservation_room_bound_#xxxx#" class="reservation_room_bound">
            ...
            <span class="multi-input">
					<input  name="mi_reservation_room[#xxxx#][adult]" class="pp" type="text" id="adult_#xxxx#" style="width:47px;" AUTOCOMPLETE=OFF><i class="fa fa-male" style="font-size: 16px;"></i></span>
            <span class="multi-input">
		...
		<fieldset style="background:#E5E5E4;margin-bottom:5px;">
			...
			<span id="mi_reservation_room_all_elems">
				<span>
                    ...
                    <span class="multi-input-header" style="width:58px;">[[.child_5.]]</span> <!-- trung add: tr.e<5 tuoi -->
