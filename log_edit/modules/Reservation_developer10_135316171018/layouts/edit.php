                ...
                <div class="room-extra-info" id="room_extra_info_#xxxx#">
                    <div>
                         <span class="multi-input-extra">
                            ...
                            <input class=" w3-gray w3-hover-orange" name="mi_reservation_room[#xxxx#][minibar_button]" type="button" value="[[.Minibar.]]" id="minibar_button_#xxxx#" onclick="if(jQuery('#status_#xxxx#').val()!='CHECKIN'){ alert('[[.Only_check_in_room_avaiable.]]!') } else{ window.open('?page=minibar_invoice&cmd=add&reservation_room_id='+jQuery('#id_#xxxx#').val() + '&portal=<?php echo PORTAL_ID; ?>');}" style="width:85px; height: 23px;"/>
                            <?php
                                } 
                            ?>
                            <?php if(User::can_add($this->get_module_id('LaundryInvoice'),ANY_CATEGORY)){ ?>
                            <input class=" w3-gray w3-hover-orange" name="mi_reservation_room[#xxxx#][laundry_button]" type="button" value="[[.Laundry.]]" id="laundry_button_#xxxx#" onclick="if(jQuery('#status_#xxxx#').val()!='CHECKIN'){ alert('[[.Only_check_in_room_avaiable.]]!') } else{window.open('?page=laundry_invoice&cmd=add&reservation_room_id='+jQuery('#id_#xxxx#').val() + '&portal=<?php echo PORTAL_ID; ?>');}" style="width:85px; height: 23px;"/>
                            <?php
                                } 
                            ?>
                            <?php if(User::can_add($this->get_module_id('EquipmentInvoice'),ANY_CATEGORY)){ ?>
                            <input class=" w3-gray w3-hover-orange" name="mi_reservation_room[#xxxx#][equipment_button]" type="button" value="[[.Equipment.]]" id="equipment_button_#xxxx#" onclick="if(jQuery('#status_#xxxx#').val()!='CHECKIN'){ alert('[[.Only_check_in_room_avaiable.]]!') } else{window.open('?page=equipment_invoice&cmd=add&reservation_room_id='+jQuery('#id_#xxxx#').val() + '&portal=<?php echo PORTAL_ID; ?>');}" style="width:85px; height: 23px;"/>
                            <?php
                                } 
                            ?>
                        </span>
		          ...
		          <div id="box_do_not_move_#xxxx#" style="clear: both; display: none;">
                    ...
                    <div style="clear: both; display: none;">
                        <span style="float: left; margin-left:20px;">[[.Cancel_note.]]: </span>
			...
			<legend class="w3-white" style="width: 190px; height: 26px; padding: 5px 5px 0px 5px; border: 1px solid orange;">[[.general_information.]]</legend>
                  ...
                  <td></td>
                    ...
                    <tr valign="top" style="line-height: 22px;">
                        <?php if(isset([[=mice_reservation_id=]]) AND [[=mice_reservation_id=]]!=0 AND [[=mice_reservation_id=]]!=''){ ?>
                            ...
                            <td align="center" colspan="2" style="color: blue;">[[.personnel_booking.]]: [[|user_name|]] ( <?php echo date("H:i d/m/Y",[[=time=]] ); ?> )</td>
                            <td align="right" nowrap>&nbsp;</td>
                        <?php }else{ ?>
                            <td></td>
                ...
                <div id="cancel_extra" style="z-index:9999;position: fixed; width:300px; height:285px; border-radius:10px 10px 0px 0px; background: white; top:30%; left:40%; display:none;">
                        <div style="background: #7979FF;padding-left:7px; width:100%;height:40px; border-radius:10px 10px 0px 0px; float:left; box-sizing: border-box;">
                            <h4 style="width: 90%; float: left; color: white;">[[.cancellation_note_details.]]</h4>
                        </div>
                        <div id="cancel_input" style="padding-left: 10px;">
                            <br />
                            <div style="margin-top: 40px;">[[.do_you_want_to_cancel_this_booking.]]?</div>
                            <br />
                            <div style="width: 100%;">
                                <textarea name="cancel_note" id="cancel_note" cancel_input="" target="" style="resize: none; width: 90%; margin: 5px; margin-top:15px; height: 100px;" placeholder="[[.reason_cancel.]]" position="3"></textarea>
                            </div>
                            <br />
                            <button style="float: right; margin-right: 10px;" type="button" onclick="cancel_back();" type="button">[[.cancel.]]</button>
                            <button style="float: right; margin-right: 10px;" type="button" onclick="setValue();">[[.save.]]</button>
                        </div>
                </div>
        </fieldset>
