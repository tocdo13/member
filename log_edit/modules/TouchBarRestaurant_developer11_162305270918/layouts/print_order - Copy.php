...
<div id="bound" style="width:320px; float:left;">
    ...
    <div style="margin-top:5px;">
    	<table width="100%">
            ...
            <!--IF:cond_total((([[=bar_fee_rate=]]>0 && [[=full_charge=]]==0)) && ([[=tax_rate=]]>0 && [[=full_rate=]] == 0))-->
            <tr>
            	<td colspan="2" style="text-transform:uppercase;">[[.subtotal.]]</td>
                <td colspan="2" align="right">[[|amount|]]</td>
            </tr>
            <!--/IF:cond_total-->
             <!--IF:cond_total(([[=bar_fee_rate=]]>0 && [[=full_charge=]]==1) && ([[=tax_rate=]]>0 && [[=full_rate=]] == 0))-->
            <tr>
            	<td colspan="2" style="text-transform:uppercase;">[[.subtotal.]]</td>
                <td colspan="2" align="right"><?php echo System::display_number(System::calculate_number([[=amount=]]) + System::calculate_number([[=bar_fee=]]) );?></td>
            </tr>
            <!--/IF:cond_total-->
            ...
            <tr>
                ...
                <td colspan="2" align="right">[[|bar_fee|]]</td>
            </tr>
            <!--/IF:cond_service-->
