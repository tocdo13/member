...
<form name="BookingConfirmForm" method="post">
    ...
    <div id="print" style="width: 85%; margin: 0px auto;">
        ...
        <table>
            ...
            <tr>
                <td style="text-align: justify; font-size: 12px;">We thank you for signing back and returning it to us within today as your acceptance. Please also take note that no room has been blocked at the moment until we receive your signature on this confirmation or your acknowledgement via email.</td>
            </tr> 
            <tr>
