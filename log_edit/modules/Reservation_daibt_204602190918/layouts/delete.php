	...
	<tr valign="top" bgcolor="#FFFFFF">
		<td align="left">
			<table width="100%" cellpadding="0" cellspacing="0" class="table-bound">
				<tr height="40">
                	<td width="90%" nowrap  class=""><i class="fa fa-times-circle w3-text-red" style="font-size: 30px;"></i> [[.delete_reservation.]]</td>
				  	<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><input name="delete" type="submit" value="[[.delete.]]" class="w3-btn w3-red"/></td><?php }?>
