	...
	<tr valign="top" bgcolor="#FFFFFF">
		<td align="left">
			<table width="100%" cellpadding="0" cellspacing="0" class="table-bound">
				<tr height="40">
                	<td width="90%" nowrap  class="form-title">[[.delete_reservation.]]</td>
				  	<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><input name="delete" type="submit" value="[[.delete.]]" class="button-medium-delete"></td><?php }?>
					<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%"><a href="<?php echo Url::build_current();?>"  class="button-medium-back">[[.cancel.]]</a></td><?php }?>
				</tr>
		  </table>
		</td>
	</tr>
