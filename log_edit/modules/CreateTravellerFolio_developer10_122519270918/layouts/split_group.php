	...
	<tr id="title">
        ...
        <td width="50%"><span style="text-align:left; color:#0A3680;">
           ...
           <!--/LIST:folio-->
                ...
                <a href="#" class="w3-btn w3-indigo w3-hover-indigo w3-hover-text-white"><input name="add_payment" type="button" id="add_payment" value="" style="float:right;display:none;margin-right: 5px; text-transform: uppercase; text-decoration: none;" />[[.add.]]</a>
                <a href="#" class="w3-btn w3-blue w3-hover-blue w3-text-white w3-hover-text-white"><input name="save" type="button" id="save" value="" style="float:right;margin-right: 5px; text-transform: uppercase; text-decoration: none;" onclick="SubmitForm('save');" />[[.Save_and_stay.]]</a>
                <a href="#" class="w3-btn w3-orange w3-hover-orange w3-text-white w3-hover-text-white"><input name="save_and_print" type="button" id="save_and_print" value="" style="float:right;height:28px; margin-right: 5px; text-transform: uppercase; text-decoration: none;" onclick="SubmitForm('save_and_print');" >[[.save_view.]]</a>
                <?php } ?>
