	...
	<tr id="title">
        ...
        <td width="50%"><span style="text-align:left; color:#0A3680;">
           ...
           <!--/LIST:folio-->
                ...
                <input name="save_and_print" type="button" id="save_and_print" class="w3-btn w3-orange w3-hover-orange w3-text-white w3-hover-text-white" value="[[.save_view.]" onclick="SubmitForm('save_and_print');" />
                <?php } ?>
