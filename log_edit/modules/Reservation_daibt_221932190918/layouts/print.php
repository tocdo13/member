...
<a id="back" style="float: right;" href="<?php echo Url::build_current(array('cmd'=>'edit','id','r_r_id'));?>"  class="button-medium-back">[[.back.]]</a>
<div class="preview">
    <?php
    ...
    <label class="customer_name"><?php echo $this->map['item']['note']?$this->map['item']['note']:$this->map['item']['fullname']; ?></label>
    ...
    <table cellpadding="7" border="0" class="total">
        <tr>
            <td>&nbsp;<?php //echo System::display_number($this->map['header']['service_charge']); ?></td>
        </tr>
        <tr>
            <td>&nbsp;<?php //echo System::display_number($this->map['header']['vat']); ?></td>
        </tr>
        <tr>
            <td><?php echo System::display_number([[=total=]]); ?></td>
        </tr>
    </table>
