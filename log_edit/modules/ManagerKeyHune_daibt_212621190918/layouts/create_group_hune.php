...
<span style="display:none">
	<span id="mi_group_sample">
		<div id="input_group_#xxxx#">
            ...
            <input name="fail_#xxxx#" type="text"  id="fail_#xxxx#" style="width: 10px; vertical-align: top; height: 15px;margin-left: 2px;display: none;background-color: transparent;border: 0px solid; font-size: 14px;"/></span> 
                                ...
                                <table width="95%" style="margin-left: 10px; margin-top: 10px;vertical-align: central;" >
                                    <tr>
                                        <td>
                                            ...
                                            <span class="multi-input-header" style="float:left;width:80px; text-align: center; ">Number keys</span>
