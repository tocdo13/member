...
<table id="tblExport" cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound">
    <tr bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" width="70px">[[.payment_type1.]]</th>                     
            ...
            <!--LIST:items.room.traveller-->
                <tr>
                    ...
                    <?php if([[=items.room.id=]]!=$rr_id){ $rr_id=[[=items.room.id=]];?>
                        ...
                        <td rowspan="<?php echo [[=items.room.count=]];?>"><?php if([[=items.room.extrabed=]]==1){ echo "Yes"; } else{ echo " "; }?></td>
                        ...
                        <td rowspan="<?php echo [[=items.room.count=]];?>" style="text-align: left;"><div style="font-size:13px;"><b>[[|items.room.note|]]</b></div><i>[[|items.room.note_room|]]</i></td>
                        <td rowspan="<?php echo [[=items.room.count=]];?>">[[|items.room.booking_code|]]</td>
                        <td rowspan="<?php echo [[=items.room.count=]];?>">[[|items.room.booker|]]</td>
                        <td rowspan="<?php echo [[=items.room.count=]];?>">[[|items.room.payment_type|]]</td>
                    <?php }?>
                    ...
                    <td>[[|items.room.traveller.country_code|]]</td>
