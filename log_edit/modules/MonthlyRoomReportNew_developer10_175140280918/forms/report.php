...
class MonthlyRoomReportNewForm extends Form
{
	...
	function draw()
    {
        ...
        /** get time **/
        $from_date = Url::get('from_date')?Url::get('from_date'):date('d/m/Y',(Date_Time::to_time(date('d/m/Y'))-(3*86400)));
        ...
        /** order by **/
        $this->map['order_by_list'] = array('1'=>Portal::language('room_level'),'2'=>Portal::language('room'));
        $cond_order_by = Url::get('order_by')==2?'room.id,room.floor,room.position':' room_level.is_virtual,room_level.id asc,room_level.position,room_level.brief_name,room.name';
