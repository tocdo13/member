        ...
        <td>
            <table width="750px" cellspacing="0" >
                ...
                <tr>
                    ...
                    <td align="center"><?php echo Date_Time::convert_orc_date_to_date([[=reservation_room_type.arrive=]])?></td>
                    <td align="center"><?php echo Date_Time::convert_orc_date_to_date([[=reservation_room_type.departure=]])?></td>
                    <td align="center">[[|reservation_room_type.room_level|]]</td>
                    <td align="center">[[|reservation_room_type.total|]]</td>
                    <td align="center" width="100px">[[|reservation_room_type.room_name|]]</td>
