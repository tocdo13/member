	...
	<span id="mi_reservation_room_sample">
		...
		<div id="reservation_room_bound_#xxxx#" class="reservation_room_bound">
            ...
            <span class="multi-input">
                ...
                <a href="" id="commission_list_#xxxx#" class="select-rate" ><i class="fa fa-edit"></i></a> 
            </span>
            <?php }else{?>
                ...
                if(defined('IS_KEY') && IS_KEY==1)
                {
                    ...
                    switch(SERVER_KEY)
                    {
                        case IS_BETECH:
                        {
                            ...
                            <img id="btn_key_#xxxx#" src="skins/default/images/key.gif" title="Tạo khóa từ" target="_blank" onclick="window.open('?page=manager_key&cmd=create&resevation_room_id='+jQuery('#id_#xxxx#').val()+ '&portal=<?php echo PORTAL_ID; ?>')" />
