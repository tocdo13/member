	...
	<span id="mi_set_menu_sample">
		<div id="input_group_#xxxx#" style="margin-top: 8px;">
			...
			<span class="multi_input"><span style="width:20px;">
				<img src="packages/core/skins/default/images/buttons/delete.gif" onclick="if(confirm('[[.Are_you_sure_delete_item.]]')) mi_delete_row($('input_group_#xxxx#'),'mi_set_menu','#xxxx#','');event.returnValue=false; change_total(); checkRestaurant();" style="cursor:hand;"/>
			</span></span><br/>
		</div>
	</span>
</span>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12" style="margin-bottom: 20px;">
                                <div class="col-md-2 form-group">
                                    <label>Mã : </label> 
                                    <input name="menu_code" type="text" id="menu_code" value="<?php echo isset($_GET['id'])?[[=menu_code=]]:''; ?>" class="form-control" autocomplete="off" <?php if(isset($_GET['id'])){ ?> readonly="" <?php } ?> />
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>Tên : </label>
                                    <input name="menu_name" type="text" id="menu_name" value="<?php echo isset($_GET['id'])?[[=menu_name=]]:''; ?>" autocomplete="off" class="form-control" required="" />
                                </div>
                                <div class="col-md-2 form-group">
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <input name="start_date" type="text" id="start_date" class="form-control" value="<?php if(isset([[=start_date=]])) echo [[=start_date=]]; ?>" />
                                </div>
                                <div class="col-md-2 form-group">
                                    <label>Ngày kết thúc : </label>
                                    <input name="end_date" type="text" id="end_date" class="form-control" value="<?php if(isset([[=end_date=]])) echo [[=end_date=]]; ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" style="padding-left: 30px;">
                                 <span id="mi_set_menu_all_elems" style="margin-bottom: 10px; display:block;">
                					<span>
                						...
                						<span class="multi-input-header" style="width:253px;">[[.product_name.]]</span>
                					    <span class="multi-input-header" style="width:70px;">[[.quantity.]]</span>
                                 ...
                                 <input type="button" value="[[.add.]]" onclick="mi_add_new_row('mi_set_menu');myAutocomplete(input_count);myAutocomplete_name(input_count);changeSttValue();"/>
                            ...
                            <div class="col-md-12" style="margin-top: 30px; margin-left: 340px;">
                                <div><span style="font-weight: bold;">Tổng : </span><input name="total_hidden" type="text" id="total_hidden" value="<?php echo isset($_GET['id'])?System::display_number([[=total=]]):'0'; ?>" style="text-align: right;" oninput="jQuery(this).val(number_format(this.value));" required=""/> </div>
