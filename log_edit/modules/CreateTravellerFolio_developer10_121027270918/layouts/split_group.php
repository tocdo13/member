	...
	<tr id="title">
        ...
        <td width="50%"><span style="text-align:left; color:#0A3680;">
           ...
           <!--/LIST:folio-->
                ...
                <a href="#" class="w3-btn w3-orange w3-hover-orange w3-text-white w3-hover-text-white" name="save_and_print" type="button" id="save_and_print" value="" style=" background-color: orange; float:right;height:28px; margin-right: 5px; text-transform: uppercase; text-decoration: none;" onclick="SubmitForm('save_and_print');" >[[.save_view.]]</a>
                <?php } ?>
