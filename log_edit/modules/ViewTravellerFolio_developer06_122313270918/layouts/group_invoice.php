...
<table id="Export" width="100%" style="position: relative; float:left;"><tr><td>
	<table cellpadding="0" width="100%" border="0">
    	<tr>
            ...
            [[.list_of_goods_and_services.]] <?php if(isset([[=folio_code=]]) and [[=folio_code=]] != ''){}else{?>(DRAG)<?php }?>
            <?php }else{ ?>
            [[.bill_folio.]]
            <?php } ?></div>
    ...
    <table width="100%" class="auto_total">
        ...
        <tr>            
            ...
            <td width="14%" style="text-align: right;">
               <b><span style="text-align:right;" class="change_num"><?php if([[=total_payment=]]>=0){echo System::display_number(round( [[=total_payment=]] - [[=total_payment_vnd=]] ));}else{echo System::display_number(round( [[=total_payment=]] + [[=total_payment_vnd=]] ));}?></span></em></b> 
            </td>                                                            
        </tr>
    </table>
    <!--IF:cond(1==1)-->
