    ...
    <td ><table cellspacing="0" width="100%" style="font-family:'Times New Roman', Times, serif">
      <tr style="font-size:12px;">
        ...
        <td >
            ...
            <span style="font-size: 14px;">Ngày [[|day|]] tháng [[|month|]] năm [[|year|]]</span>
            </div>
        </td>
        <td ><strong>[[.template_code.]]</strong>
        </td>
      </tr>
    </table></td>
  </tr>
</table>
<div style="width: 100%;text-align: right;">Nhân viên: <input name="staff_name" type="text" id="staff_name" style="width: 150px; font-size: 14px; border: none;" readonly="readonly"/></div><!--border:none-->
<!---------REPORT----------->	
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="font-size:11px; margin-top: 5px;">
    ...
    <tr>
        <td>[[|items.index|]]</td>
         <td>[[|items.room_status|]]</td>
        <td>[[|items.room_guest_status|]]</td>
        <td>[[|items.name|]]</td>
        <td>[[|items.brief_name|]]</td>
        <td  >[[|items.arrival_time|]]</td>
        <td>[[|items.departure_time|]]</td>
        <td>[[|items.adult|]]/[[|items.child|]]</td>
        <td align="left">[[|items.guest_name|]]</td>
        <td>[[|items.work_in|]]</td>
        <td>[[|items.work_out|]]</td>
        <td>[[|items.remark|]]</td>
        <td class="print_hide">[[|items.reservation_note|]]</td>
    </tr>
    <!--/LIST:items-->
