            ...
            <!--LIST:items.room.traveller-->
                <tr>
                    ...
                    <?php if([[=items.room.id=]]!=$rr_id){ $rr_id=[[=items.room.id=]];?>
                        ...
                        <td rowspan="<?php echo [[=items.room.count=]];?>" style="text-align: left;"><div style="font-size:13px;"><b>[[|items.room.note|]]</b></div><i>[[|items.room.reservation_note|]]</i></td>
