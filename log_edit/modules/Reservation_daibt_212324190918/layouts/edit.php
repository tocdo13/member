                            ...
                            <span class="multi-input-header" style="width:20px;">
                                <?php
                                    switch(SERVER_KEY)
                                    {
                                        ...
                                        {
                                            ?>
                                            <a title="Tạo nhóm khóa" target="_blank" onclick="window.open('?page=manager_key&cmd=create_group&reservation_id='+'<?php echo Url::get('id'); ?>&portal=<?php echo PORTAL_ID; ?>')" ><i class="fa fa-tags w3-text-red"></i></a>
                                            <?php
                                            break; 
                                        }
                                        case IS_ADEL:
                                        {
                                            ?>
                                            <a title="Tạo nhóm khóa" target="_blank" onclick="window.open('?page=manager_key_adel&cmd=create_group&reservation_id='+'<?php echo Url::get('id'); ?>&portal=<?php echo PORTAL_ID; ?>')" ><i class="fa fa-tags w3-text-red"></i></a>
                                            <?php 
                                            break;
                                        }
                                        case IS_SALTO:
                                        {
                                            ?>
                                            <a title="Tạo nhóm khóa" target="_blank" onclick="window.open('?page=manager_key_salto&cmd=create_group&reservation_id='+'<?php echo Url::get('id'); ?>&portal=<?php echo PORTAL_ID; ?>')"><i class="fa fa-tags w3-text-red"></i></a>
                                            <?php 
                                            break;
                                        }
                                        case IS_HUNERF:
                                        {
                                            ?>
                                            <a title="Tạo nhóm khóa" target="_blank" onclick="window.open('?page=manager_key_hune&cmd=create_group&reservation_id='+'<?php echo Url::get('id'); ?>&portal=<?php echo PORTAL_ID; ?>')" ><i class="fa fa-tags w3-text-red"></i></a>
                                        ...
                                        {
                                            ?>
                                            <a title="Tạo nhóm khóa" target="_blank" onclick="window.open('?page=manager_key_orbita&cmd=create_group&reservation_id='+'<?php echo Url::get('id'); ?>&portal=<?php echo PORTAL_ID; ?>')" ><i class="fa fa-tags w3-text-red"></i></a>
                                            <?php
                                            break; 
                                        }
                                        case IS_BQLOCK:
                                        {
                                            ?>
                                            <a title="Tạo nhóm khóa" target="_blank" onclick="window.open('?page=manager_key_bqlock&cmd=create_group&reservation_id='+'<?php echo Url::get('id'); ?>&portal=<?php echo PORTAL_ID; ?>')" ><i class="fa fa-tags w3-text-red"></i></a>
                                            <?php
                                            break; 
                                        }
                                        default:
