                        ...
                        <div>
                            ...
                            <div  style="margin-top:5px;" class="center">
                                ...
                                <?php if(!isset([[=is_group=]])){
                                 ?>
                                 <span style="font-weight: bold; font-size:18px;">[[|room_name|]]</span>
                                 <?php   
                                } 
                                else{
                                ?>
                                  <span style="font-weight: bold; font-size:18px;">[[|list_customer.room_name|]]</span>  
                                <?php    
                                }
                                ?>                               
                                </div>
...
?>
var miny= <?php echo date('Y',[[=time_in=]]);?>;
var minm= <?php echo intval(date('m',[[=time_in=]]))-1;?>;
var mind = <?php echo date('d',[[=time_in=]]);?>;
var maxy = <?php echo date('Y',[[=time_out=]]);?>;
var maxm= <?php echo intval(date('m',[[=time_out=]]))-1;?>;
var maxd = <?php echo date('d',[[=time_out=]]);?>;
