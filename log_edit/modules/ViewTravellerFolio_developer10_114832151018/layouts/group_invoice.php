...
<div id="invoice">
    <table id="dn_printer" width="100%">
        <tr>
            ...
            <td align="right"><input name="print" type="checkbox" id="short" onclick="fun_check_option(1)" checked="" onchange="check_option();"/>[[.print_short.]]</td>
            <td align="right"><input name="print" type="checkbox" id="full" onclick="fun_check_option(2)"  onchange="check_option();"/>[[.print_full.]]</td>
...
<table id="Export" width="100%" style="position: relative; float:left;"><tr><td>
    ...
    <table width="100%" class="auto_total">
        ...
        <tr>            
            ...
            <td width="14%" style="text-align: right;">
               <b><span style="text-align:right;" class="change_num"><?php if([[=total_payment=]]>=0){echo System::display_number(round( [[=total_payment=]] - [[=total_payment_vnd=]] +  $total_refund));}else{echo System::display_number(round( -[[=total_payment=]] + [[=total_payment_vnd=]] -  $total_refund));}?></span></em></b> 
            </td>                                                            
        </tr>
    </table>
    <!--IF:cond(1==1)-->
