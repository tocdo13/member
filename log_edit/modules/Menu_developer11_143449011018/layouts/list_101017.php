  ...
  <div id="testRibbon" class="officebar" style="display:none;">
    ...
    <!--LIST:categories-->
      ...
      <?php 
          ...
          $i++; $k=0;
      ?> 
      rel="[[|categories.id|]]" class="w3-button w3-hover-light-gray">
<!---Background menu cha--->
        <a href="#" rel="home" id="[[|categories.id|]]">
         ...
         <ul>
               ...
               ?>
                    <li>
<!---Background footer nhom chuc nang--->
                	<!--IF:cond_group([[=categories.child.group_name=]])-->
                        <span class="w3-light-gray w3-text-light-gray">[[|categories.child.group_name|]]</span>
                    <!--/IF:cond_group-->
                    <?php 
                        } 
                            $group++; 
...
<!---Background menu Vuong--->
                               <ul class="w3-center ">
                                   <div class="dropdown w3-hover-light-blue" style="height: 54px; padding: 0px !important;" id="button_dropdown">
                                       <a href="#" rel="paste" style="padding: 0px !important; text-align: center !important;">                                	
                                       ...
                                       <div>
                                           ...
                                           <!--LIST:categories.child.child-->
                                                ...
                                                ?>
                                                <li>
<!---Background menu do xuong---> 
                                                    <a class="w3-hover-light-gray" href="[[|categories.child.child.url|]]">
                                                        ...
                                                        <!--/IF:img_cond04-->
                                                        <span><?php echo Portal::language()==1?[[=categories.child.child.name_1=]]:[[=categories.child.child.name_2=]]; ?></span>
                                                    </a>
                                                </li>
                                           <!--/LIST:categories.child.child-->
                                           </ul>
...
<!---Background menu small--->
                                 <a class="w3-light-gray w3-hover-light-blue" style="height: 55px; width: 63px !important; text-align: center; margin-top: 2px; padding: 0px !important;" href="[[|categories.child.url|]]" rel="paste">
                                 <!--IF:img_cond02([[=categories.child.icon_url=]] && [[=categories.child.icon_url=]]!=' ')-->
                                    <img src="[[|categories.child.icon_url|]]" title="<?php echo Portal::language()==1?[[=categories.child.name_1=]]:[[=categories.child.name_2=]]; ?>" style="width: 25px; height: 24px; margin-bottom: 2px;"/>
                                 <!--/IF:img_cond02-->
                                 <span style="line-height: 12px; width: 63px !important; text-align: center;"><?php echo Portal::language()==1?[[=categories.child.name_1=]]:[[=categories.child.name_2=]]; ?></span>
                                 </a>
                             </li>
                           <!--/IF:cond_position-->
                         <!--/IF:cond_child_02-->
                  ...
                  ?>  
                          ...
                          <a style="w3-light-gray" href="#" rel="paste">
                            <i class="fa fa-sign-in w3-hover-indigo" style="font-size: 14px;"></i>
                          </a>
                          <div>
                            <ul>
   ...
   // echo $path;
    ...
    //End Luu Nguyen Giap
    ?>    
	<div id="chang_language" style="color:gray;">
  
        <a onclick="var user ='<?php echo User::id(); ?>';printWebPart('printer',user);" title="[[.print.]]"><i class="fa fa-print w3-text-indigo" style="font-size: 40px;"></i></a> | 
        <a href="<?php echo Url::build('change_language',$param_build_change_lang);?>" title="[[.change_language.]]" style="font-size:15px;color:black; text-decoration: none;"><i class="fa fa-language w3-text-black w3-hover-text-red" style="font-size: 20px;"></i> <!--IF:l_cond(Portal::language()==1)-->Eng<!--ELSE-->VN<!--/IF:l_cond--></a>
    </div>
	...
	<div id="sign-in" style="width: 100%; margin: 0px; padding: 0px; left: 0px; bottom: 0px; box-shadow: 0px 0px 5px #171717; <?php if(User::id()=='developer05'){ ?>background-color: rgba(236, 236, 236, 0.7);<?php } ?>">  
        <a href="<?php echo Url::build('home',array());?>" title="[[.home_page.]]" style="float: left; margin-right: 10px;"><i class="fa fa-home w3-text-orange" style="font-size: 30px;"></i></a>
