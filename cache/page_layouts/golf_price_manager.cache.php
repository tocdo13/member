...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '2188',
      'name' => 'GolfPriceManager',
      'path' => 'packages/hotel/packages/golf/modules/GolfPriceManager/',
      'type' => NULL,
...
<?php $blocks[1117]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[1118]['object']->on_draw();?></div>
