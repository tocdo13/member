...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1979',
      'name' => 'Recommendation',
      'path' => 'packages/hotel/packages/purchasing/modules/Recommendation/',
      'type' => NULL,
...
<?php $blocks[962]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[963]['object']->on_draw();?></div>
