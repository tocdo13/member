...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1771',
      'name' => 'HkDepartureList',
      'path' => 'packages/hotel/packages/housekeeping/modules/HkDepartureList/',
      'type' => NULL,
...
<?php $blocks[674]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[675]['object']->on_draw();?></div>
