...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '2191',
      'name' => 'GolfCaddieScheduler',
      'path' => 'packages/hotel/packages/golf/modules/GolfCaddieScheduler/',
      'type' => NULL,
...
<?php $blocks[1123]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[1124]['object']->on_draw();?></div>
