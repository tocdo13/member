...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1401',
      'name' => 'Reservation',
      'path' => 'packages/hotel/packages/reception/modules/Reservation/',
      'type' => NULL,
  ...
  array (
    ...
    array (
      'id' => '1560',
      'name' => 'Footer',
      'path' => 'packages/utils/modules/Footer/',
      'type' => NULL,
      'action_module_id' => NULL,
      'use_dblclick' => NULL,
      'package_id' => '24',
...
<?php $blocks[723]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[724]['object']->on_draw();?></div>
		<div class="simple-layout-footer" id="_footer_region">
<?php $blocks[555]['object']->on_draw();?></div>
	</div></div>
