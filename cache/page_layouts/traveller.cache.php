...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1',
      'name' => 'Traveller',
      'path' => 'packages/hotel/packages/reception/modules/Traveller/',
      'type' => NULL,
      'action_module_id' => NULL,
      'use_dblclick' => NULL,
      'package_id' => '22',
...
<?php $blocks[131]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[172]['object']->on_draw();?></div>
		<div class="simple-layout-footer" id="_footer_region">
<?php $blocks[424]['object']->on_draw();?></div>
	</div></div>
