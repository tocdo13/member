...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '2185',
      'name' => 'StatusTraveller',
      'path' => 'packages/hotel/packages/sale/modules/StatusTraveller/',
      'type' => NULL,
      'action_module_id' => NULL,
      'use_dblclick' => NULL,
      'package_id' => '23',
...
<?php $blocks[1113]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[1114]['object']->on_draw();?></div>
