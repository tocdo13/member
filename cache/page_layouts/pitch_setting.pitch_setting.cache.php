...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '2183',
      'name' => 'PitchSetting',
      'path' => 'packages/hotel/packages/pitch/modules/PitchSetting/',
      'type' => NULL,
...
<?php $blocks[1109]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[1110]['object']->on_draw();?></div>
