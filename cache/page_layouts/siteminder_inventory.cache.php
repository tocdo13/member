...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '2163',
      'name' => 'SiteminderInventory',
      'path' => 'packages/hotel/packages/siteminder/modules/SiteminderInventory/',
      'type' => NULL,
      'action_module_id' => NULL,
      'use_dblclick' => NULL,
      'package_id' => '40',
...
<?php $blocks[1082]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[1083]['object']->on_draw();?></div>
