...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1408',
      'name' => 'RoomMap',
      'path' => 'packages/hotel/packages/reception/modules/RoomMap/',
      'type' => NULL,
      'action_module_id' => NULL,
      'use_dblclick' => NULL,
      'package_id' => '22',
...
<?php $blocks[1016]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[1046]['object']->on_draw();?></div>
		<div class="simple-layout-footer" id="_footer_region">
<?php $blocks[423]['object']->on_draw();?></div>
	</div></div>
