...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1880',
      'name' => 'DetailSaleInDate',
      'path' => 'packages/hotel/packages/report/modules/DetailSaleInDate/',
      'type' => NULL,
...
<?php $blocks[863]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[864]['object']->on_draw();?></div>
