...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1919',
      'name' => 'EmailGroupEvent',
      'path' => 'packages/hotel/packages/sale/modules/EmailGroupEvent/',
      'type' => NULL,
...
<?php $blocks[885]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[886]['object']->on_draw();?></div>
