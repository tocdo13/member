...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '2106',
      'name' => 'VatRevenueReport',
      'path' => 'packages/hotel/modules/VatRevenueReport/',
      'type' => NULL,
...
<?php $blocks[1012]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[1011]['object']->on_draw();?></div>
