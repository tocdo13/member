...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1717',
      'name' => 'ArrivalInDayList',
      'path' => 'packages/hotel/packages/report/modules/ArrivalInDayList/',
      'type' => NULL,
...
<?php $blocks[602]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[603]['object']->on_draw();?></div>
