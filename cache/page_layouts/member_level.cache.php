...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '1930',
      'name' => 'MemberLevel',
      'path' => 'packages/hotel/packages/sale/modules/MemberLevel/',
      'type' => NULL,
  ...
  'help_id' => NULL,
  'name' => 'member_level',
  'title_1' => 'Quản Lý Hạng Thành Viên',
  'title_3' => NULL,
  'description_1' => NULL,
  'description_3' => NULL,
  'title_2' => NULL,
...
<?php $blocks[896]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[897]['object']->on_draw();?></div>
