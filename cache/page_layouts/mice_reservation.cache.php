...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => '2085',
      'name' => 'MiceReservation',
      'path' => 'packages/hotel/packages/mice/modules/MiceReservation/',
      'type' => NULL,
...
<?php $blocks[987]['object']->on_draw();?></div>
		<div class="simple-layout-center" id="printer">
<?php $blocks[988]['object']->on_draw();?></div>
