...
<div width="100%">
    <table width="100%" >
        <tr>
            <td class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px; width: 70%;"><i class="fa fa-calendar w3-text-orange" style="font-size: 26px;"></i> <?php echo Portal::language('predict_material');?></td>
            <td align='right' style="width: 30%; padding-right: 30px;"><button class="w3-btn w3-lime" id="export" style="text-transform: uppercase;"><?php echo Portal::language('export');?></button></td>
        </tr>
    </table>
    <br /><br />
                ...
                <td width="100%" valign='top'>
                    <table>
                        <tr>
                            <td>
                                <fieldset>
                        			<legend class="title"><?php echo Portal::language('product_reservation');?></legend>
                        				<span id="mi_predict_material_all_elems">
                        					<span style="text-transform: uppercase;">
                        						<span class="multi-input-header" style="width:33px; height: 20px; padding-top: 2px;"><?php echo Portal::language('stt');?></span>
                        						<span class="multi-input-header" style="width:71px;height: 20px; padding-top: 2px;"><?php echo Portal::language('code');?></span>
                        						<span class="multi-input-header" style="width:201px;height: 20px; padding-top: 2px;"><?php echo Portal::language('product_name');?></span>
                        						<span class="multi-input-header" style="width:71px;height: 20px; padding-top: 2px;"><?php echo Portal::language('quantity');?></span>
                        						<span class="multi-input-header" style="width:30px;height: 20px; padding-top: 2px;"><img src="skins/default/images/spacer.gif"/></span>
                        						<br/>
                        					</span>
                        				</span>
                        			<input class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; margin-top: 5px;" type="button" value="<?php echo Portal::language('add');?>" onclick="mi_add_new_row('mi_predict_material');myAutocomplete(input_count);"/>
                        		</fieldset>    
                            </td>
                        </tr>
                    </table>
        ...
        <table>
            <tr>
                ...
                <td width="600px" valign='top'>
                    ...
                    <fieldset>
             			<legend class="" style="text-transform: uppercase;"><?php echo Portal::language('material');?></legend>
                        <table id="tblExport" width="100%" cellpadding="5" cellspacing="0" border="1" bordercolor="#CCCCCC" class="table-bound">
                            <tr class="w3-light-gray" style="height: 30px; text-transform: uppercase;">
            					<th width="20px" nowrap align="center"><?php echo Portal::language('stt');?></th>
            					<th width="70px" nowrap align="center"><?php echo Portal::language('code');?></th>
                                <th width="250px" nowrap align="center"><?php echo Portal::language('product_name');?></th>
            					<th width="100px" nowrap align="center"><?php echo Portal::language('quantity_request');?></th>
                                <th width="100px" nowrap align="center"><?php echo Portal::language('in_warehouse');?></th>
                                <th width="100px" nowrap align="center"><?php echo Portal::language('shopping');?></th>
                            </tr>
                            <?php 
				if((!empty($this->map['remain_quantity_product'])))
				{?>
                            <?php $i=1?>
                            <?php if(isset($this->map['remain_quantity_product']) and is_array($this->map['remain_quantity_product'])){ foreach($this->map['remain_quantity_product'] as $key1=>&$item1){if($key1!='current'){$this->map['remain_quantity_product']['current'] = &$item1;?>
                            <tr>
            					<td width="20px" nowrap align="center"><?php echo $i;?></td>
            					<td width="70px" nowrap align="center"><?php echo $this->map['remain_quantity_product']['current']['id'];?></td>
                                <td width="250px" nowrap align="center"><?php echo $this->map['remain_quantity_product']['current']['product_name'];?></td>
            					<td width="100px" nowrap align="center"><?php echo $this->map['remain_quantity_product']['current']['request_quantity'];?></td>
                                <td width="100px" nowrap align="center"><?php echo $this->map['remain_quantity_product']['current']['remain_quantity'];?></td>
                                <td width="100px" nowrap align="center"><?php echo $this->map['remain_quantity_product']['current']['shopping'];?></td>
                            </tr>
                            <?php $i++;?>
                            <?php }}unset($this->map['remain_quantity_product']['current']);} ?>
