	...
	<span id="mi_product_sample">
		<div id="input_group_#xxxx#" style="text-align:left;">
            ...
            <span class="multi-input">
                ...
                <select   name="mi_product[#xxxx#][units_id]" id="units_id_#xxxx#" style="display:none;width:60px;" onchange="$('unit_id_#xxxx#').value = this.value;"  tabindex="#xxxx#_8"><?php echo $this->map['units_id'];?></select>
            </span>
            ...
            <span class="multi-input">
                ...
                <select   name="mi_product[#xxxx#][categorys_id]" id="categorys_id_#xxxx#" style="display:none;width:144px;" onchange="$('category_id_#xxxx#').value = this.value;"  tabindex="#xxxx#_9"><?php echo $this->map['categorys_id'];?></select>
            </span>
            ...
            <span class="multi-input price">
                ...
                <select   name="mi_product[#xxxx#][types_id]" id="types_id_#xxxx#" style="display:none;width:83px;" onchange="$('type_#xxxx#').value = this.value;"  tabindex="#xxxx#_10"><?php echo $this->map['types_id'];?></select>
            </span>
            ...
            <?php 
				if((Url::get('edit_average_price') and Url::get('edit_average_price') == 1))
				{?>
            <span class="multi-input">
    ...
    <tr>
		...
		<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
            <tr>
            	...
            	<td  width="40%" align="right" nowrap="nowrap" style="padding-right: 30px;">
            		<?php if(User::is_admin() or Url::get('cmd') == 'add'){ ?><input style="text-transform: uppercase; margin-right: 5px;" name="save" id="save" type="button" onclick="fun_submit('save');" value="<?php echo Portal::language('save');?>" class="w3-btn w3-blue"/><?php }?>
                    <?php if(User::is_admin() or Url::get('cmd') == 'add'){ ?><input name="save" id="save_and_input" style="text-transform: uppercase; margin-right: 5px;" type="button" onclick="fun_submit('save_and_import');" value="<?php echo Portal::language('save_and_import');?>"  class="w3-btn w3-lime"/><?php }?>
                    <input name="save_type" id="save_type" style="display: none;" />
                    <?php if(User::can_delete(false,ANY_CATEGORY)){?><input  style="text-transform: uppercase;"  class="w3-btn w3-green" value="<?php echo Portal::language('back');?>" id="back_page" onclick="window.location='<?php echo Url::build_current(array('type'));?>'"  /><?php }?>
        ...
        <div class="product-bill-bound">
            <div class="content" style="background:#FFFFFF;width:100%;padding:0px;">
                ...
                <fieldset>
                    <legend class="" style="text-transform: uppercase; font-size: 14px;"><?php echo Portal::language('Contents');?></legend>
					<table width="100%" border="0" cellspacing="0" cellpadding="2">
						<tr>
                            <td style="padding-left:10px;">
                                <table cellspacing="0" cellpadding="5" width="100%">
                                <tr>
                                    <td nowrap="nowrap" style="width: 100px;"><?php echo Portal::language('date');?><em style="color:#F00;">(*)</em>:</td>
				...
				if((Url::get('type')=='IMPORT'))
				{?>
                                    <td nowrap="nowrap" style="width: 90px; "><?php echo Portal::language('warehouse');?>:</td>
                                    <td style="">
                                        <!--<select  name="warehouse_id" id="warehouse_id" style="margin:0px;padding:0px;" onclick="ignore_change();"><?php
                    ...
                    ?>
                                        ...
                                        <input  name="warehouse_name" id="warehouse_name" readonly="readonly" style="width:120px; height: 24px; border: none;" / type ="text" value="<?php echo String::html_normalize(URL::get('warehouse_name'));?>">
                                        <input  name="warehouse_id" id="warehouse_id"/ type ="hidden" value="<?php echo String::html_normalize(URL::get('warehouse_id'));?>">
                                    </td>
				...
				if((Url::get('type')=='EXPORT'))
				{?>
                                    <td nowrap="nowrap" style="width: 90px; display: none;"><?php echo Portal::language('warehouse');?>:</td>
                    ...
                    ?>
                                        ...
                                        <input  name="warehouse_name" id="warehouse_name" readonly="readonly" style="background: lightgray; width:120px; height: 24px;" / type ="text" value="<?php echo String::html_normalize(URL::get('warehouse_name'));?>">
                                        <input  name="warehouse_id" id="warehouse_id"/ type ="hidden" value="<?php echo String::html_normalize(URL::get('warehouse_id'));?>">
                                    </td>
				...
				?>
                                    <td nowrap="nowrap" style="width: 90px;">
                                        <span class="label"><?php echo Portal::language('bill_number');?>: </span></td>
                                    <td>
                                        <input  name="bill_number" id="bill_number" readonly="readonly" style="width:120px; height: 24px; border: none;"  / type ="text" value="<?php echo String::html_normalize(URL::get('bill_number'));?>">
                                    </td>
                                    <td style="width: 90px;">
                                        <?php 
				if((Url::get('type')=='IMPORT'))
				...
				if((Url::get('type')=='IMPORT'))
				{?>
                                    <td nowrap="nowrap" style=""><?php echo Portal::language('export_to_warehouse');?>:
                                        <input  name="direct_export" id="direct_export" value="1" onclick="toogleToWarehouse(this);" style="margin:0px;padding:0px;" / type ="checkbox" value="<?php echo String::html_normalize(URL::get('direct_export'));?>"> 
                                    </td>
				...
				if((Url::get('type')=='EXPORT'))
				{?>
                                    <td nowrap="nowrap" style="display: none;"><?php echo Portal::language('export_to_warehouse');?>:
                                        <input  name="direct_export" id="direct_export" value="1" onclick="toogleToWarehouse(this);" style="margin:0px;padding:0px;" / type ="checkbox" value="<?php echo String::html_normalize(URL::get('direct_export'));?>"> 
                                    </td>
				...
				{?>
                                ...
                                <tr id="to_warehouse" style="display:none;">
                                    <td nowrap="nowrap" style="width: 100px;"><?php echo Portal::language('to_warehouse');?>:
                                    </td>
                                    <td style="width: 100px;">
                                        <select  name="to_warehouse_id" id="to_warehouse_id" style="width: 100%;height: 24px;"><?php
					if(isset($this->map['to_warehouse_id_list']))
					{
						foreach($this->map['to_warehouse_id_list'] as $key=>$value)
						{
							echo '<option value="'.$key.'"';
							echo '>'.$value.'</option>';
                    ...
                    if(URL::get('to_warehouse_id',isset($this->map['to_warehouse_id'])?$this->map['to_warehouse_id']:''))
                    echo "<script>$('to_warehouse_id').value = \"".addslashes(URL::get('to_warehouse_id',isset($this->map['to_warehouse_id'])?$this->map['to_warehouse_id']:''))."\";</script>";
                    ?>
	</select>
                                    </td>
                                    <td colspan="7">&nbsp;</td>
                                ...
                                <tr>
    	                            <td nowrap="nowrap" style="width: 100px;"><?php echo Portal::language('supplier');?>:
                                    </td>
                                    <td colspan="8">
                                        ...
                                        <input  name="supplier_code" id="supplier_code" style="width:110px;height: 24px;text-transform:uppercase;"  onblur="getSupplierFromCode(this.value);" onfocus="supplierAutocomplete();"/ type ="text" value="<?php echo String::html_normalize(URL::get('supplier_code'));?>">                                        
                                        : 
                                        <input  name="supplier_name" id="supplier_name" readonly="readonly" style=" width: 86%;height: 24px;background-color:#CCC;" onfocus="check(this);" / type ="text" value="<?php echo String::html_normalize(URL::get('supplier_name'));?>">
                                    </td>
                                    <script>
                                        function check(obj)
                                        {
                                ...
                                <tr>
                                    <td style="width: 100px;"><?php echo Portal::language('tax_code');?>:
                                    </td>
                                    <td style="width: 120px;">
                                         <input  name="tax_code" id="tax_code" readonly="readonly" style="width: 100%;height: 24px;background-color:#CCC;" / type ="text" value="<?php echo String::html_normalize(URL::get('tax_code'));?>">
                                    </td> 
                                    <td style="width: 90px;"><?php echo Portal::language('address');?>:</td>
                                    <td colspan="6">
                                         <input  name="address" id="address" readonly="readonly" style="width: 100%;height: 24px;background-color:#CCC;"/ type ="text" value="<?php echo String::html_normalize(URL::get('address'));?>">
                                    </td>
				...
				{?><!--chuyen kho-->
                                    <tr>
                                        <td nowrap="nowrap" style="width: 130px;"><?php echo Portal::language('from_warehouse');?>:</td>
                                        <td style="width: 120px;">
                                            <!--<select  name="warehouse_id" id="warehouse_id" style="margin:0px;padding:0px;" onclick="ignore_change();"><?php
					if(isset($this->map['warehouse_id_list']))
					{
                    ...
                    ?>
                                       	    ...
                                       	    <input  name="warehouse_name" id="warehouse_name" readonly="readonly" style="height: 24px; width: 100%; border: none;" / type ="text" value="<?php echo String::html_normalize(URL::get('warehouse_name'));?>">
                                            <input  name="warehouse_id" id="warehouse_id"/ type ="hidden" value="<?php echo String::html_normalize(URL::get('warehouse_id'));?>">
                                        </td>
                                        <td nowrap="nowrap" style="width: 100px;"><?php echo Portal::language('to_warehouse');?>:</td>
                                        <td style="width: 120px;">
                                            <select  name="to_warehouse_id" id="to_warehouse_id" style="width: 100%; height: 24px;"><?php
					if(isset($this->map['to_warehouse_id_list']))
					{
                    ...
                    ?>
                                    ...
                                    <!--xuat kho ra ngoai-->
                                    <tr>
                                        <td nowrap="nowrap" style="width: 130px;"><?php echo Portal::language('from_warehouse');?>:
                                        </td>
                                        <td style="width: 120px;">
                                            <!--<select  name="warehouse_id" id="warehouse_id" onclick="ignore_change();"><?php
					if(isset($this->map['warehouse_id_list']))
					{
						foreach($this->map['warehouse_id_list'] as $key=>$value)
						{
                    ...
                    ?>
                                            ...
                                            <input  name="warehouse_name" id="warehouse_name" readonly="readonly" style="width: 100%; border: none;" / type ="text" value="<?php echo String::html_normalize(URL::get('warehouse_name'));?>">
                                            <input  name="warehouse_id" id="warehouse_id"/ type ="hidden" value="<?php echo String::html_normalize(URL::get('warehouse_id'));?>">
                                       	
                                           </td>
                                           <td nowrap="nowrap" style="width: 130px;"><span class="label"><?php echo Portal::language('receiver_name_1');?> :</span></td>
                                           <td>
                                            <select  name="wh_receiver_name" id="wh_receiver_name" style=" width: 120px; height: 24px;"><?php
					if(isset($this->map['wh_receiver_name_list']))
					{
						foreach($this->map['wh_receiver_name_list'] as $key=>$value)
						{
							echo '<option value="'.$key.'"';
							echo '>'.$value.'</option>';
                    ...
                    if(URL::get('wh_receiver_name',isset($this->map['wh_receiver_name'])?$this->map['wh_receiver_name']:''))
                    echo "<script>$('wh_receiver_name').value = \"".addslashes(URL::get('wh_receiver_name',isset($this->map['wh_receiver_name'])?$this->map['wh_receiver_name']:''))."\";</script>";
                    ?>
	</select></td>
                                    ...
                                    <tr>
                                        <td nowrap="nowrap" style="width: 130px;"><?php echo Portal::language('returned_supplier');?>:</td>
                                        <td style="width: 120px;">
                                            <input  name="get_back_supplier" id="get_back_supplier" value="1" onclick="toogleSupplierSelect(this);" style="height: 24px;" width="100%"  / type ="checkbox" value="<?php echo String::html_normalize(URL::get('get_back_supplier'));?>">
                                       	    <script>
                                    ...
                                    <!--<tr id="returned_supplier" style="display:none;">
        	                            <td nowrap="nowrap"><?php echo Portal::language('supplier');?>:</td>
                                        <td nowrap="nowrap" colspan="3">
                                            <select  name="supplier_id" id="supplier_id" style="margin:0px;padding:0px;"><?php
                    ...
                    ?>
                                    ...
                                    <tr id="returned_supplier" style="display:none;">
        	                            <td nowrap="nowrap"><?php echo Portal::language('supplier');?>:</td>
                                        <td nowrap="nowrap" colspan="3">
                                            <input  name="ware_supplier_name" id="ware_supplier_name" onfocus="Autocomplete()"  / type ="text" value="<?php echo String::html_normalize(URL::get('ware_supplier_name'));?>">
                                            <input  name="ware_supplier_id" id="ware_supplier_id" style="display:none;"  / type ="text" value="<?php echo String::html_normalize(URL::get('ware_supplier_id'));?>">
                                        </td>
        							</tr> 
				...
				?>
                                ...
                                <tr>
                                    <td valign="top" style="width: 100px;"><?php echo Portal::language('description');?>:</td>
                                    <?php if(Url::get('type')=='IMPORT'){ ?>
                                    <td colspan="8"><textarea  name="note" tabindex="5_100" id="note" rows="3" style="padding:0px;margin:0px;width:100%;"><?php echo String::html_normalize(URL::get('note',''));?></textarea></td>                              
                                    <?php }else{ ?>
                                    <td colspan="3"><textarea  name="note" tabindex="3_100" id="note" rows="3" style="padding:0px;margin:0px;width:100%;"><?php echo String::html_normalize(URL::get('note',''));?></textarea></td> 
                                    <?php } ?>
                                </tr>
                                <tr>
                                    <?php 
				if((Url::get('type')=='IMPORT'))
				{?>
                                    <td nowrap="nowrap"><span class="label" style="display: none;"><?php echo Portal::language('receiver_name_1');?> :</span></td>
                                    <td><select  name="wh_receiver_name" id="wh_receiver_name" style="margin:0px;padding:0px; display: none;"><?php
					if(isset($this->map['wh_receiver_name_list']))
					{
						foreach($this->map['wh_receiver_name_list'] as $key=>$value)
						{
                    ...
                    ?>
                                    ...
                                    <!--<input  name="wh_receiver_name" id="wh_receiver_name" tabindex="+" style="margin:0px;padding:0px;"/ type ="text" value="<?php echo String::html_normalize(URL::get('wh_receiver_name'));?>">-->
                                    
				<?php
				}
				?>
                                    </td> 
                                    <td nowrap="nowrap" style="width: 90px;"><span class="label"><?php echo Portal::language('receiver');?>:</span></td>
                                    ...
                                    <td nowrap="nowrap" style="width: 90px;"><?php echo Portal::language('deliver');?>:</td>
				...
				<fieldset>
                    <legend class="" style="text-transform: uppercase; font-size: 14px; padding-top: 10px; padding-bottom: 10px;"><?php echo Portal::language('products');?></legend>
                        <span id="mi_product_all_elems" style="text-align:center; text-transform: uppercase;">
                            <span>
								<span class="multi-input-header" style="width:80px; height: 24px; padding-top: 4px;"><?php echo Portal::language('code');?></span>
								<span class="multi-input-header" style="width:150px;height: 24px;padding-top: 4px;"><?php echo Portal::language('name');?></span>
                                <span class="multi-input-header" style="width:55px;height: 24px;padding-top: 4px;"><?php echo Portal::language('unit_at');?></span>
                                <span class="multi-input-header" style="width:140px;height: 24px;padding-top: 4px;"><?php echo Portal::language('category');?></span>
                                <span class="multi-input-header" style="width:80px;height: 24px;padding-top: 4px;"><?php echo Portal::language('type');?></span>
                                <span class="multi-input-header" style="width:100px;height: 24px;padding-top: 4px;"><?php echo Portal::language('remain_quantity');?></span> 
                                <?php 
				if((!Url::get('edit_average_price') and Url::get('edit_average_price') != 1))
				{?>
								<span class="multi-input-header" style="width:80px;height: 24px;padding-top: 4px;"><?php echo Portal::language('quantity');?></span>
				...
				if((Url::get('type')=='IMPORT'))
				{?>
                                <?php echo Portal::language('last_import_price');?>
                                 <?php }else{ ?>
                                <?php echo Portal::language('average_price');?>
				...
				{?>
                                <?php 
				if((!Url::get('edit_average_price') or Url::get('edit_average_price') != 1))
				{?>  
                                <span class="multi-input-header" style="width:80px;height: 24px;padding-top: 4px;"><?php echo Portal::language('price');?></span>
				...
				if((!Url::get('edit_average_price') or Url::get('edit_average_price') != 1))
				{?>
                                <span class="multi-input-header" style="width:80px;height: 24px;padding-top: 4px;"><?php echo Portal::language('amount');?></span>
                                 <?php }else{ ?>
                                <span class="multi-input-header" style="width:80px;height: 24px;padding-top: 4px;"><?php echo Portal::language('add_money');?></span>
				...
				?>
						...
						<input class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase;" id="add_new" type="button" value="<?php echo Portal::language('add_product');?>" 
                            onclick="
                ...
                <div style="height: 200px; width: 100%;">
                    <fieldset id="total_payment_bound" style="float:right; margin-right: 20px; padding:20px;">
                        <div style="text-align:right;">
    						<strong><?php echo Portal::language('total');?>:</strong> 
                            <input  name="total_amount" id="total_amount" readonly="true" style="width:100px;text-align:right;border:0px;border-bottom:1px solid #CCCCCC;font-weight:bold;color:#000000;"/ type ="text" value="<?php echo String::html_normalize(URL::get('total_amount'));?>">
    					</div>
                        <br />
                        <div style="text-align:right;">
    						<strong><?php echo Portal::language('tax');?>:</strong> 
                            <input  name="tax" id="tax" class="input_number" oninput="this.value = number_format(to_numeric(this.value)); updateTotalPayment();" style="width:100px;text-align:right;border:0px;border-bottom:1px solid #CCCCCC;font-weight:bold;color:#000000;"/ type ="text" value="<?php echo String::html_normalize(URL::get('tax'));?>">
    					</div>
                        <br />
                        <div style="text-align:right;">
                            <strong><?php echo Portal::language('total_amount');?>:</strong> 
                            <input  name="total" id="total" readonly="true" style="width:100px;text-align:right;border:0px;border-bottom:1px solid #CCCCCC;font-weight:bold;color:#000000;"/ type ="text" value="<?php echo String::html_normalize(URL::get('total'));?>">
                        </div>
...
function getSupplierFromCode(value)
{
    ...
    else
    {
        if(value)
        {
            ...
            $('supplier_name').value = '<?php echo Portal::language('New_supplier');?>';
        }
        else
        {
    		$('supplier_name').readOnly = true;
    ...
    else//neu khong co
    {
        if(invoice_type=='IMPORT')//neu hoa don nhap => kiem tra co trong all product khong
        {
			...
			for(j in all_products)
            {
                ...
                {
					flag = 1;	
					alert('<?php echo Portal::language('product_code_exists');?>');
					return false;
				}
			}
			if(flag == 0)
        ...
        {
            //alert('<?php echo Portal::language('product_is_not_in_warehouse');?>');
            $('name_'+id).className = 'notice';
            $('name_'+id).value = '<?php echo Portal::language('product_is_not_in_warehouse');?>';
...
<?php 
    ...
    //jQuery("#total_payment_bound").hide();
    <?php 
				if((Url::get('get_back_supplier') && Url::get('get_back_supplier')!=''))
				{?>
...
{
    <?php 
				if((ALLOW_OVER_EXPORT==0&&Url::get('type')=='EXPORT'))
				{?>
        //alert(1);
        ...
        if(to_numeric(remain) < to_numeric(num))
        {
            ...
            {
                alert('<?php echo Portal::language('product_has_not_in_warehouse');?>');
                mi_delete_row($('input_group_'+id),'mi_product',id,'group_');
            }
            else
            {
                alert('<?php echo Portal::language('remain_is_0');?>');
                $('num_'+id).value = '';
            } 
        }
				...
				?>    
    <?php 
				if((ALLOW_OVER_EXPORT == 1 && Url::get('type') == 'EXPORT'))
				{?>
