...
<tr><td>
	...
	<td align="center">
		<p>&nbsp;</p>
        <h2 class="report-title-new"><?php echo Portal::language('detailed_daily_report');?></h2>
		<br>
		...
		<table border="0">
            ...
            <tr>    
                    <td></td>
             		<td style="width: 25px;"> <input  name="checked_all" id="checked_all"/ type ="checkbox" value="<?php echo String::html_normalize(URL::get('checked_all'));?>"></td> 
                    <td ><b><label for="checked_all"><?php echo Portal::language('select_all_bar');?></label></b></td>
             </tr>
