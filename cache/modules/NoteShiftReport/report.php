                ...
                <tr>
    				<td colspan="2"> 
                        <div style="width:100%; text-align:center;">
                            <font class="report_title specific" ><?php echo Portal::language('note_shift_report');?><br /></font>
...
<?php 
				...
				{?>
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="margin:auto;">
	<tr bgcolor="#EFEFEF">
       
        <th class="report_table_header" width="10%"><?php echo Portal::language('room');?></th>
        <th class="report_table_header" width="90%"><?php echo Portal::language('note');?></th>
    </tr>
...
<!---------LAST GROUP VALUE----------->	        
    <tr>
        <td class="report_sub_title" align="right"><b><?php echo Portal::language('last_page_summary');?></b></td>
    ...
    <tr bgcolor="white">
        ...
        <td align="center" class="report_table_column"><?php echo $this->map['items']['current']['name'];?></td>
        <td align="left" class="report_table_column" style="padding-left:2%;"><?php echo $this->map['items']['current']['note'];?></td>
	</tr>
	<?php }}unset($this->map['items']['current']);} ?>
    <tr>
        <td align="right" class="report_sub_title" ><b><?php if($this->map['page_no']==$this->map['total_page'])echo Portal::language('summary');else echo Portal::language('next_page_summary');?></b></td>        
        <td style="text-align:left;padding-left:2%;" class="report_table_column"><strong><?php echo System::display_number($this->map['group_function_params']['total']);?></strong></td>
