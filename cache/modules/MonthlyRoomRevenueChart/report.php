...
<tr>
	...
	<tr>
	<td align="center">
		<font class="report_title" style="font-size:20px; text-align:center;"><b><?php echo Portal::language('montly_revenue_chart_year');?></b></font>
		<br><br />
		...
		<table border="0" style="margin:auto;">
        	<tr style="text-align:center;">
            	<td><?php echo Portal::language('month_from');?>:&nbsp;&nbsp;</td>
            	<td>
                ...
                <td><?php echo Portal::language('year');?></td>
                <td>
                ...
                <td><?php echo Portal::language('month_to');?>:&nbsp;&nbsp;</td>
                <td>
...
<script type="text/javascript">
	...
	var title = '';
	if(curency='VND'){
		title='<?php echo Portal::language('unit');?> 1000 VND';
	}
	var $money=0;
	var chart;
	jQuery(document).ready(function() {
		...
		chart = new Highcharts.Chart({
			...
			yAxis: {
				min:0,
				title: {
					text: '<?php echo Portal::language('month_revenue');?>'
				}
			}
			,
			plotOptions: {
			...
			tooltip:{
				formatter: function() {
					s ='<?php echo Portal::language('month');?>:'+this.x+'<br/><b><?php echo Portal::language('revenue');?>:'+ number_format(this.y)+'</b><br/>';
					return s;
				}
			},
			rect:{
			...
			series: [{
				name: '<?php echo Portal::language('mont_revenue');?> ',
				data:oy
			}, { name:'', data:[]
			}]
		});
