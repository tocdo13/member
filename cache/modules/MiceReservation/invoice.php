   ...
   <div style="width: 950px; height: auto; margin: 10px auto; padding: 5px; background: #FFFFFF; border: 1px solid #DDDDDD;">
        <table style="width: 100%;" cellpadding="5" border="1" bordercolor="#EEEEEEE">
            <tr style="display: none;">
                <td colspan="2" style="text-align: center; text-transform: uppercase;">
                    <h1 style="line-height: 30px; padding: 0px; margin: 0px auto; font-weight: normal; color: #656565;">
                        <?php echo Portal::language('invoice');?> MICE <?php echo Url::get('id'); ?>
            ...
            <tr>
                <td style="width: 50%;">
                    <select  onclick="OpenMiceInvoice(this.value);" style="padding: 5px; margin-right: 5px; border: 1px solid #ff6600; color: #ff6600; font-weight: bold;">
                        <option value="" style="color: #ff6600; font-weight: bold;"><?php echo Portal::language('bill_folio');?></option>
                        <?php if(isset($this->map['invoice_mice_other']) and is_array($this->map['invoice_mice_other'])){ foreach($this->map['invoice_mice_other'] as $key1=>&$item1){if($key1!='current'){$this->map['invoice_mice_other']['current'] = &$item1;?>
                        <?php if($this->map['invoice_mice_other']['current']['payment_time']!=''){ ?>
                            <option value="<?php echo $this->map['invoice_mice_other']['current']['id'];?>" style="color: #ff6600; font-weight: bold;"> - <?php echo $this->map['invoice_mice_other']['current']['bill_id'];?></option>
                        <?php }?>
                        <?php }}unset($this->map['invoice_mice_other']['current']);} ?>
                    </select>
                    <select  onclick="OpenMiceInvoice(this.value);" style="padding: 5px; margin-right: 5px; border: 1px solid #89d0ff; color: #89d0ff; font-weight: bold;">
                        <option value="" style="color: #89d0ff; font-weight: bold;"><?php echo Portal::language('preview_order');?></option>
                        <?php if(isset($this->map['invoice_mice_other']) and is_array($this->map['invoice_mice_other'])){ foreach($this->map['invoice_mice_other'] as $key2=>&$item2){if($key2!='current'){$this->map['invoice_mice_other']['current'] = &$item2;?>
                        <?php if($this->map['invoice_mice_other']['current']['payment_time']==''){ ?>
                            <option value="<?php echo $this->map['invoice_mice_other']['current']['id'];?>" style="color: #89d0ff; font-weight: bold;"> - <?php echo $this->map['invoice_mice_other']['current']['bill_id'];?></option>
                        <?php } ?>
                        <?php }}unset($this->map['invoice_mice_other']['current']);} ?>
                    </select>
                </td>
                <td style="text-align: right;">
                    <?php if(isset($this->map['invoice_mice_other']) and is_array($this->map['invoice_mice_other'])){ foreach($this->map['invoice_mice_other'] as $key3=>&$item3){if($key3!='current'){$this->map['invoice_mice_other']['current'] = &$item3;?>
                    <?php if(Url::get('invoice_id')==$this->map['invoice_mice_other']['current']['id']){ ?>
                        <span style="float: left; line-height: 30px; color: #ff5656; font-weight: bold;"><?php echo $this->map['invoice_mice_other']['current']['bill_id'];?></span>
                    <?php } ?>
                    <?php }}unset($this->map['invoice_mice_other']['current']);} ?>
                    <select  name="reservation_traveller_id" id="reservation_traveller_id" style="padding: 5px; width: 150px;"><?php
                    ...
                    <?php if(User::can_edit(false,ANY_CATEGORY)){ ?>
                        <div id="save" class="DivButton" onclick="jQuery('#act').val('save'); InvoiceMiceReservationForm.submit();" style="display: none;">
                            <label> <span><i class="fa fa-save fa-fw"></i> <?php echo Portal::language('save');?></span></label>
                        </div>
                    <?php } ?>
                    <?php if(User::can_add(false,ANY_CATEGORY)){ ?>
                        <div class="DivButton" onclick="window.location.href='?page=mice_reservation&cmd=invoice&id=<?php echo Url::get('id'); ?>';">
                            <label> <span><i class="fa fa-plus fa-fw"></i> <?php echo Portal::language('create_mice_invoice');?></span></label>
                        </div>
                    <?php } ?>
                </td>
            </tr>
                ...
                <td colspan="2" style="display: none;">
                    <ul class="tag-button green">
                        <?php if(isset($this->map['items']) and is_array($this->map['items'])){ foreach($this->map['items'] as $key4=>&$item4){if($key4!='current'){$this->map['items']['current'] = &$item4;?>
                            <?php if($this->map['items']['current']['count_item']>0){ ?>
                            <li><i><?php echo $this->map['items']['current']['name'];?> <span><?php echo $this->map['items']['current']['count_item'];?></span></i></li>
                            <?php } ?>
                            ...
                            <tr style="background: #F8F8F8;">
                                <td colspan="3">
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="width: 20px; text-align: center; font-weight: bold;"><i id="items_<?php echo $this->map['items']['current']['id'];?>" class="fa fa-fw fa-plus-square-o iconasome" onclick="toogleshowhide('items_<?php echo $this->map['items']['current']['id'];?>');"></i><input id="class_items_<?php echo $this->map['items']['current']['id'];?>" type="checkbox" checked="checked" style="display: none;" /></td>
                                            <td style="font-weight: bold;"><?php echo $this->map['items']['current']['id'];?>: <i><?php echo $this->map['items']['current']['name'];?></i></td>
                                            <td style="text-align: right; font-weight: bold;"><?php echo System::display_number($this->map['items']['current']['total_amount']); ?></td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width: 20px; text-align: center;"><i onclick="moveitem('<?php echo $this->map['items']['current']['id'];?>','ALL');" class="fa fa-fw fa-2x fa-arrow-circle-o-right iconasome"></i></td>
                            </tr>
                            <?php if(isset($this->map['items']['current']['item']) and is_array($this->map['items']['current']['item'])){ foreach($this->map['items']['current']['item'] as $key6=>&$item6){if($key6!='current'){$this->map['items']['current']['item']['current'] = &$item6;?>
                                <tr class="class_items_<?php echo $this->map['items']['current']['id'];?>" id="mice_items_<?php echo $this->map['items']['current']['id'];?>_<?php echo $this->map['items']['current']['item']['current']['id'];?>" style="display: none; <?php if($this->map['items']['current']['item']['current']['status']==1){ ?> background: #DDDDDD; <?php } ?>">
                                    <td colspan="3">
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="width: 40px; text-align: center;"><?php echo substr($this->map['items']['current']['item']['current']['date'],0,-5); ?></td>
                                                <td><?php echo $this->map['items']['current']['item']['current']['description'];?> <?php echo $this->map['items']['current']['item']['current']['description_'];?></td>
                                                <td style="text-align: right;"><a target="_blank" href="<?php echo $this->map['items']['current']['item']['current']['link'];?>" style="color: #15885b;"><?php echo $this->map['items']['current']['item']['current']['bill_number'];?></a></td>
                                                <td style="text-align: right; width: 120px;">
                                                    <?php echo $this->map['items']['current']['item']['current']['total_amount'];?>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td style="width: 20px; text-align: center;"><i onclick="moveitem('<?php echo $this->map['items']['current']['id'];?>','<?php echo $this->map['items']['current']['item']['current']['id'];?>');" class="fa fa-fw fa-2x fa-arrow-circle-o-right iconasomechild"></i></td>
                                </tr>
                ...
                <td style="vertical-align: top;">
                    <table id="TableSplit" style="width: 100%;" cellpadding="5" border="1" bordercolor="#EEEEEEE">
                        <tr style="text-transform: uppercase; height: 35px;">
                            <th><?php echo Portal::language('description');?> <?php echo Portal::language('detail');?></th>
                            <th>%</th>
                    ...
                    <table id="PaymentDescription" style="width: 100%; display: none;" cellpadding="5" border="1" bordercolor="#EEEEEEE">
                        <tr>
                            <td colspan="3"></td>
                            <td style="text-align: right;"><b><i><?php echo Portal::language('amount');?>: </i></b></td>
                            <td style="width: 120px; text-align: right;"><input  name="total_before_tax" id="total_before_tax" readonly="" style="border: none; text-align: right; width: 120px;" / type ="text" value="<?php echo String::html_normalize(URL::get('total_before_tax'));?>"></td>
                            <td style="width: 20px; text-align: center;"></td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                            <td style="text-align: right;"><b><i><?php echo Portal::language('service_amount');?>: </i></b></td>
                            <td style="width: 120px; text-align: right;"><input  name="service_amount" id="service_amount" readonly="" style="border: none; text-align: right; width: 120px;" / type ="text" value="<?php echo String::html_normalize(URL::get('service_amount'));?>"></td>
                            <td style="width: 20px; text-align: center;"></td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                            <td style="text-align: right;"><b><i><?php echo Portal::language('tax_amount');?>: </i></b></td>
                            <td style="width: 120px; text-align: right;"><input  name="tax_amount" id="tax_amount" readonly="" style="border: none; text-align: right; width: 120px;" / type ="text" value="<?php echo String::html_normalize(URL::get('tax_amount'));?>"></td>
                            <td style="width: 20px; text-align: center;"></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"><b><i><?php echo Portal::language('extra_amount');?>: </i></b></td>
                            <td style="width: 120px; text-align: right;"><input  name="extra_amount" id="extra_amount" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val())));" class="input_number" style="border: none; text-align: right; width: 120px;" / type ="text" value="<?php echo String::html_normalize(URL::get('extra_amount'));?>"></td>
                            <td style="width: 20px; text-align: center;"></td>
                            <td style="text-align: right;"><b><i><?php echo Portal::language('extra_vat');?>: </i></b></td>
                            <td style="width: 120px; text-align: right;"><input  name="extra_vat" id="extra_vat" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); gettotalamount();" class="input_number" style="border: none; text-align: right; width: 120px;" / type ="text" value="<?php echo String::html_normalize(URL::get('extra_vat'));?>"></td>
                            <td style="width: 20px; text-align: center;"></td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                            <td style="text-align: right;"><b><i><?php echo Portal::language('total_amount');?>: </i></b></td>
                            <td style="width: 120px; text-align: right;"><input  name="total_amount" id="total_amount" readonly="" style="border: none; text-align: right; width: 120px;" / type ="text" value="<?php echo String::html_normalize(URL::get('total_amount'));?>"></td>
                            <td style="width: 20px; text-align: center;"></td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                            <td style="text-align: right;"><b><i><?php echo Portal::language('balance');?>: </i></b></td>
                            <td style="width: 120px; text-align: right;">
                                <input value="<?php echo $this->map['payment'];?>" name="payment" type="text" id="payment" readonly="" style="border: none; text-align: right; width: 120px; display: none;" />
                                <input  name="balance" id="balance" readonly="" style="border: none; text-align: right; width: 120px;" / type ="text" value="<?php echo String::html_normalize(URL::get('balance'));?>">
                            </td>
                            <td style="width: 20px; text-align: center;"></td>
                        </tr>
                    </table>
                            ...
                            <td style="text-align: right;">
                                <?php if(isset($_REQUEST['invoice_id'])){ ?>
                                    <div class="DivButton" onclick="window.open('?page=mice_reservation&cmd=bill_new&invoice_id=<?php echo $_REQUEST['invoice_id']; ?>')">
                                        <label> <span><i class="fa fa-file fa-fw"></i> <?php echo Portal::language('view_invoice');?></span></label>
                                    </div>
                                <?php } ?>
                                <?php if(User::can_edit(false,ANY_CATEGORY)){ ?>
                                    <div id="payment_button" class="DivButton" onclick="jQuery('#act').val('payment'); InvoiceMiceReservationForm.submit();" style="display: none;">
                                        <label> <span><i class="fa fa-usd fa-fw"></i> <?php echo Portal::language('save_and_payment');?></span></label>
                                    </div>
                                <?php } ?>
                                <?php if(User::can_edit(false,ANY_CATEGORY)){ ?>
                                    <div id="refunr_button" class="DivButton" onclick="jQuery('#act').val('payment'); InvoiceMiceReservationForm.submit();" style="display: none;">
                                        <label> <span><i class="fa fa-usd fa-fw"></i> <?php echo Portal::language('save_and_refunr');?></span></label>
                                    </div>
                                <?php } ?>
                            </td>
                        </tr>
            ...
            <tr style="height: 50px;">
                <td colspan="2">
                    <i class="fa fa-fw fa-bookmark" style="color: #ff5656; float: left; font-size: 13px;"></i><span style="color: #656565; float: left;"><?php echo Portal::language('note');?>:</span> 
                    <div style="width: 15px;  height: 15px; background: #89d0ff; float: left; margin-left: 20px;"></div>
                    <span style="margin-left: 5px; color: #656565; float: left;"><?php echo Portal::language('preview_order');?></span> 
                    <div style="width: 15px; height: 15px; background: #ff6600; float: left; margin-left: 20px;"></div>
                    <span style="margin-left: 5px; color: #656565; float: left;"><?php echo Portal::language('bill_folio');?></span>
                    <div style="width: 15px; height: 15px; background: #ff5656; float: left; margin-left: 20px;"></div>
                    <span style="margin-left: 5px; color: #656565; float: left;"><?php echo Portal::language('invoice_active');?></span>
                </td>
            </tr>
            -->
        </table>
...
<script>
    var items_js = <?php echo String::array2js($this->map['items']); ?>;
    var invoice_detail = new Array();
    var Input_count_group = 100;
    var Input_count_item = 101;
    <?php if(isset($_REQUEST['invoice_id'])){ ?>
        invoice_detail = <?php echo String::array2js($this->map['invoice_detail']); ?>;
        Input_count_group = <?php echo $this->map['input_count'];?>;
        Input_count_item = <?php echo $this->map['input_count_detail'];?>;
        jQuery("#extra_amount").val(number_format(to_numeric(<?php echo $this->map['extra_amount']==''?0:$this->map['extra_amount']; ?>)));
        jQuery("#extra_vat").val(number_format(to_numeric(<?php echo $this->map['extra_vat']==''?0:$this->map['extra_vat']; ?>)));
        parselayout();
    <?php } ?>
    ...
    function parselayout()
    {
        ...
        content = '<tr style="text-transform: uppercase; height: 35px;">';
                    content += '<th><?php echo Portal::language('description');?> <?php echo Portal::language('detail');?></th>';
                    content += '<th>%</th>';
                    content += '<th style="width: 120px;"><?php echo Portal::language('amount');?></th>';
