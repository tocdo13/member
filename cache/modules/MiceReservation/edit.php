<form name="EditMiceReservationForm" method="POST">
                    ...
                    <td>
                        <div class="DivTitle">
                            ...
                            <?php if(Url::get('cmd')=='edit'){ ?>
                                <h1 style="border: none;"><?php echo Portal::language('detail');?> MICE</h1>
                            <?php }else{ ?>
                                <h1 style="border: none;"><?php echo Portal::language('mice_reservation');?></h1>
                            <?php } ?>
                        </div>
                    </td>
                    <td>
                        ...
                        <div id="JsPdf" >
                            ...
                            <span><?php echo Portal::language('PDF');?></span>
                        </div>
                        <div id="editor"></div>
                        -->
                        ...
                        <?php if( (Url::get('cmd')=='add' AND User::can_add(false,ANY_CATEGORY)) OR (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
                        <div class="DivButton" onclick="CheckSubmit('SAVE');">
                            ...
                            <span><?php echo Portal::language('save');?></span>
                        </div>
                        <?php } ?>
                        <?php if( (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
                        <div class="DivButton" onclick="CheckSubmit('CONFIRM');">
                            ...
                            <span><?php echo Portal::language('confirm_for_guest');?></span>
                        </div>
                        <?php } ?>
                        <?php if( (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
        ...
        <div id="MiceReservationContainer">
            <div id="MiceReservationInfoContact">
                ...
                <table cellpadding="10" style="width: 100%;">
                    <tr>
                        <td>
                            <label><i class="fa fa-user fa-fw"></i> <?php echo Portal::language('contact_person');?>:</label><br />
                            <input  name="contact_name" id="contact_name" / type ="text" value="<?php echo String::html_normalize(URL::get('contact_name'));?>">
                        </td>
                        <td>
                            <label><i class="fa fa-group fa-fw"></i> <?php echo Portal::language('customer_name');?>:</label><br />
                            <input  name="customer_name" id="customer_name" onfocus="Autocomplete();" autocomplete="OFF" style="width: 210px;" / type ="text" value="<?php echo String::html_normalize(URL::get('customer_name'));?>">
                        ...
                        <td rowspan="6" style="vertical-align: top;">
                            <label><i class="fa fa-sticky-note fa-fw"></i> <?php echo Portal::language('note');?>:</label><br />
                            <textarea  name="note" id="note" style="width: 400px; height: 210px; border: 1px solid #217346;"><?php echo String::html_normalize(URL::get('note',''));?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label><i class="fa fa-phone fa-fw"></i> <?php echo Portal::language('contact_phone');?>:</label><br />
                            <input  name="contact_phone" id="contact_phone" autocomplete="OFF" / type ="text" value="<?php echo String::html_normalize(URL::get('contact_phone'));?>">
                        </td>
                        <td>
                            <label><i class="fa fa-user-secret fa-fw"></i> <?php echo Portal::language('traveller_name');?>:</label><br />
                            <input  name="traveller_name" id="traveller_name" onfocus="get_traveler();" autocomplete="OFF" style="width: 210px;" / type ="text" value="<?php echo String::html_normalize(URL::get('traveller_name'));?>">
                            <input  name="traveller_id" id="traveller_id" style="display: none;" / type ="text" value="<?php echo String::html_normalize(URL::get('traveller_id'));?>">
                    ...
                    <tr>
                        <td>
                            <label><i class="fa fa-envelope-o fa-fw"></i> <?php echo Portal::language('contact_email');?>:</label><br />
                            <input  name="contact_email" id="contact_email" autocomplete="OFF" / type ="text" value="<?php echo String::html_normalize(URL::get('contact_email'));?>">
                        </td>
                        <td>
                            <label><i class="fa fa-calendar-times-o fa-fw"></i> <?php echo Portal::language('create_date');?>:</label><br />
                            <input  name="code_mice" id="code_mice" autocomplete="OFF" / type ="text" value="<?php echo String::html_normalize(URL::get('code_mice'));?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label><i class="fa fa-calendar-times-o fa-fw"></i> <?php echo Portal::language('start_date');?>:</label><br />
                            <input  name="start_date" id="start_date" autocomplete="OFF" / type ="text" value="<?php echo String::html_normalize(URL::get('start_date'));?>">
                        </td>
                        <td>
                            <label><i class="fa fa-calendar-times-o fa-fw"></i> <?php echo Portal::language('end_date');?>:</label><br />
                            <input  name="end_date" id="end_date" autocomplete="OFF" / type ="text" value="<?php echo String::html_normalize(URL::get('end_date'));?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label><i class="fa fa-calendar-times-o fa-fw"></i> <?php echo Portal::language('cut_of_date');?>:</label><br />
                            <input  name="cut_of_date" id="cut_of_date" autocomplete="OFF" / type ="text" value="<?php echo String::html_normalize(URL::get('cut_of_date'));?>">
                        </td>
                        <td>
                            <?php if(Url::get('cmd')=='edit'){ ?>
                                <label><i class="fa fa-code fa-fw"></i> <?php echo Portal::language('code_mice');?>:</label><br />
                    ...
                    <tr>
                        <td>
                            <?php if(isset($this->map['items']) and is_array($this->map['items'])){ foreach($this->map['items'] as $key1=>&$item1){if($key1!='current'){$this->map['items']['current'] = &$item1;?>
                                <div id="MiceDepartment_<?php echo $this->map['items']['current']['id'];?>" class="Department DepartmentHide" >
                                    <input id="SH_<?php echo $this->map['items']['current']['id'];?>" type="checkbox" style="display: none;" />
                                    ...
                                    <div class="DepartmentItems">
                                        <?php if($this->map['items']['current']['id']=='REC'){ ?>
                                            <table id="MutilsREC" cellpadding="4" style="width: 100%;">
                                                <tr style="border-bottom-style: double; background: #217346; height: 35px;">
                                                    <th><label></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('room_level');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('quantity_def');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('child');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('adult');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('time_in');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('from_date');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('time_out');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('to_date');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('price');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('usd_price');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_amount');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('net');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('service_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('tax_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('note');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('delete');?></label></th>
                                                </tr>
                                            </table>
                                        <?php }elseif($this->map['items']['current']['id']=='EXS'){ ?>
                                            <table id="MutilsEXS" cellpadding="4" style="width: 100%;">
                                                <tr style="border-bottom-style: double; background: #217346; height: 35px;">
                                                    <th><label></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('type');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('service');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('start_date');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('end_date');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('quantity');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('price');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_before_tax');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('service_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('tax_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_amount');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('net');?></label></th>
                                                    <th style="display: none;"><label style="color: #FFFFFF;"><?php echo Portal::language('close');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('note');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('delete');?></label></th>
                                                </tr>
                                            </table>
                                        <?php }elseif($this->map['items']['current']['id']=='RES'){ ?>
                                            <table id="MutilsRES" cellpadding="4" style="width: 100%;">
                                                <tr style="border-bottom-style: double; background: #217346; height: 35px;">
                                                    <th><label></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('bar');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('bar_table');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('date');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('time_in');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('time_out');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('full_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('full_charge');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('service_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('tax_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF; display: none;"><?php echo Portal::language('order_type');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('num_people');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('discount');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('discount_percent');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('delete');?></label></th>
                                                </tr>
                                            </table>
                                        <?php }elseif($this->map['items']['current']['id']=='VENDING'){ ?>
                                            <table id="MutilsVENDING" cellpadding="4" style="width: 100%;">
                                                <tr style="border-bottom-style: double; background: #217346; height: 35px;">
                                                    <th><label></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('area_vending');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('date');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('time_in');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('full_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('full_charge');?></label></th>
                                        ...
                                        <?php }elseif($this->map['items']['current']['id']=='BANQUET'){ ?>
                                            <table id="MutilsPARTY" cellpadding="4" style="width: 100%;">
                                                <tr style="border-bottom-style: double; background: #217346; height: 35px;">
                                                    <th><label></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('party_type');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('date');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('time_in');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('time_out');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('service_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('tax_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('promotions');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_before_tax');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('delete');?></label></th>
                                                </tr>
                                            </table>
                                        <?php }elseif($this->map['items']['current']['id']=='SPA'){ ?>
                                            <table id="MutilsSPA" cellpadding="4" style="width: 100%;">
                                                <tr style="border-bottom-style: double; background: #217346; height: 35px;">
                                                    <th><label></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('net');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('discount_before_tax');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('discount_percent');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('discount_amount');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('tax_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('service_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_before_tax');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_amount');?></label></th>
                                        ...
                                        <?php }elseif($this->map['items']['current']['id']=='TICKET'){ ?>
                                            <table id="MutilsTICKET" cellpadding="4" style="width: 100%;">
                                                <tr style="border-bottom-style: double; background: #217346; height: 35px;">
                                                    <th><label></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('ticket_area');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('ticket');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('date_used');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('quantity');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('price');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('discount_quantity');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('discount_rate');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_before_tax');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('total_amount');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('note');?></label></th>
                                                    <th><label style="color: #FFFFFF;"><?php echo Portal::language('delete');?></label></th>
                                        ...
                                        <?php if( (Url::get('cmd')=='add' AND User::can_add(false,ANY_CATEGORY)) OR (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
                                        <br />
                                        <div class="DivButton"  onclick="AddItems('<?php echo $this->map['items']['current']['id'];?>'); GetTotalAmount();" style="float: left; clear: both;">
                                            <div class="DivButtonIcon"><img src="packages/hotel/packages/mice/skins/img/add.png" /></div>
                                            <span><?php echo Portal::language('add');?> <?php if($this->map['items']['current']['id']=='REC'){ ?><?php echo Portal::language('booking');?><?php }elseif($this->map['items']['current']['id']=='RES'){ ?><?php echo Portal::language('bar_reservation');?><?php }elseif($this->map['items']['current']['id']=='BANQUET'){ ?><?php echo Portal::language('party');?><?php }elseif($this->map['items']['current']['id']=='SPA'){ ?><?php echo Portal::language('spa');?><?php } ?></span>
                                        </div>
                                        <?php } ?>
                                    </div>
                                </div>
    ...
    <div id="SildeBarLeft">
        <table id="sammary" cellpadding="5" style="width: 100%;">
            ...
            <tr>
                <td colspan="2"><img src="<?php echo $this->map['items']['current']['icon'];?>" title="<?php echo $this->map['items']['current']['name'];?>" style="width: 15px; height: auto;" /> <label style="font-weight: bold;"><?php echo $this->map['items']['current']['name'];?></label></td>
            </tr>
            <tr style="border-bottom: 1px solid #CCCCCC;">
                <td><label><?php echo Portal::language('quantity_def');?></label><br /><label id="summary_quantity_<?php echo $this->map['items']['current']['id'];?>">0</label></td>
                <td><label><?php echo Portal::language('total_amount');?></label><br /><label id="summary_total_<?php echo $this->map['items']['current']['id'];?>">0</label></td>
            </tr>
            <?php }}unset($this->map['items']['current']);} ?>
            <tr style="background: #217346; height: 40px;">
                <td colspan="2"><label style="color: #FFFFFF;"><?php echo Portal::language('infomation_payment');?></label></td>
            </tr>
            <tr>
                <td colspan="2">
                    <label><?php echo Portal::language('total_amount');?>:</label><br />
                    <input  name="total_amount" id="total_amount" style="text-align: right; border: none; border-bottom: 1px solid #00b2f9;" readonly="readonly" / type ="text" value="<?php echo String::html_normalize(URL::get('total_amount'));?>">
                </td>
            </tr>
            <?php if($_REQUEST['cmd']!='add'){ ?>
            <tr style="display: none;">
                <td colspan="2">
                    <label><?php echo Portal::language('deposit');?>:</label><br />
                    <input  name="deposit" id="deposit" style="text-align: right; border: none; border-bottom: 1px solid #00b2f9;" readonly="readonly" / type ="text" value="<?php echo String::html_normalize(URL::get('deposit'));?>">
                </td>
            </tr>
            <tr style="display: none;">
                <td colspan="2">
                    <?php if(User::can_edit(false,ANY_CATEGORY) AND $this->map['status']==1){ ?>
            ...
            <tr style="display: none;">
                <td colspan="2">
                    <label><?php echo Portal::language('payment');?>:</label><br />
                    <input  name="payment" id="payment" style="text-align: right; border: none; border-bottom: 1px solid #00b2f9;" readonly="readonly" / type ="text" value="<?php echo String::html_normalize(URL::get('payment'));?>">
                </td>
            </tr>
            <tr style="display: none;">
                <td colspan="2">
            ...
            <tr style="display: none;">
                <td colspan="2">
                    <label><?php echo Portal::language('remain');?>:</label><br />
                    <input  name="remain" id="remain" style="text-align: right; border: none; border-bottom: 1px solid #00b2f9;" readonly="readonly" / type ="text" value="<?php echo String::html_normalize(URL::get('remain'));?>">
                </td>
            </tr>
            <?php } ?>
        </table>
...
<div style="display: none;"> 
    ...
    <table id="TemplateSpa">
        ...
        <tr class="TemplateSpa_X######X">
            <td colspan="9" style="text-align: right;">
                <fieldset style="float: right;">
                    <legend  style="text-align: right;"><label><i class="fa fa-cog fa-fw"></i></label><?php echo Portal::language('detail');?> <?php echo Portal::language('service');?></legend>
                    <table id="MutilsSPAService_X######X" cellpadding="5" style="float: right;">
                        <tr style="background: #EEEEEE;">
                            <th><label></label></th>
                            <th><label><?php echo Portal::language('product_code');?></label></th>
                            <th><label><?php echo Portal::language('product_name');?></label></th>
                            <th><label><?php echo Portal::language('room');?></label></th>
                            <th><label><?php echo Portal::language('staff');?></label></th>
                            <th><label><?php echo Portal::language('date');?></label></th>
                            <th><label><?php echo Portal::language('time_in');?></label></th>
                            <th><label><?php echo Portal::language('time_out');?></label></th>
                            <th><label><?php echo Portal::language('quantity_def');?></label></th>
                            <th><label><?php echo Portal::language('price');?></label></th>
                            <th><label><?php echo Portal::language('delete');?></label></th>
                        </tr>
                    </table>
                    <?php if( (Url::get('cmd')=='add' AND User::can_add(false,ANY_CATEGORY)) OR (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
                    <br />
                    <div class="DivButton"  onclick="AddServiceSpa('X######X'); GetTotalAmount();" style="float: right; clear: both;">
                        <div class="DivButtonIcon"><img src="packages/hotel/packages/mice/skins/img/add.png" /></div>
                        <span><?php echo Portal::language('add');?> <?php echo Portal::language('service');?></span>
                    </div>
                    <?php } ?>
                </fieldset>
            </td>
        ...
        <tr class="TemplateSpa_X######X">
            <td colspan="9" style="text-align: right; border-bottom: 1px solid #DDDDDD;">
                <fieldset style="float: right;">
                    <legend style="text-align: right;"><label><i class="fa fa-dot-circle-o fa-fw"></i> <?php echo Portal::language('detail');?> <?php echo Portal::language('product');?></label></legend>
                    <table id="MutilsSPAProduct_X######X" cellpadding="5" style="float: right;">
                        <tr style="background: #EEEEEE;">
                            ...
                            <th><label><?php echo Portal::language('quantity_def');?></label></th>
                            <th><label><?php echo Portal::language('price');?></label></th>
                            <th><label><?php echo Portal::language('amount');?></label></th>
                            <th><label><?php echo Portal::language('delete');?></label></th>
                        </tr>
                    </table>
                    <?php if( (Url::get('cmd')=='add' AND User::can_add(false,ANY_CATEGORY)) OR (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
                    ...
                    <div class="DivButton"  onclick="AddProductSpa('X######X'); GetTotalAmount();" style="float: right; clear: both;">
                        <div class="DivButtonIcon"><img src="packages/hotel/packages/mice/skins/img/add.png" /></div>
                        <span><?php echo Portal::language('add');?> <?php echo Portal::language('product');?></span>
                    </div>
                    <?php } ?>
                </fieldset>
            </td>
    ...
    <table id="TemplateSpaService">
        <tr id="TemplateSpaService_X######X_Y######Y">
            ...
            <td style="text-align: center;">
                <input   type="button" onclick="Check_Staff_Availblity(X######X,Y######Y);" value="<?php echo Portal::language('select_staff');?>" style="width: 100px; text-align: center;" />
    ...
    <table id="TemplateParty">
        <tr class="TemplateParty_X######X">
            ...
            <td style="text-align: center; position: relative;"><select  name="party[X######X][party_type]" id="party_party_type_X######X" style="width: 120px; text-align: center;"><?php echo $this->map['all_party'];?></select><div class="cover_party_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
            ...
            <td style="text-align: center; position: relative;"><input   type="button" onclick="Select_Promotions(X######X);" value="<?php echo Portal::language('promotions');?>" style="width: 100px; text-align: center;" /><input   name="party[X######X][promotions]" type="text" id="party_promotions_X######X" style="width: 120px; text-align: center; display: none;" /><div class="cover_party_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
                ...
                <fieldset style="float: right;">
                    ...
                    <table id="MutilsPARTYProduct_X######X" cellpadding="5" style="float: right;">
                        <tr style="background: #EEEEEE;">
                            ...
                            <th><label><?php echo Portal::language('product_code');?></label></th>
                            <th><label><?php echo Portal::language('product_name');?></label></th>
                            <th><label><?php echo Portal::language('unit');?></label></th>
                            <th><label><?php echo Portal::language('quantity_def');?></label></th>
                            <th><label><?php echo Portal::language('price');?></label></th>
                            <th><label><?php echo Portal::language('type');?></label></th>
                            <th><label><?php echo Portal::language('delete');?></label></th>
                        </tr>
                    </table>
                    <?php if( (Url::get('cmd')=='add' AND User::can_add(false,ANY_CATEGORY)) OR (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
        ...
        <tr class="TemplateParty_X######X">
            <td colspan="11" style="text-align: right; border-bottom: 1px solid #DDDDDD; position: relative;">
                <fieldset style="float: right;">
                    <legend style="text-align: right;"><label><i class="fa fa-check fa-fw"></i> <?php echo Portal::language('detail');?> <?php echo Portal::language('party_room');?></label></legend>
                    <table id="MutilsPARTYRoom_X######X" cellpadding="5" style="float: right;">
                        <tr style="background: #EEEEEE;">
                            <th></th>
                            <th><label><?php echo Portal::language('party_room');?></label></th>
                            <th><label><?php echo Portal::language('time_type');?></label></th>
                            <th><label><?php echo Portal::language('address');?></label></th>
                            <th><label><?php echo Portal::language('price');?></label></th>
                            <th><label><?php echo Portal::language('type');?></label></th>
                            <th><label><?php echo Portal::language('note');?></label></th>
                            <th><label><?php echo Portal::language('delete');?></label></th>
                        </tr>
                    </table>
                    <?php if( (Url::get('cmd')=='add' AND User::can_add(false,ANY_CATEGORY)) OR (Url::get('cmd')=='edit' AND User::can_edit(false,ANY_CATEGORY) AND $this->map['status']!=1) ){ ?>
                    <div class="DivButton"  onclick="AddRoomParty('X######X');GetTotalAmount();" style="float: right; clear: both;">
                        <div class="DivButtonIcon"><img src="packages/hotel/packages/mice/skins/img/add.png" /></div>
                        <span><?php echo Portal::language('add');?> <?php echo Portal::language('party_room');?></span>
                    </div>
                    <?php } ?>
                </fieldset>
                <div class="cover_party_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div>
    ...
    <table id="TemplatePartyProduct">
        <tr id="TemplatePartyProduct_X######X_Y######Y">
            ...
            <td style="text-align: center;"><select  name="party[X######X][child_product][Y######Y][type]" id="party_X######X_child_product_type_Y######Y" style="width: 120px; text-align: center;" onchange="partygetProductFromCode(X######X,Y######Y);"><?php echo $this->map['all_product_party_type'];?></select></td>
    ...
    <table id="TemplatePartyRoom">
        <tr id="TemplatePartyRoom_X######X_Y######Y">
            ...
            <td style="text-align: center;">
                <select   name="party[X######X][child_room][Y######Y][party_room_id]" id="party_X######X_child_room_party_room_id_Y######Y" onchange="selectpartyrooms(X######X,Y######Y);" style="text-align: center; width: 150px;"><?php echo $this->map['banquet_room_options'];?></select>
            </td>
            <td style="text-align: center;">
                <select   name="party[X######X][child_room][Y######Y][time_type]" id="party_X######X_child_room_time_type_Y######Y" onchange="selectpartyrooms(X######X,Y######Y);" style="text-align: center; width: 150px;"><option value="DAY"><?php echo Portal::language('full_day');?></option><option value="MORNING"><?php echo Portal::language('morning');?></option><option value="AFTERNOON"><?php echo Portal::language('afternoon');?></option></select>
            </td>
            ...
            <td style="text-align: center;"><select  name="party[X######X][child_room][Y######Y][type]" id="party_X######X_child_room_type_Y######Y" style="width: 120px; text-align: center;"><option value="1"><?php echo Portal::language('party_room');?></option><option value="2"><?php echo Portal::language('meeting_room');?></option></select></td>
    ...
    <table id="TemplateRes">
        <tr class="TemplateRes_X######X">
            ...
            <td style="text-align: center; position: relative;"><select  name="bar[X######X][bar_id]" id="bar_bar_id_X######X" onchange="parselayouttable(X######X);" style="width: 120px; text-align: center;"><?php echo $this->map['bar_options'];?></select><div class="cover_res_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
            <td style="text-align: center; position: relative;"><select  name="bar[X######X][table_id]" id="bar_table_id_X######X" onchange="parselayoutproduct(X######X);" style="width: 120px; text-align: center; border: 1px solid #00b2f9;"><?php echo $this->map['bar_table_options'];?></select><div class="cover_res_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
            ...
            <td style="text-align: center; position: relative;"><input   name="bar[X######X][discount_after_tax]" type="text" id="discount_after_tax_X######X" style="width: 30px; text-align: center;" /></td>
        ...
        <tr class="TemplateRes_X######X" style="border-bottom: 1px solid #DDDDDD;">
            <td style="text-align: center; position: relative;">
                <input type="number" id="coppy_bar_X######X" value="" style="width: 80px; text-align: center;" placeholder="<?php echo Portal::language('number_copy');?>" />
                <input type="button" onclick="CoppyBar(X######X);" value="<?php echo Portal::language('copy');?>" style="padding: 10px; margin-top: 5px;" />
                ...
                <fieldset style="float: right;">
                    ...
                    <table id="MutilsRESProduct_X######X" cellpadding="5" style="float: right;">
                        <tr style="background: #EEEEEE;">
                            ...
                            <th><label><?php echo Portal::language('quantity_def');?></label></th>
                            <th><label><?php echo Portal::language('price');?></label></th>
                            <th><label><?php echo Portal::language('quantity_discount');?></label></th>
                            <th><label><?php echo Portal::language('discount_rate');?></label></th>
                            <th><label><?php echo Portal::language('note');?></label></th>
                            <th><label><?php echo Portal::language('delete');?></label></th>
                        </tr>
                    </table>
    ...
    <table id="TemplateVending">
        <tr class="TemplateVending_X######X">
            ...
            <td style="text-align: center; position: relative;"><input   name="vending[X######X][discount_percent]" type="text" id="vending_discount_percent_X######X" onkeyup="if(to_numeric(jQuery(this).val())>100 || to_numeric(jQuery(this).val())<0){ alert('khong duoc nhap nho hon 0 hoac lon hon 100'); jQuery(this).val(0); } jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); GetTotalAmount();" style="width: 30px; text-align: center;" /><input   name="vending[X######X][exchange_rate]" type="text" id="vending_exchange_rate_X######X" value="<?php echo $this->map['exchange_rate'];?>" style="display: none;" /><div class="cover_ve_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
        ...
        <tr class="TemplateVending_X######X" style="border-bottom: 1px solid #DDDDDD;">
            <td style="text-align: center; position: relative;">
                <input type="number" id="coppy_vending_X######X" value="" style="width: 80px; text-align: center;" placeholder="<?php echo Portal::language('number_copy');?>" />
                <input type="button" onclick="CoppyVending(X######X);" value="<?php echo Portal::language('copy');?>" style="padding: 10px; margin-top: 5px;" />
    ...
    <table id="TemplateExs">
        <tr class="TemplateExs_X######X" style="border-bottom: 1px solid #DDDDDD;">
            ...
            <td style="text-align: center; position: relative;"><select  name="extra[X######X][type]" id="extra_type_X######X" onchange="selecttypeserviceextra(X######X);" style="width: 100px; text-align: center;"><option value="SERVICE"><?php echo Portal::language('extra_service_other');?></option><option value="ROOM"><?php echo Portal::language('service_room');?></option></select><div class="cover_exs_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
            <td style="text-align: center; position: relative;"><select  name="extra[X######X][service_id]" id="extra_service_id_X######X" onchange="selectserviceextra(X######X);" style="width: 120px; text-align: center;"><?php echo $this->map['extra_service_options'];?></select><input  name="extra[X######X][service_name]" type="text" id="extra_service_name_X######X" style="display: none;" /><div class="cover_exs_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
    ...
    <table id="TemplateRec">
        <tr class="TemplateRec_X######X" style="border-bottom: 1px solid #DDDDDD;">
            ...
            <td style="text-align: center; position: relative;"><select  name="booking[X######X][room_level_id]" id="booking_room_level_id_X######X" onchange="selectroomlevel(X######X);" style="width: 120px; text-align: center;"><?php echo $this->map['room_level_option'];?></select> <div class="cover_rec_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
            ...
            <td style="text-align: center; position: relative;"><input   name="booking[X######X][usd_price]" type="text" id="booking_usd_price_X######X" onchange="jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); jQuery('#booking_price_X######X').val(number_format((to_numeric(this.value)*jQuery('#booking_exchange_rate_X######X').val()))); GetTotalAmount();" style="width: 50px; text-align: right;" /><input   name="booking[X######X][exchange_rate]" type="text" id="booking_exchange_rate_X######X" value="<?php echo $this->map['exchange_rate'];?>" style="width: 70px; text-align: right; display: none;" /> <div class="cover_rec_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
    ...
    <table id="TemplateTicket">
        <tr class="TemplateTicket_X######X" style="border-bottom: 1px solid #DDDDDD;">
            ...
            <td style="text-align: center; position: relative;"><select  name="ticket[X######X][ticket_area_id]" id="ticket_ticket_area_id_X######X" onchange="selectticketarea(X######X);" style="width: 120px; text-align: center;"><?php echo $this->map['ticket_area_options'];?></select> <div class="cover_ticket_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
            <td style="text-align: center; position: relative;"><select  name="ticket[X######X][ticket_id]" id="ticket_ticket_id_X######X" onchange="selectticket(X######X);" style="width: 120px; text-align: center;"><?php echo $this->map['ticket_options'];?></select> <div class="cover_ticket_X######X" style="width: 100%; height: 100%; background: rgba(0,0,0,0.3); position: absolute; top: 0px; left: 0px; display: none;"></div></td>
...
<div id="SildeBarRight">
    <table cellpadding="5">
        ...
        <tr>
            <td>
                <div>
                    <a href="#MiceDepartment_<?php echo $this->map['items']['current']['id'];?>" style="text-decoration: none;"><img src="<?php echo $this->map['items']['current']['icon'];?>" title="<?php echo $this->map['items']['current']['name'];?>" /></a>
                </div>
            </td>
        </tr>
        <?php }}unset($this->map['items']['current']);} ?>
...
<script>
    ...
    var list_bars = <?php echo String::array2js($this->map['list_bars']);?>;
    var list_bar_tables = <?php echo String::array2js($this->map['list_bar_tables']);?>;
    var room_level = <?php echo String::array2js($this->map['room_level']);?>;
    var banquet_rooms = <?php echo String::array2js($this->map['banquet_rooms']);?>;
    var all_party_promotions = <?php echo String::array2js($this->map['all_party_promotions']);?>;
    var all_products = <?php echo String::array2js($this->map['all_products']);?>;
    var list_area_vending = <?php echo String::array2js($this->map['list_area_vending']);?>;
    var all_extra_service = <?php echo String::array2js($this->map['all_extra_service']);?>;
    var all_ticket_area = <?php echo String::array2js($this->map['all_ticket_area']);?>;
    var all_ticket = <?php echo String::array2js($this->map['all_ticket']);?>;
    /** parselayout **/
    ...
    {
        var WinSrc = 'http://<?php echo $_SERVER['HTTP_HOST'];?>/<?php echo Url::$root;?>form.php?block_id=428&cmd=payment&id=<?php echo Url::get('id'); ?>&type=MICE&total_amount=<?php echo $this->map['total_amount'];?>';
