<?php //System::debug($this->map['product_list_js']);?>
<script>
    var product_array=<?php echo $this->map['product_array'];?>;
     var room_array={
        '':''
...
<div><input value="<?php echo Portal::language('full_screen');?>" name="full_screen_button" type="button" id="full_screen_button" onclick="switchFullScreen();" class="button-large fullscreen" style="float:right; display:none;"/></div>
<br clear="all" />
...
<div style="padding:0px;">
	...
	<div style="float:right; width:100%;margin-right:0px;text-align:right;white-space:nowrap;margin-bottom:5px;">
        ...
        <?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=0 AND $this->map['mice_reservation_id']!=''){ ?>
            ...
            <input class="button-medium" type="button" value="<?php echo Portal::language('save');?>" id="li_payment" onclick="fun_submit_open('save')" />
            <?php } ?>
        <?php }else{ ?>
        <input class="button-medium-save" type="button" value="<?php echo Portal::language('payment');?>" id="li_payment" onclick="fun_submit_open('payment')" />
        <?php } ?>
        <input name="back" type="button" value="<?php echo Portal::language('list_order');?>" class="button-medium" onclick="window.location='<?php echo Url::build('vending_reservation',array());?>'" />
        -->
        <div class="w3-button w3-right w3-green w3-hover-green" style="margin-right: 5px;" onclick="window.location='<?php echo Url::build('automatic_vend',array('cmd'=>'add','department_id','department_code','arrival_time'));?>';"><i class="fa fa-fw fa-plus"></i> <?php echo Portal::language('create_vending');?></div>
        <div class="w3-button w3-right w3-orange w3-hover-orange" style="margin-right: 5px;" onclick="fun_submit_open('save');"><i class="fa fa-fw fa-save"></i> <?php echo Portal::language('save');?></div>
        <div class="w3-button w3-right w3-yellow w3-hover-yellow" style="margin-right: 5px;" onclick="window.location='<?php echo Url::build('automatic_vend',array('cmd'=>'option_area'));?>'"><i class="fa fa-fw fa-th"></i> <?php echo Portal::language('select_area');?></div>
        <div class="w3-button w3-right w3-gray w3-hover-gray" style="margin-right: 5px;" onclick="window.location='<?php echo Url::build('vending_reservation',array());?>'"><i class="fa fa-fw fa-arrow-left"></i> <?php echo Portal::language('back');?></div>
            ...
            <table>
                <?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=0 AND $this->map['mice_reservation_id']!=''){ ?>
                        ...
                        <td align="left" style="padding-left:10px;">
                            ...
                            <input value="<?php echo Portal::language('split');?> MICE" type="button" onclick="FunctionSplitMice('<?php echo $this->map['mice_reservation_id'];?>','VENDING','<?php echo $this->map['id'];?>');" style="font-weight: bold; padding: 3px 10px; margin-left: 20px;" />
                        </td>
                        <td></td>
                    <?php }else{ ?>
                        <?php if($this->map['pay_with_room']!=1){ ?>
                        <td></td>
                        <td align="right"><input value="<?php echo Portal::language('add_mice');?>" type="button" onclick="FunctionAddMice('VENDING','<?php echo $this->map['id'];?>');" style="font-weight: bold; padding: 3px 10px;" /></td>
                        <td align="left" style="padding-left:10px;"><input value="<?php echo Portal::language('select');?> MICE" type="button" onclick="FunctionSelectMice('VENDING','<?php echo $this->map['id'];?>');" style="font-weight: bold; padding: 3px 10px;" /></td>
                        <td></td>
                        <?php } ?>
                    <?php } ?>
            </table>
    ...
    <div style="width:100%;margin-bottom:5px;">
        <table style="float: right;">
            <tr>
                <td><b><?php echo Portal::language('number_guest');?></b></td>
                <td><input name="number_guest" type="text" id="number_guest" value="<?php echo $this->map['number_guest'];?>" class="w3-input w3-border w3-cyan w3-text-white" style="width: 120px; font-weight: bold;" /></td>
                <td><b><?php echo Portal::language('person_order');?></b></td>
                <td><input name="person_order" type="text" id="person_order" value="<?php echo $this->map['person_order'];?>" class="w3-input w3-border w3-cyan w3-text-white" style="width: 120px; font-weight: bold;" /></td>
                <td><b><?php echo Portal::language('device_code');?></b></td>
                <td><input  name="device_code" id="device_code" class="w3-input w3-border w3-cyan w3-text-white" style="width: 120px; font-weight: bold;" / type ="text" value="<?php echo String::html_normalize(URL::get('device_code'));?>"></td>
                <td><b><?php echo Portal::language('guest_phone_number');?></b></td>
                <td><input  name="guest_phone_number" id="guest_phone_number" class="w3-input w3-border w3-cyan w3-text-white" style="width: 120px; font-weight: bold;" / type ="text" value="<?php echo String::html_normalize(URL::get('guest_phone_number'));?>"></td>
            </tr>
        </table>
    </div>
	<table cellpadding="2" width="100%" border="1" bordercolor="#A6A6A6" id="table_bound">
		<tr>
				...
				<div id="product_select_expansion" style="padding: 0px; margin: 0px;">
                    ...
                    <div class="select-menu-bound" style="padding: 0px; margin: 0px;">
                        <div class="title">
                            ...
                            <!--barcode la ma vach-->
                            <input name="barcode" type="text" id="barcode" style="width: 70px; display: none;"  placeholder="<?php echo Portal::language('barcode');?>" onkeypress="if(event.keyCode==13){get_barcode(this.value);}"/><!--oninput="get_barcode(this.value);"-->
                            <input name="select_bar" type="button" value="<?php echo Portal::language('select_area');?>" style="display: none;" id="select_bar" onclick="jQuery('#div_select_bar').css({'display':'block','top':'250px','left':'600px'});" class="expan"/>
                            <input name="bar_name_this" type="button" value="<?php echo $this->map['bar_name'];?>" style="display: none;" onclick="jQuery('#restaurant_other').css('display','none');jQuery('#bar_id_other').val(<?php echo $this->map['department_id'];?>);jQuery('#bar_name').val('<?php echo $this->map['department_name'];?>');searchProduct('this_bar',jQuery('#bar_id_other').val());" class="expan"/>
                            <input name="back" type="button" value="<?php echo Portal::language('Back');?>" id="back" class="expan" style="display: none;" />
                            
                        </div>
						<div>
                        	<div id="div_food_category" style="margin-top: -40px;"><?php echo $this->map['food_categories'];?></div>
                            <div class="body" style="width: 520px; background: none;"><?php echo $this->map['products'];?></div>
                        </div>
				    </div>
                    <!--End:Thanh search-->
            ...
            <td class="info-right" id="expan_display">
                <div class="info">
                	<div style="float:left;">
    					<span style="font-size:12px; font-weight:500;" ><?php echo Portal::language('create_date');?>: &nbsp;<?php echo $this->map['date'];?></span><br />
                        <?php 
				...
				?>
            		...
            		<div style="float:right; <?php if($this->map['status']==''){echo 'display:none;';}?>">
                    	<input type="button" name="preview" value=" <?php echo Portal::language('view_order');?>" tabindex="-1" class="expan" onclick="window.open('<?php echo Url::build('automatic_vend',array('cmd'=>'detail',md5('act')=>md5('print'),md5('preview')=>1,'id'=>Url::get('id')))?>');"/>                           
                    </div>
                </div>
                <div id="menu_extra">
                	<ul id="menu_extra_ul" style="float:left;">
                        ...
                        <!--<li class="menu_extra_li <?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=''){ ?>css_menu_estra_disable<?php }else{ } ?>" <?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=''){ ?>style="cursor: default; background: rgb(214, 214, 214);"<?php }else{ } ?> id="li_deposit" onclick="<?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=''){ ?>return false;<?php }else{ ?>fun_submit_open('deposit');<?php } ?>" <?php if(Url::get('cmd')=='add'){ echo 'style="cursor: default; background: rgb(214, 214, 214);"';} ?>><img src="packages/hotel/skins/default/images/iosstyle/7.png" /></li>-->
                        <!--<li class="menu_extra_li <?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=''){ ?>css_menu_estra_disable<?php }else{ } ?>" <?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=''){ ?>style="cursor: default; background: rgb(214, 214, 214);"<?php }else{ } ?> id="li_payment" onclick="<?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=''){ ?>return false;<?php }else{ ?>fun_submit_open('payment')<?php } ?>" <?php if(Url::get('cmd')=='add'){ echo 'style="cursor: default; background: rgb(214, 214, 214);"';} ?>><img src="packages/hotel/skins/default/images/iosstyle/8.png" /></li>-->
                        ...
                        <li class="menu_extra_li_order" style="display:none;"><input name="guest_info" type="button" id="guest_info" value="<?php echo Portal::language('for_sale');?>" class="summary" onclick="getResevationRoom();"/> </li>
				...
				<div id="foot_drink_bound" style="width:84%; float:right;" class="selected-foot-and-drink-table">
					<table cellpadding="5" width="100%" id="foot_drink" cellspacing="5">
						<tr class="foot-drink-tr header">
							<td width="100px"><?php echo Portal::language('name_product');?></td>
							<td width="25px" align="center">SL</td>
							<td width="50px" align="center"><?php echo Portal::language('price');?></td>
                            <td width="25">&nbsp;</td>
						</tr>
					</table>
                ...
                <!---->
				<input  name="items_id" id="items_id"/ type ="hidden" value="<?php echo String::html_normalize(URL::get('items_id'));?>">
				<script>
                ...
                <div id="total_mini" style="margin-bottom:5px; margin-top:5px;clear: both;" align="right">
                	<p><font style="font-size:12px; "><b><?php echo Portal::language('total_amount');?> (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp;<span id="amount_mini" style="font-weight: bold;"><b><?php echo $this->map['remain'];?></b></span></p>
                    <p style="display: none;"><font style="font-size:12px; "><b><?php echo Portal::language('total_payment');?> (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp;<span><b><?php echo System::display_number($this->map['total_payment']); ?></b></span></p>
                    <p style="display: none;"><font style="font-size:12px; "><b><?php echo Portal::language('total_remain');?> (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp;<span id="amount_remain"><b><?php echo System::display_number(System::calculate_number($this->map['remain'])-$this->map['total_payment']); ?></b></span></p>
                    <p><font style="font-size:12px;"><b><?php echo Portal::language('total_payment_traveller');?> (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp; <input  name="total_payment_traveller" id="total_payment_traveller" onkeyup="jQuery('#total_payment_traveller').val(number_format(to_numeric(jQuery('#total_payment_traveller').val())));GetTotalPayment();" autocomplete="OFF" style="text-align: right; width: 120px; padding: 3px;" / type ="text" value="<?php echo String::html_normalize(URL::get('total_payment_traveller'));?>"></p>
                    <p><font style="font-size:12px;"><b><?php echo Portal::language('total_remain_traveller');?> (<?php echo HOTEL_CURRENCY;?>)</b></font>: &nbsp; <span id="total_remain_traveller"><b></b></span></p>
                </div>
                <div style="margin-top: 5px; clear: both;">
                    <fieldset style="border: none; border-top: 1px dashed #EEE;">
                        <legend style="text-transform: uppercase;"><b><?php echo Portal::language('payment');?></b></legend>
                        <table style="width: 100%;">
                            <tr style="background: #EEE;">
                                <td><b><?php echo Portal::language('cash');?>(<?php echo HOTEL_CURRENCY;?>)</b></td>
                                <td style="text-align: right;"><input  name="payment_cash" id="payment_cash" class="input_number" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); GetTotalPayment(this);" style="text-align: right; width: 120px; padding: 3px;" / type ="text" value="<?php echo String::html_normalize(URL::get('payment_cash'));?>"></td>
                            </tr>
                            <tr>
                                <td><b><?php echo Portal::language('credit_card');?>(<?php echo HOTEL_CURRENCY;?>)</b></td>
                                <td style="text-align: right;"><input  name="payment_credit_card" id="payment_credit_card" class="input_number" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); GetTotalPayment(this);" style="text-align: right; width: 120px; padding: 3px;" / type ="text" value="<?php echo String::html_normalize(URL::get('payment_credit_card'));?>"></td>
                            </tr>
                            <tr>
                                <td><?php echo Portal::language('credit_type');?></td>
                                <td style="text-align: right;"><select  name="payment_credit_card_type" id="payment_credit_card_type" style="text-align: right; width: 120px; padding: 3px;"><?php
					if(isset($this->map['payment_credit_card_type_list']))
					{
						foreach($this->map['payment_credit_card_type_list'] as $key=>$value)
						{
                    ...
                    if(URL::get('payment_credit_card_type',isset($this->map['payment_credit_card_type'])?$this->map['payment_credit_card_type']:''))
                    echo "<script>$('payment_credit_card_type').value = \"".addslashes(URL::get('payment_credit_card_type',isset($this->map['payment_credit_card_type'])?$this->map['payment_credit_card_type']:''))."\";</script>";
                    ?>
	</select></td>
                            </tr>
                            <tr style="background: #EEE; display: none;">
                                <td><b><?php echo Portal::language('refund');?>(<?php echo HOTEL_CURRENCY;?>)</b></td>
                                <td style="text-align: right;"><input  name="payment_refund" id="payment_refund" class="input_number" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); GetTotalPayment(this);" style="text-align: right; width: 120px; padding: 3px;" / type ="text" value="<?php echo String::html_normalize(URL::get('payment_refund'));?>"></td>
                            </tr>
                            <tr>
                                <td><b><?php echo Portal::language('free');?>(<?php echo HOTEL_CURRENCY;?>)</b></td>
                                <td style="text-align: right;"><input  name="payment_foc" id="payment_foc" class="input_number" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); GetTotalPayment(this);" style="text-align: right; width: 120px; padding: 3px;" / type ="text" value="<?php echo String::html_normalize(URL::get('payment_foc'));?>"></td>
                            </tr>
                            <tr>
                                <td><b><?php echo Portal::language('debit');?>(<?php echo HOTEL_CURRENCY;?>)</b></td>
                                <td style="text-align: right;"><input  name="payment_debit" id="payment_debit" class="input_number" onkeyup="jQuery(this).val(number_format(to_numeric(jQuery(this).val()))); GetTotalPayment(this);" style="text-align: right; width: 120px; padding: 3px;" / type ="text" value="<?php echo String::html_normalize(URL::get('payment_debit'));?>"></td>
                            </tr>
                            <tr>
                                <td><b style="text-transform: uppercase;"><?php echo Portal::language('remain');?> <?php echo Portal::language('after_payment');?>(<?php echo HOTEL_CURRENCY;?>)</b></td>
        ...
        <div id="info_summary" style="margin: 0px; padding: 0px;"> <?php echo $this->map['categories'];?></div>
        <div id="div_bound_summary">
        <div id="bound_summary" class="dragclass" style="display:block; position: absolute; top:100px; left:500px;">
            <div class="info">
                <span class="title_bound"><?php echo Portal::language('summary');?></span>
            ...
            <table cellpadding="0" width="100%">
                ...
                <td>
                    <fieldset style="text-align:left; margin-bottom:10px;margin-top:10px;">
                        <legend class="title"><?php echo Portal::language('guest_info');?></legend>
            			<table cellpadding="3" width="100%">
                            <tr>
                                <td><?php echo Portal::language('guest_name');?>:<input name="receiver_name" type="text" id="receiver_name" value="<?php echo $this->map['receiver_name'];?>" style="width:150px;"  /></td>
                                <td  colspan="2">
                            ...
                            <tr>
                                <td width="200px">
                                    <?php echo Portal::language('company');?>:
                                    <input name="customer_name" type="text" id="customer_name" value="<?php echo $this->map['customer_name'];?>" class="input-text-max" />
                                ...
                                <td>
                                    <?php echo Portal::language('customer_address');?>:
                                    <input name="customer_address" type="text" id="customer_address" value="<?php echo $this->map['customer_address'];?>" class="input-text-max" style="width: 220px;"  />
                                </td>
                                <td>   
                                    <?php echo Portal::language('tax_code');?>:
                                    <input name="tax_code" type="text" id="tax_code" value="<?php echo $this->map['tax_code'];?>" class="input-text-max" style="width: 170px;"   />
                                </td>
                            </tr>
                        </table>
            		</fieldset>
                       ...
                       <legend class="title"><img src="packages/core/skins/default/images/customer_icon.jpg" width="15" height="20" align="top"/>&nbsp;<?php echo Portal::language('guest_room');?></legend>
                            <table cellpadding="3" width="55%">
                                <tr style="<?php if(isset($this->map['mice_reservation_id']) AND $this->map['mice_reservation_id']!=0 AND $this->map['mice_reservation_id']!=''){ ?> display: none; <?php } ?>">
                                    ...
                                    ?>
                                        <td nowrap>&nbsp;</td>
                                        <th align="left"><?php echo Portal::language('select_guest_room');?> <br /><select  name="reservation_traveller_id" id="reservation_traveller_id" onchange="update_room(this);if(this.value!=0){jQuery('#pay_with_room').attr('checked',true);}else{jQuery('#pay_with_room').attr('checked',false);}"  style="width:170px;height:35px;"><?php
                    ...
                    ?>
                                        ...
                                        <td nowrap width="50%"><?php echo Portal::language('room_name');?> <br /><select  name="reservation_room_id" id="reservation_room_id"  onchange="update_traveller(this);if(this.value!=0){ jQuery('#pay_with_room').attr('checked',true);}else{jQuery('#pay_with_room').attr('checked',false);}" style="width:100px;height:35px;"><?php
                    ...
                    ?>
                                        ...
                                        <td align="right" valign="bottom">
                                            <input name="pay_with_room" type="checkbox" class="checkbox" id="pay_with_room" <?php if($this->map['pay_with_room']==1){ echo 'checked="checked"';}?> style="display:none !important;" />
                                            <label for="pay_with_room"><span class="checkbox-span" title="<?php echo Portal::language('pay_with_room');?>">?</span></label>
                                        </td>
                                    <?php 
                                    }
                                     ?>
            ...
            <fieldset>
                <legend class="title"><?php echo Portal::language('Order_vending_info');?></legend>
                <table>
                	<tr>
                        <td>
                            <?php echo Portal::language('create_date');?><br />
                            <input name="arrival_date" type="text" id="arrival_date"  class="input-text" value="<?php echo $this->map['arrival_date'];?>" onclick="jQuery('#ui-datepicker-div').css('z-index',103);" />
                            ...
                            <input  name="arrival_time_in_munite" id="arrival_time_in_munite" class="input_number" style="width:30px;" maxlength="2"  / type ="text" value="<?php echo String::html_normalize(URL::get('arrival_time_in_munite'));?>">
                        </td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td>
                            <?php echo Portal::language('note');?><br /><input name="note" type="text" id="note" value="<?php echo $this->map['note'];?>" class="input-text-max" style="width:380px;"/>
                        </td>
                    </tr>               
                </table>
            </fieldset>
            <fieldset>
            	...
            	<table class="general-info" align="center" border="1" cellpadding="3" cellspacing="3" width="100%" >
                    ...
                    <tr>
                        <td><?php echo Portal::language('amount');?>:</td>
                        ...
                        <td>Full charge:<input name="full_charge" type="checkbox" id="full_charge" value="1" <?php if($this->map['full_charge']==1){echo 'checked="checked"';}?> disabled="disabled"/><input name="input_full_charge" type="text" id="input_full_charge" value="<?php echo $this->map['full_charge'];?>" style="display:none;" /> </td>
                    ...
                    <tr>
                        <!--Thue va phi-->
                        <td><?php echo Portal::language('service_charge');?>/<?php echo Portal::language('tax_rate');?>:</td>
                        <td>
                            <input name="service_charge" type="text" id="service_charge" value="<?php echo $this->map['service_charge'];?>" class="input_number"  maxlength="3" style="width:30px !important;text-align:right;margin-right:15px;" onkeyup="if(to_numeric(this.value)<=100){GetTotalPayment();}else{this.value=((this.value).substr(0,((this.value).length-1)));}" />
                            <input name="tax_rate" type="text" id="tax_rate" value="<?php echo $this->map['tax_rate'];?>" class="input_number"  maxlength="3" style="width:30px !important;text-align:right;" onkeyup="this.value=number_format(this.value);GetTotalPayment();" onblur="GetTotalPayment();" />
                        </td>
                        <td style="display: none;"><?php echo Portal::language('discount');?>(%/VND):</td>
                        <td style="display: none;">
                            <input name="discount_percent" type="text" id="discount_percent" value="<?php echo $this->map['discount_percent'];?>" class="input_number"  maxlength="200" style="width:30px !important;text-align:right;margin-right:5px;" onkeyup="if(to_numeric(this.value)<=100){GetTotalPayment();}else{this.value=((this.value).substr(0,((this.value).length-1)));}" />
                            <input name="discount" type="text" id="discount" value="<?php echo $this->map['discount'];?>" class="input_number"  maxlength="200" style="width:125px !important;text-align:right;" onkeyup="this.value=number_format(this.value);GetTotalPayment();" onblur="GetTotalPayment();" placeholder="<?php echo Portal::language('discount_cash');?>" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="display:none"><?php echo Portal::language('is_debit');?>:</td>
                        <td><input style="display:none" name="is_debit" type="checkbox" id="is_debit" value="1" <?php if($this->map['is_debit']==1){echo 'checked="checked"';}?>/></td>
                    </tr>
                    <tr style="display: none;">
                        <td><?php echo Portal::language('FOC');?>:</td>
                        <td><input name="foc" type="checkbox" id="foc" value="1" <?php if($this->map['foc']==1){echo 'checked="checked"';}?>/></td>
                    </tr>
                </table>
            </fieldset>
            
            <div id="button_total">
                <input name="button_ok" type="button" id="button_ok" value="<?php echo Portal::language('ok');?>" onclick="HideDialog('bound_summary');" style="height:35px; width:80px;float:right;"/>
                <input name="button_reset" type="button" id="button_reset" value="<?php echo Portal::language('reset');?>" onclick="jQuery('#receiver_name').val('');jQuery('#discount_percent').val('');jQuery('#service_charge').val(0);jQuery('#tax_rate').val(0);jQuery('#deposit').val(0);HideDialog('bound_summary');" style="height:35px; width:80px;float:right;"/>              
            </div>
        </div>
        </div>
    <div id="div_bound_note" style="display:none;">
        <div id="bound_note"><div class="info"><span class="title_bound"><?php echo Portal::language('note_product');?></span><img width="20" height="20" id="btnClose" src="packages/core/skins/default/images/buttons/delete.gif" onclick="submitNote(jQuery('#note_product').val(),jQuery('#id_note').val());HideDialog('div_bound_note');" style="float:right;"/></div>
    ...
    <div id="dialog" class="web-dialog">
        <div class="info">
            <span style="text-align:center; font-size:14px; color:#6D84B4;line-height:35px;" id="title_select_quantity"><b><?php echo Portal::language('edit_quantity_for_menu');?></b></span>
        	...
        	<tr>
                <td valign="top">
					<table id="caculator" cellpadding="2" cellspacing="0">
						...
						<tr><td><input  name="name_4" value="4" class="button" onclick="GetNumber(this.value,jQuery('#prd_key').val(),jQuery('#pass').val());" type ="button" value="<?php echo String::html_normalize(URL::get('name_4'));?>"></td>
					...
					<table style="margin-top:20px;">
						...
						<tr id="tr_percentage" style="display: none;">
                        	<td>
                                ...
                                <label for="radio_percentage"><?php echo Portal::language('agent_discount');?>(%)</label>:
                            </td>
                            <td>
                        ...
                        <tr id="tr_promotion">
                        	<td>
                                ...
                                <label for="radio_percentage"><?php echo Portal::language('quantity_discount');?>(%)</label>:
                            </td>
                            <td>
                                <input  name="promotion" type="text" id="input_radio_promotion" onclick="$('radio_promotion').checked=true;" class="text-right" style="width:55px;" title="<?php echo Portal::language('discount_product_rate');?>" value="" />
    							<input name="discount_quantity" type="text" id="discount_quantity" value="0" onkeyup="checkLimited(this.value);" onblur="checkLimited(this.value);" style="width:38px;" class="text-right" title="<?php echo Portal::language('quantity_discount');?>" />
                            </td>
                        </tr>
    ...
    <div id="div_select_bar" style="display:none;">
    	<div class="info"><span class="title_bound"><?php echo Portal::language('select_area');?></span><img width="30" height="25" id="btnClose" src="packages/core/skins/default/images/buttons/delete.gif" onclick="HideDialog('div_select_bar');" style="float:right;"/></div>
        <input  name="bar_id_other" type="hidden" value="<?php echo $this->map['department_id'];?>" id="bar_id_other" />
...
<script>
    ...
    var total_payment = to_numeric('<?php echo $this->map['total_payment']; ?>');
    ...
    function fun_submit_open(act)
    {
        ...
        {
            alert('<?php echo Portal::language('are_you_input_product');?>!');
        }
        else
        {
	...
	function checkSubmit(obj)
    {
		...
		if(id=='checkin'){
			...
			var answ = confirm('<?php echo Portal::language('do_you_want_to_save');?>');
			if(answ == true){
				jQuery('#act').val(name);
				if(id == 'save_stay'){
    ...
    function checkLimited(original_value)
    {
        ...
        {
            alert('<?php echo Portal::language('discount_quantity_must_be_smaller_than_quantity');?>');
