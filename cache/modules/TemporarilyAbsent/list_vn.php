	...
	<td>
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		  <tr>
		   ...
		   <tr>
			<td align="center" style="font-weight:bold;text-transform:uppercase;font-size:15px;"><?php echo Portal::language('temporaty_absent_list_vn');?></td>
		  </tr>
		   <tr>
			...
			<td>
				<table class="printer" width="100%" border="0" cellspacing="0" cellpadding="6" style="font-size:11px; border-collapse:collapse;">
				  <tr style="background-color:#CCCCCC">
					<td align="center"><strong><?php echo Portal::language('stt');?></strong></td>
					<td align="center" width="200px"><strong><?php echo Portal::language('full_name');?></strong></td>
                    <td align="center" width="30px"><strong><?php echo Portal::language('room_name');?></strong></td>
					<td align="center" width="70px"><strong><?php echo Portal::language('birth_day');?></strong></td>                    
					...
					<td align="center" width="150px"><strong><?php echo Portal::language('address');?></strong></td>
                    <td align="center" width="100px"><strong><?php echo Portal::language('job');?></strong></td>
					<td align="center" width="70px"><strong><?php echo Portal::language('arrive_date');?></strong></td>
					<td align="center" width="70px"><strong><?php echo Portal::language('depart_date');?></strong></td>
					<td align="center" width="150px"><strong><?php echo Portal::language('resion_entry');?></strong></td>
                    <td align="center" width="150px"><strong><?php echo Portal::language('note');?></strong></td>                    
				  </tr>
				  <?php $i=0;?>
				  <?php if(isset($this->map['items']) and is_array($this->map['items'])){ foreach($this->map['items'] as $key1=>&$item1){if($key1!='current'){$this->map['items']['current'] = &$item1;?>
				  <tr>
					<td><?php echo ++$i;?></td>
					<td><span style="cursor:pointer" onClick="'location='<?php echo Url::build('traveller',array('id'=>$this->map['items']['current']['id'],'cmd'=>'edit'));?>"><?php echo $this->map['items']['current']['first_name'];?> <?php echo $this->map['items']['current']['last_name'];?></span></td>
				...
				?></td>                  
                    ...
                    <td align="center"><?php echo $this->map['items']['current']['occupation'];?></td>                    
                    ...
                    <td align="center"><?php echo $this->map['items']['current']['entry_target'];?></td>
                    <td></td>
				  </tr>
