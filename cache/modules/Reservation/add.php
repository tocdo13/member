...
var vip_card_list = <?php echo String::array2js($this->map['vip_card_list']);?>;
</script>
<span style="display:none;">
	<span id="mi_reservation_room_sample">
		<div id="input_group_#xxxx#"  onblur="updateRoomForTraveller('#xxxx#');" onmouseover="updateRoomForTraveller('#xxxx#');">
			...
			<span class="multi-input" style="display: none;">
					<input  name="mi_reservation_room[#xxxx#][early_checkin]" type="checkbox" id="early_checkin_#xxxx#" title="<?php echo Portal::language('show_in_early_check_in_report');?>"/>
			</span>
			<span class="multi-input">
            ...
            <span class="multi-input" style="display: none;">
					<select   name="mi_reservation_room[#xxxx#][early_checkin]" id="early_checkin_#xxxx#" class="early_checkin" title="<?php echo Portal::language('early_checkin');?>" style="width:50px;"><?php echo $this->map['verify_dayuse_options'];?></select>
            ...
            <span class="multi-input" style="display: none;">
					<select   name="mi_reservation_room[#xxxx#][reservation_type_id]" id="reservation_type_id_#xxxx#" style="width:58px;font-size:11px;"><?php echo $this->map['reservation_type_options'];?></select>
			</span>
                ...
                <div class="room-extra-info" id="room_extra_info_#xxxx#" >
                    <div>
                        <span class="multi-input-extra">
                            <span class="label"><?php echo Portal::language('foc_room_charge');?></span>
							<input  name="mi_reservation_room[#xxxx#][foc]" type="text" id="foc_#xxxx#" style="width:100px;">
                            <span class="label"><?php echo Portal::language('foc_all');?></span>
                            <input  name="mi_reservation_room[#xxxx#][foc_all]" style="width:15px;" value="1" type="checkbox" id="foc_all_#xxxx#" align="left" title="<?php echo Portal::language('foc_all_services');?>">
                        </span>
                        <span class="multi-input-extra">
                            <span class="label" style="width: 150px;"><?php echo Portal::language('discount_room_charge');?>(%) <!---(% / <?php echo HOTEL_CURRENCY;?>)---></span>
                             <input  name="mi_reservation_room[#xxxx#][discount_after_tax]" style="width:15px;display:none;" value="1" type="checkbox" id="discount_after_tax_#xxxx#" align="left" title="<?php echo Portal::language('discount_percent_after_tax');?>">
                       ...
                       <span class="multi-input-extra">
                            <span class="label"><?php echo Portal::language('tax_rate_vat');?>(%)</span>
							...
							<span class="label"><?php echo Portal::language('service_rate');?>(%)</span>
                            ...
                            <span class="label"><?php echo Portal::language('net_price');?></span><input name="mi_reservation_room[#xxxx#][net_price]" style="width:15px;" value="1" type="checkbox" id="net_price_#xxxx#" align="left" title="<?php echo Portal::language('net_price');?>" <?php if(NET_PRICE==1){ echo 'checked';}?>>
                        </span>
						<span class="multi-input-extra" style="display:none;">
                            <span class="label"><?php echo Portal::language('deposit_amount');?></span>
                    ...
                    <div>
						<span class="multi-input-extra" style="display:none;">
							<span class="label"><?php echo Portal::language('vip_card_code');?></span>
                        ...
                        <span class="multi-input-extra" style="display:none;">
                            <span class="label"><?php echo Portal::language('invoice_number');?></span>
						 ...
						 <span class="multi-input-extra" style="display:none;">
                            <span class="label"><?php echo Portal::language('deposit_type');?></span>
							<select   name="mi_reservation_room[#xxxx#][deposit_type]" id="deposit_type_#xxxx#"  style="width:110px;float:left;">
								<option value="CASH"><?php echo Portal::language('cash');?></option>
								<option value="CREDIT_CARD"><?php echo Portal::language('credit');?></option>
							</select>
                        </span>
						<span class="multi-input-extra" style="display:none;">
                            <span class="label"><?php echo Portal::language('deposit_date');?></span>
                    ...
                    <div id="extra_bed" style="padding:5px 0px 5px 0px;clear:both; display:none;">
                        ...
                        <legend class="title"><?php echo Portal::language('Extra_room_charge');?></legend>
	                    <span class="multi-input-extra">
                           <span class="label"><?php echo Portal::language('Early_checkin');?>:</span>
                           <select   name="mi_reservation_room[#xxxx#][early_checkin]" id="early_checkin_#xxxx#" title="<?php echo Portal::language('early_checkin');?>" style="width:60px;" onchange="update_verify_dayuse(this.value,#xxxx#,'early_checkin');"><?php echo $this->map['verify_dayuse_options'];?></select>
                           <span class="label"><?php echo Portal::language('early_checkin_date');?>:</span>
                           <input name="mi_reservation_room[#xxxx#][early_checkin_date]" type="text" id="early_checkin_date_#xxxx#" class="extra_bed_from_date" />
                           <span class="label"><?php echo Portal::language('early_checkin_rate');?>:</span>
                           <input name="mi_reservation_room[#xxxx#][early_checkin_amount]" type="text" id="early_checkin_amount_#xxxx#"/>
                        </span>
                        <br clear="all" />
		                <span class="multi-input-extra">
                           <span class="label"><?php echo Portal::language('late_checkout');?>:</span>
                           <select   name="mi_reservation_room[#xxxx#][late_checkout]" id="late_checkout_#xxxx#" title="<?php echo Portal::language('late_checkout');?>" style="width:60px;" onchange="update_verify_dayuse(this.value,#xxxx#,'late_checkout');"><?php echo $this->map['verify_dayuse_options'];?></select>
                           <span class="label"><?php echo Portal::language('late_checkout_price');?>:</span>
                           <input name="mi_reservation_room[#xxxx#][late_checkout_date]" type="text" id="late_checkout_date_#xxxx#" />
                           <span class="label"><?php echo Portal::language('late_checkout_rate');?>:</span>
					...
					<div id="price_schedule_bound_#xxxx#" style="float:left;width:100%;padding:5px 0px 5px 0px;margin:5px 0px 5px 0px;display:none;">
						<span class="multi-input-extra">
							 <span><?php echo Portal::language('price_schedule');?></span><br />
                    ...
                    <div style="display:none;">&nbsp;&nbsp;&nbsp;&nbsp;
                    	<span id="invoice_#xxxx#" style="display:none;">
                            <a href="javascript:;" onclick="if($('id_#xxxx#').value!=''){window.open('?page=reservation&cmd=invoice&total_amount='+$('total_amount_#xxxx#').value+'&price='+$('price_#xxxx#').value+'&deposit='+$('deposit_#xxxx#').value+'&reduce_balance='+$('reduce_balance_#xxxx#').value+'&reduce_amount='+$('reduce_amount_#xxxx#').value+'&time_in='+$('time_in_#xxxx#').value+'&time_out='+$('time_out_#xxxx#').value+'&departure_time='+$('departure_time_#xxxx#').value+'&tax_rate='+$('tax_rate_#xxxx#').value+'&service_rate='+$('service_rate_#xxxx#').value+'&id='+$('id_#xxxx#').value+'');}"><img src="skins/default/images/edit.png" width="15"> <?php echo Portal::language('preview_invoice');?></a> |
                            <a href="javascript:;" onclick="if($('id_#xxxx#').value!=''){window.open('?page=reservation&cmd=invoice&type=ROOM&total_amount='+$('total_amount_#xxxx#').value+'&price='+$('price_#xxxx#').value+'&deposit='+$('deposit_#xxxx#').value+'&reduce_balance='+$('reduce_balance_#xxxx#').value+'&reduce_amount='+$('reduce_amount_#xxxx#').value+'&time_in='+$('time_in_#xxxx#').value+'&time_out='+$('time_out_#xxxx#').value+'&departure_time='+$('departure_time_#xxxx#').value+'&tax_rate='+$('tax_rate_#xxxx#').value+'&service_rate='+$('service_rate_#xxxx#').value+'&id='+$('id_#xxxx#').value+'');}"><img src="skins/default/images/edit.png" width="15"> <?php echo Portal::language('preview_room_invoice');?></a> |
                            <a href="javascript:;" onclick="if($('id_#xxxx#').value!=''){window.open('?page=reservation&cmd=invoice&type=SERVICE&total_amount='+$('total_amount_#xxxx#').value+'&price='+$('price_#xxxx#').value+'&deposit='+$('deposit_#xxxx#').value+'&reduce_balance='+$('reduce_balance_#xxxx#').value+'&reduce_amount='+$('reduce_amount_#xxxx#').value+'&time_in='+$('time_in_#xxxx#').value+'&time_out='+$('time_out_#xxxx#').value+'&departure_time='+$('departure_time_#xxxx#').value+'&tax_rate='+$('tax_rate_#xxxx#').value+'&service_rate='+$('service_rate_#xxxx#').value+'&id='+$('id_#xxxx#').value+'');}"><img src="skins/default/images/edit.png" width="15"> <?php echo Portal::language('preview_service_invoice');?></a>
							<?php if(User::can_add(false,ANY_CATEGORY)){?><input name="update" type="submit" value="<?php echo Portal::language('update');?>" class="update-room-info"> <a href="#" title="&#272;&#7875; &#273;&#7843;m b&#7843;o th&#244;ng tin ch&#237;nh x&#225;c b&#7841;n h&#227;y nh&#7845;n n&#250;t c&#7853;p nh&#7853;t tr&#432;&#7899;c khi xem h&#243;a &#273;&#417;n"><img src="packages/core/skins/default/images/buttons/question.gif" /></a><?php }?>
                        </span>
                    </div>
                 </div>
...
<table cellspacing="0" cellpadding="5" width="100%" style="margin-top:10px;" align="center">
	<tr valign="top">
		<td align="left">
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr height="40">
					<td width="70%" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;"><i class="fa fa-file-text w3-text-blue" style="font-size: 30px;"></i> <?php echo Portal::language('make_reservation');?></td>
				  	<?php if(User::can_add(false,ANY_CATEGORY)){?><td width="1%" nowrap="nowrap" style="padding-right: 10px;" class="hidden_btn"><input name="save_button" type="button" readonly="true" value="<?php echo Portal::language('Save');?>" class="w3-button w3-orange w3-hover-orange" onclick="checkDirtyAll('save');" style="text-transform: uppercase;" /><input name="save" id="save" type="checkbox" style="display: none;"/></td><?php }?><!--AddReservationForm.submit();-->
					<?php if(User::can_edit(false,ANY_CATEGORY)){?><td width="1%" nowrap="nowrap" style="padding-right: 10px;" class="hidden_btn"><input name="update_button" type="button" readonly="true" value="<?php echo Portal::language('Save_and_stay');?>" class="w3-button w3-blue w3-hover-blue" onclick="checkDirtyAll('update');" style="text-transform: uppercase;" /><input name="update" id="update" type="checkbox" value="<?php echo Portal::language('Save_and_stay');?>" style="display: none;"/></td><?php }?>
					<?php if(User::can_delete(false,ANY_CATEGORY)){?><td width="1%" nowrap="nowrap" style="padding-right: 10px;"><a href="<?php echo Url::build_current();?>"  class="w3-button w3-green w3-hover-green"  style="text-transform: uppercase; text-decoration: none;"><?php echo Portal::language('back');?></a></td><?php }?>
				</tr>
		  </table>
		</td>
	</tr>
	...
	<tr><td align="left">
			...
			<legend class="w3-white" style="width: 190px; height: 24px; padding: 5px 5px 0px 5px; border: 1px solid orange;"><?php echo Portal::language('general_information');?></legend>
                <div id="head_table">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">                
                 ...
                 <td align="right" nowrap>&nbsp;</td>
                 <td rowspan="8" width="40%"><?php echo Portal::language('note_for_tour_or_group');?>
                     <textarea  name="note" id="note" style="width:99%;height:90px;"><?php echo String::html_normalize(URL::get('note',''));?></textarea>
                     <a href="#" onclick="
                 ...
                 <tr valign="top">
                   <td align="right" nowrap>&nbsp;</td>
                   <td align="right"><?php echo Portal::language('customer');?> <i style="color: red;">(*)</i></td>
                    <td align="left" style="padding-left:10px;margin-bottom: 5px;"><input  name="customer_name" id="customer_name" onfocus="Autocomplete();" autocomplete="off" style="width:170px;margin-bottom: 5px;" type ="text" value="<?php echo String::html_normalize(URL::get('customer_name'));?>">
                      ...
                      <i class="fa fa-plus-square" style="font-size: 18px;"></i> <?php echo Portal::language('add_now');?>
                      </a> 
                 ...
                 <tr valign="top" style="display: none;">
                    ...
                    <td align="left" style="padding-left:10px;"><input  name="tour_name" id="tour_name" style="width:170px;margin-bottom: 5px;" readonly="" class="readonly" type ="text" value="<?php echo String::html_normalize(URL::get('tour_name'));?>">
                      <input  name="tour_id" id="tour_id" class="hidden" / type ="text" value="<?php echo String::html_normalize(URL::get('tour_id'));?>">
                 ...
                 <tr valign="top">
                    ...
                    <?php if(RATE_CODE==1 && User::can_admin($this->get_module_id('RateCodeAdmin'),ANY_CATEGORY)){
                      ...
                      <td align="right"><label class="w3-text-blue" for="is_rate_code" style="margin-left: 10px;"><?php echo Portal::language('use_rate_code');?></label></td>
                      <td>
                      ...
                      {
                      ?>
                         <td align="right" style="display: none;"><label class="w3-text-blue" for="is_rate_code" style="margin-left: 10px;"><?php echo Portal::language('use_rate_code');?></label></td>
                    ...
                    <td style="padding-left:10px;">
                    <input  name="email_booker" id="email_booker" style="width:170px;"/ type ="email" value="<?php echo String::html_normalize(URL::get('email_booker'));?>">
                    </td>
                    
                 </tr>
                 <tr valign="top" style="display:none;">
                      <td align="right" nowrap>&nbsp;</td>
                      <td align="right" height="20"><?php echo Portal::language('Room_total_amount');?></td>
                 ...
                 <tr valign="top" style="display:none;">
					...
					<td align="left" style="padding-left:10px;"><input  name="payment" id="payment" style="width:170px;margin-bottom: 5px;" type ="text" value="<?php echo String::html_normalize(URL::get('payment'));?>">
					  USD</td>
					<td align="right"></td>
					<td align="left"></td>
                  </tr>
                  ...
                  <tr valign="top">
                    ...
                    <td align="left" style="padding-left:10px;">
                       <select  name="payment_type1" id="payment_type1" style="width:170px; height: 20px;"><?php
                    ...
                    <td align="left" style="padding-left:10px;"><input  name="color" id="color" style="width:148px;margin-bottom: 5px;" type ="text" value="<?php echo String::html_normalize(URL::get('color'));?>"><span onclick="TCP.popup($('color'));" class="color-select-button" title="<?php echo Portal::language('select_color');?>"><img src="packages/core/skins/default/images/color_picker.gif" width="18" style="margin-left: 4px;"/></span></td>
                  </tr>
            </table>
            </div>
        </fieldset>
		<fieldset style="background:#E5E5E4" id="reservation_room">
			<legend class="w3-white"style="width: 190px; height: 24px; padding: 5px 5px 0px 5px; border: 1px solid orange;"><?php echo Portal::language('reservation_room');?>&nbsp;(<span style="color: red; font-size: 20px;" id="count_number_of_room">1</span> <?php echo Portal::language('room');?>)</legend>
			<span id="mi_reservation_room_all_elems">
				<span>
					...
					<span class="multi-input-header" style="width:78px;"><?php echo Portal::language('room_level');?></span>
					<span class="multi-input-header" style="width:68px;"><?php echo Portal::language('room_id');?></span>
                    <span class="multi-input-header" style="width:40px;"><?php echo Portal::language('adult');?></span>
                    <span class="multi-input-header" style="width:32px; display: none;"><?php echo Portal::language('note');?></span>
                    <span class="multi-input-header" style="width:58px;"><?php echo Portal::language('child');?></span>
                    <span class="multi-input-header" style="width:45px;"><?php echo Portal::language('child_5');?></span>
					<span class="multi-input-header" style="width:62px;"><?php echo Portal::language('room_rate');?></span>
                    <span class="multi-input-header" style="width:62px;"><?php echo Portal::language('usd_price');?></span>
                    ...
                    <?php if(User::can_admin($this->get_module_id('ReceptionCommission'),ANY_CATEGORY)){ ?>
                    <span class="multi-input-header" style="width:59px;"><?php echo Portal::language('cms');?></span>
                    
					<?php } ?>
					<span class="multi-input-header" style="width:45px;"><?php echo Portal::language('time_in');?></span>
                    <span class="multi-input-header" style="width:70px;"><?php echo Portal::language('arrival_time');?></span>
					<span class="multi-input-header" style="width:16px; display: none;">
					<input  name="all_early_checkin" id="all_early_checkin" onclick="check_early_checkin();" / type ="checkbox" value="<?php echo String::html_normalize(URL::get('all_early_checkin'));?>"></span>
					<span class="multi-input-header" style="width:45px;"><?php echo Portal::language('time_out');?></span>					
					<span class="multi-input-header" style="width:70px;"><?php echo Portal::language('departure_time');?></span>
                    <span class="multi-input-header" style="width:46px; display: none;" title="<?php echo Portal::language('early_checkin');?>">E.I</span>
                    <span class="multi-input-header" style="width:46px; display: none;" title="<?php echo Portal::language('late_checkout');?>">L.O</span>
					<span class="multi-input-header" style="width:68px;"><?php echo Portal::language('status');?></span>
					<span class="multi-input-header" style="width:50px; display: none;"><?php echo Portal::language('reservation_type');?></span>
					<span class="multi-input-header" style="width:25px;" title="<?php echo Portal::language('confirm');?>"><?php echo Portal::language('CF');?></span>
                    <span class="multi-input-header" style="width:25px;" title="<?php echo Portal::language('breakfast');?>"><?php echo Portal::language('BF');?></span>
                    <span class="multi-input-header" style="width:25px; <?php if(!USE_ALLOTMENT){ ?> display: none; <?php } ?>" title="<?php echo Portal::language('allotment');?>"><?php echo Portal::language('ALM');?></span>
			...
			<br clear="all"/>
			<input class="w3-button w3-gray w3-hover-cyan w3-hover-text-white" type="button" value="<?php echo Portal::language('add_room');?>" onclick="var roomCount = to_numeric($('count_number_of_room').innerHTML);$('count_number_of_room').innerHTML=roomCount+1;mi_add_new_row('mi_reservation_room');updateInput(input_count);AddInput(input_count);buildRateList(input_count);buildCommissionList(input_count); "/>
            <br clear="all"/>
            <br clear="all"/>
<!---THAY DOI CHO GROUP--->
            ...
            <fieldset id="change_for_group_div" style="width: 99%; margin: 0px auto; background: #F2F4CE; border: 1px dashed #171717;">
                ...
                <table style="width: 100%;">
                    <tr style="background: #fac73e;">
                        <td style="width: 175px; padding-left: 25px;"><span style="width: 70px; "><?php echo Portal::language('room_type');?></span></td>
                        <td style="width: 125px;"><span style="width: 40px;"><?php echo Portal::language('adult');?></span></td>
                        <td style="width: 65px; "><span style="width: 70px; "><?php echo Portal::language('price');?></span></td>
                        <td style="width: 65px; "><span style="width: 70px; "><?php echo Portal::language('usd_price');?></span></td>
                        <td style="width: 55px; "><span style="width: 55px; "></span></td>
                        <!-- Oanh add  -->
                        <td style="width: 38px; "><span style="width: 45px; "><?php echo Portal::language('time_in');?></span></td>
                        <td style="width: 76px; "><span style="width: 70px; "><?php echo Portal::language('arrival_time');?></span></td>
                        <td style="width: 38px; "><span style="width: 50px; "><?php echo Portal::language('time_out');?></span></td>
                        <!-- End Oanh add-->                        
                        <td style="width: 76px; "><span style="width: 70px; "><?php echo Portal::language('departure_time');?></span></td>
                        ...
                        <td><span><?php echo Portal::language('status');?></span></td>
                    </tr>
                    <tr style="border-bottom: 1px solid gray;">
                        <td style="cursor: pointer; padding-left: 25px;" onclick="fun_Check_Availblity(input_count,'<?php echo Url::get('cmd');?>');"><i class="fa fa-refresh w3-text-blue" style="font-size: 18px;"></i> <?php echo Portal::language('choose_room_type');?></td>
                        ...
                        <!---<td style=""><select  name="all_early_checkin" style="width: 50px; display: none;" id="all_early_checkin"  onchange="fun_change_all_ei(this.value);"><?php
	...
	<?php echo $this->map['verify_dayuse_options'];?></select></td>
                        <td style=""><select  name="all_late_checkout" style="width: 50px; display: none;" id="all_late_checkout" onchange="fun_change_all_lo(this.value);"><?php
                    ...
                    ?>
	<?php echo $this->map['verify_dayuse_options'];?></select></td>--->
                        <td><select  name="change_all_status" id="change_all_status" onchange="changeAllStatus(this.value,input_count);" style="width: 80px; height: 20px;"><option value=""><?php echo Portal::language('status');?></option><option value="CHECKIN">CHECKIN</option><option value="CHECKOUT">CHECKOUT</option></select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="14" style="text-align: center;">
                            <fieldset style="width: 100%; text-align: center;">
                                ...
                                <select onchange="func_change_price_in_date();" id="room_level_group" name="room_level_group"><?php echo $this->map['room_level_options'];?></select>
			...
			<!--|<?php echo Portal::language('change_all');?> <?php echo Portal::language('reservation_type');?> <select  name="change_all_reservation_type" id="change_all_reservation_type" onchange="changeAllReservationType(this.value);"><?php echo $this->map['reservation_type_options'];?></select>-->
...
<span style="display: none;"><?php echo Portal::language('commission');?>(%)</span>
<div id="selected_room" onmouseover="$('selected_room').style.display='';" onmouseout="$('selected_room').style.display='none';" style="display:none;float:left;position:absolute;top:0px;left:0px;width:180px;background-color:#FFCC00;border:2px solid #0099CC;vertical-align:top;">
    <div id="rooms" style="width:99%;background-color:#FFFFFF;">
        <div style="height:20px;background-color:#FF9900;border:1px solid #CCCCCC;text-align:center;margin:2px;color:#FFFFFF;font-weight:bold;text-transform:uppercase;padding:2px 0px 2px 0px;">
            <?php echo Portal::language('rooms');?>
        </div>
    </div>
</div>
...
function checkDirtyAll(key)
{
    ...
    if(jQuery('#customer_id').val()==''){
        alert('<?php echo Portal::language('select_customer_please');?>');
        return false;
    }
    /**start kieu check chon nguon khĂ¡ch  **/
...
<!-- <?php echo Portal::language(' time_in_is_more_than_current_time');?> -->