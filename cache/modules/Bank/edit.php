...
<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr height="40">
		<td width="70%" class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;"><?php echo Portal::language('bank_project');?></td>
		...
		<a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('bank');" class="w3-btn w3-red" style="text-transform: uppercase; text-decoration: none;"><?php echo Portal::language('Delete');?></a></td>
	</tr>
</table>
			...
			<div>
				<span id="bank_all_elems">
					<span>
						...
						<span class="multi-input-header" style="width:155px;"><?php echo Portal::language('bank_name');?></span>
						<span class="multi-input-header" style="width:70px; text-align: center;"><?php echo Portal::language('Delete');?></span>
					</span>
                    <br clear="all">
				</span>
			</div>
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('bank');$('name_'+input_count).focus();" class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; margin-top: 5px;"><?php echo Portal::language('Add');?></a></div>
...
function Confirm(index)
{
    ...
    return confirm('<?php echo Portal::language('Are_you_sure_delete_bank');?>'+ bank_name+'?');
}

function ConfirmDelete()
{
    return confirm('<?php echo Portal::language('Are_you_sure_delete_bank_selected');?>');
}
</script>