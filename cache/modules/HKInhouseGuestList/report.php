...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="font-size:11px;">
	<tr bgcolor="#EFEFEF">
        ...
        <th class="report_table_header" width="30px"><?php echo Portal::language('room_type');?></th>
		...
		<th class="report_table_header" width="40px"><?php echo Portal::language('country');?></th>  
	...
	<tr bgcolor="white">
        ...
        <a href="<?php echo Url::build('reservation',array('cmd'=>'edit','id'=>$this->map['items']['current']['reservation_id'],'r_r_id'=>$this->map['items']['current']['reservation_id']));?>" target="_blank"><?php echo $this->map['items']['current']['reservation_id'];?></a></td>
        <td align="center" class="report_table_column" rowspan="<?php echo $k; ?>"><?php echo $this->map['items']['current']['room_name'];?></td>
        <td align="center" class="report_table_column" rowspan="<?php echo $k; ?>"><?php echo $this->map['items']['current']['room_level'];?></td>           
        ...
        <span 'location'="<?php echo Url::build('traveller',array('id'=>$this->map['items']['current']['traveller_id']));?>" target="_blank"><?php echo $this->map['items']['current']['fullname'];?></span>
        </td>
        ...
        <?php 
            ...
            {
        ?>
        <td align="center" class="report_table_column" rowspan="<?php echo $k; ?>"><?php echo $this->map['items']['current']['night'];?></td>
        <?php
            }
        ?>
