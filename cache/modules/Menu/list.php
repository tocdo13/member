...
<div id="testRibbon" class="officebar" style="display:none;">
    ...
    <?php if(isset($this->map['categories']) and is_array($this->map['categories'])){ foreach($this->map['categories'] as $key1=>&$item1){if($key1!='current'){$this->map['categories']['current'] = &$item1;?>
      ...
      <?php 
          ...
          $i++; $k=0;
      ?> 
      rel="<?php echo $this->map['categories']['current']['id'];?>">
        <a href="#" rel="home" id="<?php echo $this->map['categories']['current']['id'];?>">
            <span id="Menu"><?php echo Portal::language()==1?$this->map['categories']['current']['name_1']:$this->map['categories']['current']['name_2']; ?></span>
        </a>
         <?php 
         ...
         <ul>
               ...
               <?php 
                   if($group_name_cate_id != $this->map['categories']['current']['child']['current']['group_name']."_".$this->map['categories']['current']['id'])
                   {
                        $t=0;
                        $group_old = $group_name;
                        $group_name_cate_id=$this->map['categories']['current']['child']['current']['group_name']."_".$this->map['categories']['current']['id'];
                        $group=0; 
                        if($act==3 && $k!=0)
                        {
                            echo '</ul></div>';				
               ...
               ?>
                    <li>
                	<?php 
				if(($this->map['categories']['current']['child']['current']['group_name']))
				{?>
                        <span class="w3-text-light-gray"><?php echo $this->map['categories']['current']['child']['current']['group_name'];?></span>
                               ...
                               <ul>
                                   <div class="dropdown" id="button_dropdown" style="padding: 0px !important;">
                                       <a href="#" rel="paste" style="text-align: center !important; padding: 0px !important;">                                	
                                           <?php 
				if(($this->map['categories']['current']['child']['current']['icon_url'] && $this->map['categories']['current']['child']['current']['icon_url']!=' '))
				{?>
                                                <img src="<?php echo $this->map['categories']['current']['child']['current']['icon_url'];?>" title="<?php echo Portal::language()==1?$this->map['categories']['current']['child']['current']['name_1']:$this->map['categories']['current']['child']['current']['name_2']; ?>" style="width: 25px; height: 25px; margin-bottom: 2px;" />
				...
				?>
                                       ...
                                       <div>
                                           <ul>
                                           <?php $y=1;?>
                                           <?php if(isset($this->map['categories']['current']['child']['current']['child']) and is_array($this->map['categories']['current']['child']['current']['child'])){ foreach($this->map['categories']['current']['child']['current']['child'] as $key3=>&$item3){if($key3!='current'){$this->map['categories']['current']['child']['current']['child']['current'] = &$item3;?>
                                                <?php 
                                                    if($y==1)
                                                    { 
                                                ...
                                                <li> 
                                                    <a href="<?php echo $this->map['categories']['current']['child']['current']['child']['current']['url'];?>">
                                                        <?php 
				if(($this->map['categories']['current']['child']['current']['child']['current']['icon_url'] && $this->map['categories']['current']['child']['current']['child']['current']['icon_url']!=' '))
				{?>
                                                            <img src="<?php echo $this->map['categories']['current']['child']['current']['child']['current']['icon_url'];?>" title="<?php echo Portal::language()==1?$this->map['categories']['current']['child']['current']['child']['current']['name_1']:$this->map['categories']['current']['child']['current']['child']['current']['name_2']; ?>" />
				...
				?><?php echo Portal::language()==1?$this->map['categories']['current']['child']['current']['child']['current']['name_1']:$this->map['categories']['current']['child']['current']['child']['current']['name_2']; ?>
                                           ...
                                           <?php }}unset($this->map['categories']['current']['child']['current']['child']['current']);} ?>
                                           </ul>
                                       </div>
                                   </div> 
                               </ul>
                             ...
                             <?php }else{ ?>
                            <?php 
				if(($this->map['categories']['current']['child']['current']['important']==1))
				{?>
                            <?php 
                            if($act==3)
                            {
                            ...
                            <div class="button textlist">
                                ...
                                <div class="dropdown" id="button_click">
                                    <a href="<?php echo $this->map['categories']['current']['child']['current']['url'];?>" id="button_<?php echo $this->map['categories']['current']['child']['current']['id'];?>">
                                        <?php 
				if(($this->map['categories']['current']['child']['current']['icon_url'] && $this->map['categories']['current']['child']['current']['icon_url']!=' '))
				{?>
                                            <img src="<?php echo $this->map['categories']['current']['child']['current']['icon_url'];?>" title="<?php echo Portal::language()==1?$this->map['categories']['current']['child']['current']['name_1']:$this->map['categories']['current']['child']['current']['name_2']; ?>" />
                                        
				<?php
				}
				?>
                                        <span><?php echo Portal::language()==1?$this->map['categories']['current']['child']['current']['name_1']:$this->map['categories']['current']['child']['current']['name_2']; ?></span>
                                    </a>
                                </div>
                            </div>
                              <?php }else{ ?>
                             ...
                             ?>
                             <li style="float: left;">
                                 <a href="<?php echo $this->map['categories']['current']['child']['current']['url'];?>" rel="paste" style="width: 65px !important; height: 60xp; text-align: center;">
                                 <?php 
				if(($this->map['categories']['current']['child']['current']['icon_url'] && $this->map['categories']['current']['child']['current']['icon_url']!=' '))
				{?>
                                    <img src="<?php echo $this->map['categories']['current']['child']['current']['icon_url'];?>" title="<?php echo Portal::language()==1?$this->map['categories']['current']['child']['current']['name_1']:$this->map['categories']['current']['child']['current']['name_2']; ?>" style="width: 25px; height: 25px; margin-bottom: 2px; text-align: center;" />
                                 
				<?php
				}
				?>
                                 <div style="width: 60px !important; text-align: center"><?php echo Portal::language()==1?$this->map['categories']['current']['child']['current']['name_1']:$this->map['categories']['current']['child']['current']['name_2']; ?></div>
                                 </a>
                             </li>
				...
				?>
                  ...
                  <?php 
                    if(isset($this->map['categories']['current']['child']['current']['counnt']) && $group==$this->map['categories']['current']['child']['current']['counnt'])
                    { 
                        echo '</ul></div></div>';
                    }
                  ?>
                  <?php 
                      ...
                      $k++;
                      if(($k+1)==sizeof($this->map['categories']['current']['child']))
                      {
                        if($act==3)
                        {
                            echo '</ul></div>';
   ...
   // echo $path;
	...
	<div id="chang_language" style="color:#FFF;">
        ...
        <a onclick="var user ='<?php echo User::id(); ?>';printWebPart('printer',user);" title="<?php echo Portal::language('print');?>"><i class="fa fa-print w3-text-black" style="font-size: 40px;"></i></a> | 
        <a  onclick="ChangeLanguageMenu('<?php echo (Portal::language()==1)?2:1; ?>');" title="<?php echo Portal::language('change_language');?>" class="w3-text-black" style="font-size:15px;"><?php 
	...
	<div id="sign-in" style="width: 100%; margin: 0px; padding: 0px; left: 0px; bottom: 0px; box-shadow: 0px 0px 5px #171717; <?php if(User::id()=='developer05'){ ?>background-color: rgba(236, 236, 236, 0.7);<?php } ?>">  
        <a href="<?php echo Url::build('home',array());?>" title="<?php echo Portal::language('home_page');?>" style="float: left; margin:0px 15px 0px 5px;"><i class="fa fa-home w3-text-orange" style="font-size: 30px;"></i></a>
	  	<!---<img src="packages/core/skins/default/css/jquery/images/banner_small.png" width="80px" height="30px" />--->
		<?php 
				if((User::is_login()))
				{?><span><?php echo Portal::language('Welcome');?>: </span><a class="link-personal" href="<?php echo Url::build('personal')?>"><?php echo $this->map['user_name'];?></a><span> | </span><a class="log-out" style="font-size:20px;" href="<?php echo Url::build('sign_out',array()); ?>"><?php echo Portal::language('sign_out');?></a> <?php }else{ ?><a href="<?php echo Url::build('sign_in',array()); ?>"><?php echo Portal::language('sign_in');?></a>
				<?php
				}
				?>
  <div>
       ...
       <ul class="show_cout">
       <li style="color: red;"><?php echo $this->map['count_note'];?> |</li>
       <li style="color: blue;"><?php echo $this->map['count2'];?> |</li>
       <li style="color: black;"><?php echo $this->map['count_all_note'];?> </li>
       </ul>      
...
<div class="header_list_work">
	...
	<ul class="testTable">
     <?php if(isset($this->map['list_work']) and is_array($this->map['list_work'])){ foreach($this->map['list_work'] as $key4=>&$item4){if($key4!='current'){$this->map['list_work']['current'] = &$item4;?>
        <li class="testRow" style='<?php if($this->map['list_work']['current']['status']==1){echo 'background:#B0C4DE';} if($this->map['list_work']['current']['mkt_start']>$this->map['time_now']){ echo 'background:#20B2AA';} if($this->map['list_work']['current']['mkt_start']<$this->map['time_now'] && $this->map['list_work']['current']['status']==0){ echo 'background:#F4A460';} ?>' >
          <div class="bao"> 
          <div class="gio"><?php echo $this->map['list_work']['current']['start_time'];?>--<?php echo $this->map['list_work']['current']['end_time'];?></div>
     	 	<div class="nd_title"><?php echo $this->map['list_work']['current']['title'];?></div>
     	 	</div>
      
        </li>
        <?php }}unset($this->map['list_work']['current']);} ?> 
        
 </ul>       
 </div>
 </div>
       <div style="float:left;margin-top:10px;margin-left:10px;">| <a style="font-size:16px; color:#03F; margin-top:15px; margin-left:10px;" onclick="switchHideMenu();"><?php echo Portal::language('show');?>/ <?php echo Portal::language('hide');?> <b><?php echo Portal::language('Menu');?></b></a></div>
	    <div style="float:right;margin-top:6px;margin-right:3px;"><strong style="color:#0000FF"> | <a href="javascript:void(0)" id="support"><?php echo Portal::language('support');?></a></div>
	    <div style="float:right;margin-top:6px;margin-right:3px; display:none;"><strong style="color:#0000FF"> | <a target="_blank" href="?page=help"><?php echo Portal::language('help');?></a></div>
	    <div id="portal" style="float:right;margin-top:6px;margin-right:3px;"><strong style="color:#0000FF"><?php echo Portal::language('Hotel_name');?>:</strong> <a style="color:#FF0000;font-weight:bold;font-size:14px;" href="<?php echo Url::build('select_portal')?>"><?php echo $this->map['current_portal'];?></a> | <strong>IP : <?php echo $_SERVER['REMOTE_ADDR'];?></strong></div>
    </div>
  <style>
    #navigation{
        width: 220px;
...
//    { //$phparray=array(1=>array('job'=>'tesst day 1','time'=>'10000'));
 ...
 <?php
    if($this->map['check_use_chat']==1 && RATE_CODE==1)
    {
 ?> 
 <div id="support-bound">
    <div id="navigation" style="height: 600px; width: 100%; overflow: auto;">
        ...
        <?php if(isset($this->map['user_list']) and is_array($this->map['user_list'])){ foreach($this->map['user_list'] as $key5=>&$item5){if($key5!='current'){$this->map['user_list']['current'] = &$item5;?>
            <div class='user_tag'>
                <span status="off" style='float:left; display:block;text-align:center; height:6px; width: 6px; margin: 12px; border-radius: 3px; background: red;'></span><span class='child_name' nickname='<?php echo $this->map['user_list']['current']['full_name'];?>' to_user='<?php echo $this->map['user_list']['current']['user_id'];?>' onclick='getContent(this);' style="font-size: 10px;"><?php echo $this->map['user_list']['current']['full_name'];?></span>
            </div>
        <?php }}unset($this->map['user_list']['current']);} ?>        
        <!-- KIEU-EDIT
        ...
        <!--<div id='chatting'>
            ...
            <form id='send-form' action="/" method="POST">
                ...
                <input type="hidden" value="<?php echo $this->map['user_name'];?>" name="nickname" id="nickname" />
...
?>       
 ...
 <div id="description_page_list">
    ...
    <br clear="all" />
    <div class="button_description_page" onclick="fun_open_description_page(<?php echo $this->map['module_id'];?>);" style="background: url('resources/icon_module/icon_add_module.png') top left no-repeat;">
        <p>VIEW MODULE</p>
    </div>
...
<?php
    if($this->map['check_use_chat']==1 && USING_CHAT && USING_CHAT == 1)
    {
?> 
<script>
    jQuery(document).ready(function(){
