            ...
            <tr>
                ...
                <th style="vertical-align: top;">
                    <div onclick="location.href='?page=touch_bar_restaurant&cmd=edit&id=<?php echo Url::get('id'); ?>&table_id=<?php echo Url::get('table_id'); ?>&bar_area_id=<?php echo Url::get('bar_area_id'); ?>&bar_id=<?php echo Url::get('bar_id'); ?>';" class="w3-button w3-white w3-hover-white w3-right w3-border" style="font-weight: normal; margin-right: 3px;">
                        <i class="fa fa-fw fa-save"></i> <?php echo Portal::language('back');?>
                    </div>
                    <div onclick="location.href='?page=touch_bar_restaurant&cmd=invoice&id=<?php echo Url::get('id'); ?>&table_id=<?php echo Url::get('table_id'); ?>&bar_area_id=<?php echo Url::get('bar_area_id'); ?>&bar_id=<?php echo Url::get('bar_id'); ?>';" class="w3-button w3-white w3-hover-white w3-right w3-border" style="font-weight: normal; color: #f27173!important; margin-right: 3px;">
                        <i class="fa fa-fw fa-plus"></i> <?php echo Portal::language('create_bill');?>
                    </div>
            ...
            <tr>
                <td style="vertical-align: top;">
                    <table id="ProductItems" style="width: 98%; margin: 1% auto;" cellpadding="5" cellspacing="5" border="1" bordercolor="#EEE">
                        ...
                        <tr class="ProductItems" id="ProductItems_<?php echo $this->map['items']['current']['id'];?>" lang="<?php echo $this->map['items']['current']['id'];?>" style="height: 35px; font-weight: bold;">
                            <td>
                                <span id="lbl_name_<?php echo $this->map['items']['current']['id'];?>"><?php echo $this->map['items']['current']['name'];?></span>
                                <input value="<?php echo $this->map['items']['current']['name'];?>" type="hidden" id="product_name_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['invoice_id'];?>" type="hidden" id="product_invoice_id_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['type'];?>" type="hidden" id="product_type_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['quantity'];?>" type="hidden" id="product_quantity_old_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['quantity'];?>" type="hidden" id="product_quantity_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['amount_before_tax'];?>" type="hidden" id="product_amount_before_tax_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['service_amount'];?>" type="hidden" id="product_service_amount_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['tax_amount'];?>" type="hidden" id="product_tax_amount_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['amount'];?>" type="hidden" id="product_amount_<?php echo $this->map['items']['current']['id'];?>" />
                                <input value="<?php echo $this->map['items']['current']['total'];?>" type="hidden" id="product_total_<?php echo $this->map['items']['current']['id'];?>" />
                            </td>
                            <td style="text-align: center; width: 80px;"><span id="lbl_quantity_<?php echo $this->map['items']['current']['id'];?>" <?php 
				if(($this->map['items']['current']['type']=='DEPOSIT' OR $this->map['items']['current']['type']=='DISCOUNT'))
				{?>style="display: none;"
				<?php
				}
				?>><?php echo $this->map['items']['current']['quantity'];?></span></td>
                            <td style="text-align: right; width: 100px;"><span id="lbl_total_<?php echo $this->map['items']['current']['id'];?>"><?php echo System::display_number($this->map['items']['current']['total']); ?></span></td>
                            <td onclick="MoveItems('<?php echo $this->map['items']['current']['id'];?>');" style="cursor: pointer; width: 42px;" title="Move All"><i class="fa fa-fw fa-2x fa-arrow-circle-o-right w3-text-dark-gray"></i></td>
                        </tr>
                    ...
                    <table id="InvoiceItems" style="width: 98%; margin: 1% auto;" cellpadding="5" cellspacing="5">
                        <tr style="height: 42px;">
                            <td style="text-align: right;">
                                <?php echo Portal::language('total_amount');?>
                                <input  name="total_before_tax" id="total_before_tax" / type ="hidden" value="<?php echo String::html_normalize(URL::get('total_before_tax'));?>">
                                <input  name="tax_amount" id="tax_amount" / type ="hidden" value="<?php echo String::html_normalize(URL::get('tax_amount'));?>">
                                <input  name="service_amount" id="service_amount" / type ="hidden" value="<?php echo String::html_normalize(URL::get('service_amount'));?>">
                            </td>
                            <td style="text-align: right; width: 100px;"><input  name="total_amount" id="total_amount" class="w3-input" style="border: none; text-align: right;" readonly="" / type ="text" value="<?php echo String::html_normalize(URL::get('total_amount'));?>"></td>
                            <td style="width: 42px;"></td>
                        </tr>
                        <tr style="height: 42px;">
                            <td style="text-align: right;">
                                <?php echo Portal::language('paid');?>
                            </td>
                        ...
                        <tr style="height: 42px;">
                            <td style="text-align: right;">
                                <?php echo Portal::language('remain');?>
                            </td>
                        ...
                        <tr style="height: 42px;">
                            <td colspan="3" style="text-align: right;">
                                <!--<div onclick="" class="w3-button w3-white w3-hover-white w3-right w3-border" style="font-weight: normal; color: #f27173!important; margin-right: 3px;">
                                    <i class="fa fa-fw fa-plus"></i> <?php echo Portal::language('payment');?>
                                </div>-->
                                ...
                                <div onclick="location.href='?page=touch_bar_restaurant&cmd=view_invoice&invoice_id=<?php echo Url::get('invoice_id'); ?>';" class="w3-button w3-white w3-hover-white w3-right w3-border" style="font-weight: normal; color: #f27173!important; margin-right: 3px;">
                                    <i class="fa fa-fw fa-save"></i> <?php echo Portal::language('view_invoice');?>
                                </div>
                                <?php } ?>
                            </td>
                        </tr>
                    ...
                    <div class="w3-row">
                        <table id="payment" style="width: 100%;" class="w3-table-all w3-hoverable">
                            <tr style="text-align: center;" class=" w3-light-grey">
                                <th style="text-align: center;"><?php echo Portal::language('description');?></th>
                                <th style="text-align: center;"><?php echo Portal::language('amount_paid');?></th>
                                <th style="text-align: center; display: none;"><?php echo Portal::language('time');?></th>
                                <th style="text-align: center;"><?php echo Portal::language('payment_type');?></th>
                                <th style="text-align: center;"><?php echo Portal::language('credit_card');?></th>
                                <th style="text-align: center;"><?php echo Portal::language('bank_acc');?></th>
                                <th style="width: 70px; text-align: center; display: none;"><?php echo Portal::language('paid');?></th>
                        ...
                        <div class="w3-button w3-blue w3-right" onclick="AddPayment();" style="margin: 5px;">
                            <i class="fa fa-plus fa-fw"></i> <?php echo Portal::language('add');?> <?php echo Portal::language('payment');?> 
                        </div>
                    </div>
                </td>
            </tr>
...
<table id="payment_teamplate" style="display: none;">
    <tr id="payment_#xxxx#" class="PaymentItems" lang="#xxxx#">
        ...
        <td style="position: relative;">
            <select id="payment_payment_type_id_#xxxx#" name="payment[#xxxx#][payment_type_id]" class="w3-select w3-border" style="height: 33px;" onchange="ShowHideBank(#xxxx#,'PAYMENT');"><?php echo $this->map['payment_type_option'];?></select>
            <span class="payment_lock_#xxxx#" style="width: 100%; height: 100%; background: rgba(255,255,255,0.4); position: absolute; top: 0px; left: 0px; z-index: 999; display: none;"></span>
        </td>
        <td style="position: relative;">
            <select id="payment_credit_card_id_#xxxx#" name="payment[#xxxx#][credit_card_id]" class="w3-select w3-border" style="height: 33px;"><?php echo $this->map['credit_card_option'];?></select>
            <span class="payment_lock_#xxxx#" style="width: 100%; height: 100%; background: rgba(255,255,255,0.4); position: absolute; top: 0px; left: 0px; z-index: 999; display: none;"></span>
        </td>
        <td style="position: relative;">
        ...
        <td style="position: relative;">
            <input id="payment_delete_#xxxx#" class="w3-button w3-red" type="button" value="<?php echo Portal::language('delete');?>" onclick="DeletePayment('#xxxx#');" />
            <span class="payment_lock_#xxxx#" style="width: 100%; height: 100%; background: rgba(255,255,255,0.4); position: absolute; top: 0px; left: 0px; z-index: 999; display: none;"></span>
        </td>
    </tr>
</table>
<script>
    var full_charge = to_numeric(<?php echo $this->map['full_charge'];?>);
    var full_rate = to_numeric(<?php echo $this->map['full_rate'];?>);
    var bar_fee_rate = to_numeric(<?php echo $this->map['bar_fee_rate'];?>);
    var tax_rate = to_numeric(<?php echo $this->map['tax_rate'];?>);
    var discount_after_tax = to_numeric(<?php echo $this->map['discount_after_tax'];?>);
    ...
    function AddPayment($row) {
        ...
        if($row){
            ...
            jQuery(".payment_lock_"+input_count_payment).click(function(){ alert('<?php echo Portal::language('paid');?> <?php echo Portal::language('not_edited');?>') });
        }else{
            jQuery("#payment_credit_card_id_"+input_count_payment).attr('disabled','disabled');
            jQuery("#payment_bank_acc_"+input_count_payment).attr('readonly','readonly');
            jQuery("#payment_credit_card_id_"+input_count_payment).val('');
