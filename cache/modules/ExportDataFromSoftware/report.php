...
<div style="width: 100%; height: 480px; background-color: #F5F5F5;">
    <table width="100%" style="margin: 0 auto; position: relative; top: 0;">
        <tr>
            <td style="text-align: center; text-transform: uppercase; font-size: 24px; color: #FFF; background-color: #069696; height: 50px; line-height: 50px; font-weight: bold;"><?php echo Portal::language('export_excel_for_cns');?></td>
        </tr>
        <br />
        <tr>
    ...
    <table width="300px" style="margin: 0 auto; position: relative; top: 0;">
        <tr>
            <td style="font-size: 12px; width: 80px;"><?php echo Portal::language('export_date');?>:</td>
            <td style="font-size: 12px; width: 100px;"><input  name="export_date" id="export_date" style="width: 80px; height: 20px;" readonly=""/ type ="text" value="<?php echo String::html_normalize(URL::get('export_date'));?>"></td>
            <td style="font-size: 12px;"><input name="export_excel" type="submit" id="export_excel" value="<?php echo Portal::language('export');?>"  style="width: 80px; height: 25px;"/></td>
        </tr>
    </table>
</div>
<div style="width: 100%;">
