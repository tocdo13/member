    ...
    <div class="w3-row w3-padding" id="DashboardContent" style="margin: 0px auto 100px;">
        <table cellspacing="5" cellpadding="15" style="width: 100%;" border="1" bordercolor="#CCCCCC">
            ...
            <tr class="w3-grey" style="font-weight: bold;">
                <td><?php echo $this->map['items']['current']['uniqueid'];?></td>
                <td><?php echo $this->map['items']['current']['status'];?></td>
                <td><?php echo $this->map['items']['current']['channel_name'];?></td>
                <td><?php echo date('H:i d/m/Y',$this->map['items']['current']['reservation_time']); ?></td>
                ...
                <td><?php echo $this->map['items']['current']['reservation_note'];?></td>
                <td><?php echo $this->map['items']['current']['total_amount'];?></td>
                <td><a href="?page=reservation&cmd=edit&id=<?php echo $this->map['items']['current']['reservation_id'];?>" class="w3-button w3-pink"><i class="fa fa-fw fa-pencil w3-text-white"></i></a></td>
            </tr>
            <tr style="background: #f9f9f9;">
                <td>Payment Note</td>
                <td colspan="9"><?php echo $this->map['items']['current']['pay_note'];?></td>
            </tr>
            <tr style="background: #f9f9f9;">
                <td>Guest and Service Note</td>
                <td colspan="9"><?php echo $this->map['items']['current']['guest_service_note'];?></td>
            </tr>
