...
<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr height="40">
		<td width="90%" class="form-title"><?php echo Portal::language('access_hotel');?></td>
		<td width="5%"><input type="submit" value="<?php echo Portal::language('Save');?>" class="button-medium-save"></td>
		<td width="5%"><a href="javascript:void(0);" onclick="if(ConfirmDelete()) mi_delete_selected_row('hotel');" class="button-medium-delete"><?php echo Portal::language('Delete');?></a></td>
	</tr>
</table>
			...
			<div>
				<span id="hotel_all_elems">
					<span>
						...
						<span class="multi-input-header" style="width:155px;"><?php echo Portal::language('hotel_name');?></span>
                        <span class="multi-input-header" style="width:155px;"><?php echo Portal::language('hotel_link');?></span>
                        <span class="multi-input-header" style="width:155px;"><?php echo Portal::language('hotel_portal');?></span>
                        <span class="multi-input-header" style="width:155px;"><?php echo Portal::language('note');?></span>
                        <span class="multi-input-header" style="width:80px;"><?php echo Portal::language('is_active');?></span>
						<span class="multi-input-header" style="width:70px;"><?php echo Portal::language('Delete');?></span>
					</span>
                    <br clear="all"/>
				</span>
			</div>
			<div><a href="javascript:void(0);" onclick="mi_add_new_row('hotel');$('name_'+input_count).focus();auto_check();" class="button-medium-add"><?php echo Portal::language('Add');?></a></div>
...
function Confirm(index)
{
    ...
    return confirm('<?php echo Portal::language('Are_you_sure_delete_hotel');?>'+ hotel_name+'?');
}

function ConfirmDelete()
{
    return confirm('<?php echo Portal::language('Are_you_sure_delete_hotel_selected');?>');
}
function auto_check()
{
    var check = false;
