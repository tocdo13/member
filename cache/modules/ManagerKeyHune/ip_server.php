                                ...
                                <table width="100%" style="margin-top: 10px;">
                                    ...
                                    <tr>
                                        <td align="center" >
                                			...
                                			<div style="padding-top: 2px; margin-left: 40px;" ><a href="javascript:void(0);" onclick="mi_add_new_row('mi_group');AddInput(input_count);" class="button-medium-add"><?php echo Portal::language('Add');?></a></div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
