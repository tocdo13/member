        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo Portal::language('Check_card_using');?></h4>
                </div>
                <div class="panel-body">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th><?php echo Portal::language('Barcode');?></th>
                                <th><?php echo Portal::language('Room_name');?></th>
                                <th><?php echo Portal::language('Guest_name');?></th>
                                <th><?php echo Portal::language('Ticket_type');?></th>
                    ...
                    <div class="col-md-12" id="btn_use" style="display: none;">
                        <div class="col-md-12" style="text-align: center;"><button class="btn btn-danger" type="button" name="active" value="Use" onclick="if(confirm('<?php echo Portal::language('Do_you_want_use_this_voucher');?>?')) change_action();"><?php echo Portal::language('Use');?></button></div>                          
                    </div>
                    <!--<div class="col-md-6 col-md-offset-3">
                        <br />
                        <p> <span class="label_info"><?php echo Portal::language('Guest_name');?> </span> <span style="padding-top: 8px; display: block;" id="guest_name"></span></p>
                        <p> <span class="label_info"><?php echo Portal::language('Ticket_type');?> </span> <span style="padding-top: 8px; display: block; color: blue;" id="ticket_type"></span></p>
                        <p> <span class="label_info"><?php echo Portal::language('Room_name');?> </span> <span style="padding-top: 8px; display: block; text-align: right; font-size: 14px; margin-right: 170px;" id="room_name"></span></p>
                        <p> <span class="label_info"><?php echo Portal::language('Date_use');?> </span> <span style="padding-top: 8px; display: block; text-align: right;font-size: 14px; margin-right: 170px;" id="date_use"></span></p>                       
                        <p> <span class="label_info"><?php echo Portal::language('Status');?> </span> <span style="padding-top: 8px; display: block;text-align: right;font-size: 14px; width:100%; text-align:left;" id="status"></span></p>
                        <div class="col-md-12" id="btn_use" style="display: none;">
                            <div class="col-md-12" style="text-align: center;"><button class="btn btn-danger" type="button" name="active" value="Use" onclick="if(confirm('<?php echo Portal::language('Do_you_want_use_this_voucher');?>?')) change_action();"><?php echo Portal::language('Use');?></button></div>                          
                        </div>
