...
<form name="ListExtraServiceInvoiceForm" method="post">
	<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr>
			...
			<?php if(User::can_add(false,ANY_CATEGORY)){?><td width="45%" style="text-align: right; padding-right: 30px;"><a href="<?php echo URL::build_current(array('cmd'=>'add'));?>"  class="w3-btn w3-cyan w3-text-white" style="text-transform: uppercase; text-decoration: none; margin-right: 5px;"><?php echo Portal::language('Add');?></a><?php }?>
            <?php if (User::can_delete(false, ANY_CATEGORY)) { ?>
            <a href="#" onclick="select_delete_all();" class="w3-red w3-btn" style="text-transform: uppercase; text-decoration: none;"><?php echo Portal::language('delete');?></a></td>
            <?php } ?>
        </tr>
    </table>
	...
	<div class="content">
		<table width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#CCCCCC">
			<tr class="w3-light-gray" style="text-transform: uppercase; height: 26px;">
			  ...
			  <th width="12%" class="center"><?php echo Portal::language('package_code');?></th>
              <th width="25%" class="center"><?php echo Portal::language('Package_name');?></th>
              <th width="15%" class="center"><?php echo Portal::language('from_date');?></th>
              <th width="15%" class="center"><?php echo Portal::language('to_date');?></th>
              <th width="15%" class="center"><?php echo Portal::language('amount');?></th>
              <th width="20%" class="center"><?php echo Portal::language('content');?></th>
		  ...
		  <?php if(isset($this->map['items']) and is_array($this->map['items'])){ foreach($this->map['items'] as $key1=>&$item1){if($key1!='current'){$this->map['items']['current'] = &$item1;?>
			<tr>
			  ...
			  <td class="center"><?php echo $this->map['items']['current']['code'];?></td>
                ...
                <td class="center"><?php echo $this->map['items']['current']['start_date'];?></td>
                <td class="center"><?php echo $this->map['items']['current']['end_date'];?></td>
                <td class="center"><?php echo $this->map['items']['current']['total_amount'];?></td>
                <td class="center"><?php echo $this->map['items']['current']['content'];?>
                </td>
