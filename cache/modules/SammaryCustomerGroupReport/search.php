...
<div id="content_search" style="margin: 5px auto; width: 500px; border: 1px solid #999; border-radius:10px;">
    <h3 style="text-transform: uppercase; width: 100%; text-align: center; margin: 10px auto; font-size: 19px;"><?php echo Portal::language('summary_customer_group_report');?></h3>
    ...
    <fieldset style="width: 300px; margin: 10px auto; background: #fff;">
        ...
        <table>
            ...
            <tr>
                ...
                <td><select  name="portal_id" id="portal_id" style="width: 100px;"><?php
            ...
            <tr>
                ...
                <td nowrap="nowrap"><p><select  name="group_id" id="group_id" style="width: 100px;"><?php
    ...
    <!--<fieldset style="width: 150px; margin: 10px auto; background: #fff;">
        ...
        <table>
            <tr>
                ...
                <td><input  name="line_per_page" id="line_per_page" tabindex="3" style="width: 50px;" value="32" / type ="text" value="<?php echo String::html_normalize(URL::get('line_per_page'));?>"></td>
            </tr>
            <tr>
                <td align="right"><?php echo Portal::language('no_of_page');?></td>
                <td><input  name="no_of_page" id="no_of_page" tabindex="4" style="width: 50px;" value="50" / type ="text" value="<?php echo String::html_normalize(URL::get('no_of_page'));?>"></td>
            </tr>
            <tr>
                <td align="right"><?php echo Portal::language('from_page');?></td>
                <td><input  name="start_page" id="start_page" tabindex="5" style="width: 50px;" value="1" / type ="text" value="<?php echo String::html_normalize(URL::get('start_page'));?>"></td>
            </tr>
        </table>
    </fieldset>-->
