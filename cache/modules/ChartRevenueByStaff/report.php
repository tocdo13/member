                ...
                <form name="SearchForm" method="post">
                    ...
                    ?>
                            ...
                            <?php echo Portal::language('date');?>
                                ...
                                <input  name="date" id="date" style="width:100px;" class="by-year"/ type ="text" value="<?php echo String::html_normalize(URL::get('date'));?>">
                            
                            <input type="submit" name="do_search" value="<?php echo Portal::language('report');?>"/></td>
    ...
    <tr>
        <td width="38%" style="padding: 5px; " >
            <div style=" border: 1px solid green ; height: auto; ">
                <table  style=" width: 100%; margin: 0px; ">
                    <tr height="30">
                        <td colspan="4" align="center" ><strong><?php echo Portal::language('real_revenue_today');?></strong></td>
                    </tr>
                    <tr height="25">
                        <th width="30%" align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('quota');?></th>
                        <th width="20%" align="center" >VND</th>
                        <th width="10%" align="center" >USD</th>
                        <th width="20%" align="center" ><?php echo Portal::language('total');?></th>
                    </tr>
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('cash');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('credit_card');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('debit');?></td>
                   ...
                   <!-- <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('free');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('bank_tranfer');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('refund');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><strong><?php echo Portal::language('total');?></strong></td>
        ...
        <td width="28%" height="100%" rowspan="2" style=" padding: 5px; " >
            <div style=" border: 1px solid green ; height: 420px; ">
                <table  style=" width: 100%; margin: 0px;">
                    <tr height="30">
                        <td colspan="2" align="center" ><strong><?php echo Portal::language('expect_revenue_today');?></strong></td>
                    </tr>
                    <tr height="25" >
                        <th width="45%" align="left"  style=" padding-left: 30px; "  ><?php echo Portal::language('quota');?></th>
                        <th width="45%" align="center" ><?php echo Portal::language('amount');?></th>
                    </tr>
                    <?php if($this->map['list_part_php']['ROOM']){ ?>
                    <tr height="25" >
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('room_revenue');?></td>
                    ...
                    <tr height="25" >
                        <td align="left" style=" padding-left: 30px; "  ><i><?php echo Portal::language('breakfast_revenue');?></i></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('housekeeping');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('extra_sevice');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('spa');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('shop');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('ticket');?></td>
                    ...
                    <tr height="25">
                        <td align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('bar');?></td>
        ...
        <td width="28%" height="100%" rowspan="2" style=" padding: 5px; " >
            <div style=" border: 1px solid green ; height: 420px; ">
                <table  style=" width: 100%; margin: 0px; ">
                    <tr height="30" >
                        <td colspan="2" align="center" ><strong><?php echo Portal::language('expect_revenue_inmonth');?></strong></td>
                    </tr>
                    <tr height="25" >
                        <th width="45%" align="left"  style=" padding-left: 30px; "  ><?php echo Portal::language('quota');?></th>
                        <th width="45%" align="center" ><?php echo Portal::language('amount');?></th>
    ...
    <tr>
        <td width="38%" style=" padding: 5px; " >
            <div style=" border: 1px solid green ; height: auto; ">
                <table  style="width: 100%; margin: 0px; ">
                    <tr height="30" >
                        <td colspan="4" align="center" ><strong><?php echo Portal::language('deposit_amount_today');?></strong></td>
                    </tr>
                    <tr height="25" >
                        <th width="30%" align="left" style=" padding-left: 30px; "  ><?php echo Portal::language('quota');?></th>
                        <th width="20%" align="center" >VND</th>
    ...
    <div width="100%" style=" border: 1px solid green ; height: auto; padding: 5px; ">
        <table  style="width: 100%; margin: 0px; ">
            <tr width="30%" height="16" >
                <td align="left" width="20%" ><?php echo Portal::language('booked_room');?></td>
                <td align="left" width="10%"><?php echo $this->map['static_room']['ROOM_BOOKED']; ?></td>
                <td align="left" width="20%" ><?php echo Portal::language('occupied_rooms');?>:  </td>
                <td align="left" width="10%"  ><?php echo $this->map['static_room']['ROOM_OCCUTIE']; ?> </td>
                <td align="left" width="20%" ><?php echo Portal::language('room_dayuse');?>:</td>
            ...
            <tr width="40%" height="16">
                ...
                <td align="left" width="30%" ><?php echo Portal::language('cancel_rooms_today');?>: </td>
                <td align="left" width="10%"  ><?php echo $this->map['static_room']['ROOM_CANCEL']; ?></td>
                <td align="left" width="30%" ><?php echo Portal::language('Guest_in_house');?>(a/c):</td>
                <td align="left" width="10%"  ><?php echo $this->map['static_room']['ROOM_GUEST']; ?>/<?php echo $this->map['static_room']['ROOM_GUEST_CHILD']; ?></td>
            </tr>
            <tr width="30%" height="16">
                <td align="left" width="20%" ><?php echo Portal::language('arrival_room_today');?>: </td>
                <td align="left" width="10%"  ><?php echo $this->map['static_room']['ROOM_ARRIVE']; ?></td>
                <td align="left" width="30%" ><?php echo Portal::language('repairing_rooms');?>: </td>
                <td align="left" width="10%"  ><?php echo $this->map['static_room']['ROOM_REPAIR']; ?></td>
                <td align="left" width="20%" ><?php echo Portal::language('extra_bed');?>: </td>
                <td align="left" width="10%"  ><?php echo $this->map['static_room']['ROOM_EXTRA_BED']; ?></td>
                
            </tr>
            <tr width="30%" height="16">
                <td align="left" width="20%" ><?php echo Portal::language('departure_room_today');?>: </td>
                <td align="left" width="10%"  ><?php echo $this->map['static_room']['ROOM_DEPART']; ?></td>
                <td align="left" width="20%" ><?php echo Portal::language('expect_room_capacity');?>:</td>
                <td align="left" width="10%"  ><?php echo number_format($this->map['static_room']['ROOM_CAPACITY'],2); ?>%</td>
                <td align="left" width="20%" ><?php echo Portal::language('average_price');?>: </td>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        var chart_indate;
        var data_date = [];
        var array_names = ['<?php echo Portal::language('room_revenue');?>'
                        ,'<?php echo Portal::language('housekeeping');?>'
                        ,'<?php echo Portal::language('extra_sevice');?>'
                        ,'<?php echo Portal::language('spa');?>'
                        ,'<?php echo Portal::language('shop');?>'
                        ,'<?php echo Portal::language('ticket');?>'
                        ,'<?php echo Portal::language('bar');?>'];
        var items = <?php echo $this->map['revention_indate_js'];?>;
        var list_depart = <?php echo $this->map['list_part_js'];?>;
        j = 0;
        k = 0;
        var tong = 0;
        ...
        chart_indate = new Highcharts.Chart(
        {
            ...
            title: {
                    text: "<?php echo Portal::language('revenue_in_date');?>"
            },
            colors: [
               '#890d43', 
               '#ff0000', 
        ...
        items = <?php echo $this->map['revention_dates_in_month_js'];?>;
        data_date = [];
        var xAsis = [];
        j=0;
        for(i in items)
        ...
        var chart_dates = new Highcharts.Chart({
                ...
                title: {
                    text: "<?php echo Portal::language('revenue_in_month');?>"
                },
                xAxis: {
                    categories: xAsis
                },
        ...
        items = <?php echo $this->map['occupied_room_dates_in_month_js'];?>;
        data_occ = [];
        var xAsis = [];
        j=0;
        for(i in items)
        ...
        var chart_dates = new Highcharts.Chart({
                ...
                title: {
                    text: "<?php echo Portal::language('expected_room_soid');?>"
                },
                xAxis: {
                    categories: xAsis
                },
