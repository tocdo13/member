...
<tr><td>
	...
	<tr>
		...
		<p>&nbsp;</p>
		<font class="report_title"><?php echo Portal::language('debit_overbalance_report');?></font>
		<br><br>
		...
		<table border="0" align="center" id="select_time">
			...
			<tr>
			  ...
			  <td nowrap="nowrap">
                <p>
				    <input  name="customer_id" id="customer_id" / type ="hidden" value="<?php echo String::html_normalize(URL::get('customer_id'));?>">
                    <input  name="customer_name" id="customer_name" onfocus="CustomerAutocomplete();" autocomplete="off"/ type ="text" value="<?php echo String::html_normalize(URL::get('customer_name'));?>">
                </p>
