	...
	<span id="mi_telephone_number_sample">
		<div id="input_group_#xxxx#">
			...
			<span class="multi-input">
					<input  name="mi_telephone_number[#xxxx#][phone_number]" style="width:150px;" type="text" id="phone_number_#xxxx#" >
			</span>
			<span class="multi-input">
	...
	<tr valign="top">
		...
		<fieldset>
			<legend><?php echo Portal::language('multiple_item');?></legend>
					...
					<span>
						<span class="multi-input-header" style="width:150px;"><?php echo Portal::language('phone_number');?></span>
						<span class="multi-input-header" style="width:70px;"><?php echo Portal::language('room_id');?></span>
						<span class="multi-input-header" style="width:20px;"><img src="skins/default/images/spacer.gif"/></span>
					</span><br clear="all">
				</span><br clear="all">
			<input type="button" value="<?php echo Portal::language('add');?>" onclick="mi_add_new_row('mi_telephone_number');">
		</fieldset>
		</td>
	</tr>
	</table>
