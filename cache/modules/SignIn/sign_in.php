...
<!---<table width="550" cellpadding="5" cellspacing="0" align="center" style="background:url(packages/hotel/skins/default/images/reservation_bg.jpg) repeat-x;background-color:#FFFFFF;border:3px solid #3089E5;margin-left:auto;margin-right:auto;">--->
  <tr>
	...
	<form name="form1" method="post">
	  ...
	  <!---<tr>
		  <td class="simple_text" width="20%" align="center" nowrap="nowrap"><?php echo Portal::language('user_name');?></td>
	  </tr>--->
	  <tr>
	  ...
	  <!---<tr>
	      <td class="simple_text" width="20%" align="center"><?php echo Portal::language('password');?></td>
	  </tr>--->
	  <tr>
	...
	<tr>
	  <td colspan="2" align="center" class="simple_text">
	    <input class="w3-btn w3-round-xxlarge w3-orange w3-text-white" name="sign_in" type="submit" id="sign_in" value=" <?php echo Portal::language('login');?> " style="width:auto;height:auto;font-size:14px; text-transform: uppercase;"/>
		<p>&nbsp;</p>
      </td>
	 </tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="2" style="height: 100%">
      ...
      <tr>
	  	<td align="center" class="w3-text-white"><?php echo Portal::language('using_for');?>: <?php echo HOTEL_NAME?></td>
	  </tr>
	</table>
</td>
</tr>
