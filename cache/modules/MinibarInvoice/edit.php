...
function calculate_housekeeping_invoice_detail()
{
	...
	<?php //new NET_PRICE_SERVICE
	 if($this->map['net_price_minibar'] == 1) {?>
...
<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		<td width="75%" class="" style="font-size: 18px; padding-left: 15px;"><i class="fa fa-file-text w3-text-orange" style="font-size: 24px;"></i> <?php echo Portal::language('minibars_invoice');?></td>
		<td><input type="button" value="<?php echo Portal::language('Save');?>" class="w3-btn w3-blue w3-text-white" onclick=" return check_save();" />
		<input type="button" value="<?php echo Portal::language('list');?>" class="w3-btn w3-green w3-text-white" onclick="location='<?php echo URL::build_current();?>';"/></td>
	</tr>
</table>
	...
	<td width="100%">
            ...
            <tr>
                ...
                <table>
                	<tr>
                        ...
                        <td><?php echo $this->map['room_name'];?><input name="minibar_id" type="hidden" id="minibar_id" value="<?php echo $this->map['minibar_id'];?>"/>
                        </td>
                    </tr>
                    <tr>
                ...
                <th scope="col">Date: <?php echo $this->map['time'];?><?php 
                ...
                <td colspan="2">
                    <table border="1" bordercolor="#000000" style="border-collapse:collapse" cellspacing="0" cellpadding="5px">
                         <tr>
                            ...
                            <td class="td_quantity" align="center" width="50px"><?php echo Portal::language('consumed');?></td>
                            <td class="td_quantity" align="center" width="50px"><?php echo Portal::language('edit_consumed');?></td>
                            <td class="td_total_consumed" align="center" width="50px"><?php echo Portal::language('total_consumed');?></td>
                        ...
                        <tr>
                            <td align="right"><?php echo $this->map['items']['current']['no'];?></td>
                            <td class="td_quantity" align="center"><input type="text" value="<?php echo $this->map['items']['current']['quantity'];?>" name="items[<?php echo $this->map['items']['current']['id'];?>][quantity]" id="quantity_<?php echo $this->map['items']['current']['no'];?>" onkeyup="recalculate_housekeeping_invoice_detail(this,<?php echo $this->map['items']['current']['norm_quantity'];?>)" <?php if($this->map['items']['current']['quantity']>0){ ?>readonly="readonly" <?php }?> style="width:40px;text-align:center" class="input_number" autocomplete="OFF"/></td>
                            <td class="td_quantity" align="center"><input type="text" value="<?php echo $this->map['items']['current']['change_quantity'];?>" name="items[<?php echo $this->map['items']['current']['id'];?>][change_quantity]" id="change_quantity_<?php echo $this->map['items']['current']['no'];?>" onkeypress="return isNumberKey(event)" onkeyup="recalculate_housekeeping_invoice_detail_for_change(this,<?php echo $this->map['items']['current']['norm_quantity'];?>,<?php echo $this->map['items']['current']['quantity'];?>)" style="width:40px;text-align:center" autocomplete="OFF"/></td>
                            <td class="td_total_consumed" align="center"><span id="span_total_consumed_<?php echo $this->map['items']['current']['no'];?>" class="span_total_consumed"></span></td>
                            <td ><?php echo $this->map['items']['current']['name'];?></td>
                            <td align="center"><input type="text" name="items[<?php echo $this->map['items']['current']['id'];?>][price]" id="price_<?php echo $this->map['items']['current']['no'];?>" onkeyup="calculate_housekeeping_invoice_detail();" style="width:60px; text-align:center" value="<?php echo System::display_number($this->map['items']['current']['price']); ?>"/></td>
                            <td align="center"><span id="amount_<?php echo $this->map['items']['current']['no'];?>">&nbsp;</span></td>
                        </tr>
        ...
        <table width="100%" style="border-bottom:1px solid black">
            ...
            <tr>
                ...
                <td>
                    <input  name="total_discount" type="text" id="total_discount"   value="<?php echo $this->map['total_discount'];?>" readonly="readonly" style="width:99%;border:0 solid white;text-align:right"/>
                </td>
            </tr>
            <tr>
                <td width="290" align="right">
                    <?php echo Portal::language('fee');?>
                    (<input type="text" name="fee_rate" id="fee_rate" class="input_number"  style="width:20px; text-align:center; border:0px #FFFFFF" value="<?php echo $this->map['fee_rate'];?>" onkeyup="recalculate_housekeeping_invoice_detail();" />%)			
                </td>
                <td align="right">
            ...
            <tr>
                <td width="290" align="right">
                    ...
                    (<input type="text" name="tax_rate" id="tax_rate" class="input_number"  style="width:20px; text-align:center; border:0px #FFFFFF" value="<?php echo $this->map['tax_rate'];?>" onkeyup="recalculate_housekeeping_invoice_detail();" />%)			
                </td>
                <td align="right">
        ...
        <div style="color:red;font-size:16px;height:20px; text-align:center;border:0 solid white;width:100%"><?php echo $this->map['position'];?></div>
        <table width="100%">
            <tr>
                <td width="30%" align="left" colspan="3" style="border-top:1px solid black;"><?php echo Portal::language('guest_signature');?></td>
                <td>&nbsp;</td>
                <td width="30%" align="right" colspan="3" style="border-top:1px solid black;"><?php echo Portal::language('inventory_taken');?></td>
            </tr>
        </table>
	</td>
</tr>
