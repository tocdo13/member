...
<span style="display:none">
	<span id="room_repair_sample">
		<div id="input_group_#xxxx#">
            ...
            <span class="multi-edit-input">
					<input  name="room_repair[#xxxx#][start_time]" style="width:50px; text-align: left;" class="multi-edit-text-input" type="text" id="start_time_#xxxx#" value="<?php echo CHECK_OUT_TIME ?>">
			</span>
            <span class="multi-edit-input">
            ...
            <span class="multi-edit-input">
					<input  name="room_repair[#xxxx#][end_time]" style="width:50px; text-align: left;" class="multi-edit-text-input" type="text" id="end_time_#xxxx#" value="<?php echo CHECK_IN_TIME ?>">
			</span>
            <span class="multi-edit-input">
                			...
                			<div style="background-color:#EFEFEF;">
                				<span id="room_repair_all_elems">
                					<span style="white-space:nowrap; width:auto;">
                                        ...
                                        <span class="multi-edit-input_header">
                                            <span class="table-title" style="float:left;width:56px;text-align:left;">
                                                <?php echo Portal::language('start_time1');?>
                                            </span>
                                        </span>
                						<span class="multi-edit-input_header">
                                        ...
                                        <span class="multi-edit-input_header">
                                            <span class="table-title" style="float:left;width:56px;text-align:left;">
                                                <?php echo Portal::language('end_time1');?>
                                            </span>
                                        </span>
                						<span class="multi-edit-input_header">
                                            <span class="table-title" style="float:left;width:106px;text-align:center;">
...
jQuery(document).ready(function(){
    ...
    {
        jQuery('#start_time_'+i).mask('99:99');
        jQuery('#end_time_'+i).mask('99:99');
    }
