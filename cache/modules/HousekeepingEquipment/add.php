...
<table cellpadding="15" cellspacing="0" width="100%" border="0" bordercolor="#CCCCCC" class="table-bound">
	<tr>
		<td class="" width="60%" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;"><i class="fa fa-plus-square w3-text-orange" style="font-size: 26px;;"></i> <?php echo Portal::language('add_new_equipment');?></td>
		<td style="width: 40%; text-align: right; padding-right: 30px;">
			<input name="save" onclick="AddHousekeepingEquipmentForm.submit();" class="w3-btn w3-orange w3-text-white" value="<?php echo Portal::language('Save_and_close');?>" style="text-transform: uppercase; margin-right: 5px;"/>		
			<a href="<?php echo Url::build_current();?>" class="w3-btn w3-green" style="text-transform: uppercase; text-decoration: none;"><?php echo Portal::language('back');?></a>
		</td>
	</tr>
</table>
...
<div id="main_div_class">
	<fieldset>
        <legend class="" style="text-transform: uppercase;"><?php echo Portal::language('select');?></legend>
        <table>
                <tr>
                    <td><input  name="select_type" checked="checked" id="single" onclick="check_radio();" / type ="radio" value="<?php echo String::html_normalize(URL::get('select_type'));?>"></td>
                    <td><strong ><label for="single"><?php echo Portal::language('room_type_id');?> : </label></strong></td>
                    <td><select  name="room_level_id" id="room_level_id" style="width:100px" ><?php
                ...
                <tr>
                    <td><input  name="select_type" id="double" onclick="check_radio();" / type ="radio" value="<?php echo String::html_normalize(URL::get('select_type'));?>"></td>
                    <td><strong><label for="double"><?php echo Portal::language('room_id');?> : </label></strong></td>
                    <td><select  name="room_id" id="room_id" style="width:100px"><?php
        ...
        <!--<strong><?php echo Portal::language('room_type_id');?>: </strong><select  name="room_level_id" id="room_level_id" style="width:100px" ><?php
					if(isset($this->map['room_level_id_list']))
					{
						foreach($this->map['room_level_id_list'] as $key=>$value)
						{
        ...
        <strong><?php echo Portal::language('room_id');?>: </strong><select  name="room_id" id="room_id" style="width:100px"><?php
					if(isset($this->map['room_id_list']))
					{
						foreach($this->map['room_id_list'] as $key=>$value)
						{
...
<fieldset>
    <legend class="" style="text-transform: uppercase;"><?php echo Portal::language('housekeeping_equipment_detail');?></legend>
	<span id="mi_housekeeping_equipment_detail_all_elems">
		<span>
			...
			<span class="multi-input-header" style="width:200px;"><?php echo Portal::language('name');?></span>
			<span class="multi-input-header" style="width:100px;"><?php echo Portal::language('unit_name');?></span>
            <span class="multi-input-header" style="width:100px;"><?php echo Portal::language('price');?></span>            
			<span class="multi-input-header" style="width:80px;"><?php echo Portal::language('quantity');?></span>
			<span class="multi-input-header" style="width:20px;"><img src="skins/default/images/spacer.gif"/></span>
		</span>
		<br clear="all"/>
	</span>
	<input class="w3-btn w3-cyan w3-text-white" type="button" value="<?php echo Portal::language('add_item');?>" onclick="mi_add_new_row('mi_housekeeping_equipment_detail');myAutocomplete(input_count);" style="margin-top: 5px; text-transform: uppercase;"/>
</fieldset> 
