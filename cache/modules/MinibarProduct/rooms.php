...
<form name="ListForm" method="post">
	<table cellpadding="0" cellspacing="0" width="50%" border="0" bordercolor="#CCCCCC" class="table-bound">
		<tr>
        	<td class="" style="text-transform: uppercase; font-size: 18px; padding-left: 15px;width: 500px;"  nowrap><?php echo Portal::language('declare_minibar');?> </td>
...
function get_room_checked(type){
    if(jQuery('.room-button-select').length>=1){
        ...
        window.location='?page=minibar_product&cmd='+type+'&rooms='+ids+'';
    }else{
