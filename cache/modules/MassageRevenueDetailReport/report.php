                ...
                <tr>
    				<td colspan="2"> 
                        <div style="width:100%; text-align:center;">
                            <font class="report_title specific" ><?php echo Portal::language('service_revenue_report');?><br /></font>
        	...
        	<div>
            	<table width="100%">
                    ...
                    ?>
                                    ...
                                    <?php //}?>
                                    -->
                                    <td><?php echo Portal::language('service');?></td>
                                	<td ><select  name="product_id" id="product_id" style="width: 150px;"><?php
                    ...
                    ?>
                                	...
                                	<td><select  name="guest_id" id="guest_id" style="width: 150px;"><?php
					if(isset($this->map['guest_id_list']))
					{
						foreach($this->map['guest_id_list'] as $key=>$value)
						{
							echo '<option value="'.$key.'"';
							echo '>'.$value.'</option>';
                    ...
                    if(URL::get('guest_id',isset($this->map['guest_id'])?$this->map['guest_id']:''))
                    echo "<script>$('guest_id').value = \"".addslashes(URL::get('guest_id',isset($this->map['guest_id'])?$this->map['guest_id']:''))."\";</script>";
                    ?>
	</select></td>
                                    <!--
                                    <td><?php echo Portal::language('staff');?></td>
                                	<td><select  name="staff_id" id="staff_id"><?php
                    ...
                    ?>
                                    ...
                                    -->
                                    <td><?php echo Portal::language('from');?><input name="from_hours" id="from_hours" style="width:50px;height:20px;" onblur="validate_time(this,this.value);"/></td>
                                    ...
                                    <td><?php echo Portal::language('to');?><input name="to_hours" id="to_hours" style="width:50px;height:20px;" onblur="validate_time(this,this.value);"/></td>
...
<table  cellpadding="5" cellspacing="0" width="100%" border="1" bordercolor="#CCCCCC" class="table-bound" style="font-size:12px; border-collapse:collapse;">
	<tr bgcolor="#EFEFEF">
        <th class="report_table_header" width="10px"><?php echo Portal::language('stt');?></th>
        <th class="report_table_header" width="70px"><?php echo Portal::language('code');?></th>
        <th class="report_table_header" width="300px"><?php echo Portal::language('product_service');?></th>
        <th class="report_table_header" width="70px"><?php echo Portal::language('quantity');?></th>
        <th class="report_table_header" width="150px"><?php echo Portal::language('total_amount');?></th>
    </tr>
...
<!---------LAST GROUP VALUE----------->	        
    <tr>
        <td colspan="3" class="report_sub_title" align="right"><b><?php echo Portal::language('last_page_summary');?></b></td>
    ...
    <tr bgcolor="white">
        ...
        <td align="left" class="report_table_column"><?php echo $this->map['items']['current']['code'];?></td>
        <td align="left" class="report_table_column"><?php echo $this->map['items']['current']['name'];?></td>
...
<strong><?php echo Portal::language('no_data');?></strong>
				...
				?>
<script>
    var from_hours = '<?php echo $this->map['from_hours'];?>';
    var to_hours = '<?php echo $this->map['to_hours'];?>';
