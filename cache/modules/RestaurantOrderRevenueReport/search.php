...
<div id="main_div">
    <form name="SearchForm" id="SearchForm" method="post">
      <table>
        <tr>
            <td><h3 class="report-title-new"><?php echo Portal::language('restaurant_order_revenue_report');?></h3></td>
        </tr>
        <tr>
            <td align="center">
                <table id="table_main">
                            ...
                            <fieldset>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td><input  name="from_date" id="from_date" onchange="changevalue()" class="style_date" class="input-long-text" / type ="text" value="<?php echo String::html_normalize(URL::get('from_date'));?>"></td>
                                        <td><?php echo Portal::language('by_time');?></td>
                                        <td><input  name="start_time" id="start_time" onblur="validate_time(this,this.value);" class="input-short-text"/ type ="text" value="<?php echo String::html_normalize(URL::get('start_time'));?>"></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo Portal::language('to_date');?></td>
                                        <td><input  name="to_date" id="to_date" onchange="changefromday()" class="style_date" class="input-long-text"/ type ="text" value="<?php echo String::html_normalize(URL::get('to_date'));?>"></td>
                                        <td><?php echo Portal::language('by_time');?></td>
                                        <td><input  name="end_time" id="end_time" onblur="validate_time(this,this.value);" class="input-short-text" / type ="text" value="<?php echo String::html_normalize(URL::get('end_time'));?>"></td>
                                    </tr>
                                </table>   
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <td class="td-left"><label for="hotel_id"><?php echo Portal::language('Hotel');?></label></td>
                        <td colspan="2" class="td-right"><select  name="hotel_id" id="hotel_id" class="input-long-text" onchange="get_bar(this);"><?php
                    ...
                    <tr>
                        <td class="td-left"><label> <?php echo Portal::language('revenue');?></label></td>
                    ...
                    <tr>
                        <td class="td-left"><label><?php echo Portal::language('user_status');?></label></td>
                        <td colspan="2" class="td-right">
                            <!-- 7211 -->  
                    ...
                    <tr>
                        <td class="td-left"><label><?php echo Portal::language('user');?></label></td>
                        <td colspan="2" class="td-right"><select  name="user_id" id="user_id" class="input-long-text"><?php
                    ...
                    <tr>
                        <td class="td-left"><label><?php echo Portal::language('customer_code');?></label></td>
                        <td colspan="2" class="td-right"><input  name="code" id="code" onfocus="customerAutocomplete();" autocomplete="off" class="input-long-text"/ type ="text" value="<?php echo String::html_normalize(URL::get('code'));?>"></td>
                    </tr>
                    <tr>
                        <td class="td-left"><label><?php echo Portal::language('vat_code');?></label></td>
                        <td colspan="2" class="td-right"><input  name="from_code" id="from_code" class="input_number input-short-text"/ type ="text" value="<?php echo String::html_normalize(URL::get('from_code'));?>"><label><?php echo Portal::language('to');?>:</label><input  name="to_code" id="to_code" class="input_number input-short-text"/ type ="text" value="<?php echo String::html_normalize(URL::get('to_code'));?>"></td>
                    </tr>
                    <tr>
                        <td class="td-left"></td>
                        <td style="width: 20px;"><input  name="checked_all" id="checked_all" / type ="checkbox" value="<?php echo String::html_normalize(URL::get('checked_all'));?>"></td>
                        <td class="td-right"><b><label for="checked_all"><?php echo Portal::language('select_all_bar');?></label></b></td>
                    </tr>
				...
				?>
                              <td class="td-right"><label for="bar_id_<?php echo $this->map['bars']['current']['id'];?>"><?php echo $this->map['bars']['current']['name'];?></label></td>
                         </tr>
                        ...
                        <td colspan="3" style="position: relative;">
                            <fieldset style="position: absolute;top: -8px;width: 99%;">
                                <legend>
                                    ...
                                    <label style="margin-bottom: 10px;display:inline-block;"><?php echo Portal::language('bill_id');?>:</label>
                                    <input  name="from_bill" id="from_bill" class="input_number b_blur" style="width:75px;" onchange="fun_check_bill();"  readonly/ type ="text" value="<?php echo String::html_normalize(URL::get('from_bill'));?>">
                                    <label><?php echo Portal::language('to');?>:</label> 
                                    <input  name="to_bill" id="to_bill" class="input_number b_blur" style="width:75px;" onchange="fun_check_bill();"   readonly/ type ="text" value="<?php echo String::html_normalize(URL::get('to_bill'));?>">
                            </fieldset>
                        </td>
                     </tr>
                </table>
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            alert('<?php echo Portal::language('the_vat_number_is_not_valid_try_again');?>');
                            return false;
                        }
                    }
                }
