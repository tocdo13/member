...
<div>
    ...
    <div style="padding:10px; ">
        <div style="text-align:center;">
        	<!--div class="report_title"><?php echo Portal::language('warehouse_remain_synthesis_report');?></div-->
        	<div class="report_title"><?php echo Portal::language('warehouse_remain_synthesis_report');?></div>

        	<br/><strong><?php echo Portal::language('date');?> <?php echo $this->map['date'];?></strong><br/><br />
        </div>
        	...
        	<table id="tblExport" cellpadding="2" cellspacing="0" bordercolor="#000000" border="1" width="100%">
                <thead>
                    <tr valign="middle" align="center" style="background-color: #D8D8D8;">
                        <th style="width:10px;background-color: #D8D8D8;" class="report_table_header"><?php echo Portal::language('stt');?></th>
                    	<th style="width:70px;background-color: #D8D8D8;" class="report_table_header"><?php echo Portal::language('id');?></th>
                        <th style="width:200px;background-color: #D8D8D8;;" class="report_table_header"><?php echo Portal::language('product_name');?></th>
                        <th style="width:70px;background-color: #D8D8D8;" class="report_table_header"><?php echo Portal::language('unit');?></th>
                        <?php if(isset($this->map['group_wh']) and is_array($this->map['group_wh'])){ foreach($this->map['group_wh'] as $key1=>&$item1){if($key1!='current'){$this->map['group_wh']['current'] = &$item1;?>
                        <th style="background-color: #D8D8D8;" class="report_table_header"><?php echo $this->map['group_wh']['current']['name'];?></th>
                        <?php }}unset($this->map['group_wh']['current']);} ?>
                        <th style="width:80px;background-color: #D8D8D8;" class="report_table_header"><?php echo Portal::language('remain1');?></th>
                    </tr>
                </thead>
                <?php
            ...
            <table cellspacing="0" cellpadding="2" style="background: white; position: absolute; top:0px; z-index:99999; width: 100%; table-layout: fixed; display:none;" border="1" id="hidTable">
                <thead style="width: 100%;"> 
                    <tr valign="middle" align="center"  style="width: 100%;">
                        ...
                        <th style="width:200px;background-color: #D8D8D8;" class="report_table_header"><?php echo Portal::language('product_name');?></th>
                        <th style="width:70px;background-color: #D8D8D8;" class="report_table_header"><?php echo Portal::language('unit');?></th>
                        <?php if(isset($this->map['group_wh']) and is_array($this->map['group_wh'])){ foreach($this->map['group_wh'] as $key2=>&$item2){if($key2!='current'){$this->map['group_wh']['current'] = &$item2;?>
                        <th class="report_table_header" style="background-color: #D8D8D8;"><?php echo $this->map['group_wh']['current']['name'];?></th>
                        <?php }}unset($this->map['group_wh']['current']);} ?>
                        <th style="width:80px;background-color: #D8D8D8;" class="report_table_header"><?php echo Portal::language('remain1');?></th>
                    </tr>
                </thead> 
        ...
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td align="right" width="45%"><em><?php echo Portal::language('day');?> <?php echo date('d');?> <?php echo Portal::language('month');?> <?php echo date('m');?> <?php echo Portal::language('year');?> <?php echo date('Y');?> </em></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td align="center"><strong><?php echo Portal::language('warehouseman');?></strong> </td>
                </tr>
            </table>
        </div>
    </div>	
