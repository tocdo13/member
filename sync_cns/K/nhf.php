    ...
    function sync_wh_invoice_nhf()
    {
        ...
        foreach($warehouse as $key=>$value)
        {
            ...
            if(!isset($row[$value['wh_id']]))
            {
                ...
                $row[$value['wh_id']]['ReferenceKey'] = 'NHF'.$value['bill_number'];
                ...
                $row[$value['wh_id']]['TransTypeCode'] = 'NHF';
                $row[$value['wh_id']]['Code'] = 'NHF'.$value['bill_number'];
            ...
            $row[$value['wh_id']]['WarehouseTransactionDetails'][$stt]['ParentReferenceKey'] = 'NHF'.$value['bill_number'];
