<?php
    function sync_wh_invoice_xhhdc()
    {
        set_time_limit(-1);
        ...
        foreach($warehouse as $key=>$value)
        {
            ...
            if(!isset($row[$value['wh_id']]))
            {
                ...
                $row[$value['wh_id']]['ReferenceKey'] = 'XHHDC'.$value['bill_number'];
                ...
                $row[$value['wh_id']]['TransTypeCode'] = 'XHHDC';
                $row[$value['wh_id']]['Code'] = 'XHHDC'.$value['bill_number'];
            ...
            $row[$value['wh_id']]['WarehouseTransactionDetails'][$stt]['ParentReferenceKey'] = 'XHHDC'.$value['bill_number'];
