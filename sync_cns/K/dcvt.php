    ...
    function sync_wh_invoice_dcvt()
    {
        ...
        foreach($warehouse as $key=>$value)
        {
            if(!isset($row[$value['wh_id']]))
            {
                ...
                $row[$value['wh_id']]['ReferenceKey'] = 'DCVT'.$value['bill_number'];
                ...
                $row[$value['wh_id']]['TransTypeCode'] = 'DCVT';
                $row[$value['wh_id']]['Code'] = 'DCVT'.$value['bill_number'];
            ...
            $row[$value['wh_id']]['WarehouseTransactionDetails'][$stt]['ParentReferenceKey'] = 'DCVT'.$value['bill_number'];
