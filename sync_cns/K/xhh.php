<?php
    function sync_wh_invoice_xhh()
    {
        ...
        $warehouse = DB::fetch_all("
                                    ...
                                    WHERE 
                                        wh_invoice.sync_cns_hh=0
                                        and wh_invoice.type='EXPORT'
                                        and (product.type='GOODS' OR product.type='PRODUCT')
        ...
        foreach($warehouse as $key=>$value)
        {
            ...
            if(!isset($row[$value['wh_id']]))
            {
                ...
                $row[$value['wh_id']]['ReferenceKey'] = 'XHH'.$value['bill_number'];
                ...
                $row[$value['wh_id']]['TransTypeCode'] = 'XHH';
                $row[$value['wh_id']]['Code'] = 'XHH'.$value['bill_number'];
            ...
            $row[$value['wh_id']]['WarehouseTransactionDetails'][$stt]['ParentReferenceKey'] = 'XHH'.$value['bill_number'];
            ...
            $row[$value['wh_id']]['WarehouseTransactionDetails'][$stt]['CaseItemCode'] = '';
            $row[$value['wh_id']]['WarehouseTransactionDetails'][$stt]['FeeItemCode'] = '';
