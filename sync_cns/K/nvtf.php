    ...
    function sync_wh_invoice_nvtf()
    {
        ...
        foreach($warehouse as $key=>$value)
        {
            ...
            if(!isset($row[$value['wh_id']]))
            {
                ...
                $row[$value['wh_id']]['ReferenceKey'] = 'NVTF'.$value['bill_number'];
                ...
                $row[$value['wh_id']]['TransTypeCode'] = 'NVTF';
                $row[$value['wh_id']]['Code'] = 'NVTF'.$value['bill_number'];
            ...
            $row[$value['wh_id']]['WarehouseTransactionDetails'][$stt]['ParentReferenceKey'] = 'NVTF'.$value['bill_number'];
