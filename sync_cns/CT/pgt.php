<?php 
    function sync_payment_pgt()
    {
        ...
        foreach($payment as $key=>$value)
        {
            ...
            $row['TotalTax'] = 0;
            $row['ContactCode'] = 'ACC_'.$value['user_id'];
            $row['ContactCode2'] = $contact_code_2;
            $row['CustomerName'] = '';
            $row['CustomerAddress'] = '';
            $row['CustomerTaxCode'] = '';
            ...
            $row['AccountingTransactionDetails'][0]['ContactCode'] = 'ACC_'.$value['user_id'];
            $row['AccountingTransactionDetails'][0]['ContactCode2'] = $contact_code_2;
